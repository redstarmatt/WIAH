      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Intergenerational wealth transmission is the dominant driver of persistent inequality. Around &pound;5.5 trillion in housing equity sits with over-65s, and annual inheritance flows now exceed &pound;90 billion &mdash; overwhelmingly benefiting families already in the top half of the wealth distribution. Private school attendance, at 6&ndash;7&percnt; of pupils, accounts for a disproportionate share of elite university places and senior professional roles. The gender wealth gap runs at roughly 35&percnt;, driven by pension disparities rooted in part-time work and caring responsibilities. Geographic concentration is stark: 14 of the 20 most deprived local authorities are in the North West or North East. Universal Credit simplified the benefits system but its five-week wait and two-child limit have deepened hardship for the poorest families. Consumption inequality is notably lower than income inequality, partly because poorer households spend a higher share on essentials whose prices rose fastest during the 2022&ndash;23 inflation spike.</p>
            <p>The Gini coefficient, while widely cited, compresses an entire income distribution into a single number and is particularly poor at capturing extremes &mdash; it understates both deep poverty and extreme wealth. The ONS Wealth and Assets Survey is conducted biennially with a two-year publication lag, meaning the latest data typically reflects conditions three to four years earlier. Household-level measures obscure intra-household inequality, particularly disadvantaging women in single-earner couples. The very wealthy systematically avoid survey participation, and HMRC&apos;s Survey of Personal Incomes is known to undercount top incomes by 15&ndash;20&percnt; compared with tax return data. ONS has revised its equivalisation methodology and income definitions multiple times since 2002, creating breaks in the time series that make long-run comparisons unreliable without careful adjustment. Consumption-based measures often tell a materially different story from income-based ones.</p>
          </div>
        </section>
