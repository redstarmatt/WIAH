      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The ONS Wealth and Assets Survey (2020&ndash;22) found that the richest 10% of households hold 43% of all UK household wealth &mdash; up from 38% in 2006&ndash;08 &mdash; while the bottom 50% share just 9%. This is not primarily a story about income inequality, which has been broadly stable since the mid-1990s: it is a story about the accumulation of assets, above all property and pensions. Median household wealth for the under-25s stands at around &pound;12,000; for those aged 65&ndash;74 it reaches &pound;462,000. Annual inheritance flows now exceed &pound;90 billion, and the IFS projects that inheritance will become more important than lifetime earnings as a determinant of wealth for cohorts born after 1980. The Bank of Mum and Dad is already the effective tenth-largest mortgage lender by volume. The UK tax system taxes wealth lightly: capital gains tax runs at 18&ndash;28%, and IHT &mdash; nominally 40% above the &pound;325,000 threshold &mdash; raises only around &pound;8bn a year after reliefs.</p>
            <p>Housing is the engine of wealth inequality, combining leverage, tax privilege, and inter-generational transfer at scale. A homeowner who bought in the 1990s has accumulated life-changing paper gains; a private renter over the same period accumulated nothing and paid, in aggregate, more than mortgage repayments on an equivalent property would have cost. Median household wealth in London and the South East is roughly double that in the North East, Yorkshire, and Wales &mdash; almost entirely because house price appreciation has been concentrated in the south. The gender wealth gap runs at roughly 35&percnt;, driven by pension disparities rooted in part-time work and caring responsibilities. Pension auto-enrolment has enrolled over 10 million previously unsaved workers since 2012, the one genuinely progressive structural intervention in an otherwise widening picture.</p>
          </div>
        </section>
