      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="recovering from 2023 low · still half 2021 peak"
              sparklineData={[4.8, 6.1, 8.3, 11.9, 14.2, 29.4, 17.2, 13.2, 15.1]}
              href="#sec-chart"source="Beauhurst / DCMS Tech Nation · 2024"
            />
            <MetricCard
              ...
              href="#sec-callout"source="Beauhurst / DCMS Tech Nation · 2024"
            />
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText="concentration risk · regional gap growing"
              sparklineData={[61, 62, 63, 62, 63, 64, 63, 62, 62]}
              href="#sec-callout"source="Beauhurst · 2024"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="UK venture capital investment, 2016–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Beauhurst — UK Startup and Venture Capital Data. beauhurst.com</p>
            <p>DCMS — Tech Nation Report. technation.io/report</p>
            <p>British Business Bank — Small Business Finance Markets Report. british-business-bank.co.uk</p>
