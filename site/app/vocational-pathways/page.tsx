      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>England&apos;s vocational education system has long promised parity with academic routes &mdash; yet the earnings data tells a different story. Young people who complete BTEC or equivalent level 3 vocational qualifications earn on average &pound;4,200 less per year than peers who studied A-levels and entered similar occupations, a gap that has widened steadily since 2015. BTEC completion rates fell from 72% in 2015 to 68% in 2023, partly driven by the per-pupil funding gap between FE colleges and schools of around &pound;3,000 per 16&ndash;18-year-old per year. Employer satisfaction with vocational leavers fell from 58% to 54% over the same period, reflecting a genuine mismatch between what qualifications test and what workplaces require. The apprenticeship levy, reformed in 2017, has shifted funding towards degree apprenticeships and management training for existing employees rather than Level 2 and 3 routes for school leavers; under-19 starts fell from over 350,000 a decade ago to fewer than 200,000 in 2023.</p>
            <p>The consequences are generational and regressive. Young people from lower-income households are significantly more likely to take vocational routes, so the earnings disadvantage maps directly onto existing inequality. A system that consistently undervalues technical skills also perpetuates the shortages in construction, engineering, healthcare, and digital that constrain growth. The evidence base for solutions is strong &mdash; structured industry placements, employer-led qualification design, FE funding parity &mdash; but chronic underfunding of colleges and consistent political prioritisation of academic routes have prevented sustained reform.</p>
          </div>
        </section>
