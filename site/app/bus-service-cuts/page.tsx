      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              changeText="-40% since 2010 · 3,000 villages with no service"
              sparklineData={[100, 97, 94, 91, 88, 85, 80, 76, 72]}
              href="#sec-chart"source="DfT · Bus Statistics Annual Report 2024"
            />
            <MetricCard
              label="Bus routes cut 2010–2024"
              value="3,780"
              unit=""
              ...
              href="#sec-chart"source="Campaign for Better Transport · Bus Report 2024"
            />
            <MetricCard
              ...
              direction={'down' as const}
              polarity={'up-is-good' as const}
              changeText="Down from 5bn peak · 30-year low"
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Local bus miles operated in England (index, 2010=100), 2016–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Department for Transport — Bus Statistics Annual Report. Published annually. gov.uk/government/collections/bus-statistics</p>
            <p>Campaign for Better Transport — Bus Report 2024. bettertransport.org.uk</p>
