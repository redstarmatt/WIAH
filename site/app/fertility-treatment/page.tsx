      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Since 2004, NICE guidance has recommended the NHS offer up to three full cycles of IVF to eligible women aged 23&ndash;42. Two decades later, that standard is met by fewer than half of England&apos;s 42 integrated care systems: the proportion of ICSs offering the full three cycles has fallen from around 60&percnt; in 2016 to just 45&percnt; in 2023, as local commissioners scaled back eligibility criteria, raised age cut-offs, or reduced funded cycles to manage budget pressures. Of approximately 54,000 IVF cycles carried out in the UK each year, roughly 16,500 &mdash; under a third &mdash; are NHS-funded; the remainder cost patients &pound;5,000 to &pound;10,000 per cycle. Average NHS waiting times have extended from nine months in 2016 to 18 months in 2023, a medically significant delay given that female fertility declines with age. NHS cycle numbers in 2023 remain approximately 15&percnt; below the 2018 peak; private cycles reached record highs over the same period.</p>
