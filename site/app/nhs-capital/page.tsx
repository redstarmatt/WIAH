    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The NHS maintenance backlog has tripled from £4.3 billion in 2014 to £13.8 billion in 2024. One in four NHS buildings is rated high-risk for infrastructure failure. Forty-two trusts have buildings containing RAAC — the same crumbling concrete that closed schools."
          colour="#6B7280"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2024 · Tripled from £4.3bn in 2014 · Growing £1bn+ per year"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2024 · 1 in 4 buildings at risk of failure · Up from 12% in 2014"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2024 · Up from 27 in 2022 · Survey incomplete — true number likely higher"
        ...
        <ScrollReveal>
          <section id="sec-backlog" className="mb-12">
            <LineChart
              title="NHS maintenance backlog, England, 2014–2024"
              subtitle="Estimated cost to restore NHS buildings to acceptable standard, in £ billions."
        ...
        <ScrollReveal>
          <section id="sec-spending" className="mb-12">
            <LineChart
              title="NHS capital spending (real terms), England, 2014–2024"
              subtitle="Total capital expenditure in 2024 prices, £ billions."
        ...
        <ScrollReveal>
          <section id="sec-risk" className="mb-12">
            <LineChart
              title="High-risk NHS infrastructure, England, 2014–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>NHS Digital — ERIC (Estates Returns Information Collection). Self-reported data from all NHS trusts in England covering building condition, maintenance backlog, energy consumption, and capital investment. Published annually.</p>
            <p>NHS England / NAO — Capital expenditure data. Real-terms figures adjusted to 2024 prices using GDP deflator.</p>
            <p>DHSC — RAAC survey programme. Confirmed RAAC presence in NHS trust buildings. Survey ongoing; figures represent confirmed cases only.</p>
