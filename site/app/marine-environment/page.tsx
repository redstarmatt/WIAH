      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The UK manages one of the world&apos;s largest marine estates &mdash; approximately 900,000 square kilometres &mdash; with 38% formally designated as Marine Protected Areas. On paper that exceeds the global 30&times;30 target; in practice only 36% of MPA features are in favourable condition, and bottom trawling continues in 90% of offshore MPAs. Fish stocks have deteriorated: ICES assessed 49% of UK stocks at or below maximum sustainable yield in 2024, down from 57% in 2016, with Celtic Sea cod well below safe biological limits. Coastal litter has fallen from a peak of 718 items per 100m in 2017 to 385 in 2023 following single-use plastics bans, but microplastics are now found in every marine sample around UK coasts and DEFRA&apos;s 2024 Marine Strategy assessment found Good Environmental Status for litter has not been achieved.</p>
