      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The economics of gig work are significantly worse than headline rates suggest. TUC research based on worker surveys consistently finds that once vehicle costs, fuel, insurance, equipment, data, and unpaid waiting time are factored in, effective hourly earnings for delivery and ride-hailing workers fall substantially below the National Minimum Wage. The platform pays per task or per mile, but workers bear all the capital costs of the work &mdash; typically a vehicle, bicycle, or scooter &mdash; and spend significant unpaid time waiting for jobs, navigating, and managing platform apps. A 2021 TUC survey found that 38&percnt; of gig workers earned less than &pound;8.72 per hour (then the National Living Wage) after costs, with delivery workers most exposed. Gig workers are also classified as self-employed for National Insurance purposes, meaning neither they nor their engagers pay employer NI contributions, reducing their access to contributory benefits and lowering the tax base for state services.</p>
            <p>The legal landscape shifted dramatically with the Supreme Court&apos;s ruling in Uber BV v Aslam [2021] UKSC 5. The Court unanimously held that Uber drivers were &ldquo;workers&rdquo; rather than self-employed contractors under the Employment Rights Act 1996, entitling them to minimum wage, holiday pay, and rest breaks. The ruling applied to the period when the meter was running &mdash; including time spent waiting for jobs within the Uber zone &mdash; and exposed Uber to substantial back-pay liabilities. Critically, however, the ruling did not automatically reclassify all gig workers as workers: it applied only to the specific facts of the Uber case, and other platforms have sought to structure their engagements to avoid the same conclusion. Deliveroo successfully argued in 2021 that its riders were genuinely self-employed because they could substitute other riders for their shifts, a test the Supreme Court accepted as sufficient for non-worker status. The Employment Rights Bill 2024 proposes new rules on worker classification, but implementation will depend on secondary legislation and tribunal interpretation.</p>
            <p>The gig economy&apos;s impact is disproportionately felt by younger workers, migrant workers, and those in urban areas with high costs of living. Workers aged 18&ndash;30 account for approximately 55&percnt; of gig economy participants, often combining platform work with other part-time or casual employment. In London and other major cities, delivery workers are disproportionately from Black, Asian, and minority ethnic backgrounds &mdash; a pattern that reflects both the concentration of platform work in urban areas and the barriers to conventional employment faced by new migrants and workers without UK qualifications. Research by the Work Rights Centre found that many migrant gig workers did not understand their legal employment status, lacked language support to access dispute resolution, and were disproportionately targeted by HMRC for tax compliance checks while the platforms themselves faced limited scrutiny. Regional concentration is striking: around 40&percnt; of all UK gig economy workers are based in London and the South East, though rural areas have seen growth in agricultural gig labour and care platform work.</p>
            <p>Measuring the gig economy presents substantial methodological challenges. There is no official ONS definition of &ldquo;gig work,&rdquo; and the Labour Force Survey does not contain a question that directly identifies platform workers. Most estimates rely on purpose-built surveys with non-random sampling methods, creating significant uncertainty around precise numbers. The TUC/University of Hertfordshire surveys use online panels weighted by demographics, but gig workers may be over- or under-represented depending on the panel characteristics. Platform companies do not disclose active worker numbers as standard; Uber, Deliveroo, and Just Eat report selected metrics in annual reports but use different definitions of &ldquo;active courier&rdquo; or &ldquo;active driver.&rdquo; Academic estimates based on bank transaction data (Lloyds Banking Group analysis, 2019) suggested 4.7 million people had received income from a digital platform at least once in a year &mdash; but this includes people for whom gig work is entirely marginal. The ONS has been developing improved measurement methodology since 2020 but consistent official estimates remain unavailable as of 2024.</p>
          </div>
        </section>
