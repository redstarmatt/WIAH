      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>England had 99,000 NHS hospital beds in 2022/23 &mdash; down from 135,000 in 2010 and a post-war peak of 300,000 in 1987. At 2.1 beds per 1,000 population, England has the lowest density in western Europe (EU average 5.4; Germany 8.0; France 5.9). Average bed occupancy reached 94% in 2022/23, well above the 85% threshold above which infection-control protocols become difficult and patient safety outcomes deteriorate &mdash; and occupancy has not fallen below 88% since 2012/13. The proximate driver is delayed discharge: 13,500 patients per day occupy acute beds while clinically fit for discharge, blocked by the absence of a care home place, domiciliary care package, or social housing arrangement &mdash; roughly 1 in 8 acute beds consumed by social care failure rather than clinical need. A King&apos;s Fund analysis estimated England needs 10,000 additional beds to bring occupancy to safe levels, at a capital cost of approximately &pound;5 billion.</p>
            <p>Running at 94% occupancy leaves no flex capacity for winter surges: the 2022/23 winter, when Covid, influenza, and RSV peaked simultaneously, was a predictable consequence of structural zero slack. Each winter&apos;s surge compounds into the next year&apos;s elective backlog, reducing capacity for the following emergency season. The delayed discharge burden falls disproportionately on older patients, those with dementia, and those in areas where social care vacancy rates are highest &mdash; typically rural communities and areas of higher deprivation where care homes and domiciliary providers cannot recruit at the wages local authorities are able to fund.</p>
          </div>
        </section>
