      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              href="#sec-chart"source="Law Society · Legal aid desert mapping"
            />
            <MetricCard
              ...
              href="#sec-chart"source="Ministry of Justice · Legal aid statistics"
            />
            <MetricCard
              label="Litigants in person in family courts"
              value="36%"
              ...
              href="#sec-chart"source="HMCTS · Family court statistics"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Legal aid cases and deserts, 2010–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Ministry of Justice — Legal aid statistics. Published quarterly. gov.uk/government/collections/legal-aid-statistics</p>
            <p>Legal Aid Agency — Provider data and contract information. gov.uk/government/organisations/legal-aid-agency</p>
            <p>Law Society — Legal aid deserts report and provider mapping. lawsociety.org.uk</p>
            <p>Access to Justice Foundation — Civil legal need research. atjf.org.uk</p>
