...
const editorialRefs: Reference[] = [
  { num: 1, name: 'Vrije Universiteit Amsterdam', dataset: 'Discovery and quantification of plastic particle pollution in human blood (Leslie et al.)', date: '2022', note: 'Published in Environment International', url: 'https://research.vu.nl/' },
