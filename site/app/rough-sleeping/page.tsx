        ...
        <section className="max-w-4xl mx-auto px-4 py-8">
          ...
          <section id="sec-context" className="max-w-2xl mt-4 mb-12">
            <div className="text-base text-wiah-black leading-[1.7] space-y-4">
              <p>In spring 2020, the government housed virtually every rough sleeper in England in six weeks. The &ldquo;Everyone In&rdquo; emergency scheme took around 14,600 people off the streets and into hotel rooms as COVID-19 spread &mdash; and the annual rough sleeping count fell from 4,266 in 2019 to 2,440 by 2021. It was the single most effective intervention in the history of homelessness policy. It also made plain what the preceding decade of rising counts &mdash; from 1,768 in 2010 to a peak of 4,751 in 2017 &mdash; had already suggested: rough sleeping is a policy choice, not an immovable social fact.</p>
              <p>Once Everyone In ended and emergency funding was withdrawn, the count climbed again. By autumn 2023 it stood at 3,898 &mdash; a 27% rise in a single year. That figure is itself an undercount: it is a single-night snapshot, and researchers at Crisis estimate the true number is three to five times higher. Behind the visible rough sleeping crisis sits a much larger homelessness emergency. A record 112,660 households &mdash; including 145,000 children &mdash; were in temporary accommodation in 2023, up from around 70,000 a decade earlier. Average stays in B&amp;Bs, hostels and emergency placements have risen from 50 to over 90 weeks. The average rough sleeper dies at 45 &mdash; against 76 for the general population &mdash; and is nine times more likely to take their own life.</p>
              <p>The primary trigger for homelessness is now the end of private sector tenancies. Section 21 &ldquo;no-fault&rdquo; evictions accounted for 25% of all homelessness presentations before their planned abolition under the Renters (Reform) Act 2024, which has been repeatedly delayed. Universal Credit delays, prison discharge directly into homelessness, and inadequate mental health pathways together account for a large share of the remainder. The Rough Sleeping Initiative has been funded at &pound;300 million since 2018 and has helped contain the numbers; Housing First pilots in Greater Manchester, Liverpool and the West Midlands show 80%-plus housing retention rates for people with complex needs. But supply remains the binding constraint: England builds roughly 220,000 homes a year, social housing stock has fallen by 1.5 million since 1980, and housing benefit rates have persistently lagged behind market rents.</p>
            </div>
          </section>
