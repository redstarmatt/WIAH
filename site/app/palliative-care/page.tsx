...
const editorialRefs: Reference[] = [
  { num: 1, name: 'Hospice UK', dataset: 'Hospice accounts and funding data', date: '2024', url: 'https://www.hospiceuk.org/our-campaigns-and-policy/policy-and-influencing/research-and-publications' },
