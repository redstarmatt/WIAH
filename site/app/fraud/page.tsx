      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The Crime Survey for England and Wales estimates 3.8 million fraud and computer misuse offences annually &mdash; more than burglary, robbery, vehicle crime, and violent crime combined. Yet fraud remains the least-policed crime in the country. Of the roughly 900,000 cases reported to Action Fraud each year, around 80,000 are referred to police forces for investigation. Fewer than 8,000 result in charges. The conviction rate, measured against reported cases, hovers at approximately 1&percnt;. For most victims, reporting fraud is an exercise in documentation rather than an entry point to justice.</p>
