...
export const metadata: Metadata = {
  ...
  description: 'Remote working has driven rural house prices up 8% above pre-pandemic trend &mdash; and 38% of rural areas now have price-to-earnings ratios above 10.',
  openGraph: {
    title: 'Are Rural Areas Becoming Unaffordable?',
    description: 'Remote working has driven rural house prices up 8% above pre-pandemic trend &mdash; and 38% of rural areas now have price-to-earnings ratios above 10.',
    type: 'article',
