      ...
      <main className="bg-white">
        ...
        <section id="sec-context" className="max-w-2xl mx-auto px-4 sm:px-6 mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Around 410,000 people live in residential and nursing care homes in England, most in the final years of their lives. The system is under sustained pressure from three directions: a workforce that cannot retain staff, local authority commissioners unable to pay full cost, and a means-testing threshold unchanged since 2010. Self-funders &mdash; 44% of residents &mdash; pay on average &pound;59,000 per year for nursing care and effectively cross-subsidise council-funded residents. The local authority funding gap in adult social care is estimated at &pound;4 billion. Adult social care had 131,000 vacancies in 2023 (down from a record 152,000 in 2022), with a turnover rate of 28.3% annually; overseas workers now fill one in three new roles. Over 400 care homes closed between 2019 and 2023, and 25% of CQC-inspected homes are rated &ldquo;requires improvement&rdquo; or &ldquo;inadequate.&rdquo;</p>
            <p>The consequences extend well beyond the homes themselves. More than 13,000 people occupy hospital beds on any given day while waiting for a social care placement, directly driving NHS delayed discharge and A&amp;E pressures. An estimated 3.5 million unpaid carers in England are in effect the invisible infrastructure keeping large numbers of people out of residential care, at considerable cost to their own health and employment. The Dilnot care cap, under discussion for 13 years, was delayed and abandoned &mdash; leaving those who face catastrophic care costs with no protection.</p>
          </div>
        </section>
