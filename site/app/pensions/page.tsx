      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              The triple lock has increased the full new state pension from &pound;97.65 per week in 2010 to &pound;221.20 in 2025/26 &mdash; a 127% cash rise &mdash; at a cost of &pound;124 billion annually, the single largest welfare line item. Auto-enrolment, launched in 2012, reversed decades of declining private pension coverage: participation rose from 47% of eligible employees to 88% by 2023, with 22.6 million workers enrolled and total contributions running at &pound;133 billion per year. Despite these twin achievements, 2.1 million pensioners &mdash; 19.1% &mdash; live below the poverty line after housing costs, the highest rate since 2011, as the cost-of-living crisis reversed a decade of improvement. Roughly 880,000 eligible pensioners do not claim Pension Credit, worth up to &pound;11,400 per year, leaving &pound;2.1 billion unclaimed.
            </p>
            <p>
              Pensioner poverty is not evenly distributed. Single female pensioners face a 24% poverty rate versus 13% for couples, driven by lower lifetime earnings, part-time work, and career breaks for caring. Private renters over 65 spend 33% of income on housing versus 10% for owner-occupiers &mdash; a gap that makes them acutely vulnerable to rent inflation. Pensioners from Pakistani and Bangladeshi backgrounds face poverty rates above 30%, reflecting historical patterns of lower-paid work and limited occupational pension access. The North East and Wales record the highest regional rates. Women born in the 1950s whose state pension age rose rapidly under the 2010 Pensions Act received an Ombudsman ruling of maladministration in 2024; the question of compensation remains unresolved.
            </p>
          </div>
        </section>
