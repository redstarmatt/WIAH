      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Pensioner poverty is not evenly distributed. Single female pensioners face the highest risk &mdash; 24&percnt; live below the poverty line after housing costs, compared with 13&percnt; of pensioner couples &mdash; a gap driven by lower lifetime earnings, part-time work, and career breaks for caring responsibilities. Private renters over 65, a small but growing group, spend 33&percnt; of their income on housing versus 10&percnt; for those who own outright, making them acutely sensitive to inflation in essentials. Ethnicity compounds the picture: pensioners from Pakistani and Bangladeshi backgrounds have poverty rates above 30&percnt;, reflecting historical patterns of lower-paid employment and limited access to occupational pensions. Geographically, the North East and Wales have the highest rates of pensioner poverty, while the South East has the lowest. Pension Credit&apos;s 33&percnt; non-take-up rate &mdash; worth an estimated &pound;2.1 billion in unclaimed entitlement &mdash; reflects a combination of stigma, complexity, and poor awareness, particularly among those without internet access.</p>
            <p>Pension adequacy is difficult to measure with precision. The Households Below Average Income survey, which produces the official poverty statistics, uses a relative threshold (60&percnt; of median income after housing costs) that shifts with the wider income distribution &mdash; meaning pensioner poverty can rise even if pensioner incomes are stable, simply because working-age incomes grow faster. The gender pension gap is estimated from survey data and tax records, but private pension wealth is unevenly reported: defined-benefit scheme values are particularly hard to compare with defined-contribution pots. Auto-enrolment participation figures count anyone who has not opted out, but do not capture contribution adequacy &mdash; the Pensions and Lifetime Savings Association estimates that the current 8&percnt; minimum contribution will deliver a retirement income well below its &ldquo;moderate&rdquo; standard for most workers. The triple lock&apos;s long-term fiscal cost depends on earnings growth, inflation, and demographic projections that carry wide confidence intervals. OBR projections to 2050 assume the lock remains in place, but any future suspension &mdash; as in 2021/22 &mdash; would materially alter the trajectory.</p>
          </div>
        </section>
