      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Poor housing quality is not merely an inconvenience&mdash;it is a direct driver of illness and premature death, with harms that fall disproportionately on children, ethnic minorities, and low-income households. Persistent damp and mould cause respiratory disease: children in affected homes experience roughly three times the rate of asthma and bronchitis compared to those in dry, well-maintained properties, according to World Health Organisation evidence. Cold homes are a separate but overlapping hazard&mdash;millions of properties with EPC ratings of D or below impose heating costs that force occupants to choose between warmth and other necessities, driving cardiovascular and respiratory hospital admissions every winter. Overcrowding affects 320,000 households in England, linked to increased transmission of respiratory infections and measurably worse child development outcomes. The number of children in temporary accommodation reached a record 145,000 in 2023, housed in conditions ranging from inadequate to dangerous. Enforcement of existing standards is structurally weak: the private rented sector was not subject to the Decent Homes Standard until the Renters&apos; Rights Bill, and the housing health and safety rating system operates on a complaint-driven basis with severely under-resourced local authority teams. Black and Asian households are disproportionately concentrated in the worst private rented conditions&mdash;a pattern shaped by discrimination in lettings markets, lower average incomes, and geographic concentration in areas with older, poorly maintained housing stock.</p>
            <p>The Decent Homes Standard, last substantially revised in 2006, does not require minimum energy efficiency levels, meaning a home can be classified as &ldquo;decent&rdquo; while holding an EPC band E rating and imposing fuel costs that make it effectively uninhabitable in winter. The English Housing Survey, the primary source for national estimates of housing quality, is based on a sample of approximately 15,000 dwellings assessed by surveyors, and relies on professional judgment that is known to vary between assessors and over time. The Category 1 hazard count under the housing health and safety rating system depends on local authority data that is not nationally standardised&mdash;different councils apply different thresholds and inspection regimes. Damp and mould are particularly difficult to assess systematically: they may appear seasonally, develop behind furniture or in spaces not inspected, and be removed before a survey visit, meaning any national estimate is almost certainly an undercount. Cladding remediation data published by DLUHC tracks buildings where work has started or completed, but verification of completion is self-reported by freeholders with no independent audit. England has no national register of licensed landlords, so enforcement is necessarily reactive and the total number of privately rented properties is itself an estimate derived from census returns and council tax records. Overcrowding statistics use the bedroom standard, which may significantly undercount functional overcrowding in houses of multiple occupation and shared accommodation where residents occupy spaces not designed as bedrooms.</p>
          </div>
        </section>
