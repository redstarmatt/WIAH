    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The British Army has 72,520 trained personnel — below its 73,000 target and less than half its Cold War strength of 152,000. All three services are below establishment. Applications are rising but retention and conversion rates are falling."
          colour="#6B7280"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-good"
              changeText="Below 73,000 target · less than half Cold War peak of 152,000"
              sparklineData={[152000, 111000, 102000, 98000, 82000, 78000, 76000, 72520]}
              source="MOD Armed Forces Statistics · 2023"
              href="#sec-strength"/>
            <MetricCard
              ...
              source="MOD Quarterly Manning Report · 2023"
              href="#sec-strength"/>
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Record applications but only 9,200 actually join · 10:1 attrition"
              sparklineData={[76000, 82000, 68000, 78000, 91000, 94000]}
              source="MOD UK Armed Forces Biannual Diversity Statistics · 2023"
              href="#sec-strength"/>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-strength" className="mb-12">
            <LineChart
              title="British Army trained strength, 1990–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>MOD — UK Armed Forces Statistics. Quarterly Manning Report provides trained strength by service and component. Available at gov.uk/government/collections/uk-armed-forces-statistics.</p>
            <p>House of Commons Defence Committee — Recruitment and Retention in the Armed Forces. Reports on personnel shortfalls and recruitment system performance. Available at committees.parliament.uk.</p>
            <p>RUSI — Royal United Services Institute. Defence analysis and commentary on NATO commitments and UK force structure. Available at rusi.org.</p>
