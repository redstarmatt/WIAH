...
export const metadata: Metadata = {
  ...
  description: 'UK clean energy investment reached £50 billion in 2023 &mdash; but it still trails the US Inflation Reduction Act stimulus by a factor of three.',
  openGraph: {
    title: 'Is Britain Actually Going Green?',
    description: 'UK clean energy investment reached £50 billion in 2023 &mdash; but it still trails the US Inflation Reduction Act stimulus by a factor of three.',
    type: 'article',
