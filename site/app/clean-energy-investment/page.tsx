      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>UK clean energy investment reached a record &pound;50.3 billion in 2023 &mdash; up 162% from &pound;19.2 billion in 2015 &mdash; and now accounts for 88% of all UK energy investment. The Contract for Difference auction mechanism drove offshore wind costs to levels unimaginable a decade ago, making the UK host to the world&apos;s largest offshore wind capacity, with new North Sea and Scottish projects continuing to come online. Battery storage deployment has accelerated sharply. Fossil fuel investment fell from &pound;11.3 billion in 2015 to &pound;6.9 billion in 2023. The Great British Energy policy, announced in 2024, aims to reach clean power by 2030 through a new state-owned energy company, a target independent analysis considers physically achievable but requiring sustained acceleration of planning approvals, grid connections, and supply chain development.</p>
            <p>The international comparison is sobering. The US Inflation Reduction Act commits approximately $150 billion per year to clean energy and climate programmes &mdash; against which UK investment of &pound;50 billion looks modest, and UK projects face competition for equipment, components, and investors from a market offering more generous subsidy terms. Grid connection queues, planning delays for onshore wind, and supply chain constraints are the practical bottlenecks now limiting UK deployment. The government&apos;s continued North Sea oil and gas licensing has been contested by environmental groups as inconsistent with the UK&apos;s legally binding net zero commitments.</p>
          </div>
        </section>
