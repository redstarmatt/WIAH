      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The burden of rail dysfunction falls unevenly across the country and the income scale. London and the South East account for over 60&percnt; of all passenger journeys but receive roughly 70&percnt; of total rail investment, a disparity the Transport Select Committee has flagged repeatedly since 2019. Northern Powerhouse Rail, promised in 2015 to connect Liverpool, Manchester, Leeds and Hull with high-speed services, was scaled back in the 2021 Integrated Rail Plan to a mix of upgrades and new track costing &pound;36bn rather than the original &pound;39&ndash;45bn vision. Commuters on Northern and TransPennine Express services experienced cancellation rates above 6&percnt; through much of 2022 and 2023, roughly double the national average. Meanwhile, regulated fares &mdash; the cheaper anytime and season tickets used disproportionately by lower-paid workers who cannot choose when to travel &mdash; have risen faster than unregulated advance fares marketed to flexible travellers. A part-time worker commuting from Wakefield to Leeds now spends roughly 14&percnt; of gross salary on rail fares, compared with 7&percnt; for the same journey in 2010. The franchising model created perverse incentives: operators could hand back unprofitable routes to the state while retaining profitable intercity services, producing a two-tier network that entrenches regional inequality.</p>
            <p>Rail performance statistics carry significant measurement caveats that can obscure the passenger experience. The industry&apos;s headline punctuality metric, On-Time, counts a train as punctual if it arrives within one minute of schedule for commuter services and five minutes for long-distance, but this replaced the older Public Performance Measure (PPM) in 2019, which used five- and ten-minute thresholds &mdash; making direct long-run comparisons unreliable without careful rebasing. Cancellation figures exclude &ldquo;planned cancellations&rdquo; for engineering works and operator-initiated timetable reductions, meaning a company which quietly removes 15&percnt; of its services from the timetable will appear to have a lower cancellation rate than one attempting to run a full schedule. Passenger satisfaction surveys conducted by Transport Focus shifted from paper to online methodology in 2020, introducing a mode effect the organisation itself estimates at 3&ndash;5 percentage points. Subsidy calculations depend heavily on whether Network Rail&apos;s capital expenditure is allocated per journey or per track-mile, producing dramatically different cost-per-passenger figures for rural versus urban routes. Fare revenue data does not capture the growing volume of split-ticketing and third-party booking workarounds, which the Rail Delivery Group estimates now account for 8&ndash;12&percnt; of long-distance journeys.</p>
          </div>
        </section>
