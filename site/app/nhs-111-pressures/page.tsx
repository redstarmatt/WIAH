      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>NHS 111 launched in 2013 as a single triage point for non-emergency medical advice; call volumes grew from 12.1 million in 2015 to 26.3 million in 2023 &mdash; a 117&percnt; rise. The surge reflects not popularity but a structural shift: as GP appointment availability has tightened and A&amp;E waiting time targets were abandoned in 2020, 111 has become the default first port of call for a growing range of conditions previously handled in primary care. The strain is visible in the abandonment rate: 8.2&percnt; of callers hung up before being answered in 2015; by 2023 that had risen to 15.2&percnt; &mdash; one in seven. Around 8&percnt; of all 111 calls result in a recommendation to attend A&amp;E, translating to over 2 million additional emergency department referrals annually layered on top of self-referred demand. The Clinical Advisor model, routing higher-risk callers to nurses and paramedics, improves safety but increases call handling time, reducing throughput and lengthening the queue that drives abandonment further.</p>
