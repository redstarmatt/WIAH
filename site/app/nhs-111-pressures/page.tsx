    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="26 million calls a year, 1 in 7 abandoned — NHS 111 is overwhelmed as it absorbs demand from A&amp;E and GP services."
          colour="#E63946"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              href="#sec-chart"source="NHS England · NHS 111 Statistical Release"
            />
            <MetricCard
              label="Abandoned calls"
              value="15.2%"
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="NHS 111 call volume and abandonment rate, 2015–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>NHS England — NHS 111 Statistical Release. Published monthly. england.nhs.uk/statistics/statistical-work-areas/urgent-and-emergency-care/nhs-111-minimum-data-set/</p>
