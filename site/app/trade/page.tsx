      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Brexit&apos;s trade effects are sharply uneven by sector and geography. Agriculture and food processing &mdash; concentrated in rural England, East Anglia, and Northern Ireland &mdash; face the highest compliance costs: export health certificates for fresh produce run &pound;180&ndash;&pound;350 per consignment, a burden falling disproportionately on SMEs. Fishing communities saw shellfish and whitefish exports collapse over 30% as cold-chain delays at the border destroyed perishable value. Services &mdash; concentrated in Remain-voting London &mdash; have been largely insulated. The geographic consequence is that Leave-voting regions dependent on goods exports experienced the greatest disruption. A veterinary and SPS agreement with Brussels remains the single measure most likely to restore lost export volumes; the Labour government elected in 2024 is pursuing it.</p>
          </div>
        </section>
