      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="+37% since 2015 · Ofwat approved rises"
              sparklineData={[386, 392, 397, 405, 410, 415, 419, 436, 448, 528]}
              href="#sec-chart"source="Ofwat · Water Company Performance 2024"
            />
            <MetricCard
              label="In water poverty"
              value="25%"
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="1 in 4 households · social tariff uptake low"
              sparklineData={[18, 18, 21, 22, 25]}
              href="#sec-chart"source="Consumer Council for Water · 2024"
            />
            <MetricCard
              ...
              href="#sec-chart"source="Ofwat · Social Tariff Review 2023"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Water bills and water poverty, 2015–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Ofwat — Water Company Performance Reports. Annual data on bills, investment, and service levels. ofwat.gov.uk/regulated-companies/company-obligations/annual-performance-reports</p>
            <p>Consumer Council for Water — Affordability and Debt Research. ccwater.org.uk/research</p>
            <p>Ofwat — Social Tariff Monitoring. ofwat.gov.uk/households/customer-and-affordability-information/social-tariffs</p>
