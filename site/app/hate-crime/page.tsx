      ...
      <section id="sec-context" className="px-6 py-12 bg-white">
        <div className="max-w-2xl mx-auto">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The headline figure masks stark variation across hate crime strands, each with distinct structural dynamics. Disability hate crime accounts for roughly 15,000 recorded offences annually, yet charities estimate the true figure is several times higher&mdash;victims are often isolated, frequently depend on their abusers for care, and face profound barriers to reporting. CPS charge rates for disability hate crime are the lowest of any strand. Transgender hate crime is the fastest-growing category, reaching 11,000 recorded offences in 2023, driven partly by improved reporting but also by a political climate in which trans people face sustained public hostility. Religious hate crime, predominantly Islamophobic, spikes sharply after terrorist incidents as entire communities absorb collective blame. The policing response is structurally weak: most hate crime is investigated by neighbourhood officers with minimal specialist training, and dedicated hate crime units are rare outside London and a handful of major cities. The Online Safety Act 2023 introduced new provisions on illegal hate speech, but translating online abuse into prosecutable cases remains hampered by jurisdictional complexity and platform cooperation failures. Beneath the specific strands lie shared structural drivers&mdash;poverty, housing stress, and economic anxiety create fertile ground for scapegoating, and communities competing for scarce public resources are more susceptible to narratives that direct frustration at visible minorities rather than systemic failures.</p>
            <p>The 147,000 police-recorded hate crime figure is as much a measure of recording improvement as it is of actual offending. Following changes to Home Office counting rules in 2014 and the adoption of the College of Policing&apos;s perception-based recording standard, forces systematically captured incidents they had previously missed. The Crime Survey for England and Wales&mdash;the gold-standard victim survey covering 50,000 households&mdash;shows no statistically significant increase in underlying hate crime victimisation over the same period, creating a fundamental tension between the two data series. Comparisons between police forces are unreliable because recording thresholds and flagging practices differ: one force may record an incident as hate-motivated where another records the same behaviour as common assault. Crown Prosecution Service data on prosecutions is collected independently from police data, meaning calculating attrition rates requires joining two datasets built on different methodologies. Online hate crime enters the recorded figures only when police investigate, but the vast majority of incidents reported to platforms never reach a police log. Disability hate crime is widely regarded as the most severely underreported strand, because victim vulnerability and perpetrator access suppress disclosure. The boundary between a hate crime&mdash;a criminal offence aggravated by hostility&mdash;and a hate incident&mdash;behaviour below the criminal threshold&mdash;is drawn inconsistently across forces, inflating or deflating local figures depending on local interpretation.</p>
          </div>
        </div>
      </section>
