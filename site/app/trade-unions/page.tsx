      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Trade union membership in the UK stood at 6.73 million in 2024, representing 23.1&percnt; of employees &mdash; a figure known as union density. This is less than half the 1979 peak of 13.2 million members (55&percnt; density), and among the lowest union membership rates in Western Europe. France has lower density (8&percnt;) but far higher collective bargaining coverage through sectoral agreements; Germany (16&percnt; density) achieves 52&percnt; coverage through its codetermination system; the Nordic countries maintain density above 65&percnt;. The UK&apos;s decline reflects three decades of structural change: the collapse of manufacturing (which employed 7 million workers in 1980 and 2.6 million today), anti-union legislation from 1980 to 2016, privatisation of unionised public utilities, and the growth of service-sector employment in hospitality, retail, and care work where organising is difficult. Union density in the private sector is now just 12&percnt;, compared with 50&percnt; in the public sector.</p>
            <p>The 2022&ndash;23 strike wave was the most significant period of industrial action in over 30 years. Working days lost to strikes reached 3.87 million in 2023, the highest annual figure since 1989. The disputes were overwhelmingly in the public sector: rail workers (RMT, ASLEF), nurses (RCN, which struck for the first time in its 106-year history), ambulance workers (GMB, Unison), junior doctors (BMA), postal workers (CWU), teachers (NEU), and civil servants (PCS) all took sustained action over pay, conditions, and staffing levels. The proximate cause was the cost-of-living crisis: with CPI inflation reaching 11.1&percnt; in October 2022, public sector workers faced real-terms pay cuts of 5&ndash;10&percnt;. The disputes highlighted a structural tension: the public sector relies heavily on labour (nurses, teachers, paramedics) that cannot be automated or offshored, giving unions in these sectors leverage that private sector unions have largely lost.</p>
            <p>Government policy toward unions has shifted. The Trade Union Act 2016 imposed a 50&percnt; turnout threshold for lawful strike ballots (40&percnt; in important public services), required six months&apos; notice of action, and mandated opt-in for political fund contributions. The Strikes (Minimum Service Levels) Act 2023 went further, enabling the government to set minimum service levels in health, education, transport, fire, and nuclear decommissioning during strikes &mdash; legislation that unions described as the most restrictive in Western Europe. The current Labour government has signalled a different approach: the Employment Rights Bill (introduced 2024) proposes repealing the Strikes Act, simplifying union recognition procedures, strengthening protections against unfair dismissal during disputes, and introducing sectoral fair pay agreements for adult social care. Whether these measures will reverse the long-term decline in collective bargaining is uncertain: structural economic change (gig work, platform employment, fragmented supply chains) presents challenges that legislative reform alone cannot address.</p>
            <p>Union membership is distributed unevenly across the workforce. Women (25.6&percnt; density) are now more likely to be union members than men (20.4&percnt;), reversing the historical pattern, largely because women are concentrated in unionised public sector professions (teaching, nursing, civil service). Black workers have the highest density of any ethnic group (27&percnt;), reflecting concentration in the public sector. Workers aged 50&ndash;59 have the highest membership rates (28&percnt;); those aged 16&ndash;24 have the lowest (7&percnt;). Geographic variation is significant: Northern Ireland (34&percnt;), Wales (30&percnt;), and Scotland (29&percnt;) have substantially higher density than England (22&percnt;), reflecting different industrial histories and public sector employment shares. The lowest union density is found in accommodation and food services (3&percnt;), arts and recreation (8&percnt;), and wholesale and retail (10&percnt;) &mdash; sectors characterised by young workers, high turnover, small employers, and fragmented workplaces where traditional union organising models are least effective.</p>
