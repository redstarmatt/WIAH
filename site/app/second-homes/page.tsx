    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Over 272,000 second homes and 230,000 short-term lets in England — concentrated in coastal and rural areas — are removing properties from local housing markets. Communities like St Ives, the Lake District, and the Norfolk Broads have seen 30% or more of their housing stock unavailable to permanent residents, driving prices beyond local earnings and depopulating villages."
          colour="#F4A261"
        />
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            description="Several councils have introduced 100–300% council tax premiums on second homes using powers under the Levelling-up and Regeneration Act 2023. Wales now has a statutory licensing scheme for short-term lets — early data shows a measurable number of properties returning to long-term rental use in affected communities, providing tentative evidence that financial disincentives can shift behaviour."
            source="DLUHC · Welsh Government STL licensing data · 2024"
          />
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-stock" className="mb-12">
            {combinedSeries.length > 0 ? (
              <LineChart
                title="Second homes and short-term lets in England, 2010–2023"
        ...
        <ScrollReveal>
          <section id="sec-prices" className="mb-12">
            {pricePremiumSeries.length > 0 ? (
              <LineChart
                title="House price index: high second-home areas vs comparable areas, 2010–2023"
