      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              The second home and short-term let market in England has expanded dramatically since 2010, shaped by a confluence of low interest rates, rising urban incomes, and the growth of platform rental businesses. DLUHC council tax data records 272,000 second homes in England in 2023 &mdash; properties declared to local authorities as a secondary residence &mdash; up from approximately 178,000 in 2010, a 53&percnt; increase. Alongside registered second homes, an estimated 230,000 properties are now let on a short-term basis through platforms including Airbnb, Vrbo, and regional alternatives &mdash; a market that barely existed before 2015. The combined effect is that in many coastal and rural areas, a substantial share of the housing stock is functionally unavailable to households seeking permanent, affordable homes.
            </p>
            <p>
              The geographic concentration is stark. In St Ives in Cornwall, a 2016 local referendum resulted in a planning restriction preventing newly built homes from being sold as second homes or holiday lets &mdash; one of the first in the country. Despite this, existing second home ownership continues to push median house prices to more than 13 times median local earnings. In the Lake District, Ofcom data suggests that up to 35&percnt; of properties in some parishes are registered neither as a primary residence nor as a commercial business &mdash; they are simply empty for most of the year. The Norfolk Broads, the Yorkshire Dales, and the Pembrokeshire coast show similar patterns. The consequence is a hollowing out of year-round community life: schools lose pupils, GP practices lose patients to register, and community organisations lose members as the permanently resident population declines.
            </p>
            <p>
              Short-term lets via platforms like Airbnb operate in a regulatory grey zone that has only recently begun to close. Until 2025, England had no statutory licensing requirement for STLs, meaning properties could be converted from residential to tourist accommodation without planning permission, provided they were let for fewer than 90 nights per year. The 2024 Renters Reform Act introduced a mandatory registration scheme for STLs in England, modelled on Scotland&apos;s 2021 licensing scheme. Wales introduced its own licensing scheme in 2023. Early data from both schemes suggests that some operators have chosen to return properties to long-term letting rather than comply with licensing requirements &mdash; a small but measurable positive effect on local rental supply. The scale of reversal remains limited relative to the size of the market.
            </p>
            <p>
              The distributional effects are not uniform. Second home ownership is concentrated among households in the top two income deciles &mdash; the Bank of England&apos;s financial stability reports note that 92&percnt; of second home owners have household incomes above &pound;40,000. The communities most affected are often those with already constrained local earnings: fishing towns, farming villages, and former manufacturing areas where the tourist economy is one of few remaining employers. A young adult raised in Whitby, Tenby, or Ambleside typically earns median wages far below the level required to service a mortgage in their home town. A 2024 ONS analysis found that in local authorities with the highest ratios of second homes to permanent households, median house prices had risen 34&percnt; faster than comparable areas between 2010 and 2023.
            </p>
            <p>
              Counting second homes and short-term lets is less straightforward than it appears. Council tax data relies on self-declaration; there are financial incentives to register properties as furnished holiday lets rather than second homes, as this historically attracted more favourable business rate treatment. HMRC estimated in 2022 that up to 40,000 properties were incorrectly classified, inflating furnished holiday let numbers and deflating registered second home counts. The government introduced reforms to the furnished holiday let tax regime in the 2024 Autumn Budget that remove the preferential treatment, which may cause reclassification in future years and produce apparent statistical changes that reflect reporting shifts rather than genuine changes in the stock. AirDNA and similar data aggregators provide useful supplementary estimates but depend on platform cooperation and may miss properties let through multiple channels.
            </p>
          </div>
        </section>
