...
const editorialRefs: Reference[] = [
  { num: 1, name: 'Fire & Rescue Services', dataset: 'Wildfire incident data — England 2022', url: 'https://www.gov.uk/government/statistical-data-sets/fire-statistics-data-tables', date: '2023', note: '26,000 hectares burned, 570% above decade average' },
  { num: 2, name: 'NFCC', dataset: 'National Wildfire Strategy 2023', url: 'https://nfcc.org.uk', date: '2023' },
  { num: 3, name: 'Natural England', dataset: 'England Peat Action Plan', url: 'https://www.gov.uk/government/publications/england-peat-action-plan', date: '2021', note: 'Approximately 80% of upland peat remains degraded' },
];
