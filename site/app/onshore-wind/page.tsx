      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The energy security case for onshore wind became dramatically clearer following Russia&apos;s full-scale invasion of Ukraine in February 2022 and the subsequent gas price shock. UK household energy bills more than doubled between 2021 and 2023, driven primarily by rising gas prices. The Energy Price Guarantee &mdash; government support for household bills &mdash; cost the Treasury an estimated &pound;25bn in 2022&ndash;23 alone. Had England been permitted to build onshore wind at the same rate as Scotland throughout the ban period, the UK&apos;s dependence on gas generation would have been meaningfully lower when prices spiked. The National Audit Office concluded in 2023 that the planning ban represented one of the costliest energy policy decisions of the past decade. Onshore wind industry estimates suggest that restoring full deployment rates &mdash; around 2 GW per year in England &mdash; could save households &pound;150 each on annual energy bills by 2030 compared to a gas-heavy counterfactual.</p>
            <p>The geography of onshore wind in the UK is strikingly uneven. Scotland dominates, with 8.5 GW across the Highlands, Southern Uplands, and Orkney and Shetland islands &mdash; some of the most productive wind sites in Europe. Wales has around 1.5 GW, concentrated in Powys and Snowdonia. England&apos;s 2.4 GW is spread thinly across the North of England, with Yorkshire, Cumbria, and Lancashire accounting for the majority &mdash; the South, Midlands, and East Anglia have almost none. Northern Ireland has around 1.1 GW, largely in County Antrim and Tyrone. Within England, community opposition has been most intense in southern England, where visual impact affects higher-value land and more densely settled populations. The government&apos;s community benefit funds &mdash; up to &pound;5,000 per megawatt per year for local projects &mdash; have reduced but not eliminated local opposition. Scotland&apos;s much larger pipeline &mdash; around 10 GW consented or in planning &mdash; reflects both political will and planning framework; enough to power every Scottish home twice over once built.</p>
            <p>Onshore wind statistics carry several important caveats. The &pound;13bn cost estimate of the English planning ban uses a counterfactual modelling approach &mdash; it compares actual energy costs with a modelled scenario in which deployment continued at pre-ban rates &mdash; and alternative assumptions produce significantly different figures. The 35 GW by 2030 target is government aspiration; the Climate Change Committee&apos;s Balanced Net Zero pathway assumes 30 GW as a more achievable figure. Capacity factor for UK onshore wind averages around 28&ndash;30&percnt;, meaning rated nameplate capacity significantly overstates actual generation. Planning consent statistics count decisions made, not projects built; a meaningful proportion of consented projects are never constructed due to grid connection costs, finance, or community legal challenges. The grid connection queue figures of 700&ndash;800 GW include speculative and duplicate applications; actual buildout is a fraction of what the queue implies.</p>
          </div>
        </section>
