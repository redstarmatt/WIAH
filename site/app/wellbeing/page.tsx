        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <ScrollReveal>
            <MetricCard
              ...
              direction="down"
              polarity="up-is-good"
              changeText="2023/24 · Peak 7.56 in 2018/19 · COVID knocked it below pre-pandemic trend"
          ...
          <ScrollReveal>
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2023/24 · Was 23.1% pre-pandemic · 1 in 4 adults"
          ...
          <ScrollReveal>
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2024 · ~4M adults · Up from 5% in 2018 · Young adults most affected"
      ...
      <section id="sec-charts" className="max-w-5xl mx-auto px-6 py-16 space-y-20">
        ...
        <ScrollReveal>
          <LineChart
            ...
            subtitle="Percentage scoring 6–10 on anxiety (0–10 scale). One in four adults now reports high anxiety — up from one in five in 2011."
        ...
        <ScrollReveal>
          <LineChart
            ...
            subtitle="Percentage of adults who often or always feel lonely. Has risen from 5% in 2016 to 7.8% in 2024 — roughly 4 million people."
