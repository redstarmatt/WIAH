      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              The judiciary of England and Wales has diversified slowly but unevenly. Women now constitute 35.4% of all judges, up from 25.2% in 2015; ethnic minority judges account for 9.8%, up from 6.1%. But diversity is concentrated in the lower tiers: tribunal judges are 46% female and 14% ethnic minority, while at the Court of Appeal those figures drop to 28% and 6% respectively. The Supreme Court has never had a non-white justice. In 2023, 37% of KC appointments were women and 14% ethnic minority &mdash; record highs, but below population parity, and KC status is the primary gateway to the senior judiciary. The Sutton Trust estimated that 65% of senior judges attended independent schools (7% of the population), and Oxbridge alumni account for approximately 75% of Supreme Court and Court of Appeal judges.
            </p>
            <p>
              The pipeline explains the pyramid. Women leave the Bar at higher rates after 10&ndash;15 years &mdash; the critical period for building a judicial profile &mdash; because self-employed barristers&apos; working patterns are incompatible with caring responsibilities. The JAC&apos;s equal merit provision has been applied in around 30% of appointments since 2013, contributing measurably to female representation at district judge level, but the government rejected statutory diversity targets in 2020. Ethnic minority women constitute just 3.2% of judges despite being approximately 9% of the population. The Judicial Diversity Forum publishes annual action plans but has no enforcement mechanism, and critics note the same commitments have appeared in successive plans since 2017.
            </p>
          </div>
        </section>
