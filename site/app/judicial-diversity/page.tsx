    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Women make up 35% of judges in England and Wales but just 28% of Court of Appeal judges. Ethnic minority representation stands at 9.8% overall &mdash; in a country where 18% of the population identifies as non-white. At the Supreme Court, no judge has ever been from an ethnic minority background."
          colour="#6B7280"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Up from 25.2% in 2015 &middot; But just 28% at Court of Appeal"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Population: 18% non-white &middot; 0 ethnic minority Supreme Court justices ever"
            ...
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText="vs 7% of population &middot; 75% Oxbridge-educated at top courts"
          ...
          <section id="sec-ethnicity" className="mb-12">
            {ethnicMinoritySeries.length > 0 ? (
              <LineChart
                ...
                subtitle="Percentage of judges who self-declare as ethnic minority. Non-declaration rate of 10&ndash;15% means true figure may be higher."
