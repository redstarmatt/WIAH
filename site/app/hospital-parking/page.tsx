...
export default function HospitalParkingPage() {
  ...
  const chargeAnnotations: Annotation[] = [
    { date: new Date(2019, 5, 1), label: '2019: NHS parking pledge &mdash; not fully implemented' },
  ];
    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="NHS hospital car parks generated &pound;214 million in charges in 2022/23. The 2019 pledge to scrap parking charges for patients with frequent attendance and disabled patients has not been fully implemented."
          colour="#E63946"
        />
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              NHS hospital car parking charges generated &pound;214 million in revenue in 2022/23, up from &pound;175 million pre-pandemic and continuing to rise as trusts face financial pressure to maximise all income streams. The charges fall disproportionately on people with chronic conditions who attend frequently &mdash; the very patients for whom the 2019 government pledge was made. Free parking was meant to be provided for disabled badge holders, people with frequent appointments (defined as more than three visits in 30 days), parents of children who are in-patients, and NHS staff working night shifts. In practice, 80% of trusts are still charging at least some of these qualifying patients.
            </p>
            <p>
              The contrast with the rest of the UK is stark. Scotland, Wales, and Northern Ireland all provide free hospital parking as standard policy, recognising that charging patients to access healthcare is fundamentally inconsistent with the NHS principle of care free at the point of need. In England, average hourly charges have risen to &pound;2.20 &mdash; a 22% increase since 2019. A patient attending for chemotherapy three times a week at two hours per visit would face &pound;13.20 per week in parking charges, or nearly &pound;700 per year, from parking alone. The revenue generated flows to trust operating budgets, but critics argue it represents a regressive tax on illness.
            </p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <section id="sec-revenue" className="mb-12">
            <LineChart
              title="NHS hospital car parking revenue, England, 2018&ndash;2024"
        ...
        <ScrollReveal>
          <section id="sec-compliance" className="mb-12">
            <LineChart
              title="NHS trusts charging qualifying patients despite 2019 pledge, 2020&ndash;2024"
        ...
        <ScrollReveal>
          <section id="sec-charges" className="mb-12">
            <LineChart
              title="Average hourly NHS hospital parking charge, England, 2019&ndash;2024"
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            source="Source: NHS England Hospital Car Parking Report 2022/23 &middot; NHS England Car Parking Policy Guidance."
          />
        </ScrollReveal>
