...
export const metadata: Metadata = {
  ...
  description: 'Households in South East England are on average three times wealthier than households in the North East &mdash; a gap that has widened since the financial crisis.',
  openGraph: {
    title: 'How Unequal Is Wealth Across Britain?',
    description: 'Households in South East England are on average three times wealthier than households in the North East &mdash; a gap that has widened since the financial crisis.',
    type: 'article',
