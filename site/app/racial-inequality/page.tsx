      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The aggregate ethnic pay gap stood at approximately 5.1&percnt; in 2024, but this masks extreme variation: Bangladeshi workers earn 20&percnt; less than white British workers, Pakistani workers 16&percnt; less, Black African workers 8&percnt; less. Even after controlling for education, age, region, and sector, IFS research finds Bangladeshi men earn 14&percnt; less than comparable white British men &mdash; an &ldquo;ethnic penalty&rdquo; that persists independent of qualifications. Black workers face unemployment rates approximately twice those of white workers, a ratio barely changed in 30 years; callback studies show applicants with names perceived as Black or South Asian need to send 60&ndash;80&percnt; more applications for the same number of interview invitations. The wealth gap is even starker: median total household wealth is &pound;314,000 for white British households versus &pound;34,000 for Black African households &mdash; a ninefold gap &mdash; reflecting lower homeownership (68&percnt; vs 20&percnt;), weaker pension provision, and intergenerational compounding of historical discrimination.</p>
            <p>These economic gaps intersect with justice and health inequalities. Black people are 3.6 times more likely to be stopped and searched and make up 13&percnt; of the prison population despite being 4&percnt; of the general population. Maternal mortality for Black women is nearly four times higher than for white women; South Asian communities face significantly higher rates of Type 2 diabetes and cardiovascular disease. The Sewell Report (2021) controversially argued Britain is not institutionally racist, but its own evidence showed persistent disparities in pay, employment, health, and criminal justice that were not satisfactorily explained. Ethnicity pay gap reporting remains voluntary; fewer than 50 large employers currently publish the data.</p>
          </div>
        </section>
