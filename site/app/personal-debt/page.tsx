      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>UK households owe &pound;1.9 trillion &mdash; 130% of annual household income and the highest debt-to-income ratio in the G7. Mortgage debt accounts for &pound;1.54 trillion; consumer credit adds &pound;220 billion. The cost-of-living crisis of 2021&ndash;23 converted manageable indebtedness into acute distress: energy bills roughly doubling created &pound;3.1 billion in energy arrears, council tax arrears rose to &pound;6 billion, and the Bank of England&apos;s rate rise from 0.1% to 5.25% added &pound;270 per month to a typical variable mortgage. Personal insolvencies in England and Wales reached 110,000 in 2023 &mdash; the highest since 2010 &mdash; with Debt Relief Orders rising 30% as lower-income households were pushed beyond their limits. An estimated 8.9 million people, one in seven adults, are in &ldquo;problem debt&rdquo; according to StepChange, up from 6.3 million in 2019.</p>
            <p>Debt distress concentrates in specific groups and geographies. Single parents report serious financial difficulty at 29% &mdash; three times the rate for couple households. Renters are four times more likely to be in arrears than homeowners, and the overlap between housing insecurity and problem debt is near-total in the lowest income decile. 25&ndash;34-year-olds are borrowing via buy-now-pay-later and credit cards for essentials rather than discretionary spending. Regionally, the North East, West Midlands, and coastal towns in the South West have the highest per-capita insolvency rates. A household in energy arrears is five times more likely to be behind on council tax and credit commitments simultaneously &mdash; creating spirals that single-issue interventions rarely break.</p>
          </div>
        </section>
