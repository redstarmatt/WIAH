      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              Around 870,000 people in England receive home care support, but an estimated 500,000 are waiting for a care needs assessment or have been assessed but are still awaiting a package to start &mdash; roughly double the number in 2016. The immediate constraint is workforce: 132,000 social care posts stand vacant at a 9.9% vacancy rate (against 3.8% economy-wide), with 38% annual turnover meaning providers must replace more than a third of staff every year simply to stand still. The median home care worker earns &pound;10.80 per hour, barely above the national living wage, and significantly below NHS equivalents doing comparable work. Provider viability is the structural problem underneath: the UK Homecare Association calculated in 2023 that a sustainable rate was &pound;25.95 per hour but the average local authority rate was &pound;19.35 &mdash; a 25% gap that drove 360 providers to return contracts in 2023.
            </p>
            <p>
              The consequences fall hardest on the oldest and most isolated: the average home care recipient is 80, 60% have dementia, and 45% live alone. When packages break down, the burden transfers to unpaid carers &mdash; predominantly women &mdash; with Carers UK estimating 600 people leave work every day to care for a relative. Rural areas, coastal towns, and the North East face the most acute shortages, combining older populations with lower council commissioning rates and fewer alternative employers to compete with for workers. As providers exit and remaining ones absorb more referrals than they can safely staff, CQC inspections increasingly cite staffing as the primary risk factor in inadequate care ratings &mdash; a cycle that will intensify unless commissioning rates rise to cover the real cost of delivery.
            </p>
          </div>
        </section>
