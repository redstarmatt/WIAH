    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The build-to-rent sector has grown to 97,000 units with 250,000 in the pipeline — but average rents run 7% above comparable market-rate properties."
          colour="#6B7280"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="quadrupled since 2016 · new supply mode"
              sparklineData={[26, 34, 43, 54, 63, 73, 83, 97, 105]}
              href="#sec-chart"source="BPF · Build to Rent Report 2024"
            />
            <MetricCard
              label="Pipeline"
              value="268k"
              ...
              direction="up"
              polarity="up-is-good"
              changeText="significant investor interest · planning key"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="above market rate · amenity premium or monopoly rent?"
              sparklineData={[4, 4, 5, 5, 6, 6, 7, 7, 7]}
              href="#sec-chart"source="Savills · UK Build to Rent Market Update 2024"
            />
          </div>
        </ScrollReveal>
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>British Property Federation — Build to Rent Report. Annual sector census. bpf.org.uk/what-we-do/residential/build-to-rent/</p>
            <p>Savills — UK Build to Rent Market Update. Quarterly research. savills.co.uk</p>
            <p>DLUHC — Private Rented Sector Survey. Annual housing market data. gov.uk/government/collections/private-rented-sector</p>
