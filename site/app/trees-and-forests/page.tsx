      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>England planted 7,164 hectares of trees in 2024/25 &mdash; 27% more than the year before and the highest planting rate in over 20 years, driven by the England Woodland Creation Offer, Countryside Stewardship supplements, and rising private sector demand for carbon credits. UK woodland cover stands at 13.2% of land area, one of the lowest proportions in Europe (average 38%), against a government target of 16.5% by 2050. The Climate Change Committee estimates 30,000&ndash;50,000 hectares must be planted annually to meet net zero obligations &mdash; roughly three times the current UK rate. The England Trees Action Plan (2021) promised to treble planting rates; delivery has fallen short, with complex grant applications, 9&ndash;12 month approval times, and competing agricultural land use pressures hampering uptake.</p>
            <p>The acceleration in planting is real, but the ecological picture is more complex. Ancient woodland &mdash; covering just 2.5% of UK land &mdash; is irreplaceable on any human timescale; the Woodland Trust estimates 1,225 ancient woodlands are currently threatened by development, with HS2 alone affecting over 100 sites. Ash dieback is expected to kill up to 80% of the UK&apos;s 150 million ash trees, fundamentally altering the woodland landscape. Scotland accounts for around 75% of all UK planting; England, the least wooded nation at 10% cover, continues to underperform relative to its own targets. The gap between current rates and the Climate Change Committee&apos;s requirements remains the defining constraint.</p>
          </div>
        </section>
