    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="England's 48 Local Nature Recovery Strategies are being finalised in 2024 — a first-ever legal framework for nature. Mandatory Biodiversity Net Gain came into force in February 2024: the first law in the world requiring new developments to leave nature better off."
          colour="#2A9D8F"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Near-complete coverage for England in 2024 · legally required framework"
              sparklineData={[12, 46]}
              source="DEFRA LNRS Programme · 2024"
              href="#sec-protected"/>
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Mandatory since Feb 2024 · first law of its kind in the world"
              sparklineData={[0, 0, 0, 0, 10]}
              source="Environment Act 2021 / DEFRA · 2024"
              href="#sec-protected"/>
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Approaching 30&times;30 target — protect 30% of land by 2030"
              sparklineData={[26.4, 27.1, 28.2, 28.8, 30.0]}
              source="DEFRA / Natural England · 2023"
              href="#sec-protected"/>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-protected" className="mb-12">
            <LineChart
              title="Protected land in England as % of total area, 2010–2030"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>DEFRA — Local Nature Recovery Strategies programme. Progress updates on publication status across all 48 responsible authorities. Available at gov.uk/government/collections/local-nature-recovery-strategies.</p>
            <p>Natural England — Protected Area Statistics. Annual data on land under statutory protection, including SSSIs, National Parks, AONBs, and Ramsar sites. Available at data.naturalengland.org.uk.</p>
            <p>Green Alliance — Nature Recovery analysis. Policy analysis of the Environment Act 2021 and delivery against targets. Available at green-alliance.org.uk.</p>
