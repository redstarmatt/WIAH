      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              The mental health crisis inside prisons is the sharpest failure. An estimated 70% of prisoners have at least one diagnosable mental health condition — including depression, anxiety, personality disorders, and psychosis — compared with roughly 8% of the general adult population.<Cite nums={3} /> Yet access to talking therapies in prison is severely limited, and waiting times for specialist mental health assessment can exceed twelve weeks. Self-harm has become endemic: incidents rose from 298 per 1,000 prisoners in 2015 to 641 per 1,000 in 2024, a 115% increase.<Cite nums={2} /> Much of this is concentrated among women prisoners, young adults, and those on remand — the populations least well served by the current system.
            </p>
            <p>
              The driver most amenable to policy intervention is workforce. Prisons cannot attract and retain GPs, nurses, and mental health practitioners because the working conditions are poor, the pay is no better than community roles, and the professional isolation is real.<Cite nums={3} /> NHS England&apos;s Health and Justice commissioning framework has improved governance, but governance without staff produces paperwork, not care. Until prison healthcare posts are made genuinely attractive — through pay premiums, career progression, and manageable caseloads — the inspection data will continue to deteriorate.
            </p>
          </div>
        </section>
