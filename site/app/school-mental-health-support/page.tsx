      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>One in six children aged 7&ndash;16 had a probable mental health condition in 2023, up from one in nine in 2017. Mental Health Support Teams (MHSTs) &mdash; joint NHS/education early intervention teams &mdash; covered 35&percnt; of pupils in England by 2024, up from 7&percnt; in 2019, but the target of 100&percnt; coverage has been pushed back repeatedly, most recently to 2027&ndash;28. The average wait for a CAMHS assessment was 18 weeks nationally in 2024; an estimated 30&ndash;40&percnt; of children referred do not meet CAMHS thresholds and fall into a &ldquo;missing middle&rdquo; with no alternative provision. The government&apos;s counsellor in every secondary school programme had reached approximately 3,100 schools by 2024, leaving around 3,400 secondary schools without a dedicated counsellor. The 2024 Children&apos;s Wellbeing Act committed to a suicide prevention duty on schools, but adequate CAMHS capacity remains unresolved.</p>
            <p>The burden of the gap falls on children from deprived backgrounds, who are more likely to experience mental health difficulties, less likely to have access to private therapy, and more likely to face long waits for CAMHS in areas where NHS capacity is thinnest. Improved teacher identification without improved access to intervention creates its own problem: more children being recognised as struggling, referred, and then waiting months or years for help. For children with complex or severe needs, school counselling is not a substitute for clinical intervention &mdash; but it is often all that is available.</p>
          </div>
        </section>
