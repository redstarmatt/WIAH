      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The economic evidence on immigration&apos;s fiscal impact is broadly positive but contested in public debate. The OBR&apos;s 2023 Fiscal Risks report calculated that higher net migration than previously assumed would reduce public debt by around 0.5% of GDP by 2027&ndash;28, primarily because working-age migrants pay tax immediately while drawing less on pension and social care spending. The Migration Advisory Committee has consistently found that skilled migrants contribute more in tax than they consume in public services; the net fiscal contribution of the post-2021 cohort is structurally higher than the pre-Brexit EU wave because the points-based system selects for higher earners. Labour market effects are more complex: there is limited evidence of wage displacement for British workers at the aggregate level, though some studies find downward pressure in specific low-wage sectors. The political and public discourse has diverged sharply from this evidence base. Polling consistently shows net migration near the top of public concerns, and the gap between the &ldquo;tens of thousands&rdquo; target set by successive governments and the actual six-figure reality became a defining feature of Brexit politics. Critics of the current system argue that high headline numbers reflect genuine demand in NHS, social care, and construction labour markets that the domestic workforce cannot fill; critics of that position argue that employer dependency on migrant labour suppresses investment in training and wages.</p>
            <p>All headline migration figures carry substantial uncertainty. The ONS&apos;s International Passenger Survey, which underpinned estimates for decades, was designed to measure tourism and consistently undercounted long-term migrants; the 2023 methodology revision, incorporating HMRC PAYE and DWP Universal Credit records, revised up previous estimates substantially and broke the historical time series. Irregular migration &mdash; those who enter legally and overstay, or who cross undetected &mdash; is not measured at all; the Home Office has no reliable estimate of the undocumented population, with academic guesses ranging from 600,000 to over one million. Small-boat crossing data is comparatively robust because arrivals are detained, but the fate of those who abscond from asylum accommodation or whose claims are refused and removal is not enforced is largely invisible to official statistics. Local-area impact data lags by several years: the Census provides the most granular picture of where migrants settle, but the 2021 Census predates the post-COVID surge and the next full count is a decade away. GP registration data and school rolls offer partial proxies but are neither complete nor nationally consistent. The result is that policy is frequently made&mdash;and public debate conducted&mdash;on the basis of national totals that mask enormous variation in local experience and that may be revised significantly as administrative data improves.</p>
          </div>
        </section>
