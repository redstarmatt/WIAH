    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Over 6,300 people are waiting for a transplant in the UK, and around 350 die each year before one becomes available. England&rsquo;s opt-out organ donation law, introduced in 2020, has helped lift family consent rates to 73% — but transplant numbers have not yet returned to pre-pandemic highs."
          colour="#2A9D8F"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="UK, 2024 · Down from 7,048 in 2020 · ~350 die waiting each year"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="UK, 2024 · Recovering from COVID low of 3,722 · Pre-COVID peak: 5,090"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="2024 · Up from 58% in 2014 · Opt-out law since May 2020"
        ...
        <ScrollReveal>
          <section id="sec-waiting" className="mb-12">
            <LineChart
              title="Organ transplant waiting list, UK, 2014–2024"
        ...
        <ScrollReveal>
          <section id="sec-transplants" className="mb-12">
            <LineChart
              title="Organ transplants performed, UK, 2014–2024"
        ...
        <ScrollReveal>
          <section id="sec-consent" className="mb-12">
            <LineChart
              title="Family consent rate for organ donation, UK, 2014–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>NHS Blood and Transplant — Organ Donation and Transplantation Activity Report 2024. UK-wide data on waiting list, transplants performed, and donor activity. Published annually.</p>
            <p>NHSBT — Potential Donor Audit. Family approach and consent rate data. Published annually.</p>
