      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The Victims&apos; Code of Practice sets out 12 rights for victims of crime in England and Wales, including the right to be informed about case progress and referred to support services. In practice, compliance is inconsistent and unenforced. The 2024 crime survey found only 56.5% of victims satisfied with their overall criminal justice experience &mdash; down from 73% in 2015 &mdash; and fewer than 45% said they had been kept adequately informed about their case. The Victims and Prisoners Act 2024 placed the Code on a statutory footing for the first time, but it creates no individually enforceable rights; compliance will be monitored through inspectorates. The Victims&apos; Commissioner&apos;s 2024 survey found 62% of victims had never heard of the Code. Referrals to Victim Support increased 35% between 2019 and 2024 without equivalent funding growth, and waiting lists for specialist sexual violence and domestic abuse counselling extend to six months or longer in some areas.</p>
