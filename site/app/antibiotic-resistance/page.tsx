      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Antimicrobial resistance kills an estimated 7,000 people in the UK each year and caused 1.27 million deaths globally in 2019 &mdash; more than HIV or malaria. Without action, the O&apos;Neill Review projects 10 million annual deaths by 2050. In England, 46&percnt; of E. coli bloodstream infections are now resistant to third-generation cephalosporins, up from 38&percnt; in 2016. The UK has made genuine progress on prescribing: primary care antibiotic prescriptions fell 25&percnt; from a 2014 peak of 47 million to 35.5 million in 2023, driven by the NHS antimicrobial stewardship programme. To address the pipeline failure &mdash; no new antibiotic class has been commercialised since the 1980s, and pharmaceuticals have largely abandoned antibiotic R&amp;D because the economics are perverse &mdash; the UK launched a world-first &ldquo;Netflix model&rdquo; in 2022, paying &pound;10 million per year to each of two manufacturers regardless of volume used. But AMR is a global commons problem: an estimated 60&percnt; of global antibiotic use is in livestock, manufacturing waste contaminates rivers in South Asia with antibiotic residues, and local reductions are overwhelmed by global overuse.</p>
            <p>The consequences fall unevenly. Drug-resistant tuberculosis is concentrated in London and other cities with high rates of migration from endemic regions. Carbapenem-resistant Enterobacteriaceae &mdash; bacteria resistant to the antibiotics of last resort &mdash; are classified by the WHO as a critical priority threat and are now detected in UK hospitals at a rate that requires contact tracing and infection control responses. MRSA rates fell sharply from their mid-2000s peak but have begun rising again. Older patients, those with complex medical histories, and people requiring surgery or intensive care are most exposed to the consequences of resistance, because they are the most likely to require antibiotic treatment and the least able to withstand infection by a resistant organism.</p>
          </div>
        </section>
