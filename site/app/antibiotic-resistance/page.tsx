      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Antimicrobial resistance kills an estimated 7,000 people in the UK each year and caused 1.27 million deaths globally in 2019 &mdash; more than HIV or malaria. Without action, the O&apos;Neill Review projects 10 million annual deaths by 2050. In England, 46% of E. coli bloodstream infections are now resistant to third-generation cephalosporins, up from 38% in 2016. The UK has made genuine progress on prescribing: primary care antibiotic prescriptions fell 25% from a 2014 peak of 47 million to 35.5 million in 2023, driven by the NHS antimicrobial stewardship programme. To address the pipeline failure &mdash; no new antibiotic class has been commercialised since the 1980s, and pharmaceuticals have largely abandoned antibiotic R&amp;D because the economics are perverse &mdash; the UK launched a world-first &ldquo;Netflix model&rdquo; in 2022, paying &pound;10 million per year to each of two manufacturers regardless of volume used. But AMR is a global commons problem: an estimated 60% of global antibiotic use is in livestock, manufacturing waste contaminates rivers in South Asia with antibiotic residues, and local reductions are overwhelmed by global overuse.</p>
