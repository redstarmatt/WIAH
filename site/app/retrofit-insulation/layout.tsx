...
export const metadata: Metadata = {
  ...
  description: 'Only 250,000 homes are retrofitted per year &mdash; but meeting net zero requires 2 million per year, meaning the programme must scale 8-fold.',
  openGraph: {
    title: 'Are Homes Being Made Energy Efficient?',
    description: 'Only 250,000 homes are retrofitted per year &mdash; but meeting net zero requires 2 million per year, meaning the programme must scale 8-fold.',
    type: 'article',
