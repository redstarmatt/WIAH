    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="England missed its secondary school teacher recruitment targets for 10 of 17 subjects in 2022/23. The teacher vacancy rate stands at 3.1% — the highest since records began. 40% of new teachers leave within five years. Real-terms teacher pay has fallen 11% since 2010."
          colour="#2A9D8F"
        />
        ...
        <div id="sec-overview" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          <MetricCard
            ...
            direction="up"
            polarity="up-is-bad"
            changeText="2023 · Highest on record · Physics: 8.2% · Maths: 5.8% · Languages: 5.1%"
            sparklineData={
              data
          ...
          <MetricCard
            ...
            direction="down"
            polarity="up-is-good"
            changeText="2022/23 · Missed target in 10 of 17 subjects · Physics: 39% · Computing: 45% · Maths: 60%"
            sparklineData={
              data
        ...
        <PositiveCallout
          ...
          description="The government introduced bursaries of up to £10,000 tax-free for graduates who train to teach maths, physics, chemistry, and computing in secondary schools — the highest in the developed world for teacher recruitment bonuses. The Early Career Framework (ECF), introduced in 2021, structured the first two years of teaching with mentoring, coaching, and reduced timetable; evidence shows improved two-year retention rates. The STEM Ambassador programme has engaged 38,000 volunteers to demonstrate science and technology careers in schools. Teach First — which places high-achieving graduates in schools in disadvantaged areas — has trained over 15,000 teachers since 2003, with 80% retention above the profession average."
