      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              England&apos;s secondary school teacher vacancy rate reached 3.1% in 2022/23 &mdash; the highest since consistent records began &mdash; with approximately 4,600 full-time equivalent posts unfilled across state-funded schools. The Department for Education missed its recruitment targets for 10 of 17 secondary subjects that year. Physics is the most acute shortage: just 39% of the target was met, a failure repeated in every year since 2012. Computing reached 45%, maths 60%. The root cause is straightforward: a starting teacher salary of &pound;30,000 compares poorly with typical graduate starting salaries of &pound;35,000&ndash;45,000 in engineering or finance, and STEM graduates have the widest gap between what teaching pays and what industry offers.
            </p>
            <p>
              Retention compounds the recruitment crisis. Some 40% of newly qualified teachers now leave the profession within five years, up from 30% in 2010. The DfE estimates average term-time working hours exceed 50 per week; 76% of teachers in the Teacher Wellbeing Index describe their workload as unmanageable. Real-terms pay fell 11% between 2010 and 2022 according to IFS analysis; a 6.5% award in 2023, accepted after NASUWT and NEU industrial action, only partially reversed the decline. Inner-city schools, coastal and rural areas, and the most deprived communities suffer worst: teachers in these settings are more likely to leave and harder to replace, creating a self-reinforcing cycle of instability.
            </p>
            <p>
              The consequences reach pupils directly. Schools facing persistent vacancies resort to unqualified supply teachers, lessons taught outside subject specialism, merged classes, and &mdash; in some cases &mdash; subjects dropped from the timetable entirely. A 2023 Ofsted review found that schools with high vacancy rates showed measurably worse pupil outcomes, particularly in GCSE maths and science. Policy responses include targeted bursaries of up to &pound;10,000 tax-free for physics, maths, and chemistry trainees, and the Early Career Framework introduced in 2021, which provides structured mentoring and a reduced timetable load for new teachers &mdash; early evidence suggests improved two-year retention. Teach First has trained over 15,000 teachers since 2003 with above-average retention once they complete the programme.
            </p>
          </div>
        </section>
