...
export default function HipKneeWaitsPage() {
  ...
  const chartAnnotations: Annotation[] = [
    { date: new Date(2020, 0, 1), label: '2020: Elective surgery halted' },
  ];
    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The combined hip and knee replacement backlog stands at 780,000 — up from 170,000 before COVID. The median wait is now over a year. Pain, immobility and loss of employment are consequences of the delay."
          colour="#E63946"
          preposition="with"
        />
        ...
        <ScrollReveal>
          <section className="mb-12">
            <LineChart
              title="Median wait for elective orthopaedic surgery (weeks), UK"
              ...
              yLabel="Median wait for elective orthopaedic surgery (weeks)"
              source={{
                name: 'NHS England',
                dataset: 'Median wait for elective orthopaedic surgery (weeks)',
                frequency: 'annual',
