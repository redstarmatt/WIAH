    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="602 homicides were recorded in England and Wales in 2023, with knife killings now accounting for 40% — up from 30% in 2010. Violence is increasingly c..."
          colour="#6B7280"
          preposition="with"
        />
