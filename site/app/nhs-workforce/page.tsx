    ...
    <main>
      ...
      <section id="sec-context" className="max-w-2xl mx-auto px-6 py-16">
        <div className="text-base text-wiah-black leading-[1.7] space-y-4">
          ...
          <p>The government&apos;s response is the NHS Long Term Workforce Plan, published in June 2023, which commits to doubling medical school places and increasing nursing training by 92% over 15 years at a cost of &pound;2.4bn. The ambition is real, but the timescale is not. Training a doctor takes more than ten years from undergraduate entry to independent practice; the doubled cohort will not be fully qualified until the mid-2030s. For the rest of this decade, the NHS will remain heavily reliant on international recruitment to fill the gap that domestic underinvestment created.</p>
          <p>The vacancy crisis is shaped by a decade of policy choices. Between 2010 and 2018, the number of funded nursing training places in England was cut by approximately 25&percnt;, and the replacement of NHS bursaries with student loans in 2017 led to a 32&percnt; drop in nursing degree applications the following year. Medical school places were capped well below projected demand throughout the 2010s. The result is a domestic training deficit that international recruitment has been asked to fill: around 34&percnt; of new NMC registrants in 2023 trained overseas, primarily in the Philippines, India, and Nigeria &mdash; countries on the WHO&apos;s Health Workforce Support and Safeguards List. Meanwhile, the cost of covering vacancies with agency and bank staff reached &pound;3 billion in 2022/23, roughly equivalent to the entire 15-year budget of the Long Term Workforce Plan. The poorest-performing trusts spend the most on agency cover, creating a cycle in which the areas most in need have the least funding available for permanent recruitment.</p>
          <p>Workforce data understates the scale of the problem in several ways. The headline vacancy figure counts only posts that trusts are actively advertising; roles that have been frozen, downgraded, or abandoned do not appear. NHS Digital does not publish a unified, trust-level dataset linking vacancies, agency spend, and patient outcomes &mdash; making it impossible to assess directly whether staffing levels in a given hospital are safe. Attrition data tracks leavers from the NMC register but does not distinguish between nurses who emigrate, those who retire, and those who move to non-clinical roles within the NHS. The Long Term Workforce Plan&apos;s projections rely on demand modelling that NHS England acknowledges carries &ldquo;significant uncertainty,&rdquo; particularly around the future role of technology and the shifting burden of disease. There is no published methodology for how the &pound;2.4 billion costing was derived, and independent analysts have questioned whether it accounts for inflation or capital costs.</p>
        </div>
      </section>
