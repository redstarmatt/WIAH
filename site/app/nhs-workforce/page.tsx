    ...
    <main>
      ...
      <section id="sec-context" className="max-w-2xl mx-auto px-6 py-16">
        <div className="text-base text-wiah-black leading-[1.7] space-y-4">
          <p>The NHS in England carried more than 112,000 vacancies in 2023 &mdash; an 8.4% rate, up from 64,000 in 2015 &mdash; with nursing the largest single shortfall at 47,500 posts, roughly one in nine. Between 2010 and 2018 funded nursing training places were cut by approximately 25&percnt;, and the 2017 replacement of NHS bursaries with student loans drove a 32&percnt; drop in nursing degree applications. Medical school places were capped below projected demand throughout the 2010s. The domestic training deficit has been papered over by international recruitment: 34&percnt; of new NMC registrants in 2023 trained overseas, predominantly in the Philippines, India, and Nigeria &mdash; WHO red-list countries. Agency and bank cover to fill the gap cost &pound;3 billion in 2022/23, roughly equal to the entire 15-year budget of the 2023 Long Term Workforce Plan. Junior doctors took the first such strikes in NHS history in 2022&ndash;23, citing 26&percnt; real-terms pay erosion since 2008.</p>
