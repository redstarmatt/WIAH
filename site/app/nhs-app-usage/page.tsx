    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The NHS App has 35 million registered users — more than any other European health app. But 24% of GP appointments are not bookable digitally and digital exclusion means 8.5 million people cannot use online health services."
          colour="#264653"
        />
        ...
        <div id="sec-overview" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="+997% since 2020 · Largest health app in Europe"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Up from 14% in 2020 · Still 46% booked by phone or in person"
            ...
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="14% of population · Elderly, disabled, and low-income hardest hit"
        ...
        <ScrollReveal>
          <section id="sec-users" className="mb-12">
            <LineChart
              title="NHS App registered users, England, 2020–2025"
        ...
        <ScrollReveal>
          <section id="sec-adoption" className="mb-12">
            <LineChart
              title="Digital GP appointment booking and digital exclusion, 2020–2025"
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            source="Source: NHSX — Digital inclusion: wider determinants of health and the role of digital 2021. NHS Digital — NHS App performance dashboard."
          />
        </ScrollReveal>
