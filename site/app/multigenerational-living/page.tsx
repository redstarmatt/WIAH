    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Multigenerational households have grown by 33% since 2001 — driven primarily by housing costs forcing adult children to stay at home."
          colour="#F4A261"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="+33% since 2001 · 6% of all households"
              sparklineData={[1.35, 1.5, 1.62, 1.74, 1.8, 1.82, 1.8]}
              href="#sec-chart"source="ONS · Census 2021 / Family Resources Survey"
            />
            <MetricCard
              ...
              href="#sec-chart"source="ONS · Family Resources Survey 2024"
            />
            <MetricCard
              label="Adult children at home (25–34)"
              value="3.7m"
              unit=""
              direction="up"
              polarity="up-is-bad"
              changeText="25–34 living with parents · record high"
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Multigenerational households in England and Wales, 2001–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>ONS — Census 2021, Household and Family Characteristics. ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/families</p>
            <p>ONS — Family Resources Survey. Longitudinal survey of household composition and income, published annually by DWP. gov.uk/government/collections/family-resources-survey--2</p>
            <p>ONS — Labour Force Survey, Young Adults Living with Parents. Annual estimates of 20–34 year olds in parental home. ons.gov.uk</p>
