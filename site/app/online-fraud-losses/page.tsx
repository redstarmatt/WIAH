      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              What is perhaps most alarming is the shifting composition of fraud. Online shopping fraud \u2014 fake goods, non-delivery scams, counterfeit websites \u2014 dominated the early part of the period. But since 2022, investment fraud has overtaken it as the largest single category by value.<Cite nums={1} /> This is driven overwhelmingly by cryptocurrency scams, which exploit social media advertising and, increasingly, AI-generated deepfake endorsements from public figures. The average loss per victim for investment fraud is now around \u00A314,600 \u2014 compared with \u00A3720 for a shopping scam.<Cite nums={1} /> Romance fraud, while lower in volume, carries devastating personal consequences alongside an average loss exceeding \u00A37,000 per case. The emotional and psychological cost of fraud \u2014 shame, isolation, loss of trust \u2014 rarely appears in the statistics but is consistently highlighted in victim surveys.
            </p>
            <p>
              There are, however, genuine signs of structural improvement. The Payment Systems Regulator introduced mandatory reimbursement for authorised push payment (APP) fraud in October 2024, requiring banks to reimburse victims within five business days unless gross negligence is proven.<Cite nums={4} /> The reimbursement rate, which had fallen from 58% in 2017 to a low of 41% in 2023 as fraud complexity outpaced bank defences, has since recovered to 52% in 2025.<Cite nums={4} /> The Online Safety Act, while primarily designed to tackle harmful content, has given Ofcom new powers to compel platforms to remove fraudulent advertisements.<Cite nums={5} /> Several major banks have deployed real-time AI detection systems that flag unusual payment patterns before transactions complete. These measures have not reversed the overall trend, but they have slowed its acceleration and improved outcomes for victims who do come forward. The challenge ahead is twofold: closing the vast gap between crimes committed and crimes reported, and keeping pace with criminal innovation in an era where generative AI makes sophisticated fraud accessible to anyone.
            </p>
          </div>
        </section>
