      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              href="#sec-chart"source="Ministry of Justice · Enforcement Statistics 2023"
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="+15% since 2015 · fees compound debt problem"
              sparklineData={[270, 275, 280, 290, 295, 295, 300, 305, 310]}
              href="#sec-chart"source="Taking Control of Goods Regulations · 2023"
            />
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText="44% of visited debtors show vulnerability signs · not identified"
              sparklineData={[44, 44, 44, 44, 44, 44]}
              href="#sec-chart"source="Money Advice Trust · Debt Collection Survey 2023"
            />
          </div>
        </ScrollReveal>
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Ministry of Justice — Enforcement Statistics Quarterly. Published quarterly. gov.uk/government/collections/enforcement-statistics-quarterly</p>
            <p>Money Advice Trust — Personal Debt Statistics. moneyadvicetrust.org</p>
            <p>StepChange Debt Charity — Statistics Yearbook. stepchange.org/policy-and-research/statistics-yearbook.aspx</p>
            <p>Taking Control of Goods (Fees) Regulations 2014 — statutory fee schedule. legislation.gov.uk/uksi/2014/1</p>
