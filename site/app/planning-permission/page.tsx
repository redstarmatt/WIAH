...
const editorialRefs: Reference[] = [
  { num: 1, name: 'DLUHC', dataset: 'Planning Applications in England', url: 'https://www.gov.uk/government/collections/planning-applications-statistics', date: '2023' },
  { num: 2, name: 'Planning Advisory Service / LGA', dataset: 'LPA Staffing and Resourcing Survey', url: 'https://www.local.gov.uk/pas', date: '2023' },
  { num: 3, name: 'DLUHC', dataset: 'House Building: New Build Dwellings, England', url: 'https://www.gov.uk/government/collections/house-building-statistics', date: '2023' },
];
