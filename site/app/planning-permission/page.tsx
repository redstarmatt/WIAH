      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              The burden of inadequate housing supply falls along clear social lines. Young people are the primary losers: home ownership among 25&ndash;34-year-olds fell from 67&percnt; in 2000 to 39&percnt; in 2023, a generational shift with profound implications for wealth accumulation, retirement security, and family formation. Renters in high-demand areas pay an increasing share of their income in rent &mdash; 40&percnt; of income in London, 30&percnt; in the South East &mdash; while housing benefit costs to the public purse have risen 40&percnt; in real terms since 2010 because rents have risen faster than wages. Rural communities are being priced out by second-home purchases and planning restrictions that prevent affordable housing development, particularly in National Parks and Areas of Outstanding Natural Beauty where local residents often cannot afford homes in the places where they were born and raised.
            </p>
            <p>
