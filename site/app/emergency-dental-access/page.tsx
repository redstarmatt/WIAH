      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>NHS dental services in England have been in structural decline since the 2006 dental contract changed how dentists were paid and drove many out of NHS practice. The number of NHS dentists fell from around 23,500 in 2009 to 20,800 in 2024 while the population grew. Pandemic closures in 2020 generated a large backlog, and many mixed-practice dentists moved permanently to private-only when UDA (Units of Dental Activity) rates made NHS work financially unrewarding — NHS treatment volumes fell 24% between 2019–20 and 2022–23. The result: an estimated 14 million adults cannot access an NHS dentist. Approximately 180,000 people now attend hospital A&amp;E each year for acute dental pain, and tooth extraction is the most common reason for hospital admission among children under 10.</p>
            <p>The access crisis falls hardest on those least able to afford private alternatives. Rural areas and deprived communities have the fewest NHS dental places; people on lower incomes who cannot afford private fees are most exposed to the consequences of untreated decay progressing to extraction rather than restoration. The NHS England Dental Recovery Plan (February 2024) committed to 2.5 million new appointments, but the British Dental Association argued this was inadequate without fundamental UDA contract reform — the perverse incentive structure that pays the same flat rate for a check-up as for a complex restoration, effectively penalising dentists who take on vulnerable, high-need patients.</p>
          </div>
        </section>
