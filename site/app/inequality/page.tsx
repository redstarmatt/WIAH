      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Regional inequality in disposable incomes is among the highest in the OECD: median household income in London (&pound;42,000) is 36% above the North East (&pound;31,000) and 38% above Wales (&pound;30,500). Intergenerational wealth transmission compounds these divides: annual inheritance flows now exceed &pound;90 billion, overwhelmingly benefiting families already in the top half of the wealth distribution. Private school attendance &mdash; 6&ndash;7% of pupils &mdash; accounts for a disproportionate share of elite university places and senior professional roles. The gender wealth gap runs at roughly 35%, driven by pension disparities rooted in part-time work and caring responsibilities. Geographic concentration is stark: 14 of the 20 most deprived local authorities are in the North West or North East.</p>
          </div>
        </section>
