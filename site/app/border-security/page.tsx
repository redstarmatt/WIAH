    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="36,816 people crossed the English Channel in small boats in 2024, up 25&percnt; on 2023. The asylum decision backlog stood at 98,600 cases at the end of 2025, down from a peak of 175,400 but still more than double pre-pandemic levels. Returns of failed asylum seekers have fallen to historic lows."
          colour="#264653"
        />
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Successive governments have pursued deterrence-based strategies with limited measurable effect. The Rwanda deportation policy, announced in 2022 and eventually declared unlawful by the Supreme Court in 2023, consumed approximately &pound;700 million without removing a single asylum seeker. The Illegal Migration Act 2023 sought to make anyone arriving by small boat permanently inadmissible to the asylum system, but implementation has been suspended following legal challenges and a change of government. France has received over &pound;500 million in UK funding since 2018 to increase beach patrols and disrupt launch sites. Interception rates have risen &mdash; around 40&percnt; of launch attempts are now prevented &mdash; but crossings continue because demand for the route is driven by factors beyond French policing: conflict, persecution, and the absence of safe legal routes to claim asylum in the UK.</p>
            ...
            <p>The demographics of small boat arrivals are specific and often misunderstood. The majority are young men, but around 20&percnt; are women and children, including unaccompanied minors. The largest nationality groups in 2024 were Afghan, Iranian, Iraqi, Eritrean, and Syrian &mdash; countries with well-documented conflict, persecution, and human rights crises. Grant rates for asylum claims from these nationalities are high: around 80&percnt; for Afghans, 73&percnt; for Eritreans, and 90&percnt; for Sudanese. Albanians, who were the largest group in 2022, declined sharply in 2023 following a bilateral returns agreement. Returns of failed asylum seekers have fallen to historic lows: fewer than 3,000 enforced returns in 2024, compared with over 12,000 a decade earlier, reflecting difficulties in negotiating returns agreements and the practical challenges of removal.</p>
