      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The UK government&apos;s net zero strategy relies substantially on Carbon Capture, Usage and Storage (CCUS) to reduce emissions from hard-to-decarbonise sectors &mdash; steel, cement, chemicals, hydrogen production &mdash; with a target of capturing 20&ndash;30 million tonnes of CO2 per year by 2030. As of 2026, no commercial CCUS plant is operational in the UK. The government&apos;s Track-1 industrial clusters &mdash; HyNet in the North West and the East Coast Cluster around Teesside and Humberside &mdash; were selected in 2021 as priority development sites but have been delayed by commercial negotiations over risk allocation and pricing; Track-1 operations are now not expected before 2028&ndash;29. The government has committed &pound;22 billion in public investment, but disbursement lags the stated timeline. The Climate Change Committee&apos;s 2024 Progress Report identified CCUS deployment as one of the areas of greatest concern in the near-term carbon budget, alongside heat pump installation and EV charging infrastructure.</p>
            <p>The gap between ambition and delivery is significant and creates knock-on risks for the overall net zero pathway. If CCUS targets are missed, the residual emissions it was supposed to address will need to be offset through additional renewable generation, demand reduction, or international credits &mdash; all costlier than capture at source. Direct Air Capture, which removes CO2 from the atmosphere rather than at point of emission, is at an earlier development stage and currently costs &pound;200&ndash;400 per tonne &mdash; far above economic viability at scale. The delay risk is primarily a policy and commercial risk rather than a technological one: the technology exists, but the commercial frameworks for deploying it have proven difficult to agree.</p>
          </div>
        </section>
