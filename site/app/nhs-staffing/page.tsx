      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              Shortages are concentrated in the specialisms already under greatest pressure. Mental health nursing carries a 16.2&percnt; vacancy rate; learning disability nursing 13.4&percnt;. Rural and coastal trusts &mdash; ambulance services in the South West, community hospitals in Norfolk and Cumbria &mdash; report vacancy rates above 15&percnt;, unable to compete for staff against urban trusts with more career progression. One in four nurses is within ten years of retirement; 30&percnt; of GPs are over 55. Agency spending of &pound;3.0 billion in 2022/23 fills immediate gaps at roughly three times the cost of permanent staff, diverting funds from the training and retention that would reduce the underlying dependency. Safe nurse-to-patient ratios remain unlegislated in England, meaning the consequences of understaffing are absorbed silently in longer waits and elevated risk.
            </p>
          </div>
        </section>
