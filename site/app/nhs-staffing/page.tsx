      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Staffing shortages are not evenly distributed. Mental health nursing carries the highest vacancy rate of any specialism at 16.2&percnt;, followed by learning disability nursing at 13.4&percnt; &mdash; services already operating at the margins of safe provision. Geographically, trusts in coastal and rural areas struggle most: ambulance trusts in the South West and community hospitals in Norfolk, Lincolnshire, and Cumbria report vacancy rates above 15&percnt;, competing for staff against better-connected urban trusts that offer more career progression. The age profile of the workforce compounds the problem: 30&percnt; of GPs are over 55, and one in four nurses is within ten years of retirement. Agency spending &mdash; &pound;3.0 billion in 2022/23 &mdash; fills the immediate gap but at roughly three times the cost of permanent staff, diverting funds from the training and retention measures that would reduce long-term dependency.</p>
            <p>NHS workforce data is less transparent than it appears. Vacancy figures are based on advertised posts, not a comprehensive census of unfilled roles &mdash; trusts that have given up trying to fill a post, or that have downgraded it to a lower band, do not appear in the count. The headline figure therefore understates the true shortfall. Sickness absence data captures days lost but not presenteeism &mdash; staff attending work while unwell &mdash; which the BMA estimates may be equally widespread. International recruitment figures track initial NMC registration but not retention: there is no published dataset on how many overseas-trained nurses leave the NHS within their first two years. The Staff Survey, while extensive, has a response rate of around 45&percnt;, and those most burned out may be least likely to complete it. Safe staffing ratios remain unlegislated in England, so there is no formal threshold against which to measure adequacy.</p>
          </div>
        </section>
