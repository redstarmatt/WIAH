...
const editorialRefs: Reference[] = [
  { num: 1, name: 'NHS England', dataset: 'National Prison Survey — Mental Health Prevalence', url: 'https://www.england.nhs.uk/commissioning/health-just/mental-health-services-in-prisons/', date: '2024' },
  { num: 2, name: 'HMPPS', dataset: 'Safety in Custody Statistics', url: 'https://www.gov.uk/government/collections/safety-in-custody-statistics', date: '2024' },
  { num: 3, name: 'NHS England', dataset: 'Prison Healthcare Data — Mental Health Treatment', url: 'https://www.england.nhs.uk/commissioning/health-just/', date: '2024' },
  { num: 4, name: 'NHS England', dataset: 'NHS Long Term Plan — Prison Mental Health Investment', url: 'https://www.longtermplan.nhs.uk/areas-of-work/mental-health/', date: '2024' },
  { num: 5, name: 'Prison Reform Trust', dataset: 'Bromley Briefings Prison Factfile', url: 'http://www.prisonreformtrust.org.uk/project/bromley-briefings/', date: '2024' },
];
    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding={<>70% of prisoners have two or more mental health conditions — yet only 1 in 3 receives treatment in custody, and the suicide rate is 10 times higher than in the general population.<Cite nums={[1, 2]} /></>}
          colour="#E63946"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText={<>Personality disorder 47%, depression 42%, anxiety 38% · concentrated disadvantage<Cite nums={1} /></>}
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText={<>10x the general population rate of 11 per 100,000<Cite nums={2} /></>}
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText={<>Up from 22% in 2014 · but 2 in 3 receive nothing<Cite nums={3} /></>}
        ...
        <ScrollReveal>
          <section className="max-w-2xl mb-12">
            ...
            <div className="text-base text-wiah-black leading-[1.7] space-y-4">
              <p>Around 70% of prisoners have at least two diagnosable mental health conditions at the time of entry, according to NHS England estimates.<Cite nums={1} /> Self-harm incidents recorded in prisons in England and Wales have risen from approximately 24,000 in 2014 to 74,590 in 2023 — a 208% increase over a decade — equivalent to more than 203 incidents every single day.<Cite nums={2} /> The in-custody suicide rate stands at around 115 per 100,000 — ten times the general population rate of 11 per 100,000.<Cite nums={2} /></p>
              <p>Despite NHS Long Term Plan investment, only 33% of prisoners receive active mental health treatment.<Cite nums={[3, 4]} /> The gap is not primarily a diagnostic failure — referral rates have risen substantially — but a capacity constraint: too few therapists, too much churn as prisoners are transferred between establishments, and a physical environment incompatible with therapeutic work. Segregation continues to be used for prisoners in acute mental health crisis in the absence of adequate alternative provision.<Cite nums={5} /></p>
              <p>The high prevalence of mental illness in prison reflects upstream failures rather than prison conditions alone.<Cite nums={5} /> Street homelessness, substance dependency, poverty, and trauma are risk factors for both offending and mental illness; prison concentrates the consequences of inadequate community mental health, housing, and drug treatment provision. Release without continuity of care is a critical failure point: the period immediately after release carries the highest risk of suicide and drug overdose death in the entire criminal justice pathway.<Cite nums={[2, 5]} /></p>
            </div>
          </section>
        </ScrollReveal>
