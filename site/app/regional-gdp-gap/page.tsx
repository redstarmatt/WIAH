      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The UK has the most geographically unequal economy of any comparable high-income country. GDP per head in London stood at &pound;67,500 in 2022, while the North East registered &pound;22,100 &mdash; a ratio of 3.1 to 1, compared with 1.9 in Germany and 1.7 in France. The Levelling Up agenda, backed by &pound;8 billion in fund expenditure over 2020&ndash;25, produced measurable improvements on some missions but failed to narrow the core gaps: wages and life expectancy continued diverging, and the cancellation of HS2&apos;s northern leg in October 2023 removed much of the connectivity rationale for rebalancing. The current government&apos;s growth mission relies on metro-mayor devolution rather than place-based grants, with combined authority deals covering skills, transport, and business support. Treasury analysis has found London received approximately &pound;4,000 more per head in public investment than comparable regions between 2000 and 2019.</p>
            <p>The burden falls hardest on post-industrial communities, coastal towns, and areas with older populations that never recovered from the deindustrialisation of the 1980s. Per-capita transport spending in London was &pound;902 in 2022/23, versus &pound;337 in the North East and &pound;296 in Yorkshire &mdash; a structural imbalance that compounds the underlying productivity gap. Agglomeration effects continue to concentrate high-value financial and professional services in London, and economists broadly agree that reversing this dynamic requires sustained investment over decades, not years.</p>
          </div>
        </section>
