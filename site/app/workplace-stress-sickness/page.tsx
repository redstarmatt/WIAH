      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Work-related stress, depression, and anxiety now account for 17.1 million lost working days per year in Great Britain &mdash; the single largest cause of occupational ill health and absence, and a 73% increase since 2015 when 9.9 million days were lost. The trend predates COVID and has not reversed: 2023 matched the elevated levels of 2022, suggesting the post-pandemic peak has become the new baseline. Healthcare, education, and public administration are the worst-affected sectors, where the causes are well-documented: chronic understaffing, lack of control over working conditions, and exposure to traumatic or emotionally demanding situations. The NHS workforce crisis and the teacher recruitment emergency both have workplace stress as a central driver and consequence. The HSE estimates the economic cost at approximately &pound;28 billion per year in lost productivity, staff turnover, and healthcare expenditure.</p>
            <p>Employer responses have been uneven and largely inadequate. Large employers have adopted Employee Assistance Programmes, mental health first aiders, and wellbeing apps &mdash; interventions with a weak evidence base that address symptoms rather than causes: a mental health first aider cannot compensate for chronic understaffing. The HSE&apos;s Management Standards framework is voluntary and unenforced, meaning the employers most likely to apply it are those already managing stress effectively. HSE inspection capacity has declined significantly over the past decade, and the rise of remote working, always-on communications, and gig economy arrangements has created new stressors that existing health and safety regulation was not designed to address.</p>
          </div>
        </section>
