      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Placeholder paragraph one about NHS screening context.</p>
            <p>Placeholder paragraph two about NHS screening drivers.</p>
            <p>Placeholder paragraph three about NHS screening policy.</p>
          </div>
        </section>
