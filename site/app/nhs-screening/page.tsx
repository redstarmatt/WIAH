      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Non-participation is concentrated in the communities that most need early detection. Cervical screening uptake is 78% in the least deprived areas but only 63% in the most deprived &mdash; precisely where cancer incidence is highest. Women aged 25&ndash;29 have the lowest attendance at 61&percnt;. South Asian and Black women are significantly less likely to attend breast screening, with language access and institutional mistrust as key barriers. GP practices in deprived areas lack dedicated screening coordinators; mobile breast screening units have reduced their rounds since 2020 due to staffing shortages; over 40&percnt; of mammographers are within a decade of retirement with no funded training pipeline to replace them.</p>
          </div>
        </section>
