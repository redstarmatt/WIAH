    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <TopicHeader
          ...
          finding="Only 70% of patients are seen within 4 hours in major A&amp;E departments — the target is 95%. This target has not been consistently met since 2015. Over 300,000 patients waited more than 12 hours in 2023/24. 24 million people attended A&amp;E in 2022/23 — the highest ever."
        />
        ...
        <div className="space-y-8">
          ...
          <ScrollReveal>
            <div className="bg-wiah-light p-6 rounded-lg space-y-4">
              <h2 className="text-xl font-bold text-wiah-black">
                Major A&amp;E 4-hour performance, England, 2012–2024
              </h2>
              <LineChart
                title="Major A&amp;E 4-hour performance, England, 2012–2024"
          ...
          <ScrollReveal>
            <div className="bg-wiah-light p-6 rounded-lg space-y-4">
              <h2 className="text-xl font-bold text-wiah-black">
                12-hour trolley waits in A&amp;E, England, 2018–2024
              </h2>
              <LineChart
                title="12-hour trolley waits in A&amp;E, England, 2018–2024"
          ...
          <ScrollReveal>
            <div className="bg-wiah-light p-6 rounded-lg space-y-4">
              <h2 className="text-xl font-bold text-wiah-black">
                Ambulance handover delays, England, 2019–2023
              </h2>
              <LineChart
                title="Ambulance handover delays >30 mins, England, 2019–2023"
          ...
          <PositiveCallout
            ...
            value="50+"
            unit="Urgent Treatment Centres opened since 2017 — taking pressure off major A&amp;E"
            description="NHS England has opened over 50 Urgent Treatment Centres (UTCs) since 2017, offering same-day care for non-life-threatening conditions without A&amp;E admission. UTCs are open 12 hours a day, 7 days a week, staffed by GPs and nurses. In 2022/23, they handled over 10 million attendances — around 44% of all emergency care activity — diverting patients away from major A&amp;E departments. The NHS 111 online triage service directed a further 6 million people to appropriate care without requiring A&amp;E attendance. The &lsquo;ambulance to the front door&rsquo; initiative is improving handover times in high-delay trusts."
            source="Source: NHS England — A&amp;E Attendances and Emergency Admissions 2023/24."
          />
          ...
          <div className="bg-wiah-light p-6 rounded-lg space-y-4">
            ...
            <p className="text-sm text-wiah-mid">
              <strong>12-hour trolley waits:</strong> Cumulative count of distinct waits exceeding 12 hours from decision to admit to leaving A&amp;E. Definition changed in 2021 — pre- and post-2021 data are not directly comparable.
            </p>
            <p className="text-sm text-wiah-mid">
            ...
            <div className="mt-4 pt-4 border-t border-wiah-border">
              <p className="text-xs text-wiah-mid">
                <strong>Known issues:</strong> 4-hour target applies to Type 1 only. &lsquo;All type&rsquo; performance (including minor injury units and UTCs) is higher. 12-hour wait definition change in 2021 breaks comparability. Ambulance data collection improved in 2022 — earlier figures may undercount.
              </p>
            </div>
          </div>
        </div>
