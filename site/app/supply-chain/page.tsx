...
const editorialRefs: Reference[] = [
  ...
  { num: 3, name: 'House of Lords', dataset: 'Science and Technology Committee — Medicine Supply Chain Report', date: '2021', note: 'NHS relies on imports for ~86% of active pharmaceutical ingredients, predominantly India and China', url: 'https://www.parliament.uk/business/lords/' },
];
