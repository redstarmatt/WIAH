...
export const metadata: Metadata = {
  ...
  description: 'New PIP claimants wait an average of 24 weeks for a decision — and when they appeal, 71% of tribunal decisions overturn the DWP&rsquo;s original ruling.',
  openGraph: {
    title: 'How Long Must Disabled People Wait for Benefits?',
    description: 'New PIP claimants wait an average of 24 weeks for a decision — and when they appeal, 71% of tribunal decisions overturn the DWP&rsquo;s original ruling.',
    type: 'article',
