        ...
        <ScrollReveal>
          <section className="max-w-2xl mb-12">
            ...
            <div className="text-base text-wiah-black leading-[1.7] space-y-4">
              ...
              <p>The statutory 20-week deadline for completing an EHCP assessment is being missed for nearly two thirds of children. Only 37% of EHCPs are now issued within the legal limit, down from 60% in 2016. Families who challenge delays through the Special Educational Needs Tribunal win their cases in over 96% of contested hearings — suggesting decisions are often wrong, not just slow.</p>
