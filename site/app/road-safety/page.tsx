      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>British road deaths fell 78% from 7,763 in 1972 to 1,695 in 2023 &mdash; one of the most significant public health achievements of the past half-century. But progress has stalled since 2010 (when there were 1,857 fatalities), suggesting the interventions that drove the long decline &mdash; seat belts, engineering standards, drink-drive enforcement &mdash; have been largely exhausted. Pedestrians and cyclists account for 31% of deaths despite travelling a small fraction of total miles; cyclist serious injuries have risen 31% since 2010 as volumes grew without commensurate infrastructure investment. Speed remains a contributory factor in 59% of all road deaths; Wales introduced a 20mph default limit in residential areas in September 2023, but England has no equivalent national policy. Young drivers aged 17&ndash;24 hold 7% of licences but are involved in 25% of fatal crashes &mdash; a risk concentration the UK has not addressed through graduated driver licensing, despite evidence it reduces young driver fatalities by 20&ndash;40%. The UK has no binding national road safety target: the last expired in 2020 and was not renewed, placing it behind Sweden, France, Spain, and the Netherlands.</p>
            <p>Deprivation is the strongest single predictor of road death. Children in the most deprived 20% of neighbourhoods are four times more likely to be killed or seriously injured as pedestrians than those in the least deprived quintile &mdash; a gradient that has barely shifted since 2013. Rural roads carry 33% of traffic but account for 58% of fatalities, yet road safety investment has historically concentrated on urban junctions. Local authority road safety budgets fell an estimated 40% in real terms between 2010 and 2020, eliminating school crossing patrols and local enforcement teams in the areas that need them most.</p>
          </div>
        </section>
