    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="857,000 young people aged 16–24 are not in education, employment or training — nearly 1 in 8 of their age group."
          colour="#E63946"
        />

        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Approximately 830,000 young people in England were NEET — not in education, employment or training — in 2024, equivalent to 11.1% of all 16–24 year olds. The number peaked at 900,000 in 2021 as employers stopped hiring and training programmes were disrupted during the pandemic, and remains above the 2019 pre-pandemic level of 770,000, suggesting some of the disengagement has become structural rather than cyclical. Around 190,000 have been NEET for over a year. Long-term NEET status is strongly associated with mental health difficulties, which became significantly more prevalent among young people during the pandemic and have not returned to pre-2020 levels. KPMG has estimated the lifetime cost to the exchequer of NEET status at around £45,000 per young person in reduced tax receipts and increased service use.</p>
            <p>NEET status is deeply unequal in its distribution. Young women are more likely to be NEET than young men, primarily because of caring responsibilities. Young people with disabilities or mental health conditions are significantly overrepresented. Care leavers, those excluded from school, and those in high-deprivation areas face substantially elevated risks — and have the fewest informal support structures to draw on during the transition to adulthood. The government's 2024 Youth Guarantee commits to ensuring every 18–21 year old has access to education, employment or training; whether it will be resourced sufficiently to re-engage those who have already disengaged once from the system remains to be seen.</p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="slowly improving · but above 2019 pre-pandemic"
              sparklineData={[840, 820, 800, 790, 770, 860, 900, 870, 857, 830]}
              href="#sec-chart"source="ONS · Young People Not in Education, Employment or Training 2024"
            />
            <MetricCard
              label="NEET rate"
              value="11.1%"
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="target &lt;8% · still well above"
            ...
            <MetricCard
              ...
              href="#sec-chart"source="DfE · NEET Statistics 2024"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Young people NEET (16–24), England, 2015–2024"
              subtitle="Total NEET young people aged 16–24. Thousands. Spike in 2020–21 reflects pandemic disruption; recovery has been incomplete."
              series={neetSeries}
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>ONS — Young People Not in Education, Employment or Training. Quarterly estimates from Labour Force Survey. ons.gov.uk/employmentandlabourmarket/peopleinwork/employmentandemployeetypes/bulletins/youngpeoplenotineducationemploymentortrainingneet/latest</p>
            <p>DfE — NEET Statistics Quarterly Brief. Detailed breakdowns by age, gender, ethnicity, and disability. gov.uk/government/collections/statistics-neet</p>
