      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Britain is consuming less alcohol than it did in 2004, when per-capita consumption peaked, yet the health toll keeps rising. Alcohol-specific deaths in England and Wales reached 8,274 in 2023 &mdash; up 24% since 2010 &mdash; driven by alcoholic liver disease, which has a long latency: drinkers dying today were drinking heavily in the 2000s. Hospital admissions where alcohol was the primary or secondary diagnosis reached 980,000 in 2022/23, up 17% from 839,000 in 2010, and now cost the NHS an estimated &pound;3.5 billion a year. The heaviest 10% of drinkers consume more than 60% of all alcohol sold. Around 21% of English adults drink above the CMO guideline of 14 units a week. Scotland introduced minimum unit pricing (MUP) at 50p per unit in 2018 &mdash; Public Health Scotland&apos;s evaluation found a 13% reduction in alcohol-specific deaths in year one. Wales followed in 2020 and is raising MUP to 65p in 2025. England has not adopted the policy, despite calls from NHS England and the Royal College of Physicians.</p>
            <p>The social gradient is sharp and widening. Alcohol-specific death rates in the most deprived areas are more than twice those in the least deprived, a disparity that has grown since 2010. Only 18% of people with alcohol dependence in England are accessing structured treatment, compared with 61% for drug dependence &mdash; a gap reflecting decades of underfunding in local authority addiction services. Alcohol is implicated in approximately 40% of domestic violence incidents. The COVID-19 pandemic produced a sharp mortality spike: deaths peaked at 9,641 in 2021 as off-licence sales surged and dependent drinkers lost clinical support. Treatment capacity remains inadequate, pub closures have relocated drinking to homes at lower unit prices, and England&apos;s refusal to adopt minimum unit pricing represents a persistent political choice to accept preventable deaths.</p>
          </div>
        </section>
