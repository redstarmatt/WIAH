      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Scotland introduced minimum unit pricing (MUP) at 50p per unit in May 2018 &mdash; the first such policy in the UK. Public Health Scotland&apos;s evaluation, published in 2023, found a 13% reduction in alcohol-specific deaths attributable to MUP in year one, with the greatest effects in the most deprived communities. Wales followed with 50p MUP in 2020 and is raising it to 65p in 2025. England has not adopted the policy, despite NHS England and the Royal College of Physicians calling for it. The 2023 alcohol duty reform linked tax to strength, favouring products below 3.5% ABV, but independent analysis by the Institute for Fiscal Studies found it had minimal impact on consumption patterns.</p>
            <p>The NHS bears a staggering burden from alcohol harm&mdash;an estimated 4.4 million alcohol-related hospital admissions each year, costing roughly &pound;3.5 billion annually in direct healthcare spending alone. Beyond hospitals, alcohol is implicated in around 40&percnt; of domestic violence incidents, and co-occurs with homelessness at rates that make separating cause from consequence nearly impossible. Yet treatment capacity remains woefully inadequate: only 18&percnt; of people estimated to have alcohol dependence in England are currently accessing structured treatment, compared with 61&percnt; for drug dependence&mdash;a gap that reflects decades of underfunding in local authority addiction services following the 2012 transfer of public health budgets. Cultural shifts like Dry January, now undertaken by an estimated 9 million adults, and the broader &ldquo;drink-free days&rdquo; movement signal genuine behavioural change among moderate drinkers, but they do not reach the heaviest consumers who account for a disproportionate share of harm. Meanwhile, pub closures&mdash;running at roughly 50 per month&mdash;have not reduced overall consumption so much as relocated it into supermarkets and living rooms, where unit prices are lower and drinking is unobserved. Licensing reform remains politically stalled, caught between public health evidence and the economic weight of the alcohol industry, which contributes &pound;46 billion annually to the UK economy and employs over 900,000 people directly.</p>
            <p>The headline figure of 8,274 alcohol-specific deaths in 2023 captures only cases where alcohol was the direct and sole underlying cause&mdash;primarily alcoholic liver disease, alcohol poisoning, and alcohol-related mental health disorders. It excludes the far larger number of deaths where alcohol contributed to cancers, cardiovascular disease, stroke, and injuries, which Public Health England has previously estimated at over 24,000 per year. AUDIT-C screening for hazardous drinking varies enormously between GP practices, meaning identification rates depend more on where a patient lives than how much they drink. The lag between changes in consumption and changes in mortality&mdash;alcoholic liver disease typically develops over 10&ndash;20 years of heavy drinking&mdash;means that today&apos;s death figures largely reflect drinking patterns from the mid-2000s peak, and any benefits from recent consumption declines among younger adults will not appear in mortality data for years. Hospital admissions coding is inconsistent between trusts, with some recording alcohol as a secondary factor far more diligently than others. The widely cited increase in &ldquo;sofa drinking&rdquo; during the pandemic is inferred primarily from off-trade sales data and household purchasing surveys rather than direct behavioural observation, and survey-based estimates of consumption consistently undercount actual intake by 40&ndash;60&percnt; when compared against sales and customs data. Home brewing and cross-border purchases remain essentially uncounted.</p>
          </div>
        </section>
