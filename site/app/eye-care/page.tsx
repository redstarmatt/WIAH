    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Over 630,000 patients are waiting for NHS ophthalmology appointments, and 22,000 people are at risk of preventable sight loss due to delayed follow-ups — described as a &ldquo;patient safety scandal&rdquo; by the Royal College of Ophthalmologists."
          colour="#6B7280"
          preposition="in"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              changeText="2024 · Up 57% from 400K in 2018"
            ...
            <MetricCard
              ...
              direction={'up' as const}
              polarity={'up-is-bad' as const}
              changeText="2024 · Breaching NHS constitution standard"
        ...
        <ScrollReveal>
          <section id="sec-waiting-list" className="mb-12">
            <LineChart
              title="NHS ophthalmology waiting list, England, 2018–2024"
        ...
        <ScrollReveal>
          <section id="sec-18-weeks" className="mb-12">
            <LineChart
              title="Ophthalmology patients waiting 18+ weeks, England, 2018–2024"
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            value="500K"
            description="Community optometry schemes — where high-street opticians handle routine follow-up appointments for stable conditions such as glaucoma monitoring and post-cataract checks — are reducing hospital pressure in pilot areas, with potential to free up 500,000 hospital appointments annually if rolled out nationally. NHS England's Community Eye Care Service reforms, piloted in several ICSs from 2022, have shown that accredited community optometrists can safely manage a significant proportion of low-risk follow-up caseload, freeing ophthalmologists to focus on complex and sight-threatening cases."
            source="Source: Royal College of Ophthalmologists — The Way Forward: Ophthalmology, 2023 Update."
          />
        </ScrollReveal>
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>NHS England — Consultant-Led Referral to Treatment Waiting Times. Monthly data on all incomplete and completed RTT pathways in England by specialty. Ophthalmology specialty code 130. Does not include follow-up appointment waits.</p>
            <p>Royal College of Ophthalmologists — The Way Forward: Ophthalmology. Service capacity analysis covering consultant and allied health professional workforce, demand projections, and patient safety implications of delayed appointments. Updated 2022.</p>
            <p>NHS Diabetic Eye Screening Programme — Annual statistical report. Covers uptake, screening outcomes, and referral rates by demographics and geography.</p>
