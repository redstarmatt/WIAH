      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Air pollution is the largest environmental risk to health in the UK, responsible for an estimated 36,000 premature deaths each year &mdash; roughly comparable to colorectal cancer. The principal culprits are PM2.5 (fine particulate matter small enough to enter the bloodstream) and nitrogen dioxide, which drives cardiovascular disease, stroke and lung cancer. Progress has been made: the national average PM2.5 concentration fell from around 11 &micro;g/m&sup3; in 2010 to 8.6 &micro;g/m&sup3; by the early 2020s, and NOx from road transport fell 53% over the same period. But the reduction is slowing. In 2021, the WHO tightened its annual PM2.5 guideline to 5 &micro;g/m&sup3; &mdash; a threshold that 98% of UK urban areas now exceed. The UK legal limit remains 10 &micro;g/m&sup3;, leaving a large gap between what the science recommends and what the law requires.</p>
            <p>Who breathes dirty air is not random. People in deprived areas are disproportionately likely to live near busy roads and industrial sites, and children in high-pollution areas develop measurably smaller lung capacity. Research by Ellison and others found a significant association between long-term NO2 exposure and reduced cognitive development in children. One of the least-discussed contributors to poor air quality is domestic solid fuel burning &mdash; wood-burning stoves and open fires &mdash; which has grown in popularity since 2010 and now accounts for 29% of UK PM2.5 emissions, making it the single largest source. Road transport follows at 26%, agriculture (primarily ammonia) at 20%, and industry at 12%. Oxford Street and Marylebone Road in London have at times recorded some of the highest NO2 concentrations in Europe.</p>
            <p>Policy is moving, but unevenly. The Environment Act 2021 set a legally binding PM2.5 target of 10 &micro;g/m&sup3; by 2040, with a commitment to tighten further to 5 &micro;g/m&sup3; for the most polluted areas &mdash; still a decade-long lag behind the WHO recommendation. London&apos;s Ultra Low Emission Zone, expanded to cover all boroughs in August 2023, brought an additional 700,000 vehicles into scope and produced a 21% reduction in roadside NO2 in its first year. Wood-burning stove regulation remains limited despite domestic burning being the top source of PM2.5. Outside London, the absence of equivalent clean-air enforcement means that the gains are concentrated where political will and population density have made action feasible, leaving large parts of the country &mdash; and the most exposed communities within them &mdash; subject only to targets that fall short of WHO guidance.</p>
          </div>
        </section>
