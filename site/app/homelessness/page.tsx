  ...
  const roughSleepAnnotations: Annotation[] = [
    {
      ...
      label: '2020: Everyone In &mdash; hotels opened',
    },
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          colour="#E63946"
          finding="Homelessness in England has reached a record level. In 2023/24, 117,500 households were accepted as homeless by local authorities &mdash; up 119% since 2012/13. 159,900 children are growing up in temporary accommodation."
        />
        ...
        <ScrollReveal>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2023/24 &mdash; All-time high &mdash; Up 119% since 2012/13"
              sparklineData={[53.5, 54.5, 59.8, 78.1, 97.2, 74.7, 74.1, 94.6, 105.4, 117.5]}
              source="Source: MHCLG &mdash; Statutory homelessness in England 2023/24."
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2024 &mdash; Near 2017 record &mdash; COVID Everyone In scheme reversed"
              sparklineData={[1768, 2309, 2744, 4134, 4751, 4266, 2688, 2440, 3069, 3898, 4255]}
              source="Source: MHCLG &mdash; Rough sleeping statistics 2024."
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2023/24 &mdash; Record high &mdash; B&amp;Bs, hostels, nightly let"
        ...
        <ScrollReveal>
          <div className="mt-16">
            <LineChart
              title="Statutory homelessness, England, 2012&ndash;2024"
        ...
        <ScrollReveal>
          <div className="mt-16">
            <LineChart
              title="Rough sleepers in England, autumn count, 2010&ndash;2024"
        ...
        <ScrollReveal>
          <div className="mt-16">
            <LineChart
              title="Households and children in temporary accommodation, 2014&ndash;2024"
              subtitle="Includes B&amp;Bs, hostels, and nightly-let properties. 159,900 children are growing up in temporary accommodation &mdash; a record high."
        ...
        <ScrollReveal>
          <div className="mt-16 bg-wiah-light p-8 rounded">
            ...
            <div className="space-y-4 text-wiah-mid leading-relaxed">
              <p>
                In 2023/24, 117,500 households were accepted as statutorily homeless in England &mdash; the highest figure since records began. A further 338,400 had homelessness prevented or relieved, also a record. The human cost is concentrated on children: 159,900 are growing up in temporary accommodation, including more than 5,000 in bed-and-breakfasts. Placing families in B&amp;Bs for longer than six weeks is illegal except in emergencies, yet 87% of local authorities breached that limit in 2023/24. Temporary accommodation now costs councils an average of &pound;1,600 per household per month; the total bill reached an estimated &pound;2.4bn in 2024/25, up from &pound;1.0bn five years earlier.
              </p>
              <p>
                The private rented sector drives the crisis. End of tenancy accounts for 22.3% of accepted cases &mdash; the single largest cause for seven consecutive years. Section 21 no-fault evictions were finally abolished in October 2025 under the Renters&apos; Rights Bill, but landlords served a wave of notices before the deadline, fuelling a surge in 2023/24 presentations. The deeper problem is affordability: Local Housing Allowance, the benefit that caps rent support at the 30th percentile of local rents, has been repeatedly frozen. In London the gap between LHA and an average one-bedroom rent is &pound;500&ndash;&pound;800 per month. Benefits no longer cover the cheapest third of the market they were designed to reach.
              </p>
              <p>
                The Everyone In programme proved what speed and political will can achieve: 37,000 rough sleepers were housed in hotels within weeks of the March 2020 lockdown, and the annual count fell from 4,266 to 2,440 by 2021. But the hotel programme wound down without adequate move-on housing, and by 2024 rough sleeping had climbed back to 4,255 &mdash; almost exactly the 2018 level. The structural deficit is social housing. One million council homes have been sold under Right to Buy since 1980, replaced at a ratio of roughly 1:8. Some 1.3 million households sit on social housing waiting lists in 2024. Until supply catches up, temporary accommodation will continue to function as England&apos;s de facto social housing system &mdash; at far greater cost.
              </p>
            </div>
          </div>
        </ScrollReveal>
