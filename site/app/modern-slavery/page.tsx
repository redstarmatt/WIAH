      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Exploitation concentrates geographically in London, Birmingham, and the West Midlands, but also in agricultural areas of East Anglia and Lincolnshire and coastal hospitality in the South West. The highest-prevalence sectors include hand car washes, nail bars, cannabis cultivation houses, construction, and food processing &mdash; industries characterised by cash payment, subcontracting, and limited regulatory inspection. County lines has become the dominant driver of child referrals because its exploitation model deliberately uses minors as disposable couriers, making prosecution difficult since victims are often charged as offenders before being identified. The 2024 review of the Modern Slavery Act proposed strengthening the Section 45 statutory defence and extending the &ldquo;move on&rdquo; period beyond 45 days &mdash; the cliff edge after which confirmed victims lose government-funded support and frequently disappear from contact, vulnerable to re-trafficking.</p>
            <p>The NRM referral count is not a victim count &mdash; one person can be referred multiple times across different encounters, inflating the headline figure. The Global Slavery Index estimate of 100,000&ndash;136,000 victims in the UK uses a modelling methodology that has been criticised for opacity, and the UK-specific figure has not been independently validated by government or academic research. The frequently cited 4&percnt; prosecution rate compares total referrals, including unsubstantiated cases, against convictions &mdash; understating the prosecution rate for confirmed victims. Supply chain transparency statements required under the Modern Slavery Act are self-reported and largely unenforced; the responsible department has never prosecuted a company for non-compliance despite widespread evidence of inadequate statements. Nationality data in NRM referrals reflects which groups are being identified by first responders, not which groups are most exploited &mdash; detection bias shapes the picture.</p>
            <p>Exploitation concentrates geographically in London, Birmingham, and the West Midlands, but also in agricultural areas of East Anglia and Lincolnshire and coastal hospitality in the South West. The highest-prevalence sectors include hand car washes, nail bars, cannabis cultivation houses, construction, and food processing &mdash; industries characterised by cash payment, subcontracting, and limited regulatory inspection. County lines has become the dominant driver of child referrals because its exploitation model deliberately uses minors as disposable couriers, making prosecution difficult since victims are often charged as offenders before being identified. The 2024 review of the Modern Slavery Act proposed strengthening the Section 45 statutory defence and extending the &ldquo;move on&rdquo; period beyond 45 days &mdash; the cliff edge after which confirmed victims lose government-funded support and frequently disappear from contact, vulnerable to re-trafficking.</p>
            <p>The NRM referral count is not a victim count &mdash; one person can be referred multiple times across different encounters, inflating the headline figure. The Global Slavery Index estimate of 100,000&ndash;136,000 victims in the UK uses a modelling methodology that has been criticised for opacity, and the UK-specific figure has not been independently validated by government or academic research. The frequently cited 4&percnt; prosecution rate compares total referrals, including unsubstantiated cases, against convictions &mdash; understating the prosecution rate for confirmed victims. Supply chain transparency statements required under the Modern Slavery Act are self-reported and largely unenforced; the responsible department has never prosecuted a company for non-compliance despite widespread evidence of inadequate statements. Nationality data in NRM referrals reflects which groups are being identified by first responders, not which groups are most exploited &mdash; detection bias shapes the picture.</p>
          </div>
        </section>
