      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The National Referral Mechanism received 17,004 referrals of potential modern slavery victims in 2023 &mdash; a 33&percnt; annual increase and ten times the 2014 figure. The Global Slavery Index estimates between 100,000 and 136,000 people are held in conditions of modern slavery in the UK at any time, making NRM referrals a fraction of the true scale. Children account for 5,509 referrals &mdash; nearly a third &mdash; driven overwhelmingly by county lines drug networks recruiting boys as young as 12. Labour exploitation accounts for 47&percnt; of identified cases across car washes, construction, nail bars, and agriculture; sexual exploitation 30&percnt;; criminal exploitation 15&percnt;; domestic servitude 8&percnt;. The Modern Slavery Act 2015 created specific offences, established the NRM statutorily, and required large businesses to publish supply chain transparency statements, yet only 4&percnt; of NRM referrals lead to a prosecution, NRM conclusive-grounds decisions now average 543 days, and the Nationality and Borders Act 2022 further restricted trafficking protections for asylum seekers.</p>
            <p>Exploitation concentrates in London, Birmingham, and the West Midlands, in agricultural areas of East Anglia and Lincolnshire, and in South West coastal hospitality &mdash; industries characterised by cash payment, subcontracting, and minimal regulatory inspection. Children caught in county lines are typically charged as offenders before being identified as victims, creating a perverse prosecution gap. At the 45-day cliff edge, confirmed victims lose government-funded support and frequently disappear from contact, vulnerable to re-trafficking. Albanian and Vietnamese nationals are the most commonly referred nationalities, but detection bias in who first responders identify shapes the picture: the most exploited groups and the most identified groups are not necessarily the same.</p>
          </div>
        </section>
