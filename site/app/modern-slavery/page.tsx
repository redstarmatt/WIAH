      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The National Referral Mechanism received 17,004 referrals of potential modern slavery victims in 2023 &mdash; a 33% annual increase and ten times the 2014 figure. The Global Slavery Index estimates between 100,000 and 136,000 people are held in conditions of modern slavery in the UK at any time, making NRM referrals a fraction of the true scale. Children account for 5,509 referrals &mdash; nearly a third &mdash; driven overwhelmingly by county lines drug networks recruiting boys as young as 12. Labour exploitation accounts for 47% of identified cases across car washes, construction, nail bars, and agriculture; sexual exploitation 30%; criminal exploitation 15%; domestic servitude 8%. The Modern Slavery Act 2015 created specific offences, established the NRM statutorily, and required large businesses to publish supply chain transparency statements, yet only 4% of NRM referrals lead to a prosecution, NRM conclusive-grounds decisions now average 543 days, and the Nationality and Borders Act 2022 further restricted trafficking protections for asylum seekers.</p>
