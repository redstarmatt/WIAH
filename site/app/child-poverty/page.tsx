      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Food insecurity now affects an estimated 2.5 million children in England. Food bank use by families with children reached record levels in 2023&ndash;24. Scotland&apos;s Scottish Child Payment &mdash; &pound;25 per week per eligible child &mdash; has demonstrably reduced child poverty rates north of the border, providing the clearest natural experiment in UK poverty policy in a generation. The UK Government&apos;s Child Poverty Taskforce, established in 2024, is examining structural drivers. Repealing the two-child limit would lift an estimated 300,000 children out of poverty at a cost of &pound;1.4 billion per year.</p>
            <p>The consequences of childhood poverty extend decades beyond childhood itself. Children raised in poverty score an average of nine months behind their peers at the end of primary school; that gap widens through secondary education. Poor children are twice as likely to experience a chronic health condition by age 11, and face significantly worse mental health outcomes in adolescence. Adult earnings for those who experienced persistent childhood poverty are, on average, 28 percent lower than peers who did not &mdash; not because of individual failing, but because constrained early environments shape cognitive development, social networks, and access to opportunity in ways that compound over time.</p>
            <p>The data captures income below a threshold; it does not capture the texture of poverty &mdash; the decisions foregone, the shame, the exhaustion of scarcity. Survey-based measures like the Households Below Average Income dataset are robust but lag by 18 months and miss the most marginalised families. Administrative data from Universal Credit provides faster signals but reflects the benefit system&apos;s own gaps. We do not have reliable national estimates of deep poverty &mdash; those living well below the threshold &mdash; nor do we fully understand how experiences of poverty differ by ethnicity, disability, or housing tenure. The numbers here are the best available picture; they are not the whole one.</p>
            <p>Ethnic disparities in infant mortality reflect compounding structural failures. Research consistently shows Black women&apos;s pain is underassessed in maternity settings, complaints are more likely to be dismissed, and language barriers reduce the quality of antenatal care for mothers whose first language is not English. Socioeconomic deprivation intersects with ethnicity &mdash; Black and South Asian families are disproportionately concentrated in the most deprived quintile. Scotland&apos;s Best Start programme and Wales&apos;s Flying Start scheme invest earlier in pregnancy support and nutrition, producing marginally better trajectories. Smoking cessation before 15 weeks and folic acid supplementation remain the highest-impact individual interventions. Yet after 15 years of monitoring, the MBRRACE-UK reports show no meaningful narrowing of the racial gap in maternal or infant death. A realistic policy response would combine targeted midwifery continuity, culturally competent bereavement care, and sustained funding for deprived-area maternity units.</p>
            <p>MBRRACE-UK publishes the most authoritative surveillance data, but small number suppression at hospital and local authority level means that individual trust performance cannot be reliably assessed for rarer outcomes. The term &ldquo;infant mortality rate&rdquo; is used inconsistently &mdash; some presentations include only deaths under one year, while others separate neonatal deaths (under 28 days) from post-neonatal deaths, creating confusion in headline comparisons. Ethnicity recording in birth and death registrations remains patchy, with maternal ethnicity missing or recorded as &ldquo;not stated&rdquo; in roughly 5&ndash;8&percnt; of records. International comparisons are complicated by differing gestational age thresholds for registering a live birth &mdash; some countries do not register births below 24 weeks, while England registers from 22 weeks, which inflates the apparent mortality rate. Stillbirth definitions also vary, with thresholds ranging from 22 to 28 weeks across countries.</p>
          </div>
        </section>
