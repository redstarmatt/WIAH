      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Around 4.3 million children in the UK live in relative poverty after housing costs &mdash; 31% of all children, the highest share since 1998. Poverty is not evenly distributed: rates exceed 45% in parts of inner London, Birmingham, and Bradford, while affluent commuter counties sit below 15%. The two-child limit on Universal Credit, introduced in 2017, directly affects 1.5 million children in larger families. In-work poverty has risen from 14% to 21% over two decades, driven by zero-hours contracts, stagnant real wages in care, retail, and logistics, and childcare costs that can consume more than a third of take-home pay. Food insecurity now affects an estimated 2.5 million children in England, with food bank use by families reaching record levels in 2023&ndash;24.</p>
            <p>Children raised in poverty score an average of nine months behind peers at the end of primary school, are twice as likely to experience a chronic health condition by age 11, and face adult earnings around 28% lower than peers who did not experience persistent childhood poverty. Lone-parent families &mdash; more than 90% headed by women &mdash; are disproportionately affected, and deprived areas of the North are hit hardest. Scotland&apos;s Scottish Child Payment of &pound;25 per week per eligible child has demonstrably reduced poverty rates north of the border; repealing the two-child limit across the UK would lift an estimated 300,000 children out of poverty at a cost of &pound;1.4 billion per year.</p>
          </div>
        </section>
