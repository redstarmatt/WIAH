      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The inflation surge of 2021&ndash;2023 was not experienced equally. Resolution Foundation and ONS analysis found that households in the bottom income quintile faced peak inflation of 12.8% in October 2022, compared to 10.4% for those in the top quintile &mdash; a 2.4 percentage point gap. Poorer households spend a higher share of income on food and energy, the categories that rose fastest. The poorest tenth spend over 25% of their budget on domestic energy and food; the wealthiest tenth around 12%. Food price inflation peaked at 19.2% in March 2023 &mdash; the highest in 45 years &mdash; while Trussell Trust food bank parcels reached 3.1 million in 2022/23. The energy price guarantee capped bills at &pound;2,500 but was a unit price cap rather than a bill cap, giving less absolute support to those in smaller homes with lower consumption.</p>
            <p>The cumulative price level effect persists long after headline inflation returned to target. A household that saw its food bill rise 25% between 2020 and 2024 does not recover that cost when inflation falls to 2%; prices simply rise more slowly from a permanently higher base. The distributional legacy of the inflation surge is a permanent reduction in real living standards concentrated among those with the least financial resilience &mdash; which, by definition, were those on the lowest incomes. Shrinkflation, identified by ONS across hundreds of product categories, represents additional effective inflation not captured in headline figures. The Cost of Living Payments targeted Universal Credit recipients and pensioners but were not calibrated to actual energy expenditure.</p>
          </div>
        </section>
