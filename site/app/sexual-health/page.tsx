      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2024 · Returned to pre-COVID levels · Gonorrhoea &amp; syphilis surging"
            ...
            <MetricCard
              ...
              direction="down"
              polarity="up-is-good"
              changeText="2024 · Down from 297 in 2014 · 41% reduction in a decade"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2024 · Nearly doubled since 2014 · Antibiotic resistance growing"
        ...
        <ScrollReveal>
          <section id="sec-sti" className="mb-12">
            <LineChart
              title="STI diagnoses, England, 2014–2024"
        ...
        <ScrollReveal>
          <section id="sec-clinics" className="mb-12">
            <LineChart
              title="Sexual health clinics in England, 2014–2024"
        ...
        <ScrollReveal>
          <section id="sec-gonorrhoea" className="mb-12">
            <LineChart
              title="Gonorrhoea diagnosis rate, England, 2014–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>UK Health Security Agency — Sexually transmitted infections and screening for chlamydia in England. Data from GUMCAD STI Surveillance System. Published annually. Retrieved March 2026.</p>
            <p>British Association for Sexual Health and HIV — Clinic survey data on service provision and capacity. Retrieved March 2026.</p>
