      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Road condition varies enormously by region and council area. The ALARM survey found that London boroughs reported the worst road conditions, with 16% of the network below an acceptable standard, followed by the North East (14%) and the North West (13%). Rural authorities face a different challenge: lower traffic volumes but longer networks to maintain, with fewer resources per mile. Cycling and pedestrian infrastructure is especially affected &mdash; damaged road edges and poor surface quality are cited as the primary safety concern by 71% of cyclists in British Cycling&apos;s 2024 survey. Scotland maintains roads through Transport Scotland and 32 councils; the Scots equivalent backlog was estimated at &pound;1.7 billion. Wales and Northern Ireland face similar challenges, with rural roads in particularly poor condition.</p>
