    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="C.difficile cases have risen for two consecutive years after decades of decline, and an estimated 300,000 patients acquire healthcare-associated infections annually — a patient safety challenge that the NHS must not lose sight of after years of hard-won progress."
          colour="#F4A261"
          preposition="in"
        />
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Healthcare-associated infections (HAIs) — infections acquired as a result of receiving care in a health setting rather than brought in by the patient — represent one of the most significant and preventable sources of patient harm in any healthcare system. In England, an estimated 300,000 patients acquire a HAI at some point each year, ranging from wound infections and urinary tract infections to life-threatening bloodstream infections caused by resistant organisms.<Cite nums={1} /> These infections are associated with prolonged hospital stays, increased morbidity and mortality, and substantial costs: Public Health England estimated the annual cost of HAIs to the NHS at over £1 billion in 2018.<Cite nums={2} /> The two organisms that attract the most systematic surveillance are Clostridium difficile (C.diff) and methicillin-resistant Staphylococcus aureus (MRSA), both because they are important clinical problems and because their trajectory is a useful indicator of the overall quality of infection prevention and control practices within a hospital system.</p>
            <p>C.difficile is a spore-forming bacterium that causes severe diarrhoea and in some cases life-threatening colitis, particularly in older patients and those who have recently received antibiotics. It is inherently difficult to control because its spores resist standard alcohol-based hand sanitisers and can persist in the environment for months. England saw a dramatic rise in C.diff cases in the early 2000s, peaking at over 55,000 cases in 2007/08<Cite nums={3} /> — a figure that provoked a national crisis response, including the creation of the National Clostridium difficile Target, mandatory reporting, and the introduction of hand-hygiene campaigns, environmental cleaning protocols, and antibiotic stewardship programmes. By 2014, cases had fallen to around 36,000, and by 2019 to approximately 13,000 — a reduction of 76% from peak. This is one of the genuine public health successes of the past two decades. However, since 2020 the trend has reversed: cases rose to approximately 14,200 in 2023, a 9% increase over three years.<Cite nums={3} /> The causes include hospital crowding, which reduces the time staff can spend on cleaning and infection control; the disruption of antibiotic stewardship programmes during the pandemic; and the operational pressures that make rigorous compliance with isolation protocols difficult to maintain when wards are running at 95% or above capacity.</p>
            </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              changeText="2023 · Rising for 3rd year · After historic fall"
            ...
            <MetricCard
              ...
              direction={'up' as const}
              polarity={'up-is-bad' as const}
              changeText="2023 · Up 45% from 2018 low of 980"
            ...
            <MetricCard
              ...
              polarity={'up-is-bad' as const}
              changeText="Annual estimate · All healthcare settings"
        ...
        <ScrollReveal>
          <section id="sec-cdiff" className="mb-12">
            <LineChart
              title="C.difficile cases, England, 2014–2023"
        ...
        <ScrollReveal>
          <section id="sec-mrsa" className="mb-12">
            <LineChart
              title="MRSA bloodstream infections, England, 2014–2023"
        ...
        <ScrollReveal>
          <PositiveCallout
            title="MRSA cases fell 95% between 2007 and 2018 — one of the NHS's greatest achievements"
            value="95%"
            description="MRSA cases fell 95% between 2007 and 2018 — from over 7,000 to under 700 — one of the greatest infection control achievements in NHS history. C.difficile fell 76% from its 2007 peak. Though both organisms have seen recent increases, they remain far below historical highs. The infection prevention infrastructure built during this period — mandatory surveillance, hand hygiene campaigns, antibiotic stewardship, and enhanced cleaning protocols — forms the foundation for reversing the current trend."
            source="Source: UKHSA — MRSA and C.difficile Annual Summary, 2023."
          />
        </ScrollReveal>
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>UKHSA — C.difficile Infections in England. Quarterly mandatory surveillance returns from NHS acute trusts. Covers all cases identified in hospital laboratories where C.difficile toxin is detected. Trust-level data published quarterly.</p>
            <p>UKHSA — MRSA Bloodstream Infections. Quarterly mandatory surveillance of MRSA bloodstream infections in NHS trusts. Covers cases identified through blood culture where MRSA is the causative organism.</p>
            <p>UKHSA — Point Prevalence Survey of Healthcare-Associated Infections. Periodic cross-sectional survey of inpatients across a sample of NHS hospitals. Most recent survey 2022. Provides estimates of overall HAI burden including non-mandatorily-reported infections.</p>
