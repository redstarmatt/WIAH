      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>England achieved one of the most remarkable infection control successes of any healthcare system: MRSA bloodstream infections fell 90&percnt; from over 7,000 per year in the mid-2000s to under 700 by 2018; C.difficile cases fell 76&percnt; from a peak of 55,000 in 2007/08 to around 13,000 by 2019. Both trajectories have now reversed. C.diff cases rose to 14,200 in 2023 &mdash; up 9&percnt; over three years &mdash; and MRSA bloodstream infections reached 1,423 in 2023, 45&percnt; above the 2018 nadir. An estimated 300,000 patients acquire a healthcare-associated infection each year across all causes, at an annual cost to the NHS exceeding &pound;1 billion. The reversal reflects hospital crowding &mdash; wards running at 95&percnt; or above capacity leave less time for cleaning and isolation protocols &mdash; combined with the disruption of antibiotic stewardship programmes during and after the pandemic.</p>
            <p>Infection risk is not uniformly distributed. Trusts in the most deprived areas tend to have higher rates, reflecting older infrastructure and historically lower capital investment: 40&percnt; of NHS hospital buildings were beyond their optimal design life in 2019. Open-bay ward configurations &mdash; common in 1960s and 1970s NHS stock &mdash; physically cannot support the single-room isolation that best practice requires for C.diff and MRSA patients. MRSA rates are highest in large teaching hospitals and major trauma centres treating the most complex patients with invasive devices; C.diff disproportionately affects older patients and those on antibiotics. The infection prevention infrastructure built between 2007 and 2018 &mdash; mandatory surveillance, hand hygiene campaigns, antibiotic stewardship &mdash; demonstrated that dramatic reductions are achievable; the current trend shows what happens when operational pressure erodes compliance with protocols that depend on staff time.</p>
          </div>
        </section>
