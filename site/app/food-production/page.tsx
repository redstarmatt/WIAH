      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              The UK is one of the least food self-sufficient countries in Western Europe. Defra&apos;s annual Agriculture in the United Kingdom report shows the ratio of domestic production to total food supply has fallen from around 78% in the mid-1980s to 57.8% in 2024, with indigenous-type food self-sufficiency at around 73%. Agricultural output has been broadly flat in real terms for a decade, at &pound;27.4 billion in 2024 (2023 prices), and the farming workforce has shrunk 30% since 2000 to 380,000. Post-Brexit policy has shifted from the area-based Basic Payment Scheme to Environmental Land Management, but uptake has been slower than expected &mdash; only 35% of eligible farmland enrolled by 2024 &mdash; creating a funding gap for smaller farms. The Ukraine crisis demonstrated the UK&apos;s exposure: wheat prices doubled in early 2022, fertiliser costs tripled, and food inflation peaked at 19.2% in March 2023, the highest in over 40 years.
            </p>
            <p>
              The decline in production capacity is uneven. Horticulture has contracted most sharply: the UK grows only 54% of its vegetables and 16% of its fruit, down from 78% and 35% respectively in 1990. Post-Brexit labour shortages have been acute, with the Seasonal Worker Visa scheme providing 45,000 visas against industry demand of 70,000+. Dairy farming has consolidated from 14,000 to 7,000 farms since 2005 while milk production has remained stable. Upland farmers in Wales, Northern England, and Scotland face the steepest income decline as Basic Payment Scheme payments &mdash; which could constitute 80% of income on hill farms &mdash; are withdrawn. The NFU argues food security should be treated as a strategic priority comparable to energy security; as of 2026 the government had not legislated for a statutory self-sufficiency target.
            </p>
          </div>
        </section>
