      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Carers UK estimates 10.6 million people provide unpaid care in the UK &mdash; looking after a family member, partner, or friend who is ill, elderly, disabled, or has a mental health condition. If that care were provided commercially at professional carer rates, it would cost &pound;93 billion per year, comparable to the entire NHS England budget and representing around 4% of GDP. Carer&apos;s Allowance &mdash; the main financial support for carers providing 35 or more hours per week &mdash; is &pound;81.90 per week, the lowest of all means-tested benefits. The earnings threshold of &pound;151 per week (raised to &pound;195 in the 2024 Autumn Budget) has trapped carers attempting to combine part-time work with caring, often losing the allowance entirely if they earn just above the limit. Only 900,000 carers claim Carer&apos;s Allowance from an eligible population of 10.6 million. An estimated 600 carers leave paid employment every day, at an ONS-estimated annual cost of &pound;1.3 billion in lost output.</p>
            <p>Women bear a disproportionate share of the burden: they are significantly more likely to reduce employment when caring responsibilities arise, contributing to gender pay gaps and pension gaps that compound across decades. Population ageing will intensify pressure on unpaid carers as the workforce gap in paid social care &mdash; already 150,000 vacancies &mdash; grows. The Carer&apos;s Leave Act 2022 gave carers the right to 5 days of unpaid leave from employment, and the NHS Long Term Plan committed to identifying carers registered with GP practices, but these are incremental steps against a structural gap between the economic value of unpaid care and the support provided to those who provide it.</p>
          </div>
        </section>
