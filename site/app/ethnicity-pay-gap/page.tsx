      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Workers from Bangladeshi and Pakistani backgrounds face pay gaps of around 20% and 16% relative to White British workers — gaps that have barely narrowed over a decade despite sustained attention from equality bodies and the introduction of ethnicity pay gap reporting guidance. Workers of Indian heritage, by contrast, now earn above the White British median, reflecting higher educational attainment and concentration in professional and managerial occupations. These divergences make aggregate &ldquo;BAME pay gap&rdquo; figures almost meaningless. Occupational segregation is a major driver for those groups with the largest gaps: Bangladeshi and Pakistani workers are overrepresented in retail, hospitality, transport, and social care — a legacy of 1960s and 1970s migration patterns that has persisted across generations. CV audit studies consistently find that applicants with ethnic minority-sounding names are significantly less likely to be called back, confirming that discrimination at hiring stage compounds structural disadvantage.</p>
            <p>The burden falls hardest where labour market geography and pay combine worst. Bangladeshi-heritage workers are concentrated in London boroughs where living costs are high but access to higher-paying employment difficult; Pakistani-heritage workers are concentrated in Midlands and Northern cities with lower-wage economies. Mandatory ethnicity pay gap reporting — analogous to the gender pay gap reporting introduced in 2017 — was proposed but not implemented, leaving employer incentives insufficient to drive structural change. The Sewell Commission (2021) concluded structural racism was not the primary driver of ethnic pay disparities; that finding was contested by equality organisations and researchers who identified discrimination as a measurable, independent factor that observable socioeconomic characteristics alone cannot explain.</p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              href="#sec-chart"source="ONS · ASHE Ethnicity Analysis 2023"
            />
            <MetricCard
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Ethnicity pay gap vs White British median, 2015–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>ONS — Ethnicity Pay Gap in Great Britain. ons.gov.uk/employmentandlabourmarket/peopleinwork/earningsandworkinghours/articles/ethnicitypaygapsingreatbritain</p>
            <p>ONS — Annual Survey of Hours and Earnings. ons.gov.uk/employmentandlabourmarket/peopleinwork/earningsandworkinghours/bulletins/annualsurveyofhoursandearnings/latest</p>
