...
export const metadata: Metadata = {
  ...
  description: '975,000 child maintenance cases are managed by the Child Maintenance Service &mdash; but &pound;394 million in arrears has accumulated, with 31% of paying parents non-compliant.',
  openGraph: {
    title: 'Are Non-Resident Parents Paying Child Support?',
    description: '975,000 child maintenance cases are managed by the Child Maintenance Service &mdash; but &pound;394 million in arrears has accumulated, with 31% of paying parents non-compliant.',
    type: 'article',
