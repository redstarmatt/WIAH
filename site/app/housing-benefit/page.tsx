      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The Local Housing Allowance links housing benefit entitlements to the 30th percentile of rents in each Broad Rental Market Area &mdash; the design intention being that recipients could access the cheapest third of the private market. In practice, the LHA was frozen in cash terms for much of 2012&ndash;2020, temporarily reset to the 30th percentile at the start of COVID in April 2020, then frozen again from April 2021. By 2023, with private rents rising sharply, the average gap between the LHA rate payable and median market rent for a two-bedroom property reached &pound;190 per month nationally; in Inner East London the gap exceeded &pound;800 per month. Approximately 1.6 million households were receiving housing benefit or Universal Credit housing costs in the private sector, and landlord possession claims &mdash; the precursor to eviction &mdash; rose 97&percnt; between Q1 2021 and Q1 2024, with rent arrears cited as the primary reason in 60&percnt; of cases. The LHA was permanently reset to the 30th percentile in April 2024, benefiting 1.6 million households by an average of &pound;800 per year, though housing charities noted this was a return to the status quo ante rather than an improvement.</p>
            <p>The consequences of frozen LHA compound across systems. Landlords increasingly refuse to let to tenants in receipt of housing benefit when the rate falls below market rent; Shelter and the National Residential Landlords Association documented a significant reduction in landlords advertising to claimants between 2020 and 2023. Discretionary Housing Payment budgets were cut from &pound;180 million in 2014/15 to around &pound;100 million by 2023, despite rising demand. Local authority temporary accommodation costs rose to over &pound;1.7 billion per year in 2023 &mdash; a direct fiscal consequence of the failure to maintain LHA at a level sufficient to prevent homelessness. The shortfall has been most acute in high-cost urban areas, where the benefit cap simultaneously limits total entitlements and where job opportunities are greatest, forcing a geographic sorting of benefit claimants away from cities toward lower-cost areas with fewer opportunities &mdash; compounding existing disadvantage.</p>
          </div>
        </section>
