...
export const metadata: Metadata = {
  ...
  description: 'South East England faces a supply-demand deficit of 5 billion litres per day by 2050 &mdash; yet no major new reservoir has been built since 1991.',
  openGraph: {
    title: 'Is Britain Running Out of Water?',
    description: 'South East England faces a supply-demand deficit of 5 billion litres per day by 2050 &mdash; yet no major new reservoir has been built since 1991.',
    type: 'article',
