      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>On 19 July 2022, the temperature at Coningsby in Lincolnshire reached 40.3&deg;C &mdash; the first time in recorded history the UK had exceeded 40 degrees &mdash; and at least 2,985 excess deaths followed across the summer. This was not an aberration: the 2019 heatwave killed 892 people above baseline; the 2020 heatwave during COVID killed 1,062. Each year with a significant heat event has pushed the toll higher. Climate projections from UKHSA suggest annual heat deaths could reach 7,000 by 2050 under a moderate 2&deg;C warming scenario and 12,000 under 3&deg;C+ &mdash; figures that assume no adaptation. Urban heat islands amplify exposure: city centres can be 8&ndash;10&deg;C warmer than surrounding countryside on still, cloudless nights, when elderly people most need the temperature to fall.</p>
            <p>The populations most at risk are well-identified and overlap substantially with poverty: those over 75 living alone, people in social housing with poor ventilation, those with heart disease or diabetes, and people on medications that impair thermoregulation. Air conditioning is rare in UK homes; the housing stock was built to retain winter warmth, not shed summer heat, making retrofit for cooling structurally different from insulation programmes. The Future Homes Standard from 2025 does not yet comprehensively address overheating. Urban greening &mdash; street trees, green roofs, permeable surfaces &mdash; is among the most cost-effective adaptation measures available but requires local authority resources and planning changes that are currently moving slowly relative to the pace of warming.</p>
          </div>
        </section>
