      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>NHS sickness absence reached 5.6&percnt; in 2022/23 &mdash; the highest rate since consistent records began in 2009 &mdash; equivalent to around 75,000 full-time staff absent on any given day and a direct cost exceeding &pound;3.3 billion annually. This is roughly 50&percnt; above the private sector average of 3.4&percnt;, a gap that has widened since the pandemic. Mental health conditions and stress have overtaken musculoskeletal problems as the leading cause, accounting for approximately 30&percnt; of all days lost. The 2023 NHS Staff Survey found that 44&percnt; of staff reported illness from work-related stress, and 33&percnt; said their organisation did not take positive action on wellbeing. COVID-19 marked a step change &mdash; long COVID affected an estimated 80,000&ndash;120,000 staff &mdash; and the underlying rate has not returned to pre-pandemic levels.</p>
            <p>The burden is not evenly distributed. Ambulance trusts record absence rates over 7&percnt;, almost double community health trusts. North East and Yorkshire trusts have the highest rates; London and the South East the lowest. Healthcare assistants and domestic staff have absence rates roughly 60&percnt; higher than medical and dental staff; women, who make up 77&percnt; of the NHS workforce, have higher rates than men in every staff group, partly because they are concentrated in the highest-absence roles and carry disproportionate caring responsibilities outside work. The relationship between pressure and absence is self-reinforcing: understaffing raises workload, which raises stress absence, which further reduces available staff.</p>
          </div>
        </section>
