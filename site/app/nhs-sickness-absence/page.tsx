...
const editorialRefs: Reference[] = [
  ...
  { num: 2, name: 'NHS Employers', dataset: 'Sickness Absence Cost Methodology', date: '2023', note: 'Estimated annual direct cost exceeding £3.3 billion', url: 'https://www.nhsemployers.org/' },
  { num: 3, name: 'NHS England', dataset: 'NHS Staff Survey', url: 'https://www.england.nhs.uk/statistics/', date: '2023', note: '44% of staff reported work-related stress; 33% said their organisation did not take positive action on wellbeing' },
];
