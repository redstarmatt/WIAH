      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Heat networks — systems that distribute heat from a central source through insulated pipes to multiple buildings — currently supply 2.8% of UK heat demand across approximately 16,000 networks serving 480,000 homes. The Climate Change Committee&rsquo;s Sixth Carbon Budget requires that share to grow to around 20% by 2050, prioritising dense urban areas where building density makes individual heat pumps less economic. The quality of the existing estate is highly variable: a 2021 survey found 35% of heat networks had a higher carbon intensity than modern condensing gas boilers, connected to gas CHP plant rather than low-carbon sources. The Heat Network (Regulation) Act 2023 established a new Ofgem-overseen regime from 2024–25, requiring all networks to register and achieve minimum performance standards — a significant step given that network customers previously had fewer consumer protections than gas or electricity customers.</p>
            <p>The economics of expansion are challenging. Distribution infrastructure in urban settings costs £1–3 million per kilometre before any revenue is generated, and the merchant risk of building ahead of connections deters private finance. Local authorities are the critical enabling actors — securing planning permissions, providing anchor loads from council buildings and social housing, and managing highway access — but many lack the capacity or risk appetite for the role. The government&rsquo;s Heat Network Zoning framework, advanced in 2024–25, would designate areas where heat networks are the preferred heating solution, creating market certainty for investors, and represents the most significant demand-side intervention to date to close the gap between the 480,000 homes currently connected and the several million needed by 2050.</p>
          </div>
        </section>
