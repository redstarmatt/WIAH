      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>England diagnoses just 54% of cancers at stages 1 or 2, against an NHS Long Term Plan target of 75% by 2028 &mdash; 21 percentage points below target with four years remaining. The survival stakes are stark: five-year survival for stage 1 bowel cancer is 97%, falling to 7% at stage 4; for lung cancer, stage 1 survival exceeds 80% but stage 4 is below 5%. NHS England&apos;s own modelling suggests meeting the 75% target would save approximately 55,000 additional lives per decade. The 62-day standard for beginning treatment after urgent referral &mdash; target 85% compliance &mdash; has not been met nationally since 2015; by 2023, only 65% of patients began treatment within 62 days, leaving around 100,000 people per year waiting longer than they should. In April 2020, urgent cancer referrals fell by 60% and a backlog of undiagnosed cases accumulated; diagnostic and treatment capacity has not caught up.</p>
            <p>Late diagnosis is concentrated in the most deprived communities and among the groups least likely to access screening. Lung cancer, the biggest cancer killer, is heavily concentrated in deprived areas where smoking remains high; bowel screening uptake ranges from 72% in the least deprived quintile to 44% in the most deprived. Ethnic minority communities have lower uptake across bowel, breast, and cervical programmes, reflecting language barriers, cultural factors, and historical distrust of health services. Women wait longer than men for diagnosis across most tumour types. The gap between what early detection could achieve and what the NHS currently delivers represents one of the most consequential and remediable performance shortfalls in the health system.</p>
          </div>
        </section>
