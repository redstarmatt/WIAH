    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Only 54% of cancers in England are diagnosed at stages 1 or 2, against a target of 75% by 2028. Stage 4 bowel cancer has a 7% five-year survival rate compared to 97% at stage 1 &mdash; making late diagnosis one of the NHS&apos;s most consequential failures."
          colour="#E63946"
          preposition="in"
        />
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            value="18%"
            description="Lung cancer 5-year survival has risen from 8% to 18% since 2010 &mdash; faster than any comparable country &mdash; largely due to targeted lung health checks in deprived areas and earlier adoption of new treatments. The NHS targeted lung health check programme, which proactively invites high-risk individuals for low-dose CT scanning without waiting for symptoms, is now rolling out nationally. In pilot areas, it detected 80% of lung cancers at stage 1 or 2, compared to 27% through the standard symptomatic pathway &mdash; demonstrating the transformative potential of proactive early detection."
