      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              The burden falls disproportionately on grandmothers. Research from the University of Bristol found that 75&percnt; of primary kinship carers are female, with a median age of 56. Many have given up work to care for grandchildren: 42&percnt; report a significant drop in household income, and 38&percnt; have fallen behind on bills or taken on debt. Black and mixed-heritage children are over-represented in kinship care relative to their share of the child population &mdash; 18&percnt; of kinship children are from Black backgrounds compared with 6&percnt; of children nationally &mdash; reflecting patterns of systemic over-surveillance of Black families by children&apos;s social care. Carers in the most deprived areas are least likely to receive a kinship carer assessment, creating a postcode lottery in support.
            </p>
            <p>
              Measuring kinship care accurately is inherently difficult. Official DfE statistics capture only children in formal arrangements known to local authorities &mdash; those on SGOs, Child Arrangements Orders, or kinship foster placements. The far larger group of children in informal kinship care &mdash; where a grandparent simply takes over without court involvement &mdash; is invisible in administrative data. Census data and household surveys offer estimates, but these are acknowledged to under-count. Financial support data relies on charity surveys with self-selection bias, meaning the 31&percnt; receiving support figure may overstate the true rate, since carers who engage with charities are more likely to have sought and received help. The 2021 Census introduced a new question on kinship care for the first time, but its wording captured only those who self-identified as a kinship carer &mdash; a term many informal carers do not use.
            </p>
          </div>
        </section>
