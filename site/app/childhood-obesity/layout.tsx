...
export const metadata: Metadata = {
  ...
  description: '22.7% of Year 6 children in England are obese &mdash; more than 1 in 5. Children in the most deprived areas are 3 times more likely to be obese than those in the least deprived.',
  openGraph: {
    title: 'How many children are obese by the time they leave primary school?',
    description: '22.7% of Year 6 children in England are obese &mdash; more than 1 in 5. Children in the most deprived areas are 3 times more likely to be obese than those in the least deprived.',
    type: 'article',
