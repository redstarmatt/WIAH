      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Suicide is the leading cause of death for people aged 20&ndash;34 in England and Wales, and 2022 recorded the highest toll in more than two decades. The 5,642 registered deaths represent a rate of 10.7 per 100,000 &mdash; above the EU average. Men account for 75% of all cases, with a rate of 16.3 per 100,000 compared with 5.1 for women. The inequalities are stark: the most deprived areas have suicide rates three times higher than the least deprived, prisoners are eight times more likely to take their own lives than the general population, and LGBTQ+ young people face a fourfold elevation in risk. Certain occupations &mdash; farming, veterinary medicine, construction &mdash; carry persistently elevated rates.</p>
            <p>Behind these deaths sits a widening crisis in self-harm and untreated mental illness. A&amp;E presentations for self-harm have doubled from roughly 115,000 in 2012 to 225,000 in 2022, with young women the fastest-growing group. Patients in crisis wait an average of 24 hours for a psychiatric bed, with some held on A&amp;E trolleys for days. One in eight adults with a diagnosable mental health condition receives no treatment at all &mdash; a treatment gap that leaves common conditions such as depression and anxiety to compound unchecked. Social isolation, economic hardship and the long tail of the COVID-19 pandemic have deepened the underlying drivers.</p>
            <p>The National Suicide Prevention Strategy, published in September 2023, identifies six priority groups &mdash; men, young people, people in contact with the justice system, those with long-term health conditions, autistic people and residents of deprived communities &mdash; and sets a target of reducing the suicide rate by 10% by 2028. Evidence on what works is encouraging: barriers installed on the Clifton Suspension Bridge in Bristol reduced local suicides by 50%, and the NHS Talking Therapies programme has demonstrated measurable reductions in suicidal ideation. Samaritans handles 21,000 contacts per day, and Crisis Resolution Home Treatment Teams now cover all of England. Whether the 10% target is achievable depends on closing the treatment gap and sustaining funding for community-based crisis services that keep people out of overstretched emergency departments.</p>
          </div>
        </section>
