      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <section id="sec-rate" className="mb-12">
            <LineChart
              title="Age-standardised suicide rate, England and Wales, 2012–2022"
        ...
        <ScrollReveal>
          <section id="sec-selfharm" className="mb-12">
            <LineChart
              title="A&amp;E presentations for self-harm, England, 2012–2022"
        ...
        <ScrollReveal>
          <section id="sec-age" className="max-w-2xl mb-12">
            ...
            <p className="font-mono text-xs text-wiah-mid mt-4">Source: ONS — Suicides in England and Wales</p>
          </section>
        </ScrollReveal>
