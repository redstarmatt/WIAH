    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="UK fishing quota increased modestly after Brexit, but total catches continue a long-term decline — and 76% of quota is sold to foreign vessels."
          colour="#264653"
        />

        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Brexit was supposed to transform British fishing. The Trade and Cooperation Agreement signed in December 2020 did deliver a quota increase — around 25% more quota value from previously EU-shared stocks, phased in over five years from 2021. But total UK catches in 2023 stood at 430,000 tonnes, below the 2017 peak of 461,000 tonnes and far below the 600,000-plus tonne figures of the 1990s. The long-term decline reflects depletion of key stocks — North Sea cod, haddock, and plaice — that decades of overfishing left at critically low levels. Meanwhile, around 76% of UK fishing quota is held or sold to non-UK-owned vessels, a legal consequence of how quota was allocated in the 1980s that large Icelandic and Dutch-owned companies have since locked in through vessel acquisitions. Post-Brexit export red tape, particularly for time-sensitive live shellfish, has in many cases offset the modest quota gains for businesses that actually fish from UK ports.</p>
            <p>The communities Brexit was intended to benefit — small ports in Cornwall, Yorkshire, Scotland, and Wales — have seen mixed outcomes at best. Around 70% of UK fish by value is exported to EU markets, and new certification requirements have pushed some smaller operators out of the export market entirely. Employment in the UK fishing fleet has continued its long-term decline, and the structural problems of the industry — ageing fleets, succession challenges, concentrated quota ownership — remain largely unchanged. The quota allocation system, once celebrated as a post-CFP achievement, is now understood to perpetuate the same inequities that coastal communities complained about before 2016.</p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              href="#sec-chart"source="MMO · UK Sea Fisheries Statistics 2023"
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="+£40m post-Brexit · modest gain"
            ...
            <MetricCard
              ...
              href="#sec-chart"source="New Economics Foundation · 2023"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Total UK fish catch, 2015–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Marine Management Organisation (MMO) — UK Sea Fisheries Statistics. Published annually. gov.uk/government/collections/uk-sea-fisheries-statistics</p>
            <p>New Economics Foundation — Who owns our oceans? Analysis of UK fishing quota ownership. neweconomics.org</p>
            <p>Defra — Trade and Cooperation Agreement fisheries annex. gov.uk</p>
