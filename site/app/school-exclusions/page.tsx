    ...
    <div className="min-h-screen bg-white text-wiah-dark">
      ...
      <section id="sec-context" className="px-4 py-12 max-w-3xl mx-auto bg-wiah-light">
        <div className="space-y-5 text-base leading-relaxed text-wiah-mid">
          <p>England recorded 9,160 permanent exclusions in 2022/23, up 77&percnt; from 5,154 in 2018/19 and the highest figure since comparable records began. A further 787,000 fixed-period suspensions were issued &mdash; a record &mdash; equivalent to more than five million school days lost. The official figures understate reality: research by the Education Policy Institute suggests 40,000&ndash;49,000 additional pupils per year are removed from school rolls through off-rolling without a formal exclusion. Excluded children enter Alternative Provision at a cost of &pound;22,000 per pupil per year, more than three times the mainstream average; only 4&percnt; of AP pupils achieve five good GCSEs, and the IPPR estimates each permanent exclusion costs the state over &pound;300,000 over a lifetime. Labour&apos;s 2024 manifesto committed to mandatory inclusion plans for schools and strengthened local authority oversight, but until mainstream schools are resourced to support pupils with unmet SEND and mental health needs, exclusion will continue to function as the system&apos;s pressure valve.</p>
          <p>The burden falls overwhelmingly on already-disadvantaged children. Pupils with SEND account for 40&percnt; of all permanent exclusions despite making up 17&percnt; of the school population; Black Caribbean pupils are excluded at three times the rate of white pupils; boys account for 78&percnt; of exclusions, peaking at age 14. Exclusion rates are highest in the most deprived local authorities &mdash; Blackpool, Middlesbrough, Knowsley &mdash; at two to three times the national average. The Ministry of Justice&apos;s 2022 data linkage study found 63&percnt; of young people in custody had been permanently excluded from school and 89&percnt; had been suspended at least once.</p>
        </div>
      </section>
