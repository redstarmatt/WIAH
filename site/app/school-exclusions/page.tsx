    ...
    <div className="min-h-screen bg-white text-wiah-dark">
      ...
      <section id="sec-context" className="px-4 py-12 max-w-3xl mx-auto bg-wiah-light">
        <div className="space-y-5 text-base leading-relaxed text-wiah-mid">
          ...
          <p>The geography and demography of exclusion reveal deep structural patterns. Exclusion rates are highest in the most deprived local authorities: Blackpool, Middlesbrough, Knowsley and Hartlepool consistently record permanent exclusion rates two to three times the national average, mirroring broader indices of child poverty, SEND prevalence and family instability. Boys account for 78&percnt; of permanent exclusions, and the peak age is 14 &mdash; Year 9 and Year 10 &mdash; when undiagnosed speech, language and communication needs, trauma responses and unmet SEND requirements most commonly manifest as disruptive behaviour. Multi-academy trusts operating across local authority boundaries have created regulatory blind spots: a pupil &ldquo;managed moved&rdquo; between schools within the same trust does not appear in any exclusion dataset, and the trust has no obligation to report the transfer as anything other than a routine admission. The Ministry of Justice&apos;s 2022 data linkage study found that 63&percnt; of young people in custody had been permanently excluded from school, and 89&percnt; had been suspended at least once. Looked-after children are excluded at four times the rate of their peers despite statutory protections requiring virtual school heads to be consulted before any exclusion decision. The cost falls disproportionately on local authority children&apos;s services budgets: the Association of Directors of Children&apos;s Services reported a &pound;3.2bn cumulative overspend in 2023/24, with alternative provision and SEND transport accounting for a growing share.</p>
          <p>The official exclusion statistics almost certainly understate the true scale of pupils being removed from mainstream education. Permanent exclusion and suspension data published by the DfE captures only those recorded through the formal statutory process, missing an estimated 40,000&ndash;49,000 pupils per year who leave school rolls through &ldquo;off-rolling&rdquo; &mdash; informal pressure on parents to withdraw children, managed moves presented as voluntary, and directed transfers that bypass the appeals process. Ofsted began flagging off-rolling in inspection reports from 2018, but its own data relies on unusual mid-year roll movements rather than direct evidence, meaning the practice is identified only where the statistical pattern is extreme. The ethnicity data that reveals disproportionate exclusion of Black Caribbean and Gypsy, Roma and Traveller pupils is drawn from the School Census, which contains roughly 5&ndash;8&percnt; missing or &ldquo;refused&rdquo; ethnicity records, potentially understating disparities if non-response correlates with specific communities. SEND status is recorded at the point of exclusion, but many excluded pupils receive their first diagnosis only after entering Alternative Provision, meaning the 40&percnt; figure for SEND involvement is likely an undercount of underlying need. Outcomes data for AP pupils is limited to headline GCSE attainment and post-16 destination measures, with no systematic longitudinal tracking of employment, mental health or criminal justice contact beyond age 18 &mdash; the &pound;300,000 lifetime cost estimate cited by IPPR is modelled rather than observed.</p>
        </div>
      </section>
