    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="3.5 million 50&ndash;64 year olds are economically inactive. The main reasons are long-term illness (rising 40% since 2019), early retirement, and caring responsibilities. The &lsquo;Great Unretirement&rsquo; has recovered only a fraction of those who left."
          colour="#264653"
        />
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              The pandemic triggered a wave of early exits from the labour market among those aged 50 and over &mdash; particularly those who had been planning to retire within the decade. Many chose to bring those plans forward when workplaces closed, caring responsibilities intensified, or redundancy packages became available. The so-called Great Unretirement &mdash; the partial reversal of this trend since 2022 as inflation eroded pension incomes &mdash; has recovered some ground, but the 50&ndash;64 employment rate in 2024 of 67.8% remains below its 2019 pre-pandemic peak of 69.8%.
            </p>
            <p>
              More structurally concerning is the rise in long-term illness as a driver of inactivity among this age group. NHS waiting list backlogs meant that conditions treatable in 2018 were not being treated until 2023 or 2024, if at all. Long-COVID added a new layer of chronic, debilitating illness disproportionately affecting working-age adults. The number of 50&ndash;64 year olds economically inactive due to long-term sickness rose from 680,000 in 2019 to a peak of 980,000 in 2023 before easing slightly to 950,000 in 2024. This is not simply &lsquo;people retiring early&rsquo;: it is people being pushed out of work by health conditions they cannot manage while working.
            </p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-overview" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              label="Employment rate 50&ndash;64 age group"
              value="67.8%"
              unit=""
              direction="up"
              polarity="up-is-good"
              changeText="Recovering from pandemic low of 65.8% &middot; But long-term illness rising"
              sparklineData={[67.2, 67.8, 68.4, 69.1, 69.8, 68.2, 65.8, 66.4, 67.1, 67.8]}
              href="#sec-employment"
            />
            <MetricCard
              label="Inactive 50&ndash;64s citing long-term illness"
              value="950,000"
              unit=""
              direction="up"
              polarity="up-is-bad"
              changeText="+40% since 2019 &middot; NHS waiting list backlog a key driver"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Record high &middot; Financial necessity and flexible working"
        ...
        <ScrollReveal>
          <section id="sec-employment" className="mb-12">
            <LineChart
              title="Employment rates for older age groups, UK, 2015&ndash;2024"
        ...
        <ScrollReveal>
          <section id="sec-illness" className="mb-12">
            <LineChart
              title="People aged 50&ndash;64 inactive due to long-term illness, UK, 2019&ndash;2024"
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            source="Source: ONS &mdash; Labour Force Survey 2024; DWP &mdash; WorkWell programme evaluation 2024."
          />
        </ScrollReveal>
