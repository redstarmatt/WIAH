      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="up 35% since 2016 · profit shifting largest element"
              sparklineData={[4.8, 5.0, 5.2, 5.6, 5.1, 5.8, 6.2, 6.5]}
              href="#sec-chart"source="HMRC · Measuring Tax Gaps 2023"
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="HMRC enforcement up · but gap growing faster"
              sparklineData={[8.9, 9.4, 10.1, 11.2, 9.8, 11.6, 12.8, 13.4]}
              href="#sec-chart"source="HMRC · 2023"
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="estimated offshore annually · Action Plan in place"
              sparklineData={[18, 19, 20, 21, 20, 22, 23, 24]}
              href="#sec-chart"source="HMRC / OECD estimates · 2023"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Corporate tax gap vs large business yield, 2016–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>HMRC — Measuring Tax Gaps. Published annually. gov.uk/government/statistics/measuring-tax-gaps</p>
            <p>HMRC — Large Business Compliance Activity and Yield Statistics. gov.uk/hmrc-internal-manuals/large-business-manual</p>
            <p>OECD — BEPS Action Plan and Pillar Two Global Minimum Tax. oecd.org/tax/beps</p>
