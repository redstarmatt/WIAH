      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>On any given day in 2023, an average of 13,500 patients in English hospitals were medically fit for discharge but unable to leave &mdash; more than double the 5,200 daily average in 2015, and costing the NHS an estimated &pound;1 billion per year in bed days. Social care delays account for 42% of all delayed discharges, the largest single cause, with 152,000 social care vacancies making it impossible to arrange home care packages quickly enough. Together, discharge-delayed patients occupy roughly one in eight acute hospital beds. The NHS Discharge Taskforce, established in autumn 2022, allocated &pound;600 million to social care capacity and mandated a Discharge to Assess model; Hospital at Home expanded to 10,000 virtual beds by 2023. Delays fell 15% from their 2022 peak but remain far above pre-pandemic levels.</p>
            <p>The blockage cascades through the whole system: a stranded patient prevents a ward admission, which prevents an A&amp;E trolley being freed, which prevents an ambulance handing over and returning to service. Delayed discharge is the single biggest structural driver of 12-hour A&amp;E waits. Older patients bear the heaviest burden &mdash; over 80&percnt; of delayed patients are aged 65 or over &mdash; and prolonged hospital stays produce deconditioning, infection risk, and delirium that create entirely new care needs. The geography of delay mirrors social care funding: North East and North West authorities with the most constrained budgets report the longest home care waits, while London trusts face a distinct problem &mdash; patients medically ready to leave but with nowhere safe to go.</p>
          </div>
        </section>
