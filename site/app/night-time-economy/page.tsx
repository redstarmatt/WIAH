...
export default function NightTimeEconomyPage() {
  ...
  const pubAnnotations: Annotation[] = [
    { date: new Date(2020, 5, 1), label: '2020: Pandemic — pubs forced to close' },
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div id="sec-overview" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="Net closures · 6\u20137 pubs per day · Rural and working-class areas hardest hit"
            ...
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="Down from 3,144 in 2005 · 72% decline in 20 years · Energy costs main driver"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Recovered from pandemic trough · But structural decline of venues continues"
        ...
        <ScrollReveal>
          <section id="sec-nightclubs" className="mb-12">
            <LineChart
              title="Number of nightclubs, UK, 2010–2024"
        ...
        <ScrollReveal>
          <section id="sec-employment" className="mb-12">
            <LineChart
              title="Night-time economy employment, UK, 2019–2024"
              ...
              annotations={[
                { date: new Date(2020, 5, 1), label: '2020: Pandemic — sector collapses' },
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            description="The Night-Time Economy Adviser role, pioneered by London, has been replicated by 12 other UK cities including Manchester, Bristol, Leeds, and Edinburgh. These advisers negotiate with licensing authorities, coordinate late-night transport, and advocate for venue operators in planning decisions. Night-Time Industries Association lobbies for flexible licensing hours to support economic revival. Some councils have introduced business rate relief specifically for music venues and late-night venues. The UK's Agent of Change planning principle — adopted in 2018 — now requires new residential developments near existing venues to fund sound insulation rather than the other way around."
