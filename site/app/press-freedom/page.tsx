...
const editorialRefs: Reference[] = [
  ...
  { num: 3, name: 'Press Gazette', dataset: 'Local News Tracker', date: '2023', note: '320 local newspapers closed since 2009; 58% of local authority areas have no dedicated reporter', url: 'https://pressgazette.co.uk/' },
  { num: 4, name: 'Cairncross Review', dataset: 'A Sustainable Future for Journalism', date: '2019', note: 'Recommended public funding for local journalism; government committed only £2m to Future News Fund', url: 'https://www.gov.uk/government/publications/the-cairncross-review-a-sustainable-future-for-journalism' },
];
