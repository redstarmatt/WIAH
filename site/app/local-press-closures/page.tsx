      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Britain&rsquo;s local newspaper industry has contracted sharply since the late 2000s: from a peak of around 1,100 local papers in 2008, the count had fallen to approximately 760 by 2024 &mdash; a loss of more than 340 titles. Print advertising revenue collapsed as classifieds migrated to Gumtree and Facebook Marketplace, while digital advertising consolidated in Google and Meta, leaving local titles starved of income. By 2024, more than 210 areas of the UK had no meaningful local print or digital news coverage at all. The BBC&rsquo;s 2024 restructuring of local radio &mdash; merging 38 local stations into regional hubs &mdash; removed a further layer of accountability journalism that had partly compensated for newspaper closures.</p>
            <p>The democratic consequences are measurable. Academic research has found correlations between local newspaper closure and lower voter turnout, less competitive local elections, higher levels of uncontested council seats, and reduced public awareness of local government decisions. Local newspapers performed functions no other institution replicates at scale &mdash; attending council meetings, scrutinising planning applications, reporting court proceedings &mdash; and no systemic replacement has emerged. Public interest media startups and community newsletters cover some gaps, but rarely the civic functions that hold local power to account.</p>
          </div>
        </section>
