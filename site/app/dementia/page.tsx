        ...
        <section id="sec-context" className="py-12 border-t border-wiah-border">
          ...
          <div className="max-w-2xl mt-4 mb-12">
            <div className="text-base text-wiah-black leading-[1.7] space-y-4">
              <p>Dementia is the UK&apos;s leading cause of death, responsible for around 66,000 deaths per year, having overtaken heart disease in 2011. An estimated 944,000 people in the UK live with the condition now; by 2040, that figure is projected to reach 1.6 million. The total cost to the UK economy is &pound;34.7 billion per year &mdash; more than cancer, heart disease, and stroke combined &mdash; split between &pound;4.3 billion in direct NHS costs, &pound;16.4 billion in social care, and &pound;13.9 billion of largely invisible unpaid family labour. Only 63.4% of estimated cases carry a formal diagnosis, below the NHS target of 66.7% and a level last consistently met before 2019; the COVID-19 pandemic caused diagnosis activity to collapse to 55.7%, creating a backlog that has not fully cleared. Two new drugs &mdash; lecanemab and donanemab, the first treatments shown to slow Alzheimer&apos;s progression by approximately 35% in early-stage patients &mdash; received FDA approval in 2023&ndash;24 and are under NICE evaluation, reinforcing the urgency of closing the diagnosis gap.</p>
              <p>Behind the clinical and fiscal numbers lies a care system sustained overwhelmingly by unpaid labour. An estimated 900,000 people provide informal care for someone with dementia, disproportionately women who reduce working hours or leave employment entirely to do so, with carer breakdown rather than clinical deterioration typically triggering the transition to residential care. Once in a care home, self-funding residents pay on average 41&percnt; more than local authority-funded residents for identical services. South Asian and Caribbean communities are significantly underdiagnosed, partly due to cultural and language barriers in assessment services that remain overwhelmingly white in staffing and orientation. Admiral Nurses &mdash; the specialist dementia nursing role &mdash; number only around 600 nationally against an estimated need of more than 3,000.</p>
            </div>
          </div>
        </section>
