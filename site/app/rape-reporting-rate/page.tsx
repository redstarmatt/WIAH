    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="70,633 rapes were reported to police in England and Wales in 2023 — a record. But the charge rate is just 4%, and most cases are closed without action..."
          colour="#6B7280"
          preposition="with"
        />
