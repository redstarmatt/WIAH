    ...
    <div className="min-h-screen bg-white text-wiah-dark">
      ...
      <section id="sec-context" className="px-4 py-12 max-w-3xl mx-auto bg-wiah-light">
        <div className="space-y-5 text-base leading-relaxed text-wiah-mid">
          <p>Britain&apos;s asylum system is processing more claims than at any point since records began. The 98,519 applications lodged in 2023 surpassed the previous record of 74,751 set in 2022, driven by 45,756 small boat crossings that year and continuing displacement from Afghanistan, Iran and Syria. At the end of 2023, more than 220,000 people were awaiting an initial decision &mdash; a backlog that leaves applicants in legal limbo for an average of 26 months. The UK nonetheless receives fewer asylum seekers per capita than France, Germany or Austria, despite widespread public perception that it is a top destination.</p>
          <p>The backlog is primarily an administrative failure. Home Office caseworker numbers were cut by more than a third during the 2010s austerity programme, hollowing out decision-making capacity just as global displacement accelerated. COVID-19 then closed immigration tribunals for months. The resulting accommodation crisis has cost &pound;4 billion in 2022/23 alone, housing 56,000 asylum seekers in hotels at roughly &pound;150 per person per night. The Bibby Stockholm barge, introduced in 2023 as an alternative, became a symbol of the system&apos;s dysfunction after Legionella bacteria were found in its water supply days before residents were due to board.</p>
          <p>Policy responses have focused on deterrence rather than processing speed. The Illegal Migration Act 2023 attempted to bar asylum claims from those arriving by irregular routes. The Rwanda deportation scheme, struck down by the Supreme Court in November 2023 as unlawful, was revived through the Safety of Rwanda Act in April 2024 &mdash; at a cost of &pound;590 million before a single flight departed. Meanwhile, the data on outcomes tells a different story: 61% of initial decisions in 2023 granted protection, with grant rates of 98% for Afghans, 95% for Syrians and 86% for Eritreans. Some 40% of refusals are overturned on appeal, adding to a tribunal backlog exceeding 50,000 cases.</p>
            <p>Behind the aggregate backlog figures are individual cases with distinct national profiles and outcomes. The largest groups of applicants in 2023 came from Afghanistan, Iran, Eritrea, Albania, and Syria&mdash;countries where the overall grant rate at initial decision sits around 70&percnt;, meaning the majority of people waiting in the system will ultimately be recognised as refugees. The human cost of prolonged uncertainty is substantial: asylum seekers report deteriorating mental health, with limited access to NHS talking therapies and no right to work until 12 months after their claim is lodged. Accommodation pressures fall disproportionately on coastal and post-industrial towns&mdash;places where available hotel capacity is cheap but local services are already stretched. The political framing often conflates distinct legal categories: asylum seekers awaiting a decision, recognised refugees with leave to remain, and economic migrants subject to immigration rules are three entirely different populations with different rights and different trajectories. International comparison provides context that domestic debate frequently omits&mdash;Germany processed approximately 350,000 asylum applications in 2023, France around 167,000. The UK&apos;s 98,519 applications represent a record domestically but are not exceptional by European standards, and the UK receives fewer applications per capita than several comparable nations.</p>
            <p>Home Office statistics on asylum applications, decisions, and pending cases are published quarterly but with reporting lags that can exceed six months. The &ldquo;pending&rdquo; caseload figure aggregates cases at fundamentally different stages: initial applications awaiting a first decision, cases under appeal, and further submissions on previously refused claims. Counting methodology has changed over time, with legacy cases periodically reclassified, creating apparent trend breaks that do not reflect real changes in asylum flows. Small boat crossings are counted at the point of interception by Border Force, not at the point of arrival, and an unknown number of crossings go undetected, particularly in poor weather when surveillance is reduced. Grant rates are calculated on decided cases, which are not representative of the full pending caseload because straightforward claims from nationals of countries with high recognition rates tend to be decided first, inflating the apparent overall success rate. The total cost of the Rwanda scheme&mdash;estimated at over &pound;500 million including diplomatic agreements, processing infrastructure in Kigali, and legal costs&mdash;is difficult to verify precisely because costs were spread across multiple departmental budgets. There is no reliable mechanism for counting individuals who leave the UK voluntarily while their claim is pending, meaning the true resolution rate of the system is unknown.</p>
        </div>
      </section>
