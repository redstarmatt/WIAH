    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Hospital admissions for assault among under-25s reached 7,100 in 2024, the highest level since 2012. Serious youth violence offences have risen 57&percnt; in a decade, concentrated in a small number of urban areas where youth services have been cut most deeply."
          colour="#E63946"
        />
