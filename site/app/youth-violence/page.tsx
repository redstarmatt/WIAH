      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Serious youth violence has risen significantly over the past decade. Police forces recorded 28,500 serious violence offences involving under-25 victims in 2024, up 57% from 18,200 in 2015. Hospital admissions for assault-related injuries among under-25s reached 7,100 &mdash; a figure that, unlike police records, cannot be inflated by changes in recording practice. The drivers are structural and well-documented: local authority spending on youth services fell by 73&percnt; in real terms between 2010 and 2023, over 750 youth centres closed since 2012, school exclusions increased 50&percnt; between 2012 and 2019 (excluded children are five times more likely to become victims or perpetrators), and county lines drug networks have recruited children as young as 10. The Serious Violence Duty, introduced in 2023, requires local authorities, police, health, and probation to collaborate on prevention strategies, and 18 Violence Reduction Units now operate across England modelled on the Glasgow approach that cut violence-related hospital admissions by 60&percnt; over 15 years.</p>
