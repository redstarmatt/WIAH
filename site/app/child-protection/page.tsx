    ...
    <main>
      ...
      <section id="sec-context" className="max-w-2xl mt-4 mb-12">
        <div className="text-base text-wiah-black leading-[1.7] space-y-4">
          <p>England&apos;s child protection system received 714,000 referrals in 2022 &mdash; up 37% since 2011/12 &mdash; while 83,840 children were in local authority care, a record high 24% above a decade ago, and 52,000 were on child protection plans. The social worker vacancy rate stands at 21%, average caseloads have risen from 13 to 19 per worker, and turnover runs at 16% a year, eroding the continuity of relationship that effective protection depends on. The Child Safeguarding Practice Review Panel reviewed 256 serious incidents in 2022/23 alone. Sure Start children&apos;s centres fell from 3,600 to under 2,500 after 2010, dismantling the early intervention infrastructure that might have intercepted families before crisis.</p>
          <p>Poverty is the strongest single predictor of a child entering care, and domestic abuse, parental mental illness, and substance misuse &mdash; all worsened by the cost-of-living crisis &mdash; drive the majority of referrals. Once in care, children are placed an average of 17 miles from their families, while private equity-backed children&apos;s homes charge &pound;3,500&ndash;&pound;7,500 per week. Of the 13,000 young people leaving care each year at 18, 25% experience homelessness within two years and around 50% are not in education, employment, or training. Black children remain significantly overrepresented in the care system relative to their share of the child population.</p>
        </div>
      </section>
