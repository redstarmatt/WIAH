      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Flood risk in England is larger and more pervasive than most people realise. 6.3 million properties face some degree of flood risk &mdash; roughly one in six homes, with 2.4 million at significant risk and 880,000 at high risk. The National Flood Risk Assessment 2, published in 2023, identified 500,000 more properties at risk than previously assessed because improved surface water mapping revealed threats invisible to earlier river-focused models. Surface water flooding &mdash; rainfall overwhelming urban drainage rather than rivers breaching banks &mdash; now accounts for 40% of at-risk properties. Winter 2023/24 saw the highest flood incident count on record: Storms Babet, Ciaran, and Henk caused 7,800 property floods in 2023 alone. Capital spending on defences has risen from &pound;670 million in 2010/11 to &pound;1.1 billion in 2022/23, but revenue and maintenance spending was cut in real terms over the same period, and the EA estimates an annual maintenance funding gap of &pound;200 million. Despite planning guidance requiring sequential flood risk tests, 13% of new homes built in 2022 were sited in flood-risk areas.</p>
            <p>Flood Re, the government-backed reinsurance scheme covering 250,000 policies, has kept insurance accessible for high-risk homes &mdash; but it excludes properties built after 2009, purpose-built flats, and small businesses, and is designed to wind down by 2039. An estimated 200,000 properties are effectively uninsurable, clustering disproportionately in deprived communities where households lack savings to self-insure. For those who have flooded, research consistently links repeated events to chronic anxiety, depression, and post-traumatic stress &mdash; not just property damage. Climate projections suggest the number of properties at significant risk will rise by 59% by 2055 under a 2&deg;C scenario. The pattern is one of rising risk, patchwork investment, and a planning regime that continues to build in harm&apos;s way.</p>
          </div>
        </section>
