      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>UK greenhouse gas emissions fell 49% between 1990 and 2022 &mdash; one of the fastest reductions among major economies &mdash; but almost all of it came from two sectors: electricity generation and heavy industry. Coal supplied 40% of UK power in 2012; by 2024 it had been phased out entirely. Renewables now account for 47% of electricity generation, led by the world&apos;s largest offshore wind fleet at 14.7 GW, with offshore wind costs down 70% since 2015. The hard sectors remain largely untouched. Transport produces 26% of UK emissions; 92% of cars on the road are still petrol or diesel. Buildings account for 17%; 24 million homes are heated by gas boilers and only 60,000 heat pumps were installed in 2023 against the 600,000 per year needed by the mid-2020s. The CCC found in its 2023 report that the UK was off track for a majority of its 2030 milestones. The legally binding target is a 68% reduction by 2030, relative to 1990. Labour&apos;s GB Energy and Clean Power 2030 mission target decarbonising electricity entirely; grid connection timelines currently running 10&ndash;15 years present the binding constraint.</p>
            <p>The distributional dimension of the transition is acute. Lower-income households spend a higher share of income on energy and transport, meaning carbon pricing and technology mandates &mdash; heat pump requirements, electric vehicle mandates &mdash; risk being regressive without substantial targeted support. Heat pump upfront costs of &pound;8,000&ndash;&pound;12,000 installed are prohibitive without subsidy for households renting or in fuel poverty. The public charging network stands at 54,000 points against an estimated 300,000 needed. Agriculture, at 11% of emissions with almost no reduction in thirty years, has been largely exempted from serious decarbonisation pressure; the cost of that exemption is carried by every other sector that must overdeliver to compensate.</p>
          </div>
        </section>
