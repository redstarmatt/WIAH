...
export const metadata: Metadata = {
  ...
  description: '78% of flexible working requests are approved &mdash; but low-paid workers are half as likely to be offered flexible options in the first place.',
  openGraph: {
    title: 'Can Workers Actually Get Flexible Hours?',
    description: '78% of flexible working requests are approved &mdash; but low-paid workers are half as likely to be offered flexible options in the first place.',
    type: 'article',
