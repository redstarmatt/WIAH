...
const editorialRefs: Reference[] = [
  { num: 1, name: 'Versus Arthritis / NICE', dataset: 'Chronic pain prevalence estimates', date: '2024', url: 'https://www.versusarthritis.org/' },
  { num: 2, name: 'Faculty of Pain Medicine', dataset: 'National pain audit and workforce survey', date: '2024', url: 'https://www.fpm.ac.uk/' },
