      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              Section 21 of the Housing Act 1988 &mdash; the &ldquo;no-fault&rdquo; eviction power &mdash; became the leading cause of homelessness in England by the mid-2010s. Landlords were granted over 25,000 Section 21 possession orders in 2023, but Crisis and Shelter estimate the true figure affected is 60,000&ndash;75,000 households annually, as many tenants comply with notices before proceedings reach court. The post-COVID moratorium surge was severe: when the 2020 moratorium lifted in May 2021, notices accelerated sharply, coinciding with rising buy-to-let mortgage rates that pushed 19% of landlords to reduce their portfolios &mdash; triggering no-fault evictions to sell with vacant possession. Rent affordability deteriorated simultaneously: average private sector rents rose 9.2% in the year to January 2024, while the Local Housing Allowance was frozen for four years, leaving a widening gap between benefit levels and market rents.
            </p>
            <p>
              The burden falls hardest on families and renters in high-cost areas. DLUHC data shows 58% of households accepted as homeless following Section 21 evictions had dependent children. In London, Section 21 accounted for 29% of all statutory homelessness acceptances in 2023, versus 19% nationally &mdash; placing acute pressure on already overwhelmed temporary accommodation services. Black and Asian renters are disproportionately represented in the private rented sector and face additional barriers when seeking alternative accommodation. The Renters&apos; Rights Bill progressing through Parliament in 2024&ndash;25 commits to abolishing Section 21, alongside rights to challenge unfair rent increases and access to a private renters&apos; ombudsman &mdash; the biggest reform to renter protections since 1988.
            </p>
          </div>
        </section>
