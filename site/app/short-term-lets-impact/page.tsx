      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>An estimated 280,000 short-term let properties were listed across the UK in 2024, up 65&percnt; since 2019. Short-term lets can generate two to four times the income of a long-term tenancy, creating strong financial incentives for landlords to withdraw from the residential market &mdash; particularly in coastal towns, rural tourist areas, and central London. In destinations such as St Ives, parts of the Lake District, and the Yorkshire Dales, the share of residential property on short-term letting platforms is estimated at between 20&percnt; and 40&percnt; of the housing stock. London&apos;s 90-day annual limit on STLs (introduced under the Deregulation Act 2015) has been inconsistently enforced. Scotland introduced a mandatory STL licensing regime in 2023, designating Edinburgh a full STL control area; England launched a registration scheme in 2024 but implementation has lagged the pace of market growth.</p>
