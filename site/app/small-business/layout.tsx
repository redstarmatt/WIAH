...
export const metadata: Metadata = {
  ...
  description: 'Company insolvencies in England and Wales reached 27,500 in 2024 — the highest level in over 30 years. The five-year survival rate for new businesses has fallen to 38&percnt;, down from 44&percnt; a decade ago. Late payment by large firms costs small businesses an estimated £23 billion per year in cash flow, with the average SME owed £22,000 in overdue invoices.',
  openGraph: {
    title: 'Are Small Businesses Actually Surviving?',
    description: 'Company insolvencies in England and Wales reached 27,500 in 2024 — the highest level in over 30 years. The five-year survival rate for new businesses has fallen to 38&percnt;, down from 44&percnt; a decade ago. Late payment by large firms costs small businesses an estimated £23 billion per year in cash flow, with the average SME owed £22,000 in overdue invoices.',
    type: 'article',
