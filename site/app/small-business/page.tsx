      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Company insolvencies in England and Wales reached 27,500 in 2024 &mdash; the highest level since records began in 1993, exceeding the 2008&ndash;09 financial crisis peak and representing an 88% increase on 2019 levels. SMEs account for 99.9% of the UK&apos;s 5.5 million businesses and employ 16.7 million people, but the environment has deteriorated sharply since 2022. The surge in failures is driven by post-pandemic Bounce Back Loan debt (&pound;47 billion disbursed, &pound;4.9 billion estimated in fraud), interest rates that doubled borrowing costs between 2022 and 2024, energy costs still 40&ndash;50% above pre-crisis business tariff levels, and persistent labour shortages. The five-year survival rate has fallen from 44% for firms born in 2013 to 38% for those born in 2019, with the retail sector hardest hit &mdash; over 17,000 stores closed in 2023 alone. Late payment compounds the pressure: &pound;23 billion is owed to SMEs in overdue invoices at any time, with the average firm waiting 52 days against 30-day terms and the voluntary Prompt Payment Code carrying no enforcement powers.</p>
            <p>Business failure falls unevenly across geography and demography. Construction accounts for 18% of all insolvencies &mdash; driven by fixed-price contracts entered before inflation surged and subcontracting chains that amplify late payment effects. Women-led businesses receive just 2% of venture capital funding; ethnic minority entrepreneurs report higher bank lending rejection rates. Young entrepreneurs under 35 are more likely to start businesses but also more likely to fail within two years, typically because they lack collateral and rely on personal credit. In smaller towns, where a single employer may dominate, failure reverberates through the entire local economy in ways invisible to national insolvency statistics.</p>
          </div>
        </section>
