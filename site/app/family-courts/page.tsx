      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Outstanding cases across the family court system reached 62,400 in 2024 &mdash; up 64&percnt; from 38,000 in 2015 &mdash; with the average private law case now taking 50 weeks from application to final order, double the 2015 figure. The 26-week statutory limit for care proceedings, introduced in 2014, initially cut disposal times from 47 to 27 weeks, but by 2024 only 43&percnt; of care cases concluded within the limit. Court closures during COVID-19 created a backlog that has never been fully cleared, and rising demand driven by domestic abuse and children&apos;s social care referrals has overwhelmed a system already at or beyond capacity. The removal of legal aid for most private family law matters under the 2013 LASPO Act has compounded the crisis: at least one party was unrepresented in 80&percnt; of private law cases in 2024, with hearings taking longer as judges provide procedural guidance to self-represented litigants.</p>
