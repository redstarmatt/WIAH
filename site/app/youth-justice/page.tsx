      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The decline in children in custody is one of the most striking achievements in modern UK criminal justice. In 2008, there were 3,006 children held in custody in England and Wales. By 2024, that figure had fallen to 430 &mdash; an 86% reduction sustained over 15 years. Youth Offending Teams, established under the Crime and Disorder Act 1998, are widely credited with driving this shift: community-based intervention, diversion from prosecution, and a consistent policy preference for non-custodial outcomes. Over 70% of children dealt with by the justice system now receive non-custodial disposals. By international standards, and by the standards of adult justice, this is a genuinely exceptional trajectory.</p>
            <p>What the aggregate number obscures is who remains. The children still in custody in 2024 are disproportionately those with the most complex, multiple needs: 47% have experienced abuse or neglect, 60% have been in local authority care, and 68% have identified mental health needs. Reoffending within 12 months of leaving custody sits at around 68% &mdash; a figure that has barely moved in a decade. Young offender institutions are, by Ofsted&apos;s consistent assessment, failing educationally: children in custody receive on average 2&ndash;3 hours of education per day. In 2022/23 there were 1,034 self-harm incidents across the youth custody estate, equivalent to 10 incidents per 10 young people in the average daily population.</p>
            <p>Racial disparity is the system&apos;s most persistent structural failure. Black children make up approximately 5% of the 10&ndash;17 population in England and Wales but 29% of the youth custody population &mdash; a sixfold overrepresentation. The Lammy Review in 2017 documented this disparity in detail and made specific recommendations; nearly a decade later, progress has been limited. Overrepresentation begins early in the system, at the point of stop-and-search, arrest, and charge decision, and compounds at each subsequent stage. It is not fully explained by socioeconomic factors or offence type.</p>
            <p>The one area where the overall reduction in youth custody has not held is knife-related offences. Knife possession charges among under-18s have risen even as overall youth custody has fallen, reflecting a specific concentration of serious violence in a small number of urban areas and age groups. Restorative justice programmes have shown promise in this context &mdash; pilot studies report around a 27% reduction in reoffending &mdash; but provision is patchy and not consistently funded across local authorities.</p>
            <p>What the data cannot tell us is whether the reduction in custody represents genuine desistance from offending or primarily a change in system response &mdash; and what the long-run consequences of each are. Nor can custody statistics capture the children who cycle through the edges of the justice system without formal prosecution: those dealt with by community resolution, those whose cases are dropped, those who appear in child protection rather than criminal proceedings. The 430 in custody are the most visible; the full population of children in contact with the justice system is considerably larger, and their outcomes are much harder to track.</p>
          </div>
        </section>
          ...
          <ScrollReveal>
            <div className="bg-white rounded-lg p-6 border border-wiah-border">
              <div className="mb-6">
                ...
                <p className="text-sm text-wiah-mid">Percentage of total secure youth estate population. Black children are 5% of the 10&ndash;17 age population but 29% of custodial population &mdash; a six-fold overrepresentation.</p>
              </div>
