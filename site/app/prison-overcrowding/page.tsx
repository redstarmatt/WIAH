      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Overcrowding concentrates in specific estate categories. Category B local prisons &mdash; which hold remand prisoners and short-sentence inmates &mdash; run at 130&ndash;150&percnt; capacity, with two people routinely placed in cells designed for one. HMP Wandsworth, built in 1851 for 943, held 1,628 in 2023. The population skews heavily: 27&percnt; of prisoners are from Black and minority ethnic backgrounds, against 14&percnt; of the general population. Foreign national prisoners number 10,100 (12&percnt; of the total), with deportation backlogs adding to the strain. Women&apos;s prisons face acute overcrowding relative to their small estate &mdash; 12 prisons hold the entire female population, with several running above 120&percnt; capacity. Self-harm among women prisoners is six times the male rate, a crisis compounded by distance from families: the average woman is held 64 miles from home.</p>
