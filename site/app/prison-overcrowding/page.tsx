      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The crisis is not evenly distributed. Category B local prisons run at 130&ndash;150% capacity, with two people routinely in cells designed for one. Women&apos;s prisons run above 120% capacity across a 12-prison estate; self-harm among women prisoners is six times the male rate, compounded by an average distance of 64 miles from home. Black and minority ethnic people represent 27% of prisoners against 14% of the general population &mdash; a disparity the system has not seriously addressed. The government&apos;s expansion plan targets 10,000 additional places; the Independent Sentencing Review launched in 2025 is examining alternatives to short sentences.</p>
          </div>
        </section>
