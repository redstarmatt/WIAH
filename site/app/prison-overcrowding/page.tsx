      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>England and Wales hold 88,225 prisoners in an estate built for 79,927 usable places &mdash; an occupancy rate of 110%. The prison population has roughly doubled since 1990, driven by a sentencing ratchet: the average custodial sentence rose from 14.5 months in 2012 to 20 months in 2023, recall prisoners now account for 16% of the total, and the Crown Court backlog has pushed the remand population to a record 16,400 &mdash; 24% of all prisoners, some held more than two years awaiting trial. In September 2023, the government activated an emergency early-release scheme, freeing 1,700 prisoners to avert operational collapse. The reoffending cycle absorbs &pound;18 billion a year, with sentences under twelve months producing the worst outcomes.</p>
            <p>The crisis is not evenly distributed. Category B local prisons run at 130&ndash;150&percnt; capacity, with two people routinely in cells designed for one. Women&apos;s prisons run above 120&percnt; capacity across a 12-prison estate; self-harm among women prisoners is six times the male rate, compounded by an average distance of 64 miles from home. Black and minority ethnic people represent 27&percnt; of prisoners against 14&percnt; of the general population &mdash; a disparity the system has not seriously addressed. The government&apos;s expansion plan targets 10,000 additional places; the Independent Sentencing Review launched in 2025 is examining alternatives to short sentences.</p>
          </div>
        </section>
