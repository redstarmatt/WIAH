      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              The market for legal aid work has contracted sharply because the fee rates paid to solicitors have not kept pace with either inflation or the cost of running a practice. Criminal legal aid fee rates were frozen from 2011, with a 15&percnt; increase in 2023 representing the first material change in 12 years. Law Society analysis found that criminal defence solicitors were earning less in real terms in 2022 than their equivalents in 2001. Under these conditions, the number of firms willing to do legal aid work has fallen from approximately 2,300 in 2010 to around 1,150 by 2024 &mdash; a 50&percnt; reduction. The firms that remain are typically either very large organisations that can cross-subsidise legal aid from private work, or small specialist firms that have structured their business around publicly funded work. Medium-sized high street practices &mdash; once the backbone of legal aid provision &mdash; have largely exited the market.
            </p>
            <p>
              The consequence is the emergence of legal aid deserts: large geographic areas where no solicitor holds a contract to provide legally aided services. The Law Society publishes annual legal aid desert maps for specific specialisms; as of 2024, 1 in 4 local authority areas in England has no housing legal aid provider within a reasonable distance; the position is equally or worse for immigration and asylum law (35&percnt; of areas without provision), family law (28&percnt;), and crime. Legal aid deserts are concentrated in rural areas, coastal towns, and the Midlands &mdash; the areas where private legal practice is least profitable and where transport links make travel to distant providers difficult. A person in Penzance, Berwick-upon-Tweed, or rural Lincolnshire who needs a legally aided solicitor for a welfare benefit appeal may face a round trip of several hours, or may simply give up.
            </p>
            <p>
              The inequality in access to justice is visible in the court statistics. The proportion of court hearings in which one or both parties are unrepresented (litigants in person) has grown from approximately 20&percnt; in 2011 to over 45&percnt; of family court hearings by 2023. Unrepresented litigants are disproportionately those facing domestic abuse allegations, debt proceedings, housing possession actions, and immigration decisions &mdash; exactly the cases where the stakes are highest and the legal complexity is greatest. Research by the Law Society found that unrepresented defendants in employment tribunals win approximately 35&percnt; of cases, compared with 60&percnt; for represented claimants &mdash; a 25 percentage point gap that is directly attributable to the withdrawal of legal aid from employment law. People from ethnic minority backgrounds are disproportionately affected: they are over-represented in immigration, criminal, and welfare benefit proceedings where legal aid cuts have been deepest.
            </p>
            <p>
