      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Aviation is one of the hardest sectors to decarbonise and one of the fastest growing sources of UK emissions. Direct CO2 from UK aviation amounted to around 35 million tonnes in 2023 &mdash; roughly equivalent to CO2 from all UK cars for four months. But CO2 is only part of the story: contrails, water vapour, and nitrogen oxides emitted at altitude have a warming effect estimated at 2 to 4 times the CO2 figure alone, meaning aviation&apos;s total climate impact is equivalent to perhaps 80&ndash;140 million tonnes of CO2-equivalent &mdash; around 7&ndash;8&percnt; of the UK&apos;s total. This is more than the combined climate impact of all UK rail, bus, and domestic shipping. Only around half the UK population flies in any given year, and the most frequent fliers &mdash; roughly 15&percnt; of adults who take more than three return flights per year &mdash; account for an estimated 70&percnt; of all flights. The distributional dimension of aviation emissions is therefore striking: a relatively small group of frequent fliers is responsible for a disproportionate share of one of the most climate-intensive activities.</p>
            <p>Aviation enjoys what critics describe as extraordinary fiscal privilege. Unlike road vehicles, aviation kerosene carries no fuel duty in the UK &mdash; a 1944 Chicago Convention provision that has never been updated for the climate era. International flights are zero-rated for VAT. HMRC analysis suggests the combined value of these exemptions is around &pound;7bn per year. The only aviation tax is Air Passenger Duty (APD), which raised around &pound;3.7bn in 2023&ndash;24 &mdash; well below the estimated cost of the exemptions. By comparison, a litre of petrol attracts 52.95p in fuel duty plus 20&percnt; VAT. The Climate Change Committee has consistently recommended reforming APD to better reflect climate costs, proposing a frequent flier levy and higher rates for long-haul flights. The government has instead frozen or reduced APD rates in recent years and expanded APD exemptions for domestic aviation.</p>
            <p>The aviation industry&apos;s central decarbonisation strategy relies on Sustainable Aviation Fuel (SAF) &mdash; fuel produced from waste, agricultural residues, or synthetic processes that can reduce lifecycle emissions by 70&percnt; or more compared to conventional jet fuel. UK law mandates a 10&percnt; SAF blend by 2030 and 22&percnt; by 2040, with a target of 10&percnt; SAF production in the UK by 2030. As of early 2024, SAF represents under 1&percnt; of UK aviation fuel. The mandates are achievable in principle but require substantial new production capacity &mdash; three UK SAF plants were under development in 2024, but none were yet operational. SAF currently costs three to five times more than conventional jet fuel, a premium that airlines have generally passed to consumers through higher fares rather than absorbing it as a margin reduction. Hydrogen-powered flight, which Rolls-Royce has successfully tested in ground and flight trials, is unlikely to be commercially viable for long-haul aviation before 2040.</p>
