...
const editorialRefs: Reference[] = [
  ...
  { num: 4, name: 'National Housing Federation', dataset: 'Capital Requirements for Social Housing', date: '2023', note: 'Estimated £10-15 billion per year needed for 90,000-100,000 homes', url: 'https://www.housing.org.uk/resources/research-and-data/' },
];
