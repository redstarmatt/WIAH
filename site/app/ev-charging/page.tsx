      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The UK public EV charging network has grown from 8,400 devices in 2017 to 65,000 in early 2024 &mdash; an 8-fold increase and a genuine infrastructure achievement. But EV registrations are outpacing charger installation: the ratio of rapid chargers to EVs has fallen from around 1:6 in 2017 to approximately 1:22 in 2023 against a government target of 1:10, and the direction of travel is moving away from that target. Reaching the government&apos;s goal of 300,000 public charge points by 2030 would require installations to roughly quadruple in five years &mdash; plausible but demanding &mdash; and grid connection upgrades to distribution networks are a separate, slower challenge that could constrain the pace.</p>
            <p>The distributional gaps are significant. Urban areas have approximately 66 public charge points per 100,000 people; rural areas have 8 &mdash; an 8-fold gap that means households without off-street parking or a workplace charger face a genuine barrier to EV adoption. The transition risks reproducing transport inequalities: those with driveways transition easily; those in flats or rural areas are left dependent on patchy public infrastructure. Reliability compounds this: Zap-Map fault data shows a significant proportion of public charge points are out of service at any given time, and a broken charger may not announce its fault status until a driver has already waited in a queue.</p>
          </div>
        </section>
