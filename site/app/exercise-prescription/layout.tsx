...
export const metadata: Metadata = {
  ...
  description: 'Physical activity referrals have reached 680,000 a year and show strong evidence of benefit &mdash; yet most GPs still default to medication.',
  openGraph: {
    title: 'Are Doctors Prescribing Exercise?',
    description: 'Physical activity referrals have reached 680,000 a year and show strong evidence of benefit &mdash; yet most GPs still default to medication.',
    type: 'article',
