    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Under-18 conception rates have fallen to a record low of 13 per 1,000 — one of the greatest public health successes of the past 25 years."
          colour="#2A9D8F"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="record low · 72% fall since 1999"
              sparklineData={[47.1, 42.5, 41.9, 35.5, 27.7, 18.8, 14.4, 13.4, 13.1]}
              href="#sec-chart"source="ONS · Conceptions in England and Wales 2022"
            />
            <MetricCard
              label="Since 1999"
              value="-72%"
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="transformation in a generation · sex education + contraception"
              sparklineData={[47.1, 42.5, 35.5, 27.7, 18.8, 14.4, 13.1]}
              href="#sec-callout"source="ONS · Conceptions in England and Wales 2022"
            />
            <MetricCard
              ...
              href="#sec-callout"source="ONS · Conceptions by deprivation decile 2022"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Under-18 conception rate, England, 1999–2022"
        ...
        <ScrollReveal>
          <div id="sec-callout">
            <PositiveCallout
              title="A 72% Fall — One of the UK&rsquo;s Greatest Health Successes"
              value="13.1"
              unit="per 1,000 under-18s"
              description="Under-18 conception rates have fallen by nearly three quarters since 1999, from 47 to 13 per 1,000. This was driven by the Teenage Pregnancy Strategy, better sex education and improved contraception access — and it saved hundreds of thousands of young lives from disruption."
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Office for National Statistics — Conceptions in England and Wales. Annual statistical bulletin. ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/conceptionandfertilityrates/bulletins/conceptionstatisticsenglandandwales/</p>
            <p>ONS — Conceptions by index of multiple deprivation. Supplementary tables published with annual conceptions bulletin.</p>
