...
export const metadata: Metadata = {
  ...
  description: 'Under-18 conception rates have fallen to a record low of 13 per 1,000 &mdash; one of the greatest public health successes of the past 25 years.',
  openGraph: {
    title: 'Is Teenage Pregnancy Still a Problem?',
    description: 'Under-18 conception rates have fallen to a record low of 13 per 1,000 &mdash; one of the greatest public health successes of the past 25 years.',
    type: 'article',
