      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              Post-adoption support is widely acknowledged as inadequate. The Adoption Support Fund, established in 2015, provides therapeutic services to adopted children and their families, with a cap of &pound;5,000 per child per year. Take-up has grown &mdash; 43,000 applications were made in 2022/23 &mdash; but the cap has not been uprated for inflation, and the Fund does not cover ongoing therapeutic parenting support or respite. Adoption UK&apos;s annual Barometer survey found that 65% of adoptive families had sought mental health support for their child, but only 38% had received it in a timely way. Adoption breakdown rates &mdash; where an adoption order is effectively reversed by the child entering care again &mdash; are not officially tracked nationally, though estimates range from 3% to 9% depending on the cohort studied.
            </p>
            <p>
              Ethnicity and age drive the deepest inequalities in adoption outcomes. Black children wait on average 18 months longer than white children from the point of a placement order to being matched with adopters. Mixed-heritage children face similar delays. The government removed the duty to give &ldquo;due consideration&rdquo; to ethnicity matching in 2014, intending to speed up placements, but the evidence on whether this accelerated timescales for minority ethnic children is mixed. Children aged five and over, sibling groups, and children with disabilities are the hardest to place: just 14% of children adopted in 2023 were aged five or older, compared with 52% of the waiting children in that age group. Sibling groups of three or more represent 6% of waiting children but just 2% of adoptive placements.
            </p>
            <p>
