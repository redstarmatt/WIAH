      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              England completed 7,500 social rented homes in 2023 &mdash; the lowest annual total since the 1920s and an 81&percnt; collapse from 39,500 in 2010. Against that trickle of supply, 1.29 million households sit on council waiting lists, up from 1.14 million in 2018, with rough sleeping reaching 4,255 and over 100,000 households in temporary accommodation. Right to Buy has removed 1.8 million council homes from the social stock since 1980, with replacement running at roughly one new social home for every eight sold &mdash; a cumulative shortfall exceeding 1.5 million units. Housing associations now build more social and affordable housing than councils, but their capacity is shrinking: post-Grenfell safety remediation has cost larger associations over &pound;1 billion, and the Affordable Homes Programme 2021&ndash;26&apos;s &pound;11.5 billion budget mostly delivers &ldquo;affordable rent&rdquo; at up to 80&percnt; of market rate rather than social rent at 40&ndash;60&percnt; &mdash; a distinction that matters enormously to the 1.29 million households still waiting.
            </p>
            <p>The burden falls with striking precision on the most vulnerable. Single mothers head 38&percnt; of households in temporary accommodation; Black households are four times more likely than white households to be on a social housing waiting list, reflecting decades of differential access to home ownership. London concentrates the crisis most visibly &mdash; temporary accommodation placements reached 57,000 households in 2023, more than half the national total, in a city where median house prices exceed median earnings by a factor of 12. Outside London, former industrial towns face a different version: older, energy-inefficient stock concentrated in weak labour markets, with less capital funding per head and fewer planning levers to mandate social tenures. The result is a two-tier system where those most in need of stable housing are least likely to secure it, regardless of where they live.</p>
          </div>
        </section>
