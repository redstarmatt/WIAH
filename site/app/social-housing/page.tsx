      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              Housing associations now build more social and affordable housing than councils, yet their capacity is shrinking. Post-Grenfell building safety remediation has cost larger associations over &pound;1 billion, and rising debt costs in 2022&ndash;23 forced some to pause development entirely. The Affordable Homes Programme 2021&ndash;26 allocates &pound;11.5 billion for 180,000 affordable homes, but most output is &ldquo;affordable rent&rdquo; at up to 80% of market rent &mdash; not social rent, which runs at 40&ndash;60% of market. Labour&apos;s 2024 NPPF reform now requires councils to prioritise social rent in planning decisions, a distinction that matters enormously for the 1.29 million households still waiting.
            </p>
            <p>The burden of the shortage falls on specific populations with precision. Single mothers head 38&percnt; of households in temporary accommodation, a group already facing the widest gender pay gap in the labour market. Black households are four times more likely than white households to be on a social housing waiting list, reflecting decades of differential access to home ownership and lower average wealth. Geographically, the crisis concentrates in London, where the ratio of median house prices to median earnings exceeds 12:1 and temporary accommodation placements reached 57,000 households in 2023 &mdash; more than half the national total. Outside London, former industrial towns in the North East and North West face a different version of the same problem: social stock is older, often energy-inefficient, and concentrated in areas with weak labour markets. Local authorities in these areas receive less capital funding per head than southern councils and have fewer planning powers to mandate affordable tenures. The result is a two-tier system in which those most in need of stable, affordable housing are least likely to secure it, regardless of where they live.</p>
            <p>The waiting list figure of 1.29 million households is, if anything, an undercount. It records only those who have successfully applied and been accepted onto a local authority register &mdash; not those who were discouraged from applying, failed eligibility tests, or were removed during periodic reviews. Councils define &ldquo;reasonable preference&rdquo; differently, making cross-authority comparisons unreliable. Completions data from MHCLG counts units at the point of physical completion, not at the point of letting, so there is a lag between the headline number and actual occupancy. Right to Buy sales figures are straightforward, but the replacement metric is contested: the government counts all &ldquo;affordable&rdquo; starts as replacements, including shared ownership and affordable rent units that serve a different population from the council tenants displaced. The 1:8 replacement ratio cited here uses a narrower definition limited to social rent, which is the like-for-like measure. Temporary accommodation statistics capture only those placed by local authorities under statutory duty, missing those who exhaust their options and leave the system entirely &mdash; the hidden homeless who never appear in any dataset.</p>
          </div>
        </section>
