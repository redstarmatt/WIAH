    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="40% of service family accommodation fails to meet basic living standards. The MOD housing backlog stands at &pound;750 million. Mould, damp and disrepair are cited as a major retention factor with 15% of service leavers citing housing as a reason."
          colour="#0D1117"
        />
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              The MOD owns approximately 49,000 homes for service families in England, Wales and Germany. In 1996, the then-Conservative government sold 57,000 of these homes to Annington Homes for &pound;1.67 billion, leasing them back. Under the Annington contract, the MOD paid rising ground rents while Annington took the proceeds of homes sold on the open market. The National Audit Office estimated in 2018 that the deal had cost taxpayers &pound;4.2 billion more than retaining the homes would have. In 2023, the government exercised its enfranchisement right and began buying back the homes at market value &mdash; estimated to cost over &pound;6 billion.
            </p>
            <p>
              The consequences of the Annington deal for housing quality have been severe. Maintenance budgets were squeezed because rental income went to Annington. Condition surveys now show 40% of service family accommodation does not meet the MOD Standard for Condition, with mould, damp, heating failures and structural defects all reported. Annual complaints from service families have risen to 11,000 &mdash; a record high. Survey data shows housing quality is among the top three reasons cited by service personnel considering leaving the military, alongside pay and deployment tempo. The MOD&apos;s Future Accommodation Model seeks to diversify provision away from tied housing, but the capital required to bring existing stock up to standard remains largely uncommitted.
            </p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-overview" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="Up from 32% in 2018 &middot; Annington Homes contract blamed"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="Up from £480M in 2018 &middot; Annington rents absorb maintenance funds"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="Record high &middot; Mould, damp, heating failures most common"
        ...
        <ScrollReveal>
          <section id="sec-standard" className="mb-12">
            <LineChart
              title="Service family accommodation below MOD standard, 2018&ndash;2024"
        ...
        <ScrollReveal>
          <section id="sec-backlog" className="mb-12">
            <LineChart
              title="MOD housing maintenance backlog and annual complaints, 2018&ndash;2024"
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            description="The MOD&apos;s Future Accommodation Model is redesigning how it provides housing from 2025, moving away from tied accommodation and towards a housing allowance model that gives service personnel more choice. The government committed &pound;1.6 billion for new service accommodation in the Defence Review 2023. The government&apos;s exercise of enfranchisement rights against Annington Homes in 2023 enables the MOD to reclaim and refurbish sold homes as they become available. Dedicated maintenance funding was increased by &pound;200 million in the 2024 Autumn Budget."
            source="Source: MOD &mdash; Annual Report and Accounts 2023/24. Defence Infrastructure Organisation &mdash; Future Accommodation Model prospectus."
          />
        </ScrollReveal>
