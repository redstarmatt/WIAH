      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The geography of under-vaccination maps closely onto deprivation, transience, and community diversity. Inner London boroughs &mdash; Hackney, Newham, Tower Hamlets &mdash; record MMR uptake below 80&percnt;, driven by high population turnover, fragmented GP registration, and concentrated vaccine hesitancy within specific communities. Orthodox Jewish, Somali, and Roma communities have been identified by UKHSA as particularly under-vaccinated, each for distinct reasons: religious authority networks, historical distrust of Western medicine, and barriers to accessing primary care respectively. Outside London, coastal towns with high deprivation and transient populations &mdash; Blackpool, Great Yarmouth, Thanet &mdash; also fall well below threshold. The structural cause is consistent: childhood vaccination in England depends entirely on GP-based delivery, and where GP registration is incomplete or appointment access is poor, children fall through the gaps. School-entry vaccination checks, standard in Australia and parts of the US, remain advisory rather than mandatory in England.</p>
