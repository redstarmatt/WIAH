    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The social care sector has 152,000 vacancies — a 9.9% vacancy rate that leaves vulnerable people without the support they need."
          colour="#E63946"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="slight improvement from 10.6% peak · 152k vacancies"
              sparklineData={[5.8, 6.2, 6.8, 7.1, 7.8, 7.0, 9.5, 10.6, 9.9]}
              href="#sec-chart"source="Skills for Care · State of the Workforce 2023"
            />
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText="nearly 1 in 3 workers leaves annually · workforce instability"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="overseas workers filling gap · ethical concerns remain"
              sparklineData={[25000, 26000, 27000, 28000, 30000, 30000, 40000, 70000, 70000]}
              href="#sec-chart"source="Home Office / Skills for Care · 2023"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Social care vacancy and turnover rates, 2015–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Skills for Care — State of the Adult Social Care Sector and Workforce in England. Published annually. skillsforcare.org.uk/adult-social-care-workforce-data/Workforce-intelligence/publications/national-information/The-state-of-the-adult-social-care-sector-and-workforce-in-England.aspx</p>
            <p>Home Office — Immigration statistics: work. gov.uk/government/collections/immigration-statistics-quarterly-release</p>
            <p>NHS Benchmarking Network — Social care workforce comparisons. nhsbenchmarking.nhs.uk</p>
