      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Train fares have risen 54% since 2010 while average wages grew only 28% in nominal terms &mdash; a 26 percentage point affordability gap. The rural bus network has halved: approximately 16,000 routes operated in 2010, falling to around 8,200 by 2023 as commercial viability and local authority funding declined in tandem. The Bus Service Operators Grant has been repeatedly reduced in real terms; the Bus Back Better strategy&apos;s promised &pound;3 billion transformation fund has not materialised at the scale needed to reverse a decade of route withdrawal. Car-free rural households &mdash; disproportionately elderly, low-income, or disabled &mdash; can spend more than 20% of household income on transport, compared to 10&ndash;15% for the wider population.</p>
