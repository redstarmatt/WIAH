    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The number of council-run public toilets in England has fallen from 5,600 in 2000 to around 2,350 in 2024 &mdash; a 58&percnt; decline. Local authority spending on public conveniences has nearly halved in real terms since 2010."
          colour="#6B7280"
        />

        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>England had approximately 5,600 council-maintained public toilets in 2000. By 2024, that number had fallen to around 2,350 &mdash; a reduction of 58&percnt;. The rate of closure accelerated sharply after 2010 as local authorities faced sustained budget cuts: total central government funding to councils fell 49.1&percnt; in real terms between 2010/11 and 2019/20, according to the National Audit Office. Public toilet provision is a discretionary service &mdash; councils may provide them but are not legally required to. When budgets contract, discretionary services are the first to go. The Royal Society for Public Health estimated in 2019 that 4 in 10 people restrict their time outside the home because of inadequate access to public toilets, with the impact heaviest on older people, disabled people, pregnant women, and those with bowel or bladder conditions.</p>
