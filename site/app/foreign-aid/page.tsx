      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              The United Kingdom was one of the first countries in the world to legislate for the 0.7&percnt; of GNI aid target, passed into law through the International Development (Official Development Assistance Target) Act 2015 following decades of cross-party commitment. In April 2021, the then Chancellor Rishi Sunak announced a temporary reduction to 0.5&percnt; of GNI, citing the fiscal pressures of the COVID-19 pandemic. The statutory basis allowed this: the Act permits a lower spend when the government determines that economic conditions make 0.7&percnt; not practicable. The cut amounted to approximately &pound;4 billion annually at current GNI levels, with immediate impact: bilateral programmes in sub-Saharan Africa, South Asia, and fragile states were cut or closed. The House of Commons International Development Committee found that programmes addressing girls&apos; education, malaria prevention, and food security were among the most severely affected.
            </p>
            <p>
              The 0.5&percnt; figure obscures a second, less-discussed problem: a growing proportion of the aid budget is being spent in the UK rather than overseas. Under OECD DAC (Development Assistance Committee) rules, expenditure on asylum seekers in the donor country during their first year of arrival can be classified as ODA. The UK government has taken full advantage of this classification: in 2023, approximately &pound;3.5 billion of the &pound;15.2 billion total ODA budget was classified as in-donor asylum costs &mdash; money spent on hotels, processing, and support for people awaiting asylum decisions in the UK. This means the overseas aid budget available for programmes in developing countries was approximately &pound;11.7 billion, not &pound;15.2 billion. The Independent Commission for Aid Impact (ICAI) found that this reclassification had resulted in the termination or significant reduction of programmes that had demonstrable life-saving impact.
            </p>
            <p>
              The specific programmes cut have been extensively documented by ICAI and parliamentary committees. The bilateral development programme with Nigeria &mdash; the world&apos;s most populous country and a key partner in addressing Sahel instability &mdash; was reduced by 58&percnt; in 2021. Support for the Global Fund to Fight AIDS, Tuberculosis and Malaria was cut by 60&percnt;; the Global Fund estimates this contributed to 300,000 preventable deaths from malaria alone. COVAX, the vaccine equity initiative, received &pound;548 million less than the UK had committed. The UK&apos;s contribution to the World Food Programme fell from &pound;300 million to &pound;114 million in 2021, in the same year that hunger in Yemen, Ethiopia, and South Sudan reached record levels. Bilateral aid to Yemen was cut by 50&percnt;.
            </p>
            <p>
              The distributional impact of UK aid cuts is almost entirely experienced outside the UK, in some of the world&apos;s most deprived communities. Within the UK, the decision to count asylum processing costs as ODA has been controversial for a different reason: critics argue it distorts the measurement of generosity, allowing ministers to claim the UK is spending 0.5&percnt; of GNI on aid when a substantial fraction of that spending is on domestic bureaucracy. DAC rules on what counts as ODA have been progressively expanded by donor countries seeking to reclassify domestic spending, and the UK has been among the most aggressive in exploiting this flexibility. The governments of Norway, Sweden, and Germany have imposed domestic caps on the proportion of their ODA budgets that can be claimed as in-donor costs.
            </p>
            <p>
              Measuring the effectiveness of aid &mdash; as distinct from its quantity &mdash; is methodologically challenging. ICAI uses a structured assessment framework that rates programmes on relevance, coherence, effectiveness, and efficiency; the majority of UK bilateral programmes reviewed in 2022&ndash;2024 were rated &ldquo;adequate&rdquo; or above, though a significant minority were rated &ldquo;poor.&rdquo; The relationship between ODA as a percentage of GNI and development outcomes is indirect: the quality and targeting of spending matters as much as volume. However, the rapid elimination of established programmes &mdash; with limited time for partners to find alternative funding &mdash; is itself a form of inefficiency, as institutional capacity built over years is lost. The 0.5&percnt; figure itself is a commitment to a ratio, not to outcomes; whether restoring it to 0.7&percnt; would produce proportionally better results depends heavily on what the additional funding is spent on.
            </p>
          </div>
        </section>
