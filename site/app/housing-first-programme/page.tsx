...
const editorialRefs: Reference[] = [
  ...
  { num: 3, name: 'Manchester Housing First Evaluation', dataset: 'Cost-Benefit Analysis', date: '2022', note: 'Cost saving £5,000-£15,000 per person per year', url: 'https://hfe.homeless.org.uk/' },
