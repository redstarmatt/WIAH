...
export const metadata: Metadata = {
  ...
  description: 'One in seven renters in England is now behind on their rent, the highest rate on record. Landlord possession claims in county courts hit 164,200 in 2024 — surpassing pre-pandemic levels — and evictions are rising sharply as the cost-of-living crisis meets a housing market where rents have increased 30&percnt; in four years.',
  openGraph: {
    title: 'How Many Renters Are Falling Behind?',
    description: 'One in seven renters in England is now behind on their rent, the highest rate on record. Landlord possession claims in county courts hit 164,200 in 2024 — surpassing pre-pandemic levels — and evictions are rising sharply as the cost-of-living crisis meets a housing market where rents have increased 30&percnt; in four years.',
    type: 'article',
