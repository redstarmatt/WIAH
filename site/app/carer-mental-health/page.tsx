      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Carer wellbeing decline, 2015–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Carers UK — State of Caring Survey. Annual survey of unpaid carers in England, Wales, and Scotland. carersuk.org/research-and-policy/state-of-caring-report/</p>
            <p>NHS Digital — Adult Psychiatric Morbidity Survey. Population-level mental health prevalence data. digital.nhs.uk/data-and-information/publications/statistical/adult-psychiatric-morbidity-survey</p>
            <p>DWP — Carer's Allowance Statistics. Quarterly claimant count data used to estimate carer population. gov.uk/government/collections/carers-allowance-statistics</p>
