    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Active Travel England investment reached £1.1 billion in 2023, but cycling represents just 2.4% of trips — well below comparable European countries."
          colour="#2A9D8F"
        />
        ...
        <PositiveCallout
          ...
          source="Source: Active Travel England — Investment Report 2024; DfT — National Travel Survey 2024."
        />

        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Active Travel England, established in 2022, received £1.1 billion in 2023 — roughly four times the level of active travel investment in 2019. Cycling trips in England grew 45% between 2019 and 2024, driven largely by e-bike adoption, with e-bike sales tripling and their share of new bike sales reaching 34% in 2023. Yet cycling remains just 2.4% of all trips, well below the Netherlands (27%), Denmark (17%), and Germany (10%). The UK's per-capita cycling infrastructure spend of £2.50 compares with £35 in the Netherlands. The Cycling and Walking Investment Strategy target of 55% of town trips by active modes by 2025 has not been achieved, and much of the historic investment went into sub-standard painted lanes rather than protected infrastructure that changes behaviour.</p>
            <p>Road danger — actual and perceived — remains the primary barrier, cited by 64% of non-cyclists in the National Travel Attitudes Survey. Women, older people, and parents with children are disproportionately deterred, creating a cycle use profile skewed heavily toward younger men. Geographic inequality is marked: London's dense network of protected lanes drives cycling rates far above those in regional cities and rural areas where infrastructure investment remains minimal. Planning reforms now require new developments to meet active travel standards, but retrofitting existing streets remains slow and contested.</p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              changeText="+£650m since 2020 · dedicated agency created"
              sparklineData={[0.20, 0.25, 0.35, 0.45, 0.48, 0.50, 0.70, 0.90, 1.1]}
              href="#sec-chart"source="Active Travel England · Investment Report 2024"
            />
            <MetricCard
              ...
              direction={'up' as const}
              polarity={'up-is-good' as const}
              changeText="+0.6pp since 2019 · well below EU peers"
              sparklineData={[1.6, 1.7, 1.8, 1.8, 1.8, 2.0, 2.1, 2.2, 2.4]}
              href="#sec-chart"source="DfT · National Travel Survey 2024"
            />
            <MetricCard
              ...
              direction={'up' as const}
              polarity={'up-is-good' as const}
              changeText="+45% since 2019 · e-bikes driving growth"
              sparklineData={[1.9, 2.0, 2.1, 2.3, 2.3, 2.5, 2.8, 3.1, 3.4]}
              href="#sec-chart"source="DfT · Cycling and Walking Investment Strategy Metrics 2024"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Active travel investment and cycling trips, 2016–2024"
              subtitle="Annual active travel infrastructure investment (£ billions) and cycling trips in England (billions)."
              series={series}
              yLabel="£ billions / trips (billions)"
              source={{
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Active Travel England — Investment Report 2024. gov.uk/government/organisations/active-travel-england</p>
            <p>Department for Transport — National Travel Survey 2024. gov.uk/government/collections/national-travel-survey-statistics</p>
            <p>Department for Transport — Cycling and Walking Investment Strategy Metrics 2024. gov.uk/government/publications/cycling-and-walking-investment-strategy</p>
