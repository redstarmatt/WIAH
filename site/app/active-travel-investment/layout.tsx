...
export const metadata: Metadata = {
  ...
  description: 'Active Travel England investment reached &pound;1.1 billion in 2023, but cycling represents just 2.4% of trips &mdash; well below comparable European countries.',
  openGraph: {
    title: 'Is Britain Building a Walking and Cycling Nation?',
    description: 'Active Travel England investment reached &pound;1.1 billion in 2023, but cycling represents just 2.4% of trips &mdash; well below comparable European countries.',
    type: 'article',
