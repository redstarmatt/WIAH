      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              England had 4,516 library branches in 2010; by 2022/23 roughly 3,000 remained &mdash; a 33% contraction in twelve years. More than 770 branches have closed outright, and the British Library Foundation has documented over 8,000 library jobs lost. Real-terms local authority spending on libraries fell approximately 34% between 2009/10 and 2022/23, according to IFS and CIPFA data. The Libraries Act 1964 places a statutory duty on councils to provide a &ldquo;comprehensive and efficient&rdquo; service, yet the Secretary of State has invoked enforcement powers only three times since the Act was passed.
            </p>
            <p>
              Usage has cratered across every traditional measure. Total visits fell from 338 million in 2010 to a COVID-driven low of 170 million in 2020/21, recovering partially to 247 million by 2022/23. Book issues dropped 42% over the same period &mdash; from 302 million to 175 million &mdash; though digital lending has surged: e-books and audiobooks now account for 22% of all loans, with more than 5 million digital issues recorded in 2022/23 via platforms such as BorrowBox. The DCMS Taking Part Survey found adult library visits fell from 48% in 2005/06 to just 27% in 2022/23.
            </p>
            <p>
              The workforce has been reshaped by austerity. Paid library staff fell from roughly 24,000 in 2010 to 16,000 by 2022 &mdash; a 33% cut &mdash; while volunteer numbers tripled from 20,000 to over 60,000 in the same period, increasingly substituting professional roles. The Society of Chief Librarians found 35% of services had reduced opening hours since 2019. During the cost-of-living crisis of winter 2022&ndash;23, more than 2,200 libraries registered as warm spaces &mdash; a stark illustration of how these institutions have evolved from lending rooms into front-line community infrastructure.
            </p>
          </div>
        </section>
