      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>London&rsquo;s urban tree canopy covers around 21% of the city&rsquo;s surface area &mdash; above the European average but distributed extremely unequally. In the wealthiest boroughs, residents have an average of 40 square metres of accessible green space per person; in the most deprived areas, that falls to 19 square metres. Approximately 7,000 street trees are lost across the UK each year to development, utilities work, and disease. The ash dieback epidemic is expected to kill up to 80% of the UK&apos;s ash trees, a significant component of urban canopy. Areas with low tree cover can be 5&ndash;7&deg;C warmer on hot days than nearby green spaces, a disparity that will intensify as climate change increases heatwave frequency and severity. Mature trees provide an estimated &pound;1,000 per year in ecosystem services through cooling, air filtration, and stormwater management.</p>
            <p>The public health consequences of the canopy deficit fall predictably on the most deprived communities. People least likely to have air conditioning are also least likely to live near cooling green space; heat mortality in cities falls most heavily on older people, those with cardiovascular conditions, and those in fuel poverty. The Trees and Design Action Group estimates urban areas would need to double canopy cover over the next two decades to adequately buffer against climate and health risks. Urban tree planting programmes exist in many councils but are consistently deprioritised in budget cuts; the Urban Tree Challenge Fund has planted approximately 200,000 trees since 2019 against an estimated need of 5 million across English towns and cities.</p>
          </div>
        </section>
