      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The scale of the problem increased dramatically during and after the pandemic, but the trend was already upward before COVID-19 arrived. Between 2017 and 2019, handover delays were rising steadily as bed occupancy rates climbed above 90% &mdash; well above the 85% threshold that NHS England considers safe for operational flow. The pandemic accelerated the crisis through multiple mechanisms: infection control requirements reduced effective bed capacity, the backlog of elective care created additional emergency admissions from deteriorating conditions, and social care capacity contracted as providers closed or reduced services. By 2023, average bed occupancy across general and acute beds had reached 94%, with many trusts routinely operating at 98&ndash;100%. At these levels, any surge in demand &mdash; a cold snap, a respiratory virus wave, a bank holiday &mdash; immediately translates into ambulance queues.</p>
            <p>The impact of handover delays is not distributed evenly across the country. Trusts in the Midlands and the North of England consistently report the longest delays, with some hospitals averaging over 45 minutes per handover against the 15-minute standard. Rural ambulance services face a compounding problem: when a crew is trapped at a distant hospital for several hours, the geographic area left without cover can span hundreds of square miles. Urban services are affected differently &mdash; shorter distances but higher call volumes mean that even modest per-handover delays quickly consume the available fleet. Winter months see handover delays roughly double compared to summer, but the problem is now year-round: even in August 2023, 22% of handovers took longer than 30 minutes. The human cost falls most heavily on the elderly and those with multiple long-term conditions, who are both the most likely to call 999 and the most likely to suffer harm from delayed response.</p>
