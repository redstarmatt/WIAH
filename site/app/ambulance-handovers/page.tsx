      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The scale of the problem increased dramatically during and after the pandemic, but the trend was already upward before COVID-19 arrived. Between 2017 and 2019, handover delays were rising steadily as bed occupancy rates climbed above 90&percnt; &mdash; well above the 85&percnt; threshold that NHS England considers safe for operational flow. The pandemic accelerated the crisis through multiple mechanisms: infection control requirements reduced effective bed capacity, the backlog of elective care created additional emergency admissions from deteriorating conditions, and social care capacity contracted as providers closed or reduced services. By 2023, average bed occupancy across general and acute beds had reached 94&percnt;, with many trusts routinely operating at 98&ndash;100&percnt;. At these levels, any surge in demand &mdash; a cold snap, a respiratory virus wave, a bank holiday &mdash; immediately translates into ambulance queues.</p>
            <p>The impact of handover delays is not distributed evenly across the country. Trusts in the Midlands and the North of England consistently report the longest delays, with some hospitals averaging over 45 minutes per handover against the 15-minute standard. Rural ambulance services face a compounding problem: when a crew is trapped at a distant hospital for several hours, the geographic area left without cover can span hundreds of square miles. Urban services are affected differently &mdash; shorter distances but higher call volumes mean that even modest per-handover delays quickly consume the available fleet. Winter months see handover delays roughly double compared to summer, but the problem is now year-round: even in August 2023, 22&percnt; of handovers took longer than 30 minutes. The human cost falls most heavily on the elderly and those with multiple long-term conditions, who are both the most likely to call 999 and the most likely to suffer harm from delayed response.</p>
            <p>Measuring handover delays accurately is itself challenging. The published data relies on ambulance trusts recording the time of arrival at hospital and the time of clinical handover, but the definition of &ldquo;handover&rdquo; is not applied consistently across all trusts. Some record handover at the point of verbal transfer; others at the point of written transfer; and some at the point when the patient is moved to a hospital trolley. The Hospital Ambulance Liaison Officer (HALO) role, which was supposed to manage flow at hospital doors, is not funded in all trusts and is frequently the first post to be stood down during surges. Data on the downstream impact of handover delays &mdash; specifically, how many patients experienced harm or death because an ambulance was not available &mdash; is not systematically collected at national level. Individual ambulance trusts conduct serious incident reviews for the most extreme cases, but there is no national registry of harm caused by handover-related response delays. The true toll of this crisis remains, by design, largely invisible in official statistics.</p>
          </div>
        </section>
