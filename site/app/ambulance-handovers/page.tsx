...
const editorialRefs: Reference[] = [
  ...
  { num: 2, name: 'Association of Ambulance Chief Executives', dataset: 'Handover delay mortality estimates', date: '2023', url: 'https://aace.org.uk/' },
  { num: 3, name: 'NHS England', dataset: 'Urgent and Emergency Care Recovery Plan', url: 'https://www.england.nhs.uk/statistics/', date: '2023' },
];
