    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="sec-context" className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        <div className="text-base text-wiah-black leading-[1.7] space-y-4">
          <p>NHS dentistry in England has been in accelerating decline since the pandemic, but the pressures pre-date COVID-19 by years. In 2023, 42&percnt; of adults reported being unable to get an NHS dentist appointment when they needed one &mdash; up from roughly 25&percnt; in 2019. The consequences are not merely inconvenient. Tooth decay, untreated without access to routine care, has become the leading cause of hospital admissions for children aged 6 to 10 in England. In 2022&ndash;23, 35,000 children had teeth removed under general anaesthetic in hospital settings &mdash; a costly, avoidable intervention that carries real clinical risk. Oral disease that elsewhere would be caught and filled has instead progressed to extraction.</p>
