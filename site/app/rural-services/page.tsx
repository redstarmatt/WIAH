      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Ten million people live in rural England &mdash; 17% of the population spread across 86% of the land area. Since 2010, more than 1,000 bus routes have been cut after local authority subsidies fell 57% in real terms; rural residents now travel an average of 5.8 miles to their nearest GP against 0.8 miles for urban residents; 45% of rural bank branches have closed; and 740,000 premises cannot access a 10Mbps broadband connection. The National Bus Strategy (2021) allocated &pound;4.65 billion through Bus Service Improvement Plans, and Project Gigabit targets full-fibre connection for 1 million hard-to-reach premises by 2025 &mdash; but the cumulative scale of disinvestment since 2010 in transport, health, banking, and digital infrastructure has not yet been reversed. Over-65s make up 25% of the rural population, rising to a projected 30% by 2035, meaning demand for health and social care is growing in exactly the areas where services are thinnest.</p>
            <p>The burden falls hardest on the 17% of rural households without a car &mdash; overwhelmingly elderly, disabled, or low-income &mdash; who cannot substitute private transport for what has been lost. Fuel poverty hits rural areas disproportionately as 14% of households rely on heating oil rather than mains gas, placing them outside the energy price cap. House prices in National Parks and AONBs run at 11&ndash;12 times local earnings versus 7.5 times nationally, locking younger residents out of the communities that depend on them for economic and service sustainability.</p>
          </div>
        </section>
