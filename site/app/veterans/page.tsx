      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The costs of military service fall unevenly across the veteran population, and the support system reflects those disparities. Veterans from enlisted ranks, who comprise the large majority of service leavers, are significantly more likely to experience unemployment, housing instability, and mental health difficulties than those who served as officers, yet transition support has historically been designed around the needs of the latter. Early Service Leavers &mdash; those serving fewer than four years &mdash; are the most vulnerable cohort: they receive reduced resettlement support, are ineligible for the full Career Transition Partnership package, and MOD research shows they are three times more likely to be unemployed two years after discharge. Women veterans, who make up approximately 11&percnt; of the veteran population, report lower rates of help-seeking for PTSD and higher rates of military sexual trauma, a category the UK system has been slow to recognise. Geographically, veterans cluster in the South West, East of England, and Scotland, but services are concentrated in major urban centres, creating access gaps in rural and coastal areas. The Armed Forces Covenant, despite its statutory footing since 2021, carries no enforcement mechanism: local authorities found to be failing veterans face no sanction, and compliance monitoring depends on self-reported data from the bodies being assessed.</p>
            <p>The 2.4 million veteran count from the 2021 Census is the first comprehensive figure the UK has produced, but it relies entirely on self-identification &mdash; there is no cross-referencing with MOD service records, and the true population could be higher if some veterans do not identify with the term, or lower if some respondents misunderstood the question to include cadets or reservists. The 17&percnt; PTSD prevalence figure among combat veterans comes from King&apos;s College London military cohort studies, which use validated screening instruments but draw from a self-selecting sample that may not represent the broader veteran population. Op COURAGE referral numbers track entries into the system but do not publish treatment completion rates or clinical outcomes, making it impossible to assess whether the service is effective rather than merely busy. Rough sleeping counts are based on single-night street estimates conducted by local authorities using inconsistent methodologies &mdash; veteran status is identified by outreach workers through conversation, not verified against records &mdash; and the 6&percnt; figure almost certainly undercounts veterans in hidden homelessness: those in temporary accommodation, sofa-surfing, or sleeping in vehicles. Defence spending as a percentage of GDP is sensitive to how both the numerator and denominator are defined, and NATO allies have repeatedly disputed the UK&apos;s accounting methodology for including items such as military pensions and intelligence spending.</p>
          </div>
        </section>
