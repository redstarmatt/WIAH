      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              Support is unequally distributed across the veteran population. Early Service Leavers &mdash; those serving fewer than four years &mdash; receive reduced resettlement support and are three times more likely to be unemployed two years after discharge. Women veterans, around 11% of the total, report lower rates of help-seeking and higher rates of military sexual trauma. Services cluster in major urban centres, leaving rural and coastal veterans with limited access. The Armed Forces Covenant, placed on a statutory footing in 2021, carries no enforcement mechanism: local authorities found failing veterans face no sanction, and compliance monitoring relies on self-reported data from the bodies being assessed.
            </p>
          </div>
        </section>
