      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              The 2021 Census &mdash; the first to include a veteran status question &mdash; counted 2.4 million veterans in the UK, of whom more than 75% are aged 55 or over. UK regular armed forces strength has fallen from 178,600 in 2010 to approximately 148,000 in 2024, well below the 160,000 trained-strength target, and the Army missed its recruitment target for eleven consecutive years from 2012 to 2023. King&apos;s College London research puts PTSD prevalence at roughly 17% among combat veterans, though only 6% of all veterans carry a clinical diagnosis. Op COURAGE, the NHS veterans&apos; mental health service launched in April 2021, received over 21,000 referrals in its first three years, but waits average seven weeks, exceeding the NICE recommendation. An estimated 50,000 veterans lack a registered GP, and veterans comprised 6% of rough sleepers in England in 2023/24 &mdash; down from 15% in 2014 but still around 250 individuals on any given night.
            </p>
            <p>
              Support is unequally distributed across the veteran population. Early Service Leavers &mdash; those serving fewer than four years &mdash; receive reduced resettlement support and are three times more likely to be unemployed two years after discharge. Women veterans, around 11&percnt; of the total, report lower rates of help-seeking and higher rates of military sexual trauma. Services cluster in major urban centres, leaving rural and coastal veterans with limited access. The Armed Forces Covenant, placed on a statutory footing in 2021, carries no enforcement mechanism: local authorities found failing veterans face no sanction, and compliance monitoring relies on self-reported data from the bodies being assessed.
            </p>
          </div>
        </section>
