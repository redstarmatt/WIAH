      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>NHS dental treatment completions fell from 30.1 million courses in 2019/20 to 25.4 million in 2022/23 &mdash; a reduction of 4.7 million treatments a year that has not recovered despite three years since the COVID-19 pandemic. Around 43 million adults in England, roughly 77% of the adult population, cannot get an NHS dental appointment when they need one; in some areas no NHS surgery accepts new adult patients at all. The structural cause is the Unit of Dental Activity (UDA) contract introduced in 2006, which pays the same whether a dentist provides a check-up or complex multi-appointment treatment, creating strong incentives to see simpler cases privately and abandon NHS work. NHS England&rsquo;s Dentistry Recovery Plan (2023) introduced a &ldquo;golden hello&rdquo; payment and increased UDA values, but critics argue full contract reform is necessary &mdash; the share of adults seen within two years stood at 46.1% in 2022/23 against 54.9% pre-pandemic.</p>
            <p>Unmet need translates directly into harm. Hospital admissions for dental conditions treatable in primary care have risen, children miss school due to dental pain, and the private market that fills the gap is unaffordable for large parts of the population. Rural and coastal communities &mdash; parts of Cornwall, North Yorkshire, and Lincolnshire &mdash; report dental deserts where patients travel 50 or more miles for NHS care. Deprivation compounds access: the most deprived communities have both the highest dental need and the lowest availability of NHS provision.</p>
          </div>
        </section>
