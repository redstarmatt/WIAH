      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The prison population is shaped by sentencing policy, not crime rates. Recorded crime has fallen 40&percnt; since its 2003 peak, yet the prison population grew 25&percnt; over the same period. Longer sentences, mandatory minimums, recall expansions under the Offender Rehabilitation Act 2014, and Imprisonment for Public Protection (IPP) sentences &mdash; abolished in 2012 but still holding 2,900 people past their tariff &mdash; all contribute. Black men are imprisoned at 5.9 times the rate of white men. Muslim prisoners now comprise 18&percnt; of the population, against 6&percnt; nationally. Mental health need is pervasive: 26&percnt; of prisoners self-report a diagnosed mental health condition, yet in-prison psychiatric provision was cut 30&percnt; between 2010 and 2020. The closure of community mental health beds has made prisons a de facto provider of last resort for people the wider system has failed.</p>
