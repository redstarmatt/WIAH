      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              The prison population is shaped by sentencing policy, not crime rates: recorded crime has fallen 40&percnt; since its 2003 peak, yet the prison population grew 25&percnt; over the same period. Black men are imprisoned at 5.9 times the rate of white men; 26&percnt; of prisoners self-report a diagnosed mental health condition, yet in-prison psychiatric provision was cut 30&percnt; between 2010 and 2020. Women make up 4% of the population, with 77% serving sentences of under 12 months &mdash; often for non-violent offences &mdash; while the building programme of 20,000 new places by 2030 will not keep pace with population growth at the current trajectory.
            </p>
          </div>
        </section>
