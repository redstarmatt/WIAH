      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText="50-year low · back to 2019 level after COVID"
              sparklineData={[244, 243, 247, 249, 245, 236, 169, 218, 236]}
              href="#sec-chart"source="ONS · Marriages in England and Wales 2022"
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="fastest-growing family type · but fewer legal protections"
            ...
            <MetricCard
              ...
              direction="down"
              polarity="up-is-good"
              changeText="vs 14.5 in 1972 · long secular decline"
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Marriages and cohabiting couples, 2005–2022"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>ONS — Marriages in England and Wales. Annual publication based on marriage registrations. ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/marriagecohabitationandcivilpartnerships</p>
            <p>ONS — Families and Households. Annual estimates from the Labour Force Survey. ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/families</p>
