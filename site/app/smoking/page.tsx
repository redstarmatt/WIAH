      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Something extraordinary has happened to smoking in Britain, and almost nobody is talking about it. In 2011, 20.2% of UK adults smoked — around 9.6 million people. By 2024, that figure had fallen to 10.6%, or 5.3 million. A habit that defined post-war British culture, that once featured in every pub, office, and hospital ward, has halved within the span of a single career. This is one of the most dramatic public health transformations of the 21st century.</p>
            <p>The generational shift is even more striking. Among 18–24 year olds — traditionally the age group with the highest smoking rates — prevalence has fallen from 25.7% in 2011 to just 8.1% in 2024. The cohort entering adulthood today is the first in British history for whom smoking is genuinely a minority behaviour, not a statistical norm. The youth smoking rate is now lower than the overall adult rate was just 13 years ago.</p>
            <p>What explains the collapse? Multiple forces have converged. Standardised plain packaging, introduced in 2017, removed the marketing power of branded cigarette packs. Annual tobacco tax rises have made smoking an increasingly expensive habit — a 20-pack now costs over £14. Workplace smoking bans, introduced in England in 2007, denormalised smoking as a social activity. NHS Stop Smoking Services, at their peak in the early 2010s, supported hundreds of thousands of quit attempts each year. And the rise of vaping from around 2012 onwards created a less harmful substitute for existing smokers seeking to quit.</p>
            <p>Vaping's role deserves nuance. By 2024, more adults vape (5.4 million) than smoke cigarettes (4.9 million) in England — a remarkable inversion. Public Health England's evidence review consistently found vaping around 95% less harmful than smoking. For existing smokers, switching is unambiguously better. The concern is uptake among young people who have never smoked. Youth vaping increased significantly between 2021 and 2023, though more recent data suggests rates are stabilising. The introduction of the Tobacco and Vapes Bill, which will prohibit the sale of tobacco products to anyone born after 2009, aims to build on existing progress and reach the Smokefree 2030 target.</p>
            <p>The health implications of declining smoking are already visible. Lung cancer mortality has fallen significantly — lung cancer in men has roughly halved since the 1990s. Cardiovascular disease deaths continue their long downward trend, with reduced smoking being a major contributing factor. COPD hospital admissions are declining. The full dividend of today's lower smoking rates will compound over decades: the diseases caused by smoking take 20–30 years to manifest, meaning the benefit of the cohort now entering adulthood as non-smokers will still be felt in 2050. This is a success story with a very long tail.</p>
          </div>
        </section>
