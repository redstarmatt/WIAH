    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Court fee income reached &pound;780 million in 2023/24, with some civil court fees over &pound;10,000. The number of civil claims issued has fallen 40% since 2010 fee increases. Fee remissions protect the poorest, but middle-income earners are priced out."
          colour="#6B7280"
        />
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              HMCTS is expected to be &ldquo;financially sustainable&rdquo; through fee recovery &mdash; a policy that has fundamentally reshaped who can access civil justice. Fees for high-value claims exceed &pound;10,000 at issue alone, and multiple hearing fees can add substantially to that. Employment tribunal fees &mdash; introduced in 2013 and struck down by the Supreme Court in 2017 as an unlawful restriction on access to justice &mdash; caused a 70% collapse in claims during their four-year existence. That case established a precedent: fees at a level that prevents ordinary people from exercising their legal rights are unconstitutional.
            </p>
            <p>
              Civil claims issued annually have fallen from 2.2 million in 2010 to 1.3 million in 2024 &mdash; a 40% decline against a backdrop of population growth and rising disputes. Legal aid reforms under the Legal Aid, Sentencing and Punishment of Offenders Act 2012 simultaneously removed eligibility for most civil legal advice, meaning many people face court costs without representation. The Help with Fees scheme (EX160) provides remissions for those on qualifying benefits or low incomes, with 600,000 remissions granted in 2024. But the income thresholds have not been uprated with inflation, and the majority of working people who cannot afford court fees do not qualify for help. The justice gap is widest for employment, housing, family and debt disputes affecting working and middle-income households.
            </p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-overview" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="2023/24 &middot; Courts as revenue generators, not public service"
            ...
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="Down 40% from 2010 peak &middot; Fee hikes suppressing access to justice"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Qualifying low-income claimants &middot; Middle income earners excluded"
        ...
        <ScrollReveal>
          <section id="sec-income" className="mb-12">
            <LineChart
              title="Civil court fee income, England and Wales, 2015&ndash;2024"
        ...
        <ScrollReveal>
          <section id="sec-claims" className="mb-12">
            <LineChart
              title="Civil claims issued and fee remissions granted, 2010&ndash;2024"
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            source="Source: HMCTS &mdash; Online civil money claims service statistics 2024. Access to Justice Foundation &mdash; Annual report 2023."
          />
        </ScrollReveal>
