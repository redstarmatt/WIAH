      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>An estimated 944,000 people live with dementia in the UK, yet only around 64% have a formal diagnosis &mdash; below the NHS target of 67% and a figure that has barely moved in a decade despite successive Prime Ministers&rsquo; Dementia Challenges. COVID-19 caused diagnosis rates to fall sharply as GP access contracted, and they have not fully recovered. Without a diagnosis, people with dementia cannot access specialist support, carers cannot access carer services, and the risk of avoidable hospital admissions and safeguarding incidents rises substantially. Post-diagnostic support is equally patchy: in principle a diagnosis triggers a named care coordinator, personalised care plan, and regular review; in practice 40% of people with dementia report receiving no structured support after diagnosis, reflecting both NHS memory service resource constraints and inconsistent ICS commissioning.</p>
            <p>Carers bear the invisible cost of these gaps. Around 700,000 people in the UK care for someone with dementia, providing an estimated 1.34 billion hours of unpaid care annually &mdash; more hours per person than carers of any other condition group. Carer support services &mdash; respite, Admiral Nurses, support groups &mdash; are inconsistently available and significantly underfunded. As dementia progresses, most people move into residential or nursing care funded through means-testing that depletes accumulated wealth before state support begins, while CQC inspections consistently identify inadequate dementia training and inappropriate antipsychotic use in care home settings.</p>
          </div>
        </section>
