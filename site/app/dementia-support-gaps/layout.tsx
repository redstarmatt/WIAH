...
export const metadata: Metadata = {
  ...
  description: 'Just 64% of people with dementia receive a formal diagnosis &mdash; and 40% get no structured post-diagnostic support, despite the Prime Minister&rsquo;s Dementia Challenge.',
  openGraph: {
    title: 'Are People with Dementia Getting the Care They Need?',
    description: 'Just 64% of people with dementia receive a formal diagnosis &mdash; and 40% get no structured post-diagnostic support, despite the Prime Minister&rsquo;s Dementia Challenge.',
    type: 'article',
