    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Only 49% of English homes have an EPC rating of C or above, against a target of 100% by 2035. Heat pump installations reached 72,000 in 2024 &mdash; less than 12% of the 600,000 per year needed to meet net zero targets."
          colour="#2A9D8F"
        />
