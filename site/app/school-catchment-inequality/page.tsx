    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The most popular state schools have average house prices within their catchment areas that are &pound;40,000 higher than the surrounding neighbourhood. FSM eligibility at oversubscribed schools is 40% below local averages."
          colour="#2A9D8F"
        />
        ...
        <ScrollReveal>
          <section id="sec-premium" className="mb-12">
            <LineChart
              title="House price premium within top-rated school catchments, England, 2015&ndash;2024"
        ...
        <ScrollReveal>
          <section id="sec-appeals" className="mb-12">
            <LineChart
              title="School admissions appeals upheld in favour of parents, England, 2019&ndash;2024"
