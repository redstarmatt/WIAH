...
const editorialRefs: Reference[] = [
  ...
  { num: 3, name: 'DWP', dataset: 'Universal Credit uplift impact research', url: 'https://www.gov.uk/government/publications/universal-credit-research-and-analysis', date: '2022' },
  { num: 4, name: 'Institute for Fiscal Studies', dataset: 'Two-child limit poverty impact analysis', url: 'https://ifs.org.uk/publications/two-child-limit-welfare-cap', date: '2024' },
];
