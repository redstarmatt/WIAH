...
const editorialRefs: Reference[] = [
  ...
  { num: 3, name: 'Carers UK', dataset: 'State of Caring Survey 2024', url: 'https://www.carersuk.org/policy-and-research/state-of-caring/', date: '2024' },
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              Behind every statistic about NHS waiting lists, social care shortages, and an ageing population stands an invisible army: the unpaid carers who hold Britain together. The 2021 Census recorded 5.0 million unpaid carers in England and Wales — a figure widely regarded as an undercount, since many people do not recognise what they do as &ldquo;caring.&rdquo;<Cite nums={1} /> Carers UK estimates the true number closer to 5.8 million, meaning roughly one in nine adults provides some form of regular unpaid care to a family member, partner, friend, or neighbour who is older, disabled, or seriously ill.<Cite nums={2} /> Around 1.5 million of these carers provide 50 or more hours of care per week — the equivalent of a gruelling full-time job, for which the state offers Carer&rsquo;s Allowance at just £81.90 per week, one of the lowest benefits in the social security system and less than £2 an hour for those providing round-the-clock care.<Cite nums={4} />
            </p>
            <p>
