...
const editorialRefs: Reference[] = [
  ...
  { num: 3, name: 'Illegal Money Lending Teams / Centre for Responsible Credit', dataset: 'Annual Report', date: '2024', note: 'Estimated 1.1 million people using illegal lenders', url: 'https://www.gov.uk/government/groups/illegal-money-lending-project-steering-group' },
];
