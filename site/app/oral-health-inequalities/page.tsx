      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              Oral health is one of the starkest markers of inequality in England. A child growing up in Blackpool, Knowsley, or Tower Hamlets is roughly three times as likely to arrive at school with visible tooth decay as a child in Hart, Waverley, or the Cotswolds. This is not a new problem. The ratio has hovered around 3:1 for over a decade, surviving multiple government strategies, dental contract reforms, and a pandemic that made everything worse. The gap is not narrowing because the structural drivers — poverty, diet, lack of fluoridated water, and a disintegrating NHS dental service — remain largely unaddressed. Only around 9% of England's population receives fluoridated water, compared with over 70% in the United States and nearly all of the Republic of Ireland. The Health and Care Act 2022 gave the Secretary of State powers to expand fluoridation schemes, but no new schemes have been commissioned.
            </p>
            <p>
              The adult picture is equally bleak. In 2012, 14% of adults reported being unable to access an NHS dentist when they needed one. By 2025, that figure had risen to 43% — a tripling in just over a decade. The cause is straightforward: NHS dentistry is funded through Units of Dental Activity (UDAs), a contract system introduced in 2006 that dentists and professional bodies have consistently described as unfit for purpose. It incentivises volume over prevention, pays dentists significantly less than private work, and has driven a steady exodus from NHS practice. England has lost nearly 5,000 NHS dentists since 2012, a decline of roughly 19%. The 2022 contract reform made modest improvements to UDA values but fell far short of the fundamental restructuring the sector has demanded. Patients in coastal towns, rural areas, and deprived urban communities are disproportionately affected — dental deserts where no NHS dentist is accepting new patients now cover large parts of the country.
            </p>
            <p>
              Perhaps the most damning statistic is that tooth extraction under general anaesthetic remains the most common reason for hospital admission among children aged five to nine in England. Around 41,500 children were admitted in 2024/25 for the removal of decayed teeth — a procedure that is almost entirely preventable with basic oral hygiene, reduced sugar consumption, and access to routine dental check-ups. The pandemic drove extraction numbers down temporarily as elective procedures were halted, but they have since climbed back towards pre-pandemic levels. Each admission costs the NHS an estimated 800 pounds, represents a day of school missed, and carries the small but real risks of general anaesthesia for a young child. This is not a failure of individual parenting. It is a failure of public health infrastructure that allows preventable disease to concentrate in communities that already bear the greatest burden of deprivation.
            </p>
          </div>
        </section>
