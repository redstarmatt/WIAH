      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>EV market statistics require careful contextualisation. The headline new car registration share &mdash; 16.5% &mdash; measures vehicles sold rather than vehicles on the road. Because cars are used for 10&ndash;15 years, the BEV share of the total licensed fleet is far lower at around 4%. The ZEV mandate percentages represent minimum requirements for manufacturers, not targets for the overall market, and manufacturers can trade credits between themselves. &ldquo;Charge point&rdquo; statistics count devices, not sockets or power output &mdash; a single unit with four plugs counts as one charge point in some datasets and four in others, creating inconsistency between sources. The comparison of UK EV adoption to Norway is somewhat misleading: Norway uses very different fiscal incentives including full VAT exemption on EVs (reducing the price by 25%) and free motorway tolls, which are not available or politically viable in the UK. Battery cost projections carry wide uncertainty ranges; the &pound;60/kWh crossover point depends on assumptions about the rate of progress in chemistry and manufacturing scale that may or may not be realised by 2030.</p>
          </div>
        </section>
