    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="EVs took 16.5% of new car sales in 2023, but public charging infrastructure is insufficient — just 1 charger per 54 EVs, against a target of 1 per 10. The 2030 petrol ban may slip to 2035, and range anxiety and upfront cost remain the top barriers for most buyers."
          colour="#2A9D8F"
        />

        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The UK's electric vehicle transition has accelerated rapidly since 2020. Battery electric vehicles (BEVs) took just 0.5% of new car sales in 2018; by 2023 that figure had risen to 16.5%, driven by an expanding model range, falling battery costs, and the government's Zero Emission Vehicle (ZEV) mandate — which requires manufacturers to sell a rising proportion of zero-emission vehicles, starting at 22% in 2024 and rising to 80% by 2030. The UK ranks in the global top five for EV adoption by new car share, alongside Norway, Germany, France, and the Netherlands. Battery costs, which determine the upfront price premium of EVs over equivalent petrol cars, have fallen from over £1,000 per kilowatt-hour in 2010 to around £100/kWh in 2024 — a 90% reduction in real terms — and are expected to reach £60–70/kWh by 2030, the level at which EVs become cost-competitive at the point of purchase without subsidy. Over a vehicle's lifetime, EVs are already cheaper than petrol equivalents at current electricity and petrol prices when home charging is available.</p>
            <p>The charging infrastructure gap is the most pressing barrier to mass adoption. The UK had around 58,000 public charge points at the start of 2024 — but with approximately 1.1 million BEVs on the road, that is one public charger per 54 EVs, well short of the government's own target of one per ten. The Automated and Electric Vehicles Act 2018 required all publicly accessible fuel stations to install rapid chargers, but enforcement has been slow. In January 2024, new regulations came into force requiring charge points at all new non-residential buildings with more than ten car parking spaces — an important long-term reform, but with limited short-term impact. The distribution of charge points is uneven: London has the highest density, while rural areas and deprived urban communities have fewer chargers per EV than the national average. Motorway service stations have improved significantly — all major operators now offer at least six rapid chargers — but many smaller A-road services have none. Reliability remains a concern: Which? mystery shopping found around 10% of charge point visits resulted in a failure to charge successfully.</p>
            </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              source="SMMT — New car registrations by fuel type"
              href="#sec-share"
            />
            <MetricCard
              label="Public charge points"
              ...
              source="DESNZ — EV charging infrastructure statistics"
              href="#sec-share"
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="Target: 10 per charger — gap widening as EVs outpace charger rollout"
