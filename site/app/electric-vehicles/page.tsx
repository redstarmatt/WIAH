      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The UK&apos;s electric vehicle transition has accelerated rapidly since 2020. Battery electric vehicles (BEVs) took just 0.5&percnt; of new car sales in 2018; by 2023 that figure had risen to 16.5&percnt;, driven by an expanding model range, falling battery costs, and the government&apos;s Zero Emission Vehicle (ZEV) mandate &mdash; which requires manufacturers to sell a rising proportion of zero-emission vehicles, starting at 22&percnt; in 2024 and rising to 80&percnt; by 2030. The UK ranks in the global top five for EV adoption by new car share, alongside Norway, Germany, France, and the Netherlands. Battery costs, which determine the upfront price premium of EVs over equivalent petrol cars, have fallen from over &pound;1,000 per kilowatt-hour in 2010 to around &pound;100/kWh in 2024 &mdash; a 90&percnt; reduction in real terms &mdash; and are expected to reach &pound;60&ndash;70/kWh by 2030, the level at which EVs become cost-competitive at the point of purchase without subsidy. Over a vehicle&apos;s lifetime, EVs are already cheaper than petrol equivalents at current electricity and petrol prices when home charging is available.</p>
            <p>The charging infrastructure gap is the most pressing barrier to mass adoption. The UK had around 58,000 public charge points at the start of 2024 &mdash; but with approximately 1.1 million BEVs on the road, that is one public charger per 54 EVs, well short of the government&apos;s own target of one per ten. The Automated and Electric Vehicles Act 2018 required all publicly accessible fuel stations to install rapid chargers, but enforcement has been slow. In January 2024, new regulations came into force requiring charge points at all new non-residential buildings with more than ten car parking spaces &mdash; an important long-term reform, but with limited short-term impact. The distribution of charge points is uneven: London has the highest density, while rural areas and deprived urban communities have fewer chargers per EV than the national average. Motorway service stations have improved significantly &mdash; all major operators now offer at least six rapid chargers &mdash; but many smaller A-road services have none. Reliability remains a concern: Which? mystery shopping found around 10&percnt; of charge point visits resulted in a failure to charge successfully.</p>
            <p>Government policy on EVs has faced accusations of inconsistency. The original 2030 petrol and diesel ban was weakened in September 2023 when the government extended it to 2035 for some vehicle types and allowed hybrids until 2035, introducing uncertainty into manufacturer planning cycles and consumer confidence. The Plug-in Car Grant, which provided up to &pound;2,500 toward the purchase of a new BEV, was abruptly ended in June 2022 with 24 hours&apos; notice, removing the only direct consumer subsidy. The company car tax regime has been used as an alternative demand signal: BEVs attract a 2&percnt; Benefit-in-Kind rate versus 20&ndash;37&percnt; for petrol cars, making EVs significantly more attractive for fleet purchasers. Around 50&percnt; of new EV registrations are fleet rather than private, suggesting that individual consumer uptake is slower than headline figures imply and that the transition is concentrated among higher-income households with access to home charging.</p>
            <p>The geography of EV adoption in the UK follows socioeconomic lines closely. Adoption is highest in London and the South East &mdash; where incomes are higher, home ownership rates support home charger installation, and urban air quality concerns are most acute. Scotland has benefited from the Scottish Government&apos;s ChargePlace Scotland network, which provides over 4,500 charge points nationwide. Wales and Northern Ireland lag the most &mdash; partly due to older housing stock less suited to home charger installation, and partly due to lower average incomes reducing the attractiveness of higher-upfront-cost vehicles. The Midlands and North of England have seen faster growth in EV adoption since 2022 as the model range has expanded to include smaller, cheaper vehicles, but still sit below the national average. Rural communities face a particular double bind: longer journeys create greater need for good charging infrastructure, yet market economics make rural charging less profitable to install.</p>
            <p>EV market statistics require careful contextualisation. The headline new car registration share &mdash; 16.5&percnt; &mdash; measures vehicles sold rather than vehicles on the road. Because cars are used for 10&ndash;15 years, the BEV share of the total licensed fleet is far lower at around 4&percnt;. The ZEV mandate percentages represent minimum requirements for manufacturers, not targets for the overall market, and manufacturers can trade credits between themselves. &ldquo;Charge point&rdquo; statistics count devices, not sockets or power output &mdash; a single unit with four plugs counts as one charge point in some datasets and four in others, creating inconsistency between sources. The comparison of UK EV adoption to Norway is somewhat misleading: Norway uses very different fiscal incentives including full VAT exemption on EVs (reducing the price by 25&percnt;) and free motorway tolls, which are not available or politically viable in the UK. Battery cost projections carry wide uncertainty ranges; the &pound;60/kWh crossover point depends on assumptions about the rate of progress in chemistry and manufacturing scale that may or may not be realised by 2030.</p>
          </div>
        </section>
