      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-overview" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-good"
              changeText="2024 · Down from 4.93M peak in 2019 · 700K left during COVID · Most have not returned"
            ...
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-good"
              changeText="2024 · Employees: £535/wk · 42% earnings gap · 1 in 3 below Living Wage hourly"
            ...
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-good"
              changeText="2024 · Employees: 79% · Auto-enrolment does not apply · Major retirement income risk"
        ...
        <ScrollReveal>
          <section id="sec-count" className="mb-12">
            <LineChart
              title="Self-employed workers, UK, 2015–2024"
        ...
        <ScrollReveal>
          <section id="sec-income" className="mb-12">
            <LineChart
              title="Median weekly earnings, self-employed, UK, 2015–2024"
              subtitle="Self-reported median weekly income from self-employment (£). Includes both full-time and part-time self-employed."
              series={incomeSeries}
              yLabel="£ per week"
              source={{
                name: 'ONS',
