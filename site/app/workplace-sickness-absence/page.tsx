    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Average sickness absence has risen to 9.4 days per worker per year — up from 5.8 days before the pandemic. Mental health conditions now account for 41% of all long-term absence, making them the single largest cause. The cost to the UK economy has reached an estimated £32 billion annually."
          colour="#E63946"
        />

        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Something broke during the pandemic and never mended. Before COVID-19, sickness absence in the UK had been on a long, slow decline for over a decade, reaching a low of 5.5 days per worker in 2020. By 2024, that figure had nearly doubled. The surge is not simply a matter of lingering COVID infections — though long COVID has contributed, accounting for around 6% of absence in 2024. The deeper story is about mental health. Stress, anxiety, and depression now account for 41% of all long-term sickness absence, up from 21% in 2015. The CIPD's annual Health and Wellbeing at Work survey found that two-thirds of employers reported an increase in mental health-related absence since 2020, with younger workers disproportionately affected. Burnout, workload pressures, and the erosion of boundaries between work and home life during the remote-working era have all played a role.</p>
            <p>The gap between the public and private sectors has widened significantly. Public sector workers now lose an average of 12.2 days per year to sickness, compared with 7.5 in the private sector. The NHS is both cause and symptom: health service staff have some of the highest absence rates in the economy, driven by chronic understaffing, emotional exhaustion, and exposure to trauma. But the pattern extends across local government, education, and the civil service. ONS data shows that the public-private gap, which stood at around 2.7 days in 2019, has now widened to 4.7 days. Part of this reflects better sick pay provisions in the public sector — workers can actually afford to be off when they are ill — but part reflects genuinely worse working conditions in stretched public services.</p>
            <p>The economic consequences are substantial. The CBI estimates that sickness absence costs the UK economy approximately £32 billion per year in lost output, employer costs, and health spending. More troublingly, rising sickness absence is feeding directly into economic inactivity: around 2.8 million working-age adults are now out of the labour force due to long-term sickness, the highest figure on record. This is not just a workplace issue — it is a macroeconomic drag. Meanwhile, presenteeism — people attending work while unwell, often because they cannot afford statutory sick pay of just £116.75 per week — costs an estimated further £24 billion annually in reduced productivity. The UK's sick pay system remains one of the least generous in Europe, creating a perverse incentive structure where workers either cannot afford to recover properly or push through illness to the detriment of everyone around them.</p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            value="Fit for Work"
            description="The government's occupational health reforms aim to address the root causes of rising absence. The expanded Fit for Work programme now offers early intervention for employees at risk of long-term sickness, with pilot schemes in 12 regions showing a 15% reduction in absence duration where occupational health support was provided within the first two weeks. The CIPD reports that organisations with dedicated mental health first aiders and employee assistance programmes see 30% lower mental health-related absence. A growing body of evidence supports investing in prevention: every £1 spent on workplace mental health interventions returns an estimated £5 in reduced absence, lower presenteeism, and improved retention. Mandatory occupational health provision for all employers, currently under consultation, could represent the most significant workplace health reform in a generation."
