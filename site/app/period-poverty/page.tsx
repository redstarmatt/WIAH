      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Period poverty &mdash; the inability to afford or access period products &mdash; affects a substantial minority of young people in the UK, and the evidence suggests it has worsened. In 2017 Plan International estimated that 1 in 10 girls aged 14&ndash;21 had struggled to afford period products in the previous year; by 2023 that figure had risen to 1 in 5. The cost-of-living crisis is the proximate cause of that increase, but the underlying conditions &mdash; low household income, benefit levels that do not track the real cost of essentials, and the absence of consistent free provision &mdash; were already in place.</p>
            <p>The educational consequences are not trivial. Plan International estimated in 2017 that around 137,000 girls missed school because of period poverty &mdash; using improvised alternatives, staying home, or simply being unable to manage adequately in school environments that lacked adequate provision or privacy. Period shame compounds the practical barrier: in surveys, 52% of those experiencing period poverty said they did not know help was available, and 38% cited embarrassment as a reason for not seeking it. The average monthly cost of period products is estimated at around &pound;13 &mdash; modest in isolation but significant across a year for households already rationing essentials.</p>
            <p>Policy responses have been uneven. Scotland passed the Period Products (Free Provision) Act in 2021, the first legislation in the world to establish a legal right to free period products in public buildings, including schools, colleges, and local authority premises. Uptake in Scottish schools is effectively universal. England launched its Period Products Scheme in January 2021, providing free products to state schools and colleges through a central procurement arrangement &mdash; but participation is voluntary, and by 2023 only around 63% of eligible institutions were actively participating. Some schools and colleges still charge for products despite the scheme. The gap between availability and actual use is wider still: stigma means that even where products are available, many pupils do not access them.</p>
            <p>The problem is sharpest at the margins. Girls in areas of high deprivation, care-experienced young people, asylum seekers in Home Office accommodation, and people in the prison and homeless populations face the most acute shortfalls, with the least consistent provision. The abolition of VAT on period products &mdash; the so-called tampon tax, cut from 5% to zero on 1 January 2021 &mdash; reduced average product costs modestly, but the savings are small relative to the affordability gap for the lowest-income households.</p>
            <p>Awareness of the issue has grown substantially since 2017, and the expansion of period product banks run by charities, food banks, and community organisations represents a genuine improvement in informal provision. But what the data cannot capture is the full scale of quiet, invisible management: the lessons missed without a formal absence record, the improvised alternatives used to avoid asking for help, or the accumulated educational disruption across years of inadequate access. Survey estimates rely on self-reporting a stigmatised experience, which means the figures are more likely to understate the problem than overstate it.</p>
          </div>
        </section>
