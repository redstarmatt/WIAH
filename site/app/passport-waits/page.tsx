      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Before the pandemic, getting a British passport was unremarkable: you applied online or by post, waited roughly three weeks, and it arrived. That system broke in 2021-22 when millions of people whose passports had expired during lockdown — alongside the normal renewal cycle — applied simultaneously. HM Passport Office received 7 million applications in 2022, around 2 million above the normal annual volume. The backlog peaked at 550,000 unprocessed applications in summer 2022, with average processing times reaching 15 weeks. People missed holidays, business trips, and family emergencies abroad. The government responded by hiring: staff numbers rose from 4,000 to 5,800, and the Passport Office shifted to seven-day working. But many of the new staff were agency workers on short contracts, and turnover was high — training takes months, and experienced caseworkers cannot easily be replaced. PCS union strikes in spring and summer 2023, over pay and conditions, compounded delays further. The cost of a standard adult passport rose from £72.50 to £88.50 in February 2023, a 22% increase that drew criticism given the service failures. Fast-track (one week, £177) and premium (same day, £212) services — designed as a pressure valve — were themselves regularly suspended during peak months because the Passport Office lacked the capacity to deliver them.</p>
            <p>The system has improved but not recovered. Average processing times in 2025 sit at around 6-7 weeks — better than the crisis peak but still double the pre-pandemic norm of three weeks. Children's passports, which require additional checks, routinely take 10 weeks or more. Digital applications now account for 75% of all submissions, up from 20% before the pandemic, but the online system has crashed under peak demand on multiple occasions, forcing applicants back to paper forms. The fast-track service remains unreliable in summer months: in 2022, it was available for only 35% of summer weeks. International comparisons are unflattering — many EU countries process standard applications in 2-3 weeks, and several have fully digital end-to-end systems that the UK has not yet matched. The fundamental problem is structural: HMPO's capacity was sized for a steady-state world of 5 million applications per year, and it has not yet been permanently rebuilt for the volatility and volume spikes that post-pandemic travel patterns produce. For the roughly 50 million British passport holders, the question is not whether the crisis is over — it is whether the system can cope the next time demand surges.</p>
          </div>
        </section>
