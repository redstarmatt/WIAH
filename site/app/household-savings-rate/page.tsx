...
export default function HouseholdSavingsRatePage() {
  ...
  const chartAnnotations: Annotation[] = [
    ...
    { date: new Date(2022, 0, 1), label: '2022: Cost-of-living · drawdown' },
  ];
    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The UK household savings ratio has fallen to 8.9% — below the long-run norm of 6.5%, with the COVID-era peak of 25.9% fully reversed. 24% of households have no savings at all, up from 20% in 2019."
          colour="#F4A261"
          preposition="with"
        />
        ...
        <ScrollReveal>
          <section className="mb-12">
            <LineChart
              title="Households with no savings (%), UK"
              ...
              yLabel="Households with no savings (%)"
              source={{
                name: 'ONS',
                dataset: 'Households with no savings (%)',
                frequency: 'annual',
        ...
        <section className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid font-mono space-y-2">
            <div className="space-y-2"><p><a href="https://www.ons.gov.uk/economy/grossdomesticproductgdp/datasets/unitedkingdomeconomicaccounts" target="_blank" rel="noopener noreferrer" className="text-wiah-blue hover:underline">ONS</a> — primary data source. Retrieved Dec 2023.</p><p>All figures are for England unless otherwise stated. Trend data uses the most recent available release at time of publication.</p></div>
          </div>
        </section>
      </main>
    </>
