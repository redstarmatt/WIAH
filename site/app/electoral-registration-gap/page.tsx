      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText="unchanged for decade · IVR system not working"
              sparklineData={[7.5, 7.8, 8.0, 8.1, 8.0]}
              href="#sec-chart"source="Electoral Commission · Annual Report 2023"
            />
            <MetricCard
              ...
              href="#sec-chart"source="Electoral Commission · 2023"
            />
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText="lower registration among minority communities · BAME 11pp below White"
              sparklineData={[11, 11, 11, 11, 11]}
              href="#sec-chart"source="Electoral Commission · Diversity Report 2023"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Electoral registration gap, 2015–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Electoral Commission — UK Electoral Registers. Annual publication of registration statistics. electoralcommission.org.uk/research-and-reports/electoral-data</p>
            <p>Electoral Commission — Diversity and Representation. Research into barriers to registration by demographic group. electoralcommission.org.uk</p>
