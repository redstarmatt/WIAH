      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The stillbirth rate in England has fallen from 5.1 per 1,000 births in 2010 to 3.53 in 2022 &mdash; a 31% reduction that represents one of the most significant improvements in perinatal safety of the past generation. This progress was not accidental. The Saving Babies&rsquo; Lives Care Bundle, introduced in 2016 and updated in 2019, standardised four key practices: enhanced foetal movement monitoring, reduced smoking in pregnancy, better foetal growth surveillance, and term induction policies. The results have been measurable and sustained.</p>
            <p>The picture on maternal mortality is far more troubling. The UK maternal mortality rate, at 9.7 deaths per 100,000 maternities in 2019&ndash;21, has barely changed in a decade. More starkly, Black women in the UK are 3.7 times more likely to die during or shortly after pregnancy than white women. Asian women are 1.8 times more likely. These disparities were first documented in MBRRACE-UK reports over 20 years ago; they have not narrowed. The factors driving them &mdash; differential access to care, unconscious bias in clinical decision-making, higher rates of underlying conditions, socioeconomic disadvantage &mdash; are known but have not been systematically addressed.</p>
            <p>Birth trauma is an underreported dimension of maternity safety. Studies suggest that around 1 in 5 women experience birth as traumatic, and approximately 4% develop full PTSD following childbirth. The NHS has historically focused maternity safety on mortality and morbidity outcomes; birth trauma, while harder to measure, has a profound and lasting impact on maternal mental health, bonding, and breastfeeding rates. The Birth Trauma Association estimates that 30,000 women a year develop PTSD after childbirth in the UK.</p>
            <p>The Ockenden Review, published in 2022, examined maternity services at Shrewsbury and Telford NHS Trust and found that hundreds of babies and a number of mothers died or were seriously harmed over 20 years due to substandard care. Its findings &mdash; failure to escalate, failure to listen to women, systemic cultural problems &mdash; prompted a major national inquiry into maternity safety. The subsequent Donna Ockenden national review found similar patterns across multiple trusts, with consistent themes of understaffing, inadequate monitoring, and failure to involve women in decision-making.</p>
            <p>NHS England&rsquo;s three ambitions for maternity safety &mdash; to halve the rates of stillbirth, neonatal death, maternal death, and brain injury by 2025 (using 2010 as baseline) &mdash; have been partially met for stillbirths but not for maternal mortality. Progress on perinatal brain injury and neonatal mortality has been slower than planned, and the ethnic disparity in maternal outcomes remains the most significant unresolved failure in NHS maternity care.</p>
          </div>
        </section>
