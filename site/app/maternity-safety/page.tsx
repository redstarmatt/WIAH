    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The stillbirth rate has halved since 2010 to a record low of 3.53 per 1,000 births. But Black women are 3.7 times more likely to die in childbirth than white women — a disparity that has not improved in 20 years."
          colour="#F4A261"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="Record low · down from 5.1 in 2010 · target 1.6 by 2025"
              sparklineData={[5.1, 4.9, 4.7, 4.4, 4.2, 4.0, 3.8, 3.7, 3.53]}
              href="#sec-stillbirth"source="MBRRACE-UK · 2022"
            />
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText="Stubbornly high · slight uptick in 2019–21 period"
              sparklineData={[10.1, 9.6, 9.7, 8.79, 9.7]}
              href="#sec-ethnicity"source="MBRRACE-UK · 2019–21"
            />
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText="Unchanged for 20 years · BAME maternal mortality gap persistent"
              sparklineData={[3.5, 3.7, 3.8, 3.7, 3.7, 3.8, 3.7, 3.7, 3.7]}
              href="#sec-ethnicity"source="MBRRACE-UK · 2021"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-stillbirth" className="mb-12">
            <LineChart
              title="Stillbirth rate, England &amp; Wales, 2010–2022"
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            value="&minus;31%"
            unit=""
            description="The stillbirth rate has fallen by 31% since 2010 — driven by better monitoring, earlier induction policies, and the Saving Babies&rsquo; Lives Care Bundle introduced in 2016. This represents one of the most significant improvements in perinatal safety in a generation."
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>MBRRACE-UK — Mothers and Babies: Reducing Risk through Audits and Confidential Enquiries across the UK. Perinatal Mortality Surveillance Report and Saving Lives, Improving Mothers&rsquo; Care. npeu.ox.ac.uk/mbrrace-uk</p>
            <p>NHS England — Saving Babies&rsquo; Lives Care Bundle. Version 2 published 2019. england.nhs.uk/mat-transformation/saving-babies</p>
