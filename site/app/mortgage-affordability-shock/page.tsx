      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Between 2009 and 2021, the Bank of England base rate sat at or near 0.1&percnt;, with the best fixed-rate mortgage deals available below 1.5&percnt;. Beginning in December 2021, the Bank raised rates fourteen consecutive times to 5.25&percnt; by August 2023; average new mortgage rates crossed 5.5&percnt;, a near-fourfold increase. Mortgage payments for new buyers now consume 41&percnt; of average take-home pay &mdash; up from 28&percnt; in 2015 and approaching early 1990s levels &mdash; translating to monthly payment increases of &pound;600&ndash;&pound;700 on a &pound;250,000 mortgage compared to the low-rate era. Approximately 800,000 households came off fixed-rate deals in 2023&ndash;24, transitioning from sub-2&percnt; to rates above 5&percnt;, with an average payment shock estimated at around &pound;300 per month. Mortgage arrears and possessions have risen from a low base, though lender forbearance under the FCA&apos;s Mortgage Charter has delayed some of the distress appearing in formal statistics.</p>
