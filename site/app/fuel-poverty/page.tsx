      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The health consequences of living in a cold home are severe and well-documented, yet persistently undertreated as a policy priority. Cardiovascular disease risk rises sharply when indoor temperatures fall below 18&deg;C, respiratory conditions including asthma and chronic obstructive pulmonary disease worsen, and mental health deteriorates through a combination of physical discomfort, financial stress, and social isolation. An estimated 280,000 children in England live in consistently cold homes, with evidence linking cold housing exposure in childhood to poorer educational outcomes and higher rates of respiratory illness into adulthood. Excess winter mortality is overwhelmingly concentrated among those aged 75 and over, driven by hypothermia and cardio-respiratory failure &mdash; yet the UK&apos;s excess winter mortality ratio remains higher than those of Norway and Sweden, countries with far harsher climates but dramatically better-insulated housing stock. The NHS bears an estimated &pound;1.36 billion annual cost from cold-housing-related illness, and there is robust evidence that every &pound;1 invested in home insulation saves approximately &pound;1.80 in reduced health service demand. The burden falls most heavily on the most deprived communities, which face a triple penalty: the worst housing stock, the lowest incomes, and the least capacity to fund energy efficiency improvements. EPC band F and G properties &mdash; the coldest and least efficient &mdash; are disproportionately concentrated in rural and coastal communities where both retrofit supply chains and support services are thinnest.</p>
            <p>Fuel poverty statistics in the UK are fractured by geography and methodology, making consistent cross-national analysis effectively impossible. England uses the Low Income Low Energy Efficiency metric, which measures whether a household in an inefficient home would fall below the poverty line after modelled energy costs. Wales applies the Low Income High Cost model, and Scotland retains the older 10% of income threshold. Northern Ireland publishes separate estimates on a different cycle. There is no single, consistent UK-wide figure, and none of these measures fully captures lived experience. Official fuel poverty statistics carry a two-year lag, meaning the figures available in 2026 describe conditions in 2024. Energy Performance Certificate ratings, central to the LILEE methodology, are frequently inaccurate for older housing stock: an estimated 28% of EPCs are based on assessor estimates rather than physical surveys, and they do not account for occupant behaviour, heating system condition, or draught levels. Excess winter deaths attributed to cold housing are derived from epidemiological models with wide confidence intervals, not direct clinical records. Smart meter data could in principle provide real-time consumption evidence, but rollout remains incomplete and low-income households are significantly less likely to have functioning smart meters installed. The &ldquo;fuel poor&rdquo; designation itself relies on income estimates derived from benefit data that is often inaccurate, and standing charge costs &mdash; which have risen 45% &mdash; are not disaggregated by household type in official statistics.</p>
          </div>
        </section>
