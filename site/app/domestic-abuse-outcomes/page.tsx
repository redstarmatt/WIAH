      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Domestic abuse accounts for roughly one in five of all incidents attended by police in England and Wales &mdash; over 1.5 million calls per year. Yet only 9.8% result in prosecution: 91,000 prosecutions were initiated in 2023 against 1.5 million incidents recorded. The Domestic Abuse Act 2021 created the offence of controlling and coercive behaviour and introduced domestic abuse protection orders, but take-up of the new tools has been slow. Attrition between incident and prosecution happens at multiple stages: many victims do not support prosecution due to fear of retaliation, economic dependence, or distrust of the criminal justice system. Evidence-led prosecution &mdash; using body-worn camera footage, medical evidence, and 999 recordings without victim cooperation &mdash; has been developed but requires specialist resource not consistently deployed across forces. The court backlog, exceeding 65,000 Crown Court cases, means that charged perpetrators may wait over a year for trial, during which time victims remain at risk and frequently withdraw.</p>
            <p>The conviction rate for cases that do reach court is 77%, suggesting well-evidenced prosecutions generally succeed; the problem is the vast gap between incident and charge. Specialist domestic abuse courts, independent domestic violence advisers (IDVAs), and multi-agency risk assessment conferences have all demonstrated improved outcomes for victims and increased successful prosecutions. The evidence base is strong &mdash; the constraint is funding: IDVAs and specialist courts require sustained resource from local authorities and police and crime commissioners who are themselves under significant budget pressure, producing a system that absorbs enormous resource at the incident end while investing far less in the specialist capacity that would convert more of those calls into protection and accountability.</p>
          </div>
        </section>
