      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>England has lost more than 1,100 community pharmacies since 2015 &mdash; roughly one in ten of the entire network. The closures are not random. High-street pharmacies in deprived areas, the ones most heavily used by people who cannot easily travel or get online, have shut at the fastest rate. The cause is structural: NHS dispensing fees have been frozen in real terms since 2015, and a &pound;113 million funding cut in 2016 was never restored. The average community pharmacy now runs at a loss of around &pound;50,000 per year, and 90% of pharmacies told the Company Chemists&apos; Association in 2023 that they were in financial difficulty. Over the same period, the number of prescriptions dispensed rose from 1.02 billion to 1.2 billion &mdash; more work, less money, fewer outlets.</p>
            <p>The pressure is not evenly shared. Large multiples and supermarket pharmacies have proved more resilient; it is the independent, often family-run pharmacies that have closed. Online and distance-selling pharmacies now handle around 8% of prescriptions and continue to grow, which suits younger, healthier patients ordering repeat medication but does not replicate the walk-in consultation that community pharmacies provide. That consultation &mdash; free, no appointment, typically five minutes &mdash; is one of the most cost-effective interventions in primary care. Its erosion shifts demand back onto GP surgeries already under acute pressure.</p>
            <p>The Pharmacy First scheme, launched in January 2024, represented a belated attempt to formalise pharmacies&apos; role in the NHS. It authorises pharmacists to treat seven common conditions &mdash; including sinusitis, earache, shingles, and uncomplicated urinary tract infections in women &mdash; without a GP referral. In theory, the scheme could absorb up to 10% of GP appointments nationally. In practice, pharmacists report that the reimbursement rates do not cover the additional clinical time required, and that it has increased workload without adequate compensation. The gap between policy ambition and funding reality is the central tension in this data.</p>
            <p>There is genuine variation across the UK. Scotland has integrated pharmacies more formally into primary care, with pharmacists embedded in GP practices and salaried through NHS boards rather than depending solely on dispensing income. Wales and Northern Ireland operate under different funding structures and have seen smaller proportional losses. England&apos;s model remains the most commercially exposed, and therefore the most vulnerable to the economics of the past decade. Expanded pharmacist prescribing rights &mdash; now covering a wider range of conditions &mdash; represent a real expansion of the profession&apos;s clinical role, but prescribing rights are worth little without a viable network of pharmacies in which to exercise them.</p>
            <p>What the data cannot tell us is how much unmet need the closures have created. When a pharmacy closes, patients do not always go elsewhere &mdash; some simply go without advice, delay collecting prescriptions, or seek care later in the pathway at greater cost. The NHS has no systematic way of counting the consultations that never happen. Nor does the data capture quality: a stressed, understaffed pharmacy dispensing at volume is counted the same as one offering full clinical services. The headline closure number understates what has been lost.</p>
          </div>
        </section>
        ...
        <div id="sec-overview" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          <MetricCard
            ...
            onExpand={pharmacyCountSeries.length > 0 ? () => setExpanded('pharmacy-count') : undefined}
          />
          <MetricCard
          ...
          <MetricCard
            ...
            onExpand={prescriptionVolumeSeries.length > 0 ? () => setExpanded('prescription-volume') : undefined}
          />
        </div>
        </ScrollReveal>
