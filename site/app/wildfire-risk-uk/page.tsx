    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="UK wildfires destroyed 9,756 hectares in 2023, three times the 2010&ndash;2020 average. The fire at Saddleworth Moor in 2018 cost &pound;120 million. Climate projections show a 50% increase in high fire-risk days by 2050."
          colour="#E63946"
        />
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              The UK is not typically associated with wildfire risk, but the combination of climate change, drought, land management practices, and moorland and peatland in close proximity to urban areas creates a risk profile that has materialised with increasing frequency. The 2018 Saddleworth Moor fire &mdash; which burned for weeks, required army assistance, and cost around &pound;120 million in response and economic impact &mdash; was a turning point in UK fire service planning. The 2021 spring wildfire season in Scotland destroyed over 12,000 hectares across multiple incidents. In July 2022, following the UK&rsquo;s first-ever 40&deg;C temperature reading, wildfires broke out across London and southern England, destroying homes in Wennington and other villages.
            </p>
            <p>
              The structural drivers are worsening. The number of days per year meeting Met Office criteria for high wildfire fire weather index has increased from an average of 12 in 2010&ndash;2020 to 16 in 2020&ndash;2024. Climate projections under mid-range scenarios suggest this could reach 24 by 2050 &mdash; a doubling from the pre-2020 baseline. Upland peatlands, which store centuries of carbon and act as natural fire breaks when wet, are degraded across large areas of England and Scotland, creating substantial fuel loads when dried by drought. The NFCC Wildfire Risk Register now covers 112 high-risk areas, but fire service capacity for large landscape fires &mdash; which require sustained multi-day responses &mdash; remains limited.
            </p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <section id="sec-area" className="mb-12">
            <LineChart
              title="Hectares burned by wildfires, UK, 2015&ndash;2023"
        ...
        <ScrollReveal>
          <section id="sec-incidents" className="mb-12">
            <LineChart
              title="Wildfire incidents, UK, 2015&ndash;2023"
        ...
        <ScrollReveal>
          <section id="sec-risk-days" className="mb-12">
            <div className="mb-4">
              <h3 className="text-lg font-bold text-wiah-black">High wildfire risk days per year &mdash; historical and projected</h3>
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            description="NFCC&apos;s Wildfire Risk Register now covers 112 high-risk areas with dedicated planning and resource pre-positioning. Fire and rescue services are updating their National Operational Guidance for wildfires to reflect landscape-scale fire tactics. Natural England&apos;s peatland restoration programme has restored over 60,000 hectares of blanket bog &mdash; wet peatland is far less susceptible to wildfire. Forestry Commission guidance now requires fire management plans for new woodland plantations in high-risk zones."
            source="Source: NFCC Wildfire Risk Register 2024 &middot; Met Office UKCP18 projections &middot; Natural England Peatland Programme."
          />
        </ScrollReveal>
