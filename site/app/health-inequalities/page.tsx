      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The NHS can treat the consequences of inequality but cannot address its causes, which are material: income, housing quality, employment conditions, and early childhood environment. NHS England&rsquo;s Core20PLUS5 framework targets the most deprived 20&percnt; across five clinical areas, but the health gap took decades to widen and will take decades to close even under optimistic scenarios. Public health spending fell 24&percnt; in real terms between 2015 and 2023, reducing the investment in prevention that could compress morbidity and narrow the gap. The burden of poor health falls heaviest on those least able to bear it &mdash; lower-income households face higher rates of long-term illness, are less likely to be in work, and draw more heavily on NHS and social care services at exactly the point those services face the most pressure.</p>
          </div>
        </section>
