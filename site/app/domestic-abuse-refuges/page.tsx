    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="35% of refuge bed requests are turned away each day — nearly 100 women per day unable to access a safe space. The Domestic Abuse Act 2021 has driven i..."
          colour="#E63946"
          preposition="with"
        />
