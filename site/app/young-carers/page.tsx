      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The burden falls hardest on children already facing multiple disadvantages. Families reliant on young carers are disproportionately in the lowest income quintiles, with single-parent households and those affected by parental disability or chronic mental illness most exposed. Children from Pakistani, Bangladeshi, and Black Caribbean backgrounds are overrepresented, partly reflecting higher rates of multigenerational households and language barriers that make children de facto interpreters for NHS and benefits interactions. Girls carry a heavier load: among carers aged 11&ndash;15, girls average four hours more care per week than boys. A 2023 Carers Trust report found that former young carers earned on average 12% less in their late twenties than peers, a gap attributable almost entirely to lower qualification levels.</p>
          </div>
        </section>
