      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Most young carers remain invisible to the services designed to help them. Schools often do not know a pupil is a carer. CAMHS rarely identifies unpaid caring as a trigger for referral. GPs treating a family member with a long-term condition do not routinely check whether a child at home is providing substantial care. The Care Act 2014 and Children and Families Act 2014 gave young carers the legal right to a needs assessment from their local authority&mdash;but only one in three has ever received one. Local authority budgets for young carer services have been cut significantly since 2010. Identification is the prerequisite for everything else: respite breaks, school support plans, counselling, and peer networks all depend on first knowing a child is a carer at all.</p>
            <p>The structural weight of unpaid caring falls hardest on children in households already facing multiple disadvantages. Families reliant on young carers are disproportionately concentrated in the lowest two income quintiles, with single-parent households and those affected by parental disability or chronic mental illness most exposed. Children from Pakistani, Bangladeshi, and Black Caribbean backgrounds are overrepresented among young carers relative to the general child population, partly reflecting higher rates of multigenerational households, language barriers that make children de facto interpreters for NHS and benefits interactions, and lower uptake of formal social care. Girls carry a heavier load than boys: among carers aged 11&ndash;15, girls average 4 hours more per week according to BBC and University of Nottingham survey data, and are more likely to provide intimate personal care such as bathing or toileting a parent. Rural young carers face compounding isolation &mdash; fewer local services, longer travel to respite provision, and schools with no dedicated pastoral support. The University of Sheffield estimated the economic value of young carers&apos; unpaid work at &pound;12,000 per young carer per year; a 2023 Carers Trust report found that former young carers earned on average 12&percnt; less in their late twenties than peers, a gap attributable almost entirely to lower qualification levels.</p>
            <p>The data on young carers is among the weakest in UK social statistics, and every headline figure should be treated with significant caution. The 2021 Census count of 800,000 relies on household self-identification, a method that systematically undercounts families who do not recognise a child&apos;s role as &ldquo;caring&rdquo; &mdash; particularly where the parent&apos;s condition is stigmatised, such as addiction or severe mental illness. Academic estimates exceeding one million are extrapolations from small-sample surveys, not direct counts. The frequently cited 48 days of missed school per year comes from a 2018 Carers Trust survey with a self-selected sample of 1,200 respondents, not a population-representative study. Mental health prevalence figures similarly derive from charity-commissioned research with small samples and no clinical diagnostic threshold &mdash; the 42&percnt; figure reflects self-reported difficulties on screening questionnaires, not confirmed diagnoses. The Department for Education does not record caring status in the school census, so no national linked dataset connects caring status to attainment. Local authority assessment data is fragmented: there is no national register of young carer assessments, so the &ldquo;one in three received an assessment&rdquo; figure is pieced together from Freedom of Information requests across a subset of councils. Until caring status is recorded in education and health administrative data as standard, the true scale remains a matter of informed estimation rather than measurement.</p>
          </div>
        </section>
