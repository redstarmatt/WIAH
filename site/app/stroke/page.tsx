      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Stroke is the fourth leading cause of death in England and the single largest cause of adult disability. Around 100,000 strokes occur each year, killing approximately 35,000 people. For every person who dies, two more survive with significant disability &mdash; difficulty speaking, walking, or living independently. The economic cost to the NHS and social care is estimated at &pound;8.9 billion annually, with additional costs to individuals, families, and employers that are harder to quantify but likely larger still.</p>
            <p>The speed of treatment determines outcomes more than almost any other factor in emergency medicine. For ischaemic stroke &mdash; caused by a blood clot blocking a brain artery, accounting for 85% of strokes &mdash; two treatments are transformative if delivered within hours. Thrombolysis (clot-dissolving drugs) must be given within 4.5 hours. Thrombectomy (mechanical clot retrieval) can be effective up to 24 hours but is most powerful within 6 hours. The evidence base is unambiguous: both treatments reduce death and disability with large effect sizes. Yet England&rsquo;s thrombolysis rate sits at just 11%, unchanged for five years. The thrombectomy rate is 3.8% &mdash; rising, but still far below the estimated 10&ndash;12% of patients who could benefit.</p>
