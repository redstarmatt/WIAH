      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="From 135 in 2016 · near-doubled but still short"
              sparklineData={[135, 152, 180, 204, 218, 236, 248, 260]}
              href="#sec-chart"source="NHS England · Perinatal Mental Health 2024"
            />
            <MetricCard
              ...
              href="#sec-callout"source="NHS England · Perinatal Mental Health 2024"
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Still 60% without access · deprivation gap"
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Mother and Baby Unit beds in England, 2016–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>NHS England — Perinatal Mental Health Programme. england.nhs.uk/mental-health/adults/perinatal-mental-health/</p>
            <p>Mental Health Services Data Set (MHSDS) — Perinatal mental health dashboard. digital.nhs.uk</p>
