      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The 3.7-times higher maternal mortality rate for Black women compared to white women in the UK is the most widely cited racial health inequality in NHS data &mdash; and one of the most disturbing. It has been documented in MBRRACE-UK reports for over two decades and has not narrowed. The disparity is not explained by socioeconomic factors alone: Black women at all income levels face elevated risk. Clinical explanations are partial; the evidence increasingly points to differential treatment within healthcare settings, including failure to take symptoms seriously, under-referral, and inadequate monitoring.</p>
            <p>Compulsory detention under the Mental Health Act shows the starkest ethnic disparity in the NHS. Black people are detained at approximately four times the rate of white people per million of population, and the gap has been growing, not shrinking. Black people are also more likely to be detained via the police or courts rather than through clinical pathways, more likely to be placed in seclusion and restraint, and less likely to receive talking therapies. The NHS Race and Health Observatory&rsquo;s 2023 report described this as a &ldquo;systemic failure&rdquo; that requires urgent structural change.</p>
            <p>Type 2 diabetes prevalence shows a pronounced South Asian gradient. Pakistani-heritage people are 3.5 times more likely to develop Type 2 diabetes than white British people; Bangladeshi-heritage people are 3.8 times more likely. This reflects a combination of genetic susceptibility (South Asian populations develop insulin resistance at lower BMI thresholds), dietary factors, physical activity patterns, and crucially, later diagnosis due to lower engagement with preventive services. The NHS Diabetes Prevention Programme has made efforts to culturally adapt its delivery, but referral rates from South Asian communities remain lower than would be expected given prevalence.</p>
            <p>COVID-19 mortality exposed racial health inequalities in particularly stark terms. During the first wave of the pandemic in 2020, Black, Asian, and minority ethnic people died from COVID-19 at substantially higher rates than white people, even after adjusting for age. NHS workforce data showed that BAME healthcare workers were disproportionately exposed and died at higher rates. The Disparities in the risk and outcomes of COVID-19 analysis by PHE became one of the most read public health reports in British history. It identified that ethnic minority people faced compounding disadvantages: higher exposure through occupational and housing factors, higher rates of underlying conditions, and worse outcomes when hospitalised.</p>
            <p>The NHS Race and Health Observatory, established in 2020, has produced extensive evidence on racial health inequalities across maternity, mental health, primary care access, cancer pathways, and workforce. Its recommendations include mandatory ethnicity data collection at all healthcare touchpoints, anti-racism training embedded in clinical education, culturally competent service design, and specific action plans for high-disparency areas. Implementation has been slow and patchy. The structural changes required &mdash; in how services are designed, how clinicians are trained, and how data is used &mdash; are substantial and culturally challenging for institutions not accustomed to examining themselves through a racial equity lens.</p>
          </div>
        </section>
