      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Police in England and Wales recorded 68,400 rape offences in the year to March 2024 &mdash; double the figure from a decade earlier. Yet the charge rate collapsed from 7.5% in 2015 to just 1.4% in 2020, before a partial recovery to 2.9% in 2024. At its lowest point, just 843 suspects were charged in a single year. The causes are structural: between 2016 and 2020 a CPS &ldquo;risk aversion culture&rdquo; led prosecutors to decline cases unlikely to secure conviction rather than testing them before juries, while police disclosure failures &mdash; under-resourced digital forensics teams unable to process complainants&apos; phone data within statutory timeframes &mdash; compounded attrition at every stage. Of an estimated 128,000 adult victims annually, fewer than half report to police; of those, 40% are closed without a suspect identified; of those reaching CPS, around one in three is charged. The average wait from report to Crown Court trial now exceeds 1,000 days.</p>
            <p>Women and girls bear the overwhelming burden: 90% of adult rape victims are female, with young women aged 16&ndash;24 at highest risk. Black and mixed-heritage women report rape at higher rates but experience lower charge rates, according to CPS data. Independent Sexual Violence Advisers (ISVAs), who support victims through the criminal justice process, are funded through short-term grants; a 2023 sector survey found 40% of ISVA posts at risk. Victims in rural areas face longer waits for specialist officers. The Victims&apos; Commissioner has described the criminal justice response to rape as &ldquo;a national scandal.&rdquo;</p>
          </div>
        </section>
