        ...
        <ScrollReveal>
          <section className="max-w-2xl mb-12 mt-12">
            ...
            <div className="text-base text-wiah-black leading-[1.7] space-y-4">
              <p>Police in England and Wales recorded 68,400 rape offences in 2024 — double the figure from a decade earlier. Yet the charge rate collapsed from 7.5% in 2015 to just 1.4% in 2019, before a partial recovery to 5.3% in 2024. The Crown Prosecution Service refers to the 2016–2020 period as the &ldquo;rape review crisis.&rdquo; At its lowest point, only 843 suspects were charged with rape in a single year — meaning that for the vast majority of 58,000 complainants, the criminal justice system delivered no meaningful outcome.</p>
