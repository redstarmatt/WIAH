      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>An estimated 415,000 people in England are currently waiting for either a social care needs assessment or for a service to begin following a completed assessment &mdash; up from 298,000 in 2019. One in three has been waiting more than six months: six months without personal care means family members leaving paid work to care informally, older people unable to wash or leave home, and conditions deteriorating until far more expensive residential care becomes unavoidable. Around 13,000 people occupy NHS hospital beds on any given day who are medically fit for discharge but cannot leave because no safe care package exists &mdash; &lsquo;delayed discharge&rsquo; that costs the NHS an estimated 120,000 bed-days per month and drives A&amp;E waiting times, ambulance handover delays, and cancelled operations. Addressing the assessment backlog alone would require an estimated &pound;7 billion in additional annual funding, according to ADASS, the King&apos;s Fund, and the Health Foundation.</p>
            <p>The 415,000 waiting substantially understates the true scale of need. An estimated 1.4&ndash;1.6 million people need care but are not receiving it and are not in any assessment queue &mdash; people who have not applied, who were assessed as ineligible under the Care Act 2014&apos;s &lsquo;substantial&apos; threshold, or who self-funded until their assets ran out. The assessment backlog is driven by workforce shortages: local authority assessment teams have been cut as council budgets contracted under a decade of real-terms funding reductions, and multiple reform commitments &mdash; including the 2021 Health and Social Care Levy funds, initially intended partly for social care &mdash; have been diverted to NHS recovery rather than community services.</p>
          </div>
        </section>
