      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              The impacts of civil liberties restrictions fall unevenly. The protest restrictions in the PCSC Act 2022 and Public Order Act 2023 have been most visibly applied against climate activists (Just Stop Oil, Extinction Rebellion), who are predominantly middle-class and white. But the same legal powers are available against any protest movement, and civil society organisations have documented cases where powers were applied against trade union picket lines, pro-Palestinian demonstrations, and anti-HS2 campaigners. People from ethnic minority backgrounds face disproportionate exposure to stop and search, counter-terrorism surveillance, and Prevent referrals &mdash; a 2021 review found that Muslim communities account for 65&percnt; of Prevent referrals despite being 5&percnt; of the population. Facial recognition technology, deployed by the Metropolitan Police and South Wales Police, has error rates that are significantly higher for darker-skinned individuals, raising both effectiveness and discrimination concerns.
            </p>
            <p>
