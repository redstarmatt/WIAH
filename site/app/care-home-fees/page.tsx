    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The average care home fee in England is £1,200 per week — £62,400 per year. Self-funders pay 41% more than council-funded residents. The CMA found self-funders effectively cross-subsidise those funded by councils by £8,600 per year."
          colour="#E63946"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="Self-funders pay £1,240/wk vs council-funded £880/wk"
              sparklineData={[41, 46, 46, 41]}
              source="CMA Care Homes Market Study · 2017 / LaingBuisson 2023"
              href="#sec-fees"/>
            <MetricCard
              ...
              direction="down"
              polarity="up-is-good"
              changeText="Down from 452,000 in 2012 · 40,000 beds lost as homes closed"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>LaingBuisson — Care of Older People UK Market Report. Annual analysis of care home fee rates, capacity, and market structure. Available at laingbuisson.com.</p>
            <p>CMA — Care Homes Market Study (2017). Investigation into pricing practices, self-funder premiums, and competition in the care home market. Available at gov.uk/cma-cases/care-homes-market-study.</p>
            <p>CQC — State of Care Annual Report. Capacity data and quality assessments across the regulated care sector. Available at cqc.org.uk.</p>
