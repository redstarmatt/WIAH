        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="max-w-2xl mt-4 mb-12">
            <div className="text-base text-wiah-black leading-[1.7] space-y-4">
              <p>The apprenticeship levy, introduced in April 2017, requires employers with an annual payroll above &pound;3 million to contribute 0.5% of their wage bill into a digital account, which can then be drawn down to fund apprenticeship training. The policy was designed to increase the quantity and quality of apprenticeships in England. Instead, total starts fell sharply &mdash; from 509,000 in 2015/16 to 375,000 in 2017/18 &mdash; as smaller employers, deterred by bureaucracy and the 20% off-the-job training requirement, dropped out of the system. Large employers, meanwhile, recognised that levy funds could be used to subsidise degree-level training for existing staff at no additional net cost to themselves.</p>
              <p>The consequences for young people have been severe. Under-19 apprenticeship starts collapsed from 264,000 in 2015/16 to 125,000 in 2022/23 &mdash; a fall of 53%. Over the same period, Level 6 and 7 degree apprenticeships grew from roughly 10% of all starts to 28%. The Public Accounts Committee concluded in 2021 that around half of levy funding was flowing to businesses rather than individuals facing barriers to work. An estimated &pound;1.3 billion in levy funds went unspent and was returned to the Treasury in 2021/22 alone &mdash; money that was never spent on a single apprentice.</p>
              <p>The Labour government&apos;s Skills England initiative, launched in 2024, proposes replacing the levy with a broader &ldquo;Growth and Skills Levy&rdquo; that would allow employers to spend up to 50% of their pot on non-apprenticeship training such as short courses and bootcamps. Supporters argue this would make retraining more flexible and reduce waste; critics warn it could further erode the entry-level provision that gave the original programme its social purpose. The fundamental tension &mdash; between a workforce development subsidy for large employers and a genuine pathway into employment for young people with few qualifications &mdash; has never been resolved.</p>
            </div>
          </div>
