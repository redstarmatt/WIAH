      ...
      <section id="sec-context" className="bg-wiah-light px-6 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="max-w-2xl mt-4 mb-12">
            ...
            <p>The apprenticeship levy, introduced in April 2017, requires employers with a payroll above &pound;3 million to contribute 0.5&percnt; of their wage bill into a digital training account. It was designed to generate 3 million starts by 2020; instead total annual starts fell from 509,000 in 2015/16 to 375,000 in 2017/18 and have not recovered. An estimated &pound;1.3 billion in unspent levy funds was returned to the Treasury in 2021/22. Smaller employers, who historically provided the majority of craft and technical apprenticeships, were deterred by increased bureaucracy and the loss of a training subsidy. Large levy-paying employers used accumulated funds to subsidise existing senior employees: Level 6 and 7 degree apprenticeships grew from 10&percnt; of starts in 2017/18 to 28&percnt; in 2022/23, with many programmes effectively funding MBA-level training for mid-career managers. The Public Accounts Committee concluded the levy had &ldquo;not delivered value for taxpayers.&rdquo; Overall completion rates stand at 53&percnt;, meaning nearly half of starters do not finish.</p>
            <p>The impact on young people is the most acute dimension. Under-19 starts fell from 264,000 in 2015/16 to 125,000 in 2022/23, a 53&percnt; reduction. Remaining young apprenticeships concentrate in social care, hospitality, and retail &mdash; industries with wages clustered around the &pound;6.40 apprenticeship minimum and limited progression prospects. Completion rates for apprentices from the most deprived quintile are around 10 percentage points below those from the least deprived; rates are also substantially lower for Black, Asian, and minority ethnic apprentices. The social mobility function the programme was designed to perform &mdash; bringing young people without professional family networks into skilled employment &mdash; has been progressively displaced by its function as a large-employer training subsidy.</p>
          </div>
          </div>
