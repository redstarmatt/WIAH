...
export const metadata: Metadata = {
  ...
  description: 'A school uniform costs an average of &pound;422 per child per year &mdash; consuming nearly 3% of the annual income of families in the poorest fifth.',
  openGraph: {
    title: 'How Much Is School Uniform Costing Families?',
    description: 'A school uniform costs an average of &pound;422 per child per year &mdash; consuming nearly 3% of the annual income of families in the poorest fifth.',
    type: 'article',
