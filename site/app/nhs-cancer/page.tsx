      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Some 376,000 new cancers are diagnosed in the UK each year and 167,000 people die from the disease &mdash; one in two people born after 1960 will receive a cancer diagnosis in their lifetime. The NHS Long-Term Plan committed to diagnosing 75&percnt; of cancers at stage 1 or 2 by 2028; the current figure is around 54&percnt;, well behind Denmark and Sweden at 60&ndash;65&percnt;. The 62-day urgent referral-to-treatment standard has not been met since 2015, falling to 67.4&percnt; against an 85&percnt; target in 2023 with 16,200 patients waiting more than 104 days. COVID-19 caused an estimated 350,000 fewer diagnoses in 2020 and that diagnostic backlog has never fully cleared. England faces a 20&percnt; shortfall in clinical oncologists, a 30&percnt; shortfall in histopathologists, and CT scanner density of 7.1 per million against an EU average of 25.8. Five-year survival has risen from 50&percnt; to 56&percnt; since 2010, but late-stage diagnosis remains the primary driver of the UK&apos;s survival gap: five-year bowel cancer survival is 57&percnt; here against 67&percnt; in Australia.</p>
            <p>The burden falls unevenly. Patients in the most deprived quintile are 60&percnt; more likely to be diagnosed with lung cancer and 15&percnt; less likely to receive curative surgery. Black women in England wait on average 4.5 days longer from urgent referral to first diagnostic test than white women. South Asian patients present with later-stage colorectal cancer at significantly higher rates. Geographically, the South West and East of England consistently meet waiting-time targets; the North West and Midlands fall furthest behind. Rural patients face round trips exceeding 90 minutes to radiotherapy centres in 40&percnt; of the most remote areas, and distance from treatment correlates directly with lower uptake. Community diagnostic centres were meant to number 160 by 2025; fewer than 100 are fully operational.</p>
          </div>
        </section>
