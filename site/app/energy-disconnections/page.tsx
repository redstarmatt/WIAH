      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Self-disconnection — where prepayment meter customers run out of credit and cannot top up — peaked at 4.8 million households in 2022 and fell to 3.2 million in 2023 following the Energy Price Guarantee. Around 7 million households use prepayment meters, disproportionately lower-income, previous energy debtors, and private renters. Forced disconnections fell from 75,000 in 2016 to 10,500 in 2023 as Ofgem tightened rules, but a 2023 ITV and Citizens Advice investigation found suppliers were forcing prepayment meter installations on vulnerable customers without proper welfare checks — prompting Ofgem to require explicit welfare checks and subsequently ban forced installations in vulnerable households. Fuel debt reached approximately £2.6 billion in 2023, with around 6.2 million households in arrears.</p>
            <p>The disconnection crisis reflects structural inadequacy in energy affordability policy. The Warm Homes Discount, Cold Weather Payment, and Winter Fuel Payment together total approximately £2.5 billion per year — far below what would be needed to bring all fuel-poor households to affordable energy at market rates. The universal service obligation requires suppliers to offer a supply contract to any customer, but does not resolve the tension between commercial survival and social obligation when households cannot pay. The Energy Price Guarantee showed government can intervene at scale but at enormous fiscal cost; the underlying vulnerability — 19 million homes on gas with poor insulation — means the exposure will recur with the next price shock.</p>
          </div>
        </section>
