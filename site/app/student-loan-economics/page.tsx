      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              When the coalition government trebled tuition fees to \u00A39,000 in 2012, the promise was that student loans would be a self-sustaining system. Graduates would repay through an income-contingent mechanism — 9% of earnings above a threshold — and the cost to the taxpayer would be modest. Thirteen years later, the evidence is in: the system does not work as advertised. The total outstanding loan book has ballooned from \u00A346 billion in 2012 to \u00A3268 billion in 2025, growing by roughly \u00A320 billion per year.<Cite nums={1} /> The government now expects to write off 45% of the total value lent, up from 32% when the scheme launched.<Cite nums={2} /> That means nearly half of all student lending is effectively a grant that appears on the public balance sheet as an asset.
            </p>
            <p>
              For individual graduates, the picture is equally opaque. The average student leaves with \u00A346,900 of debt on which interest accrues at rates that have recently peaked at 7.6% — well above any savings account available to ordinary borrowers.<Cite nums={1} /> Most graduates will never repay in full. Under Plan 2, any balance remaining after 30 years is written off. Under the newer Plan 5 (from 2023), the repayment window has been extended to 40 years and the interest rate capped at RPI — but the repayment threshold was frozen at \u00A325,000, meaning graduates begin paying sooner in real terms.<Cite nums={3} /> The median graduate now faces repayments lasting the entirety of their working life, making the loan function as a decades-long additional marginal tax rate of 9%.
            </p>
            <p>
              The macroeconomic consequences are significant. The loan book sits off the headline public sector net debt measure but is included in the broader public sector net financial liabilities figure, which the Office for Budget Responsibility now watches closely. The annual cost to the exchequer — the gap between what is lent and what is expected to be repaid — runs to approximately \u00A310 billion per year.<Cite nums={2} /> Independent analysts, including the Institute for Fiscal Studies, have repeatedly argued that a transparent graduate contribution scheme would be cheaper to administer, fairer across income levels, and honest about the true cost.<Cite nums={3} /> Yet no government has been willing to reform the system, because doing so would require acknowledging that student loans are, for most borrowers, a tax by another name.
            </p>
          </div>
        </section>
