      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>By 2024, IPPR and ONS analysis put 7.6 million UK jobs — approximately 21% of the workforce — at high risk of substantial automation within the next decade, up from around 4.2 million in 2017. Successive technology waves have driven the rise: robotics in logistics and manufacturing, machine learning in financial services, and generative AI across a far wider range of cognitive tasks. ONS analysis finds that 37% of all UK jobs now have significant AI exposure, including many professional and graduate-level roles in law, finance, and media that previously appeared safe. Historical precedent offers cautious grounds for optimism: each previous wave of automation — from mechanised weaving to computerised clerical work — has been followed by net job creation, even as specific occupations were substantially reduced.</p>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="21% of workforce · transport and admin most exposed"
              sparklineData={[4200000, 4800000, 5400000, 5900000, 6200000, 6800000, 7400000, 7600000]}
              href="#sec-chart"source="IPPR / ONS · 2024"
            />
            <MetricCard
              ...
              href="#sec-chart"source="ONS · Generative AI and UK Employment 2023"
            />
            <MetricCard
              ...
              href="#sec-chart"source="CCC / Green Jobs Taskforce · 2024"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="UK jobs at high risk of automation, 2017–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>IPPR — Technology and the Future of Work. ippr.org</p>
            <p>ONS — Which Occupations Are at Highest Risk of Being Automated? ons.gov.uk</p>
            <p>ONS — Generative AI and the UK Labour Market. ons.gov.uk</p>
            <p>Green Jobs Taskforce — Report to Government. gov.uk/government/publications/green-jobs-taskforce-report</p>
