...
export const metadata: Metadata = {
  ...
  description: 'Council tax in England has risen 25&percnt; in real terms since 2016 — with many councils raising bills by the maximum permitted 5&percnt; per year — yet local authorities are simultaneously closing libraries, cutting bin collections, and reducing adult social care, because government grants have fallen faster than council tax has risen.',
  openGraph: {
    title: 'Why Does Council Tax Keep Rising While Services Are Cut?',
    description: 'Council tax in England has risen 25&percnt; in real terms since 2016 — with many councils raising bills by the maximum permitted 5&percnt; per year — yet local authorities are simultaneously closing libraries, cutting bin collections, and reducing adult social care, because government grants have fallen faster than council tax has risen.',
    type: 'article',
