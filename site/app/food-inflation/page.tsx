      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The distributional impact of food inflation was profoundly unequal. Food represents approximately 8% of spending for the highest-income fifth of households but over 14% for the lowest-income fifth, meaning that a given percentage increase in food prices has nearly twice the proportional impact on low-income households. Within the low-income population, certain groups were particularly exposed: families with young children (who spend more on food per head), households in rural areas (with less access to budget supermarkets and food banks), and households with certain medical conditions requiring specific dietary products. The Food Foundation&apos;s modelling found that a family with two children in the lowest income decile faced a real-terms income reduction equivalent to approximately &pound;1,200 per year once food price increases were accounted for alongside energy bills, at a time when benefit uprating did not keep pace with food-specific inflation. Food bank usage reached a record 3.1 million food parcels distributed by Trussell Trust network food banks in 2022/23 &mdash; a 37% increase on the previous year and nearly five times the pre-pandemic figure.</p>
