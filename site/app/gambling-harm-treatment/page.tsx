      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Gambling disorder affects approximately 290,000 to 340,000 people in England, with a further 1.5 million at moderate risk. The Gambling Commission estimates gambling-related harms cost the UK economy approximately &pound;1.4 billion per year in health, social care, and criminal justice costs. Until 2019, the National Problem Gambling Clinic in London was the sole NHS provider; by 2024, 15 specialist clinics operate across England with a combined capacity of approximately 6,200 people per year &mdash; a 7.5-fold expansion in five years, funded initially from voluntary operator contributions and subsequently from a mandatory statutory levy introduced in 2023. Waiting times at many clinics extend to six to eight weeks.</p>
            <p>Despite the expansion, NHS capacity can treat approximately 2.1% of problem gamblers &mdash; fewer than one in 48. The gap between provision and need is most acute for those in areas without clinics, those whose gambling disorder coexists with other addictions or mental health conditions, and those who cannot access face-to-face services. Debt, family breakdown, domestic abuse, and suicide are all significantly elevated among problem gamblers; harms extend well beyond the individual and fall hardest on households already in financial difficulty.</p>
          </div>
        </section>
