    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="8.1 million people live in working households below the poverty line — 60% of all people in poverty live in households where someone works, up from 45% in 1997."
          colour="#E63946"
          preposition="with"
        />
        ...
        <ScrollReveal>
          <section id="sec-poverty" className="mb-12">
            <LineChart
              title="People in working poverty, UK, 2002–2023 (millions)"
              ...
              source={{
                name: 'DWP',
                dataset: 'Households Below Average Income (HBAI) — in-work poverty',
                frequency: 'annual',
              }}
            />
          </section>
        ...
        <ScrollReveal>
          <section id="sec-share" className="mb-12">
            <LineChart
              title="Working households as share of all people in poverty, 2002–2023 (%)"
              ...
              source={{
                name: 'JRF &amp; DWP',
                dataset: 'UK Poverty Report — HBAI analysis',
                frequency: 'annual',
              }}
            />
          </section>
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            unit="2021"
            description="The Universal Credit work allowance was raised and the taper rate cut from 63p to 55p in October 2021 — meaning that for every £1 of earnings above the work allowance, claimants kept 45p instead of 37p. The OBR estimated this benefited approximately 1.9 million working families, increasing effective income by an average of £1,000 per year. The change was the largest single improvement to work incentives in Universal Credit since its introduction. Combined with above-inflation National Living Wage increases, it represents meaningful progress, though in-work poverty rates remain well above early-2000s levels."
            source="Source: DWP — Households Below Average Income 2023; JRF — UK Poverty 2024; Resolution Foundation — Earnings Outlook 2024; OBR — Universal Credit taper rate assessment 2021."
          />
        </ScrollReveal>
