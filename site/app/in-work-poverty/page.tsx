      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>In-work poverty &mdash; the situation in which a household has at least one adult in paid employment but still has income below 60&percnt; of the contemporary median after housing costs &mdash; has become the dominant form of poverty in Britain. According to the DWP&apos;s Households Below Average Income (HBAI) dataset, approximately 8.1 million people were living in in-work poverty in 2022/23, representing 60&percnt; of everyone below the poverty line. This is a fundamental change from 1997, when working households represented approximately 45&percnt; of people in poverty, and from the 1980s when the majority of poverty was concentrated among workless households &mdash; the unemployed, long-term sick, and retired. The shift is not primarily the result of more people working: employment rates have been high by historical standards for most of the past two decades. Rather, it reflects structural changes in the labour market that have allowed high employment to coexist with low wages, insecure hours, and insufficient work. High housing costs, which absorb an increasing share of low-income households&apos; budgets, amplify the problem: poverty measured before housing costs is significantly lower than the after-housing-costs measure, reflecting the pressure that rent and mortgages place on working families with limited incomes.</p>
