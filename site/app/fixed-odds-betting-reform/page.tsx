      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section className="max-w-2xl mt-4 mb-10">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Fixed-odds betting terminals (FOBTs) — high-speed electronic roulette machines in high street bookmakers — were described by critics as the 'crack cocaine of gambling' for their ability to enable rapid, high-stakes losses. In 2018, following years of campaigning and a government review, the maximum stake per spin was reduced from £100 to £2 — one of the most significant gambling regulations in decades. The change came into force in April 2019 and resulted in an immediate reduction of around £400 million in FOBT gross gambling yield. Some bookmakers closed shops as a result; high street gambling density in deprived areas fell modestly.</p>
            <p>However, the FOBT reform has been partially offset by the explosion in online gambling. Online gambling gross yield grew from £4.5 billion in 2016 to approximately £10 billion in 2024 — more than doubling — as smartphone apps, in-play betting, and algorithm-driven product design made gambling more accessible, persistent, and immersive than ever. The Gambling Commission estimates there are around 800,000 problem gamblers in Great Britain, with a further 1.5–2 million 'at-risk'. The government's 2023 Gambling Act White Paper proposed stake limits for online slots (confirmed at £5 for over-25s), enhanced affordability checks, and a statutory gambling levy to fund treatment — though the levy rate has been contested by the industry. The NHS Northern Gambling Service now operates nationally.</p>
          </div>
        </section>
        <SectionNav sections={[
