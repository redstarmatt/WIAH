    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="Avoidable mortality has fallen 27% since 2010 to 218 per 100,000 — one of the NHS&rsquo;s quiet success stories. But the gap between London (166) and the North East (276) means preventable deaths are 66% more common in the poorest regions."
          colour="#2A9D8F"
        />
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="Down 27% from 293 in 2010 · progress accelerated 2012–2019"
              sparklineData={[293, 275, 258, 242, 231, 243, 218]}
              href="#sec-chart"source="ONS Avoidable Mortality · 2021"
            />
            <MetricCard
              ...
              direction="flat"
              polarity="up-is-bad"
              changeText="60% higher than London (166) · gap not narrowing"
              sparklineData={[310, 298, 285, 270, 260, 268, 276]}
              href="#sec-regions"source="ONS · 2021"
            />
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="293 &rarr; 218 per 100,000 · biggest driver: cardiovascular improvements"
              sparklineData={[293, 275, 258, 242, 231, 243, 218]}
              href="#sec-regions"source="ONS · 2021"
            />
          </div>
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            value="&minus;27%"
            unit=""
            description="Avoidable mortality has fallen significantly since 2010, driven by better treatment of cardiovascular disease, improved cancer survival, and reduced smoking rates. This represents one of the NHS&rsquo;s most sustained improvements — thousands of people alive today who would not have survived under 2010 care standards."
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Avoidable mortality rate, England, 2010–2021"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>ONS — Avoidable mortality in the UK. Published annually. ons.gov.uk/peoplepopulationandcommunity/healthandsocialcare/causesofdeath/bulletins/avoidablemortalityinenglandandwales</p>
