      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Coastal erosion is happening now, not in the future. The Holderness coast of East Yorkshire retreats at an average of 1.7 metres per year &mdash; among the fastest rates in Europe &mdash; and entire streets have been lost within living memory. The Environment Agency identifies around 100,000 properties at significant risk from erosion over the next 50 years, a figure projected to rise to 156,000 by 2050 as sea levels rise and storm frequency increases. Shoreline Management Plans classify some stretches of coast as &ldquo;no active intervention&rdquo;, meaning public funds will not be spent to defend them &mdash; a deliberate managed retreat from communities where people live. There is no compensation scheme for properties lost to coastal erosion, and homeowners in at-risk areas increasingly cannot obtain affordable building insurance or sell their properties as banks factor erosion risk into mortgage lending decisions.</p>
            <p>The consequences fall on individuals rather than the state: trapped owners cannot recoup investment in their homes, cannot insure them adequately, and often cannot sell. Eighteen major managed realignment projects in England have deliberately breached sea walls to allow farmland to become saltmarsh, creating coastal habitat and reducing storm surge pressure &mdash; a genuine success where the affected land is agricultural. Extending the same logic to inhabited communities is politically and morally far harder, and the absence of a compensation framework means that homeowners in declining coastal areas bear costs that are, in effect, a public policy choice.</p>
          </div>
        </section>
