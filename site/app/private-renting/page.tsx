      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>
              The cost burden falls hardest on younger and lower-income households. Renters aged 25&ndash;34 spend a median 38% of income on rent; those on housing benefit face a widening gap between Local Housing Allowance rates and actual market rents. Families with children &mdash; 1.6 million households &mdash; face particular instability: 45% of Section 21 evictions involve families, and each move costs an average &pound;1,400. The Renters (Reform) Act 2024, which abolishes no-fault evictions, is the most significant change to private renting law since 1988, but the fundamental constraint remains supply: England needs 300,000 new homes per year and is building approximately 220,000 &mdash; almost none affordable private rented properties.
            </p>
          </div>
        </section>
