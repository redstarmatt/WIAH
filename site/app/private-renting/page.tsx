      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The cost burden falls hardest on younger and lower-income households. Renters aged 25&ndash;34 spend a median 38&percnt; of gross income on rent; those on housing benefit face a widening gap between Local Housing Allowance rates, frozen since 2020 and restored only to the 30th percentile in 2024, and actual market rents. Families with children are the fastest-growing group in private renting &mdash; 1.6 million households &mdash; and face particular instability: 45&percnt; of Section 21 evictions involve families, and each move costs an average &pound;1,400 in deposits, fees, and moving expenses. Geographically, the crisis is sharpest in coastal towns and smaller cities where wages are low but housing demand from retirees and second-home owners inflates prices. The buy-to-let exodus is most pronounced among landlords with one or two properties, who account for 60&percnt; of all landlords but are selling at twice the rate of portfolio investors.</p>
            <p>Official rent statistics understate the market reality. The ONS Index of Private Housing Rental Prices tracks rents on all tenancies, including sitting tenants on older agreements; new-let rents, which reflect what someone entering the market actually pays, are 10&ndash;15&percnt; higher than the headline figure. Zoopla and Rightmove indices capture asking rents rather than agreed rents, introducing upward bias. The English Housing Survey, the primary source for tenure and condition data, has a sample of 13,300 households and a two-year publication lag &mdash; its 2023 report uses 2021/22 data. EPC ratings measure modelled energy efficiency at the point of assessment, not actual energy use, and 40&percnt; of private rented stock has not been assessed since 2015. There is no national register of landlords in England, making it impossible to track portfolio size, compliance history, or total stock with precision.</p>
          </div>
        </section>
