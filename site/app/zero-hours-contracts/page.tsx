    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding={<>Over 1.1 million workers in the UK are on zero-hours contracts — a figure that has nearly trebled since 2013 — leaving them without sick pay entitlement, pension auto-enrolment, or predictable income.<Cite nums={1} /></>}
          colour="#E63946"
          preposition="with"
        />
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Zero-hours contracts have become one of the defining features of the modern UK labour market. The ONS Labour Force Survey recorded approximately 1.1 million workers on zero-hours contracts in late 2024, nearly three times the 400,000 estimated in 2013 when consistent measurement began.<Cite nums={1} /> These contracts guarantee no minimum hours of work, meaning employers can offer shifts as needed while workers have no certainty about their weekly income. The growth has been concentrated in sectors with high seasonal demand and low unionisation: accommodation and food services, retail, and health and social care together account for over 60% of all zero-hours contract workers. The pandemic accelerated the trend, as employers sought maximum flexibility during uncertain trading conditions, and many of these arrangements became permanent. The Resolution Foundation estimates that zero-hours contract workers earn on average £6,200 less per year than comparable employees on standard contracts, even when controlling for hours worked, occupation, and qualifications.<Cite nums={2} /></p>
            <p>The legal framework around zero-hours contracts has evolved slowly. The Small Business, Enterprise and Employment Act 2015 banned exclusivity clauses that prevented zero-hours workers from seeking additional employment, but enforcement has been minimal.<Cite nums={3} /> Workers on zero-hours contracts are classified as &ldquo;workers&rdquo; rather than &ldquo;employees&rdquo; under UK employment law, which means they are entitled to the national minimum wage, paid annual leave, and protection from discrimination, but not to statutory sick pay (which requires minimum earnings of £123 per week), statutory redundancy pay, or the right to request flexible working. The Taylor Review of Modern Working Practices (2017) recommended a new category of &ldquo;dependent contractor&rdquo; with enhanced rights, but this was never implemented.<Cite nums={4} /> The government's Good Work Plan (2018) introduced a right for zero-hours workers to request a more predictable contract after 26 weeks, but the request can be refused on broad business grounds and take-up has been negligible.<Cite nums={5} /> The fundamental asymmetry remains: the employer retains full flexibility while the worker bears all the risk.</p>
            </div>
        </section>
