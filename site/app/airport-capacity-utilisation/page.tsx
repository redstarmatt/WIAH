      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              changeText="97% in 2024 · constrained vs Schiphol 72%"
              sparklineData={[91, 92, 93, 95, 97, 40, 75, 88, 97]}
              href="#sec-chart"source="CAA · Airport Statistics 2024"
            />
            <MetricCard
              ...
              changeText="+12% since 2019 · recovered to pre-pandemic"
            ...
            <MetricCard
              ...
              href="#sec-chart"source="Airports Commission · Economic Analysis 2015, updated 2024"
            />
          </div>
        </ScrollReveal>
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Civil Aviation Authority — Airport Statistics. Published annually. caa.co.uk/data-and-analysis/uk-aviation-market/airports/</p>
            <p>Airports Commission — Final Report 2015, Economic Analysis. gov.uk/government/publications/airports-commission-final-report</p>
