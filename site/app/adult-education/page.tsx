      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Adult participation in learning has fallen from 20% to 15.4% since 2015, and further education enrolments have dropped 30% &mdash; from 3.3 million to 2.3 million &mdash; over the same period. The Adult Education Budget has been cut over 40% in real terms since 2010, leaving the UK spending less on adult skills as a proportion of GDP than any comparator OECD economy except Turkey and Mexico. The decline falls at precisely the wrong moment: the Migration Advisory Committee identifies over 40 shortage occupations; the Construction Industry Training Board projects a shortfall of 251,000 workers by 2028; the green transition needs an estimated 480,000 workers in insulation, heat pump installation, and renewables. Apprenticeship starts for adults aged 25 and over have fallen 42% since the Apprenticeship Levy was introduced in 2017, with employer spending concentrated on management qualifications rather than technical skills. Nine million adults in England still lack Level 2 qualifications equivalent to GCSEs.</p>
            <p>The decline is not evenly distributed. Participation is lowest among those who would benefit most: adults without Level 2 qualifications, low-paid workers, those aged 55 and over, disabled people, and people in rural areas with poor transport links. Adults with existing qualifications are twice as likely to participate in further learning as those without &mdash; a compounding inequality. Geographic gaps are stark: London&apos;s participation rate of 21% compares with 12% in the North East. ESOL funding has been cut 60% since 2009, limiting access for ethnic minority adults. For workers on zero-hours contracts or in the gig economy, time off for training is economically prohibitive, making the population with the greatest skills need the least able to access provision.</p>
          </div>
        </section>
