      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Independent schools in England have operated under charitable status, entitling them to significant tax advantages including 80% mandatory relief on business rates, Gift Aid on donations, and exemption from corporation tax on surpluses, with an estimated annual value of approximately &pound;522 million per year. The VAT exemption on school fees &mdash; a long-standing anomaly in UK tax law &mdash; was removed from January 2025, with the government applying the standard 20% VAT rate. The measure was Labour&apos;s flagship education policy in the 2024 general election, projected to raise approximately &pound;1.6 billion per year for reinvestment in state school provision including teacher recruitment and SEND support. Initial data from early 2025 showed smaller pupil number reductions than independent school associations had predicted.</p>
            <p>Despite educating 7% of pupils, independent school alumni disproportionately occupy positions of power: 65% of senior judges, 55% of senior civil servants, 52% of Foreign Office ambassadors, and 44% of newspaper columnists attended independent schools. State school funding stood at approximately &pound;7,700 per pupil in 2024, compared to an average independent school fee of &pound;18,000 per year for day schools. The spending difference is visible in class sizes, facilities, extracurricular provision, and teacher staffing &mdash; advantages that are not replicated in state schools and that compound the inequality of outcome that selective private education perpetuates.</p>
          </div>
        </section>
