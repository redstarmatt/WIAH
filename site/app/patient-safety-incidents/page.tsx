    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="392 &lsquo;never events&rsquo; — mistakes so serious they should never occur — were recorded in 2023/24, alongside 12,400 serious incidents."
          colour="#E63946"
        />

        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>&ldquo;Never events&rdquo; are defined by NHS England as serious, largely preventable incidents that known safeguards should prevent — wrong-site surgery, retained surgical instruments, misplaced nasogastric tubes. In 2024, 367 were recorded across NHS England, down from a peak of 487 but still indicative of persistent system-level failure. Serious incidents — a broader category covering significant patient harm — rose from 10,800 in 2018 to a peak of 12,400 in 2023, before falling to 11,800 in 2024. Maternity incidents account for 28% of all serious incidents, disproportionate to maternity's share of NHS activity, with the Ockenden, Kirkup and East Kent reviews all finding that systemic failures went uninvestigated and uncorrected for years. The Patient Safety Incident Response Framework, introduced in 2022, aims to shift from individual blame toward systemic learning.</p>
            <p>The burden of unsafe care falls on the patients least able to advocate for themselves. Those in maternity services, mental health inpatient units, and emergency departments account for a disproportionate share of serious incidents. Deprived communities face higher rates of harm partly because the trusts serving them are more likely to face staffing shortages and infrastructure constraints that create the conditions for error. Rising reporting rates can reflect improving safety culture as much as worsening performance — psychologically safe organisations tend to report more because staff trust they can flag concerns without personal consequences — making crude comparisons between trusts unreliable without cultural context.</p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-bad"
              changeText="down from 487 peak · wrong-site surgery most common"
              sparklineData={[413, 487, 358, 349, 378, 392, 367, 367]}
              href="#sec-chart"source="NHS England · Never Events Data 2023/24"
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="+9% since 2018 · maternity highest risk area"
              sparklineData={[10800, 11200, 9900, 10100, 11600, 12400, 11800, 11800]}
              href="#sec-chart"source="NHS England · Serious Incidents Report 2023/24"
            />
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="28% of all serious incidents · Donna Ockenden review"
              sparklineData={[2700, 2900, 2600, 2900, 3200, 3500, 3300, 3300]}
              href="#sec-chart"source="NHS England · Maternity Safety Data 2023/24"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Patient safety incidents, England, 2018–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>NHS England — Never events data. Published annually. england.nhs.uk/patient-safety/never-events/</p>
            <p>NHS England — Patient Safety Incident Management System (PSIMS). england.nhs.uk/patient-safety/patient-safety-incident-management-system/</p>
            <p>Donna Ockenden — Independent Review of Maternity Services at Shrewsbury and Telford NHS Trust. March 2022.</p>
