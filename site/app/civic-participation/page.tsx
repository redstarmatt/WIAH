      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-good"
              changeText="Down from 28% in 2010 · long-term secular decline"
              sparklineData={[28, 27, 26, 25, 23, 24, 24]}
              source="NCVO Time Well Spent · 2023"
            ...
            <MetricCard
              ...
              direction="down"
              polarity="up-is-good"
              changeText="COVID surge (39%) has largely receded · but above 2010 levels"
              sparklineData={[35, 33, 31, 39, 34, 33]}
              source="NCVO / Community Life Survey · 2023"
              href="#sec-volunteering"/>
            <MetricCard
              ...
              direction="up"
              polarity="up-is-good"
              changeText="Up from 22,000 in 2015 · grassroots civic energy around need"
              sparklineData={[22000, 28000, 36000, 39000]}
              source="Trussell Trust Annual Report · 2022"
              href="#sec-volunteering"/>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-volunteering" className="mb-12">
            <LineChart
              title="Volunteering rates, England, 2010–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>NCVO — Time Well Spent. Biennial survey of volunteering attitudes and behaviour in England. Available at ncvo.org.uk.</p>
            <p>DCMS — Community Life Survey. Annual survey of volunteering, charitable giving, and civic participation in England. Available at gov.uk/government/statistics/community-life-survey.</p>
            <p>Trussell Trust — Annual Report. Volunteer numbers and network statistics for the Trussell Trust food bank network. Available at trusselltrust.org.</p>
