...
export const metadata: Metadata = {
  ...
  description: 'Schools broadly meet nutritional standards &mdash; but free school meal uptake falls well below eligibility, and primary school universality ends at Year 2.',
  openGraph: {
    title: 'Are School Meals Actually Nutritious?',
    description: 'Schools broadly meet nutritional standards &mdash; but free school meal uptake falls well below eligibility, and primary school universality ends at Year 2.',
    type: 'article',
