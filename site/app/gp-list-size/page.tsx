    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The average GP now looks after 2,271 patients — and in some practices, a single doctor covers over 4,000."
          colour="#E63946"
        />

        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The average number of registered patients per GP full-time equivalent has risen from 1,891 in 2015 to 2,290 in 2024 — a 21% increase in nine years. Almost one in five GPs (18.8%) work in practices where each doctor has more than 3,000 registered patients; the BMA recommends a maximum of 1,500. The NHS committed in 2019 to recruit 6,000 additional GPs by 2024 — a target that was not met — and around 40% of GPs are now over 50, with younger entrants more likely to work part-time. BMA surveys find that GPs are conducting an average of 38 consultations per day, well above the 25-contact safety threshold recommended by the GMC.</p>
            <p>Large list sizes carry direct patient safety consequences. BMJ research found GPs with lists above 2,000 patients have higher rates of missed diagnoses and unplanned hospital admissions. High workloads drive burnout and early exit, which in turn leaves remaining colleagues with still larger lists — a self-reinforcing cycle that no amount of international recruitment has yet broken. The burden falls hardest in rural and deprived areas where recruitment is weakest and where GP access is already most constrained, creating compounding inequality in the quality of primary care received.</p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="+21% since 2015 · recommended max: 1,500"
              sparklineData={[1891, 1943, 1987, 2031, 2078, 2134, 2224, 2290]}
              href="#sec-chart"source="NHS Digital · GP Workforce Statistics 2024"
            />
            <MetricCard
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="+7 since 2019 · safety threshold: 25 per GMC"
              sparklineData={[31, 32, 33, 34, 35, 36, 37, 38]}
              href="#sec-chart"source="BMA · GP Workload Survey 2024"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Average GP list size, England, 2015–2024"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>NHS Digital — General Practice Workforce Statistics. Published monthly. digital.nhs.uk/data-and-information/publications/statistical/general-and-personal-medical-services</p>
            <p>NHS Digital — Patients Registered at a GP Practice. Published quarterly. digital.nhs.uk/data-and-information/publications/statistical/patients-registered-at-a-gp-practice</p>
            <p>BMA — GP Workload Survey. bma.org.uk/advice-and-support/nhs-delivery-and-workforce/pressures/pressures-in-general-practice-data-analysis</p>
