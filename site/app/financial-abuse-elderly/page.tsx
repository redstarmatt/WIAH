      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Financial abuse of older people is the most common form of elder abuse in the UK after neglect. Age UK and Action on Elder Abuse estimate over 190,000 older people experience some form of financial abuse each year &mdash; theft by family members or carers, fraud by strangers, and misuse of powers of attorney &mdash; costing approximately &pound;3.6 billion annually. Phone and online scams impersonating banks, HMRC, and government agencies generated &pound;1.2 billion in losses from people over 65 in 2023 alone. Office of the Public Guardian referrals for attorney misconduct have nearly doubled, from around 5,000 per year in 2019 to over 9,000 in 2024. Yet fewer than 5% of incidents are ever reported, meaning official data dramatically understates the true scale.</p>
            <p>The low reporting rate reflects the particular vulnerability of older victims: many do not recognise abuse is occurring, especially where cognitive decline reduces financial decision-making capacity. Where the perpetrator is a family member &mdash; the most common scenario in domestic settings &mdash; victims often stay silent out of loyalty, shame, or fear of losing the care that the abusive relative also provides. The adult safeguarding system, strengthened by the Care Act 2014, is the primary statutory mechanism for response &mdash; but it is under severe pressure, with social care workforces stretched and inadequate capacity to investigate the forensic complexity of multi-party financial abuse.</p>
          </div>
        </section>
