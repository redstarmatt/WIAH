      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>NHS Talking Therapies &mdash; established in 2008 as the world&apos;s first large-scale, population-level psychological therapy programme &mdash; now treats over 1.2 million people per year through approximately 60 commissioned services in England. The national recovery rate reached 52.3% in 2023, above the 50% target, up from around 45% in 2016. But access barriers remain the programme&apos;s most persistent problem: of 1.6 million referrals received in 2023, around 450,000 people who were referred did not start therapy. Average waiting times have grown from three weeks in 2016 to approximately six weeks in 2023 as demand has outpaced capacity, and self-referral rates have grown from 30% to over 40% of all referrals.</p>
            <p>The programme&apos;s benefits are not evenly distributed. Recovery rates across 60 commissioned services ranged from below 40% to above 75% in 2023, making postcode a significant predictor of outcome. South Asian communities are referred at roughly half the rate of white British people relative to their prevalence of depression and anxiety. Older adults over 65 are referred at the lowest rate of any age group. People with severe mental illness, personality disorders, or significant trauma histories are largely excluded from the programme&apos;s scope. The shift to remote delivery &mdash; over 60% of sessions by video or telephone in 2023 &mdash; has expanded reach while raising unresolved questions about clinical equivalence.</p>
          </div>
        </section>
