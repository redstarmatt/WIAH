      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Britain has a drug and alcohol crisis that is, by several measures, the worst in Europe. The Office for National Statistics recorded 4,907 drug poisoning deaths in England and Wales in 2022 &mdash; the highest annual total since records began, and a rate per million population that substantially exceeds that of any other large European nation. The crisis is concentrated in Scotland, which has the highest drug death rate in Europe by an extreme margin, but England and Wales&apos;s own figures have risen 46&percnt; since 2012. The driving forces are well understood: an ageing cohort of long-term heroin and crack cocaine users with deteriorating health, the increasing adulteration of the drug supply with highly potent synthetic opioids, and a decade of cuts to the treatment services that would once have been their lifeline. Between 2013 and 2020, local authority public health budgets &mdash; which fund drug and alcohol treatment &mdash; were cut by 24&percnt; in cash terms and 36&percnt; in real terms. Treatment numbers fell from 311,000 in 2010/11 to a low of around 271,000 in 2020/21. The number of people receiving opiate substitution therapy, the single most effective intervention for reducing drug-related deaths, fell proportionately.</p>
