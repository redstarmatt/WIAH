      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The UK Post Office network stood at 18,390 branches in 2000 — the culmination of over 350 years as one of the most extensive retail networks in the country. By 2024, that number had fallen to approximately 11,180, a reduction of 39%. The steepest decline came between 2005 and 2008, when the Labour government's Network Change Programme closed 2,367 branches in a single consolidation round. The pace of closure has slowed since then, but a steady attrition of 100–150 branches per year continues, driven primarily by the retirement of sub-postmasters who cannot find successors and the declining commercial viability of rural outlets. Post Office Ltd operates as a government-owned company; sub-postmasters are self-employed agents, not employees — a distinction that has been central to many of the network's problems.</p>
            <p>The shift from Crown offices to franchise operations has accelerated in recent years. Crown post offices — directly operated by Post Office Ltd on high streets — have been systematically converted to franchise counters inside WHSmith and other retailers, reducing from 373 Crown offices in 2013 to fewer than 80 by 2024. This saves Post Office Ltd money but often reduces service quality: franchise counters have limited opening hours, smaller premises, and staff less familiar with complex transactions. Meanwhile, the Horizon IT scandal — in which 900-plus sub-postmasters were wrongly prosecuted between 1999 and 2015 due to a faulty Fujitsu accounting system — devastated trust in the institution and made recruitment of new sub-postmasters significantly harder.</p>
            </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              direction="down"
              polarity="up-is-good"
              changeText="Down from 18,390 in 2000 — a 39% decline"
            ...
            <MetricCard
              ...
              direction="up"
              polarity="up-is-bad"
              changeText="100–150 closures per year continue; recruitment of sub-postmasters remains difficult"
        ...
        <ScrollReveal>
          <section id="sec-branches" className="mb-12">
            <LineChart
              title="UK Post Office branches, 2000–2024"
        ...
        <ScrollReveal>
          <section id="sec-access" className="mb-12">
            <LineChart
              title="Rural population within 3 miles of a post office, 2010–2024"
