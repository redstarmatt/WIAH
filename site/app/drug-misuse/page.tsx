      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>There were 4,534 drug poisoning deaths registered in England and Wales in 2022 &mdash; the second highest annual total on record, just below the 2021 peak of 4,907. The UK has the highest drug-related death rate in Europe by most measures. These are not deaths concentrated among young recreational users: the typical profile is a man in his 40s or 50s with a long history of opioid dependency, tracking back to the heroin epidemic that flooded post-industrial towns in the 1980s and 1990s. Scotland&apos;s death rate is approximately three times that of England, concentrated in Glasgow, Dundee, and other post-industrial cities. An estimated 300,000 people in England have a dependency on heroin or crack cocaine, but only around 150,000 are in structured treatment at any one time. Drug treatment funding fell by around 35% in real terms between 2013 and 2020; the 2021 ten-year drugs strategy committed &pound;780 million to rebuilding it. Nitazenes &mdash; synthetic opioids far more potent than heroin &mdash; have been detected in the UK drug supply with increasing frequency since 2021, raising the risk of mass casualty events seen in North America.</p>
            <p>The geography of drug deaths maps closely onto the geography of deindustrialisation: communities that lost industrial employment in the 1980s face the highest rates of drug mortality four decades later. Scotland&apos;s higher death rate reflects historically lower treatment coverage in the areas most affected. Drug checking services, where people test substances before use, have demonstrated they can identify dangerous adulterants and change behaviour, but regulatory and political barriers to expanding them remain substantial. The full cost of drug dependency to families and communities &mdash; children taken into care, relationships destroyed, housing lost, unpaid caring by relatives &mdash; does not appear in any single dataset; the mortality figures measure only the terminal outcome of a much larger harm.</p>
          </div>
        </section>
