      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Drug poisoning deaths in England and Wales reached 4,534 in 2022 &mdash; the second highest figure ever recorded, just below the 2021 peak of 4,907. Deaths have more than doubled since 2012, when the total stood at 2,858. The UK has one of the highest drug death rates in Europe: a rate of 7.7 per 100,000 in England, compared with an EU average closer to 4. Scotland&apos;s position is worse still &mdash; at 22.6 per 100,000, it has the highest drug death rate on the continent. Opiates (heroin and morphine) remain the largest single cause, responsible for around 35% of deaths, or roughly 1,575 lives in 2022.</p>
            <p>Deaths are not rising evenly across the population. The largest share now falls in the 40&ndash;49 age group: people who began using heroin in the 1980s and 1990s whose bodies are ageing and whose tolerance to polysubstance combinations is declining. This &ldquo;ageing cohort&rdquo; effect means deaths will likely remain elevated for at least another decade, regardless of new interventions. Cocaine deaths have risen sharply alongside &mdash; from 247 in 2012 to 840 in 2022, a 3.4-fold increase &mdash; driven by higher purity and wider use. Illicitly obtained benzodiazepines combined with opiates are increasingly implicated in overdose deaths. Fentanyl, a synthetic opioid 50&ndash;100 times more potent than heroin, which devastated drug death rates in the United States and Canada, has begun appearing in UK supply chains.</p>
            <p>An estimated 300,000 people in England have a heroin or crack cocaine dependency; only around 150,000 are in structured treatment at any one time. Between 2013 and 2020, treatment services were cut by approximately 25% in real terms as local authority public health budgets fell. The 2021 ten-year drug strategy committed &pound;780 million over three years to partially reverse those cuts. Naloxone &mdash; the overdose-reversal drug, which can be administered by bystanders &mdash; is now more widely distributed, and take-home naloxone programmes are expanding. The evidence base for Drug Consumption Rooms (supervised injection sites, where users can consume drugs under clinical supervision) is strong: studies from Switzerland, the Netherlands and Canada consistently show reductions of around 33% in surrounding overdose deaths. The UK government has declined to pilot them.</p>
          </div>
        </section>
