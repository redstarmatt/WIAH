    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        <TopicHeader
          ...
          finding="The UK has 14.7 GW of installed offshore wind — second in the world behind China. The government's 50 GW by 2030 target is ambitious: current trajectory suggests 35–40 GW is achievable, if grid upgrades and planning keep pace."
          colour="#2A9D8F"
        />
        ...
        <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          <MetricCard
            ...
            direction="up"
            polarity="up-is-good"
            changeText="Second largest in world · up from 1.3 GW in 2010"
            sparklineData={[1.3, 2.9, 4.5, 5.7, 8.2, 10.4, 13.8, 14.7]}
            source="DESNZ / Wind Europe · 2024"
            href="#sec-capacity"/>
          <MetricCard
            ...
            direction="up"
            polarity="up-is-good"
            changeText="Current trajectory: 35–40 GW by 2030 · needs planning reform"
          ...
          <MetricCard
            ...
            direction="down"
            polarity="up-is-good"
            changeText="No offshore wind awarded in AR5 · developers said prices too low"
            sparklineData={[0.8, 3.2, 5.9, 7.0, 0.0]}
            source="DESNZ CfD Allocation Round 5 · 2023"
            href="#sec-international"/>
        </div>
        </ScrollReveal>
        ...
        <PositiveCallout
          ...
          value="14.7 GW"
          unit=""
          description="The UK has built more offshore wind than any country except China — generating enough electricity to power 16 million homes. Costs have fallen 70% since 2015."
        ...
        <section id="sec-capacity" className="mb-12">
          <LineChart
            title="UK installed offshore wind capacity, 2010–2024"
