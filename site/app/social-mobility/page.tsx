      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>Ethnicity, disability, and gender intersect with class in ways the headline figures obscure. British Pakistani and Bangladeshi workers face a class pay gap 40&percnt; wider than the white British average, compounding ethnic pay penalties with socioeconomic disadvantage. Disabled graduates are 15 percentage points less likely to be in professional employment three years after university than non-disabled peers with identical qualifications. Women from working-class backgrounds face a double penalty &mdash; the class ceiling and the gender pay gap combine so that a working-class woman in a professional role earns on average &pound;12,000 less per year than an upper-middle-class man in the same occupation. Early childhood is where the trajectory sets: by age five, children from the poorest fifth of families are already 11 months behind their wealthiest peers in vocabulary development, a gap that current early years provision narrows only marginally. The 30 hours of free childcare entitlement does not cover children under nine months, precisely the period when parental return to work is most constrained and the class divergence in cognitive stimulation is sharpest.</p>
