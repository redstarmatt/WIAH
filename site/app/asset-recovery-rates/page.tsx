      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The UK recovers approximately £378 million in criminal assets each year against an estimated £12 billion laundered through the financial system — a recovery rate of around 3%, up from 1.4% in 2015. The Proceeds of Crime Act 2002 established one of the world's most comprehensive legislative frameworks for confiscation, civil recovery, and cash seizure; the Criminal Finances Act 2017 added account freezing orders that have driven some of the improvement. Yet around £2 billion in active confiscation orders remains unenforced at any time — defendants hide assets offshore or die before collection — and Unexplained Wealth Orders, introduced in 2018 and widely publicised, had been issued fewer than ten times by 2024, hampered by the resource cost of legal challenges. Around 900,000 Suspicious Activity Reports were filed by professionals in 2023, a volume far exceeding law enforcement's capacity to analyse them.</p>
            <p>The gap between the UK's legislative framework and practical outcomes falls hardest on the public interest in disrupting organised crime. Incentive structures are misaligned: confiscation proceeds flow to the Consolidated Fund rather than back to enforcement agencies, reducing the financial motivation to pursue complex recovery cases over new investigations. FCA fines against banks for money laundering failings have increased in frequency but remain a fraction of the flows they are meant to deter. The UK's position as a major international financial centre — a significant source of its economic strength — simultaneously makes it an attractive destination for illicit funds that domestic enforcement resources cannot adequately intercept.</p>
          </div>
        </section>
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              href="#sec-chart"source="NCA · UK Financial Intelligence Unit annual report"
            />
            <MetricCard
              ...
              href="#sec-chart"source="Home Office · Asset recovery statistical bulletin"
            />
            <MetricCard
              label="Recovery rate"
              value="3%"
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Criminal asset recovery, 2015–2024 (£ millions)"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>Home Office — Asset recovery statistical bulletin. Published annually. gov.uk/government/statistics/asset-recovery-statistical-bulletin</p>
            <p>National Crime Agency — UK Financial Intelligence Unit annual report. nationalcrimeagency.gov.uk</p>
            <p>HMCTS — Confiscation order enforcement data. gov.uk/government/organisations/hm-courts-and-tribunals-service</p>
            <p>UK Financial Intelligence Unit — Suspicious Activity Reports annual report. nationalcrimeagency.gov.uk/who-we-are/publications/suspicious-activity-reports-sars-annual-report</p>
