      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Britain&apos;s maternal mortality rate stands at 9.7 per 100,000 maternities &mdash; up from 8.2 in 2014, roughly double Norway&apos;s rate, and above the EU average. Sixty per cent of NHS maternity units are rated &ldquo;requires improvement&rdquo; or &ldquo;inadequate&rdquo; by the CQC. The Ockenden Report (2022) found 1,223 cases of harm over 20 years at Shrewsbury and Telford NHS Trust, including 201 baby deaths and 9 maternal deaths deemed potentially avoidable; the East Kent inquiry (2023) identified a further 45 unnecessary baby deaths. England carries 2,500 midwife vacancies at a 12.3&percnt; vacancy rate, and only 14&percnt; of women receive continuity of carer despite NICE evidence that this model reduces preterm birth by 24&percnt; and stillbirth by 16&percnt;. Neonatal mortality has fallen 25&percnt; since 2010, but maternal mortality has not moved.</p>
            <p>The racial disparity is the starkest unresolved failure: Black women are 3.7 times more likely to die in or shortly after childbirth than white women, Asian women 1.8 times &mdash; a gap documented for two decades without meaningful narrowing. Implicit bias in clinical escalation, higher rates of pre-eclampsia and gestational diabetes linked to socioeconomic deprivation, and language barriers to antenatal education all compound one another. The structural remedy &mdash; continuity of carer through caseload-based midwifery teams &mdash; requires restructuring shift rotas that trusts with 12&percnt; vacancy rates cannot deliver at scale on the &pound;165 million committed by the Three-Year Delivery Plan.</p>
          </div>
        </section>
