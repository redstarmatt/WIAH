      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The racial disparity in maternal mortality reflects compounding structural factors. Research consistently shows Black women&apos;s pain is underestimated by clinicians and their concerns are less likely to trigger escalation &mdash; a pattern of implicit bias documented across multiple NHS trusts. Higher rates of pre-eclampsia, gestational diabetes, and cardiovascular conditions in some ethnic groups are partly driven by socioeconomic deprivation and its health consequences, while language barriers reduce access to antenatal education and informed consent. Continuity of carer &mdash; seeing the same midwife throughout pregnancy, birth, and postnatal care &mdash; improves outcomes by 24&percnt; for preterm birth, but delivering it requires restructuring shift-based rotas around caseload teams, which trusts with 12&percnt; vacancy rates cannot staff. The midwifery training pipeline takes three years and attrition during training runs at 25&percnt;. The Three-Year Delivery Plan committed &pound;165 million but focused primarily on workforce retention rather than expansion.</p>
            <p>Several measurement limitations affect how maternity data should be interpreted. MBRRACE-UK reports maternal mortality as a three-year rolling average specifically because annual numbers are too small for statistical reliability at national level &mdash; this means genuine changes in trend take years to appear in the data. The 9.7 per 100,000 rate uses &ldquo;maternities&rdquo; as its denominator, which differs from the &ldquo;live births&rdquo; or &ldquo;pregnancies&rdquo; denominators used elsewhere, complicating international comparison. CQC maternity ratings reflect a point-in-time inspection and services can change substantially between visits. Midwife vacancy data counts unfilled posts against an establishment figure that trusts themselves set &mdash; and which can be understated to manage headcount budgets, masking the true shortfall. Ethnic disparity data relies on self-reported ethnicity in NHS records, where coding inconsistencies and missing data are well documented.</p>
            <p>The racial disparity in maternal mortality reflects compounding structural factors. Research consistently shows Black women&apos;s pain is underestimated by clinicians and their concerns are less likely to trigger escalation &mdash; a pattern of implicit bias documented across multiple NHS trusts. Higher rates of pre-eclampsia, gestational diabetes, and cardiovascular conditions in some ethnic groups are partly driven by socioeconomic deprivation and its health consequences, while language barriers reduce access to antenatal education and informed consent. Continuity of carer &mdash; seeing the same midwife throughout pregnancy, birth, and postnatal care &mdash; improves outcomes by 24&percnt; for preterm birth, but delivering it requires restructuring shift-based rotas around caseload teams, which trusts with 12&percnt; vacancy rates cannot staff. The midwifery training pipeline takes three years and attrition during training runs at 25&percnt;. The Three-Year Delivery Plan committed &pound;165 million but focused primarily on workforce retention rather than expansion.</p>
            <p>Several measurement limitations affect how maternity data should be interpreted. MBRRACE-UK reports maternal mortality as a three-year rolling average specifically because annual numbers are too small for statistical reliability at national level &mdash; this means genuine changes in trend take years to appear in the data. The 9.7 per 100,000 rate uses &ldquo;maternities&rdquo; as its denominator, which differs from the &ldquo;live births&rdquo; or &ldquo;pregnancies&rdquo; denominators used elsewhere, complicating international comparison. CQC maternity ratings reflect a point-in-time inspection and services can change substantially between visits. Midwife vacancy data counts unfilled posts against an establishment figure that trusts themselves set &mdash; and which can be understated to manage headcount budgets, masking the true shortfall. Ethnic disparity data relies on self-reported ethnicity in NHS records, where coding inconsistencies and missing data are well documented.</p>
          </div>
        </section>
