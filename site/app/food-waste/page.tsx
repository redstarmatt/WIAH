      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>The UK wastes approximately 9.5 million tonnes of food annually across the whole supply chain &mdash; from farm gate through manufacturing, retail, and hospitality, to the household bin. Of this, households account for around 6.4 million tonnes, or roughly 70&percnt; by weight. WRAP &mdash; the Waste and Resources Action Programme &mdash; estimates the household food waste bill at &pound;19bn per year, or around &pound;700 per household, making it among the most significant items in the average household budget after housing, transport, and energy. The food thrown away is not predominantly food past its use-by date: around 50&percnt; of household food waste is food that was still edible when discarded, including bread, salad, and fruit. Environmental impact compounds the economic cost: food waste is responsible for approximately 6&percnt; of global greenhouse gas emissions when production, transportation, and decomposition are all accounted for. In the UK, the embedded carbon in wasted food amounts to around 25 million tonnes of CO2-equivalent per year. Yet the scale of food waste coexists with acute food insecurity: the Food Foundation estimates that around 7 million UK adults live in households that experienced food insecurity in 2023 &mdash; sometimes going a whole day without eating.</p>
            <p>Progress on reducing food waste has been made but at a slow and insufficient rate. WRAP data shows total UK food waste fell from an estimated 11.5 million tonnes in 2007 to 9.5 million tonnes in 2023 &mdash; a reduction of around 18&percnt; over sixteen years. The headline improvement is partly methodological: WRAP revised its measurement approach in 2018, making the comparison imperfect. Over the more recent period 2015&ndash;2023, total waste has barely moved. The UN Sustainable Development Goal 12.3 requires a 50&percnt; reduction in food waste per capita at retail and consumer level by 2030 &mdash; an ambition that would require the UK to cut household waste from around 6.4 million tonnes to around 3.2 million tonnes in seven years. At current rates of progress, the UK will fall far short. The Courtauld Commitment &mdash; a voluntary industry agreement led by WRAP &mdash; has engaged major retailers and food manufacturers in waste reduction targets, but voluntary action has inherent limits and progress has been slower than hoped.</p>
