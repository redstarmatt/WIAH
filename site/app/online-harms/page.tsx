      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The burden falls heaviest on the most vulnerable. Over-65s lose the most per fraud incident &mdash; an average &pound;3,500 per case &mdash; while 18&ndash;34-year-olds face the highest volume of attacks through social media and marketplace scams. Women account for 72% of romance fraud victims and the majority of image-based sexual abuse cases. Fewer than 1% of fraud cases result in a charge; Action Fraud was so widely criticised for losing reports that it is being replaced in 2025. The structural gap is institutional: fraud sits across the National Crime Agency, City of London Police, local forces, and banks, with no single body owning the problem end to end.</p>
          </div>
        </section>
