      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>Ministry of Justice proven reoffending data shows consistently that one-year reoffending rates for community orders average around 32%, compared with approximately 45% for sentences under 12 months in custody &mdash; a 13 percentage-point gap that has been stable since 2015. Short prison sentences are too brief to deliver rehabilitation but long enough to sever employment, housing, and family ties that protect against reoffending, leaving people in a worse position on release. Community orders can attach conditions &mdash; unpaid work, drug treatment, alcohol monitoring, mental health treatment &mdash; while preserving those protective social ties. Completion rates improved to 68% in 2023, despite probation vacancy rates exceeding 20% in some regions and rising caseloads following COVID-19 court backlogs.</p>
