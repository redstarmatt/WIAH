      ...
      <main>
        ...
        <section id="sec-context" className="bg-wiah-light py-16 px-6">
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <p>
              Drug poisoning deaths in England and Wales hit 4,907 in 2023 (provisional)&mdash;166% higher than the 1,843 recorded in 2004. Opioids account for roughly 52% of all drug deaths: heroin and morphine alone killed 2,219 people, and synthetic opioids including fentanyl are rising fast. Scotland recorded 1,051 deaths in 2022, a rate 3.7 times the England and Wales figure per capita and the highest in Europe. The age profile is telling. Most deaths occur among people aged 35&ndash;54, not the young&mdash;a cohort effect tracing back to the 1980s heroin wave now compounded by decades of poverty, poor health, and polydrug use.
            </p>

            <p>
              Alcohol-specific deaths reached 10,048 across the UK in 2023&mdash;a record. England and Wales accounted for 7,852, with liver disease the primary cause. The 2020&ndash;22 surge was driven by heavy drinkers isolated during lockdowns with reduced access to healthcare; deaths have remained elevated even as the pandemic ended. Treatment infrastructure was hollowed out between 2013 and 2020: Public Health England estimated a 40% real-terms funding cut, and many specialist units closed. NICE estimates around 800,000 people in the UK have severe drug or alcohol problems; only about 300,000 are in treatment&mdash;a gap of roughly 500,000.
            </p>

            <p>
              The government&apos;s 2021 strategy, From Harm to Hope, committed &pound;780 million over three years, shifting emphasis toward recovery rather than maintenance prescribing. Treatment numbers have begun climbing: 298,700 adults were in structured treatment in 2023/24. One significant policy change arrived in 2023&mdash;naloxone, the life-saving opioid antidote, became available without prescription from pharmacies, a measure that could prevent thousands of deaths annually if distribution reaches the people most at risk. Deaths, however, continue to rise. The strategy is funded; the question is whether it can outrun a crisis four decades in the making.
            </p>
            <p>The demographics of drug death in the UK confound public assumptions. The typical victim is not a teenager experimenting at a party but a white man in his forties or fifties, often with decades of opioid dependence behind him. This is the cohort effect in action&mdash;people who began using heroin during the supply glut of the 1990s are now dying in middle age, their bodies weakened by years of chronic use, hepatitis C, poor nutrition, and social exclusion. Deaths peak in the 25&ndash;54 age range, and in some local authority areas up to 40&percnt; of drug poisoning deaths involve people with no fixed abode. Homelessness and drug death are not merely correlated; they share the same root causes of poverty, trauma, and fractured services. When heroin supply is disrupted&mdash;the so-called &ldquo;heroin drought&rdquo;&mdash;users do not stop using. They switch to more dangerous alternatives: synthetic opioids, illicit benzodiazepines, or combinations that multiply overdose risk. The policy response most supported by international evidence&mdash;supervised drug consumption rooms&mdash;remains legally impossible in the UK. More than 200 such facilities operate worldwide, with consistent evidence of reduced overdose deaths and increased treatment uptake. The Scottish Government has sought to pilot one in Glasgow since 2017, but the Misuse of Drugs Act 1971 is reserved to Westminster, and no legislative amendment has been forthcoming.</p>
            <p>The headline figure of 4,907 drug poisoning deaths in England and Wales is drawn from ONS mortality data based on coroner&apos;s verdicts, and it carries an inherent lag of 18 months or more from the date of death to registration. The classification itself is narrow: a death is counted as drug poisoning only where substances are identified as the direct cause on the death certificate. Deaths where drug use was a major contributing factor but not the formal cause&mdash;hypothermia while intoxicated, drug-related violence, infections from injecting&mdash;fall outside the count entirely. The National Drug Treatment Monitoring System records treatment episodes rather than unique individuals, and its counting methodology has changed multiple times, making longitudinal comparisons unreliable without careful adjustment. The headline figure of 298,700 people &ldquo;in treatment&rdquo; does not distinguish between a single brief intervention and 18 months of structured residential rehabilitation. Scotland uses a different mortality coding approach from England and Wales, meaning UK-wide comparisons carry significant caveats that are rarely acknowledged in media reporting. There is no reliable real-time surveillance of drug supply changes. Fentanyl prevalence is estimated from seizure data and post-mortem toxicology&mdash;both of which tell you what was there after the fact, not what is circulating now.</p>
          </div>
        </section>
