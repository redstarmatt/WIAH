      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            <p>
              The UK has met NATO&apos;s 2&percnt; of GDP defence spending target continuously since 2014, when the target was formally adopted at the Wales Summit. The current figure of 2.3&percnt; represents approximately &pound;55 billion annually. The Integrated Review Refresh 2023 committed to spending 2.5&percnt; of GDP on defence &ldquo;in the longer term,&rdquo; following the strategic shock of Russia&apos;s full-scale invasion of Ukraine in 2022 which exposed the inadequacy of European defence preparedness. The 2024 Strategic Defence Review, commissioned by the new Labour government and published in 2025, set out a pathway to 2.5&percnt; by the early 2030s. The headline percentage figures, however, mask serious questions about what the money is buying, how it is spent, and whether the UK&apos;s actual military capability matches its global commitments and stated ambitions.
            </p>
            <p>
              The British Army is smaller now than at any time since the defeat of Napoleon at Waterloo in 1815. The 2010 Strategic Defence and Security Review cut army regular strength to a target of 82,000, which was further reduced in the 2021 Integrated Review to 72,500 &mdash; the lowest on record. By 2023, actual strength had fallen to approximately 73,000 &mdash; a force that would be challenged to sustain a single major warfighting division in the field. The army&apos;s 2023 recruiting shortfall was the largest on record: it recruited 6,600 soldiers against a target of 9,000, a success rate of around 73&percnt;. Recruitment has been hampered by physical fitness requirements, pay that is uncompetitive with civilian employers, housing quality concerns, and reputational damage from high-profile misconduct cases. The Army Recruiting Review 2023 acknowledged that the service model &mdash; designed for a Cold War mass conscript force &mdash; had not been adequately reformed for a professional volunteer army.
            </p>
            <p>
