      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <div id="sec-metrics" className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
            <MetricCard
              ...
              href="#sec-chart"source="ONS · ASHE Disability Analysis 2023"
            />
            <MetricCard
              ...
              href="#sec-chart"source="DWP · Labour Force Survey 2023"
            />
            <MetricCard
              ...
              href="#sec-chart"source="ONS / Scope · 2023"
            />
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal>
          <section id="sec-chart" className="mb-12">
            <LineChart
              title="Disability pay gap and employment gap, 2015–2023"
        ...
        <section id="sec-sources" className="mt-16 pt-8 border-t border-wiah-border max-w-2xl">
          ...
          <div className="text-sm text-wiah-mid space-y-3 font-mono">
            <p>ONS — Disability Pay Gaps in the UK. ons.gov.uk/employmentandlabourmarket/peopleinwork/earningsandworkinghours/articles/disabilitypaygapsintheuk</p>
            <p>DWP — Employment of Disabled People. gov.uk/government/statistics/the-employment-of-disabled-people-2023</p>
            <p>Scope — Disability and the Poverty Premium. scope.org.uk/research/disability-poverty</p>
