...
export default function AmbulanceRuralPage() {
  ...
  const responseAnnotations: Annotation[] = [
    { date: new Date(2020, 5, 1), label: '2020: COVID — reduced demand' },
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <ScrollReveal>
          <section id="sec-response" className="mb-12">
            <LineChart
              title="Category 2 ambulance mean response time by area type, England, 2019–2024"
        ...
        <ScrollReveal>
          <PositiveCallout
            ...
            source="Source: NHS England — Ambulance Quality Indicators, 2024. Association of Ambulance Chief Executives."
          />
        </ScrollReveal>
