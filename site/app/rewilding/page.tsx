      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section id="sec-context" className="max-w-2xl mt-4 mb-12">
          <div className="text-base text-wiah-black leading-[1.7] space-y-4">
            ...
            <p>The Nature Recovery Network &mdash; a government commitment to create and restore wildlife-rich habitat across England &mdash; sits at the centre of domestic policy. The Environment Act 2021 introduced legally binding targets including halting net species decline by 2030. Biodiversity Net Gain became mandatory for major developments from January 2024, requiring all new construction to demonstrate a 10% net improvement in biodiversity value. Environmental Land Management schemes &mdash; Sustainable Farming Incentive, Countryside Stewardship, and Landscape Recovery &mdash; direct agricultural payments toward environmental outcomes, replacing EU Common Agricultural Policy subsidies. By March 2024, around 34,000 farm businesses had active SFI agreements, covering 1.8 million hectares. Landscape Recovery, the most ambitious tier, has 56 projects approved in two rounds, covering around 700,000 hectares &mdash; a promising start, but less than 2% of UK land area. Cairngorms Connect, a 200-year restoration partnership covering 60,000 hectares of Highland Scotland, is one of the most ambitious rewilding projects in Europe, targeting natural regeneration of native woodland and restoration of river systems.</p>
            <p>The geography of rewilding in the UK is deeply uneven. Scotland hosts the majority of large-scale rewilding ambitions, underpinned by vast upland estates and stronger government support: NatureScot&apos;s peatland restoration programme has restored over 50,000 hectares since 2012. Wales launched its Nature Recovery Action Plan in 2022, with a target of 30% of land in good ecological condition by 2030. England lags, partly because higher land values, more intensive agriculture, and denser settlement reduce the supply of viable rewilding land. The Cambrian Wildwood project in mid-Wales aims to restore 10,000 hectares of Celtic rainforest. In Northern Ireland, just 9% of land is in protected areas and nature recovery planning is at an early stage. Urban rewilding &mdash; wildflower verges, rewilded parks, pollinator corridors &mdash; has expanded rapidly in cities including London and Manchester but contributes only marginally to national biodiversity targets. Rewilding projects disproportionately occur on land that was already relatively wildlife-rich; the deepest conservation deficits are in intensively farmed lowland England, precisely where rewilding is hardest to achieve.</p>
            <p>The 30x30 target is ambitious but its measurement is contested. The UK currently counts 26% of seas as &ldquo;protected&rdquo; via Marine Protected Areas, but independent assessments find most MPAs offer minimal ecological benefit because damaging activities including bottom trawling are still permitted within their boundaries. On land, the gap between the 8.5% in protected areas and the 3.2% in good condition reflects the extent to which designation has outpaced management. The species index used in State of Nature is a composite of well-monitored taxa &mdash; birds, butterflies, plants &mdash; and may not capture trends in less-studied groups including invertebrates and fungi. Carbon sequestration estimates from rewilding are highly sensitive to assumptions about soil carbon dynamics, tree species, and counterfactual land use. Rewilding Britain&apos;s 47 million tonne figure assumes the most optimistic combination of land use change and natural regeneration rates, and independent peer review has questioned whether it can be achieved at the speed claimed.</p>
          </div>
        </section>
