...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    topics: ['food-insecurity', 'food-banks', 'food-inflation', 'food-deserts', 'food-production', 'agricultural-emissions', 'farming-subsidies', 'food-hygiene-compliance', 'food-standards-post-brexit', 'sugar-levy-impact', 'ultra-processed-food', 'meat-consumption-trend', 'infant-feeding', 'holiday-hunger', 'food-waste', 'school-meals-standards', 'school-meals-procurement'],
  },
  {
...
export const TOPICS: Record<string, TopicEntry> = {
  ...
  // ── Orphan pages ────────────────────────────────────────────────────────
  'buy-to-let-exit': { topic: 'Buy-to-Let Exit', slug: 'buy-to-let-exit', href: '/buy-to-let-exit', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Net landlord decline 2022–25', value: '140,000', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'selling faster than entering · Section 24 tax change', sparklineData: [2820,2800,2770,2730,2680,2620,2560] }, { label: 'Private rental listings vs 2020', value: '-29%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'fewer properties · rents rising as supply shrinks', sparklineData: [100,105,108,95,82,75,71] }] },
  'care-home-staffing': { topic: 'Care Home Staffing', slug: 'care-home-staffing', href: '/care-home-staffing', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Care home vacancies', value: '165,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '30% annual turnover · 1 in 8 posts unfilled', sparklineData: [120000,130000,140000,155000,148000,160000,165000] }, { label: 'Average care worker hourly pay', value: '£11.20', direction: 'up' as const, polarity: 'up-is-good' as const, context: '+27% since 2019 but below NHS equivalents', sparklineData: [8.8,9.2,9.6,10.0,10.4,10.8,11.2] }] },
  'child-tooth-decay': { topic: 'Child Tooth Decay', slug: 'child-tooth-decay', href: '/child-tooth-decay', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Children aged 5 with tooth decay', value: '26%', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: 'down from 33% in 2015 but stalling since 2021', sparklineData: [33,31,29,28,27,26,26,26] }, { label: 'Hospital admissions for decay under-18', value: '34,000', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: 'almost entirely preventable · #1 reason for child hospital admission', sparklineData: [35000,34500,34200,33800,34000,34200,34000] }] },
  'climate-adaptation-costs': { topic: 'Climate Adaptation Costs', slug: 'climate-adaptation-costs', href: '/climate-adaptation-costs', colour: '#264653', preposition: 'with', metrics: [{ label: 'Annual adaptation spending', value: '£800M', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'vs £78bn needed by 2050 at 2°C · 1% of requirement', sparklineData: [400,480,540,600,660,730,800] }, { label: 'Uninsured households in flood zones', value: '1.4M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'growing as insurers exit or price out', sparklineData: [900000,1000000,1100000,1200000,1280000,1350000,1400000] }] },
  'community-energy': { topic: 'Community Energy', slug: 'community-energy', href: '/community-energy', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Community energy installed capacity', value: '350 MW', direction: 'up' as const, polarity: 'up-is-good' as const, context: '+80% since 2020 · enough to power 350,000 homes', sparklineData: [130,160,195,230,270,310,350] }, { label: 'Annual community energy investment', value: '£215M', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'record investment in 2025 · grid connection costs rising', sparklineData: [95,110,130,155,175,195,215] }] },
  'court-fees-access': { topic: 'Court Fee Barriers', slug: 'court-fees-access', href: '/court-fees-access', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Civil court fee income', value: '£780M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '2023/24 · courts as revenue generators not public service', sparklineData: [520,580,620,660,690,730,780] }, { label: 'Civil claims issued annually', value: '1.3M', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down 40% from 2010 peak · fee hikes suppressing access', sparklineData: [2200000,2000000,1800000,1650000,1500000,1380000,1300000] }] },
  'employment-tribunal-backlog': { topic: 'Employment Tribunal Backlog', slug: 'employment-tribunal-backlog', href: '/employment-tribunal-backlog', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Outstanding employment tribunal cases', value: '54,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '+135% since pre-pandemic · 2022 peak of 58,000', sparklineData: [23000,26000,32000,45000,58000,56000,54000] }, { label: 'Average wait for final hearing', value: '51 weeks', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 27 weeks in 2018 · nearly a year for resolution', sparklineData: [27,30,34,38,44,49,51] }] },
  'equity-release-market': { topic: 'Equity Release Market', slug: 'equity-release-market', href: '/equity-release-market', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'Total equity release lending', value: '£2.6bn', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from £6.2bn peak in 2022 · rate rise knocked market', sparklineData: [3.5,5.0,5.8,6.2,5.5,3.9,2.6] }, { label: 'Average lifetime mortgage rate', value: '6.8%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'debt doubles in ~12 years · compound interest main risk', sparklineData: [5.0,5.2,5.5,5.8,6.1,6.5,6.8] }] },
  'food-hygiene-compliance': { topic: 'Food Hygiene Compliance', slug: 'food-hygiene-compliance', href: '/food-hygiene-compliance', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'Food businesses rated 4–5 (FSA)', value: '65%', direction: 'down' as const, polarity: 'up-is-good' as const, context: 'down from 76% in 2019 · pandemic and cost pressures', sparklineData: [76,75,72,68,65,65,65] }, { label: 'Annual food poisoning hospitalisations', value: '25,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 22,000 in 2018 · Campylobacter main cause', sparklineData: [22000,22500,23000,23500,24000,24500,25000] }] },
  'food-standards-post-brexit': { topic: 'Food Standards Post-Brexit', slug: 'food-standards-post-brexit', href: '/food-standards-post-brexit', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'Food safety incidents (imports)', value: '87', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 62 in 2021 · delayed border checks left gap', sparklineData: [62,65,68,72,76,82,87] }, { label: 'Cumulative food standard divergences from EU', value: '14', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'affects agri-food exporters to EU', sparklineData: [0,2,4,6,8,10,12,14] }] },
  'grassroots-sport': { topic: 'Grassroots Sport', slug: 'grassroots-sport', href: '/grassroots-sport', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Sports/leisure facilities closed since 2010', value: '1,200', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'austerity-era council cuts · swimming pools hardest hit', sparklineData: [200,400,600,750,900,1050,1200] }, { label: 'Weekly sport participation (adults)', value: '61.3%', direction: 'flat' as const, polarity: 'up-is-good' as const, context: 'stagnant since 2019 · pre-pandemic peak was 63%', sparklineData: [59,60,61,63,61,61,61.3] }] },
  'green-skills-gap': { topic: 'Green Skills Gap', slug: 'green-skills-gap', href: '/green-skills-gap', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Heat pump installers trained per year', value: '3,200', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'vs 130,000 needed by 2028 · gap widening not closing', sparklineData: [1200,1500,1800,2200,2600,2900,3200] }, { label: 'UK green job vacancies per quarter', value: '215,000', direction: 'up' as const, polarity: 'up-is-good' as const, context: '+514% since 2020 · not enough workers to fill them', sparklineData: [35000,60000,90000,130000,165000,190000,215000] }] },
  'hospital-parking': { topic: 'Hospital Parking Charges', slug: 'hospital-parking', href: '/hospital-parking', colour: '#E63946', preposition: 'with', metrics: [{ label: 'NHS parking charge revenue', value: '£214M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '2022/23 · up from £188M pre-pandemic', sparklineData: [165,175,188,180,190,205,214] }, { label: 'Trusts charging disabled patients', value: '38%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 52% · 2019 pledge still not fully met', sparklineData: [52,50,47,44,42,40,38] }] },
  'housing-first-programme': { topic: 'Housing First Programme', slug: 'housing-first-programme', href: '/housing-first-programme', colour: '#F4A261', metrics: [{ label: 'Housing First placements (England)', value: '1,400', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'cumulative since 2019 · tiny vs 270,000+ hidden homeless', sparklineData: [0,200,400,700,950,1150,1400] }, { label: 'Housing retention after 2 years', value: '80%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'most successful intervention for complex needs homelessness', sparklineData: [72,74,76,77,78,79,80] }] },
  'infant-feeding': { topic: 'Infant Feeding', slug: 'infant-feeding', href: '/infant-feeding', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Breastfeeding at 6 months', value: '26%', direction: 'flat' as const, polarity: 'up-is-good' as const, context: 'lowest in developed world · OECD average 46%', sparklineData: [25,25,26,26,26,26,26] }, { label: 'Monthly formula cost per baby', value: '£50', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '+32% since 2020 · some families diluting formula', sparklineData: [38,40,42,44,46,48,50] }] },
  'military-housing-quality': { topic: 'Military Housing Quality', slug: 'military-housing-quality', href: '/military-housing-quality', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Service accommodation below standard', value: '40%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 32% in 2018 · Annington Homes contract blamed', sparklineData: [32,33,35,36,37,39,40] }, { label: 'MOD housing maintenance backlog', value: '£750M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from £480M in 2018 · rents absorb maintenance funds', sparklineData: [480,520,570,610,650,700,750] }] },
  'nhs-app-usage': { topic: 'NHS App Usage', slug: 'nhs-app-usage', href: '/nhs-app-usage', colour: '#E63946', preposition: 'with', metrics: [{ label: 'NHS App registered users', value: '35.1M', direction: 'up' as const, polarity: 'up-is-good' as const, context: '+997% since 2020 · largest health app in Europe', sparklineData: [3.2,8.0,15.0,22.0,28.0,32.0,35.1] }, { label: 'People unable to access online services', value: '8.5M', direction: 'down' as const, polarity: 'up-is-bad' as const, context: '14% of population · elderly and low-income hardest hit', sparklineData: [11.0,10.5,10.0,9.5,9.0,8.7,8.5] }] },
  'night-time-economy': { topic: 'Night-Time Economy', slug: 'night-time-economy', href: '/night-time-economy', colour: '#1A1A1A', preposition: 'with', metrics: [{ label: 'UK pubs closed since 2016', value: '7,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '6–7 pubs per day · rural areas hardest hit', sparklineData: [1000,2000,3000,4200,5400,6200,7000] }, { label: 'UK nightclubs remaining', value: '872', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 3,144 in 2005 · 72% decline in 20 years', sparklineData: [3144,2800,2400,1900,1500,1100,872] }] },
  'obesity-treatment-access': { topic: 'Obesity Treatment Access', slug: 'obesity-treatment-access', href: '/obesity-treatment-access', colour: '#E63946', preposition: 'with', metrics: [{ label: 'NHS Wegovy prescriptions', value: '35,000', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'vs 860,000 eligible · strict rationing via tier system', sparklineData: [0,2000,6000,12000,20000,28000,35000] }, { label: 'Bariatric surgery wait time', value: '30 months', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 8 months in 2018', sparklineData: [8,10,14,18,22,26,30] }] },
  'over-50s-employment': { topic: 'Over-50s Employment', slug: 'over-50s-employment', href: '/over-50s-employment', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Employment rate 50–64', value: '67.8%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'recovering from pandemic low of 65.8%', sparklineData: [67.5,68.0,68.5,65.8,66.5,67.2,67.8] }, { label: 'Inactive 50–64s citing long-term illness', value: '950,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '+40% since 2019 · NHS waiting list backlog a key driver', sparklineData: [678000,700000,730000,780000,840000,900000,950000] }] },
  'planning-appeals': { topic: 'Planning Appeals', slug: 'planning-appeals', href: '/planning-appeals', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'Housing appeal success rate', value: '43%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 33% in 2015 · developers win £1bn in permissions pa', sparklineData: [33,35,36,38,40,42,43] }, { label: 'Permitted homes unbuilt', value: '260,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'planning permission granted but not built', sparklineData: [180000,200000,220000,235000,245000,255000,260000] }] },
  'private-school-vat': { topic: 'Private School VAT', slug: 'private-school-vat', href: '/private-school-vat', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'Average private school termly fee', value: '£6,300', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up 21% since 2022 · VAT pass-through + pre-existing inflation', sparklineData: [5200,5400,5600,5800,6000,6150,6300] }, { label: 'Pupils moved to state sector (2025)', value: '35,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'below government 40,000 projection', sparklineData: [0,0,0,0,0,0,35000] }] },
  'remote-work-access': { topic: 'Remote Work Access', slug: 'remote-work-access', href: '/remote-work-access', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Homeworking access (bottom income quintile)', value: '12%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'vs 68% top quintile · 56pp class divide in flexibility', sparklineData: [5,6,7,8,9,10,12] }, { label: 'Working from home (at least 1 day/week)', value: '22%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 5.7% pre-pandemic · settled at new norm', sparklineData: [5.7,15.0,20.0,22.0,22.5,22.0,22.0] }] },
  'school-catchment-inequality': { topic: 'School Catchment Inequality', slug: 'school-catchment-inequality', href: '/school-catchment-inequality', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'House price premium near top schools', value: '£40,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'average premium to live in best catchment · up from £28k in 2015', sparklineData: [28000,30000,32000,34000,36000,38000,40000] }, { label: 'FSM pupils at oversubscribed schools', value: '40% below avg', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'top schools consistently less deprived than local area', sparklineData: [38,39,39,39,40,40,40] }] },
  'second-job-holders': { topic: 'Second Job Holders', slug: 'second-job-holders', href: '/second-job-holders', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'People in second jobs (UK)', value: '1.3M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '+22% since 2019 · gig platforms facilitating side income', sparklineData: [1060000,1080000,1100000,1150000,1200000,1250000,1300000] }, { label: 'NHS staff working second jobs', value: '13%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 7% in 2019 · pay stagnation driving moonlighting', sparklineData: [7,8,9,10,11,12,13] }] },
  'social-care-turnover': { topic: 'Social Care Turnover', slug: 'social-care-turnover', href: '/social-care-turnover', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Adult social care staff turnover', value: '28.3%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 25% in 2015 · 1 in 3 workers leaves every year', sparklineData: [25.0,25.5,26.0,26.5,27.0,27.8,28.3] }, { label: 'Unfilled care vacancies', value: '131,000', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from peak 155,000 · international recruitment main relief', sparklineData: [90000,105000,120000,145000,155000,142000,131000] }] },
  'worker-monitoring': { topic: 'Workplace Monitoring', slug: 'worker-monitoring', href: '/worker-monitoring', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Employers using productivity monitoring', value: '72%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 22% in 2019 · keystroke logging, screen capture, GPS', sparklineData: [22,28,38,50,60,67,72] }, { label: 'Workers citing monitoring harm to wellbeing', value: '45%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'TUC/YouGov 2024 · anxiety, distrust, chilling effect', sparklineData: [20,25,30,35,38,42,45] }] },
  'youth-club-closures': { topic: 'Youth Club Closures', slug: 'youth-club-closures', href: '/youth-club-closures', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Youth clubs closed since 2010', value: '4,500', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '>50% of all provision · fastest in deprived urban areas', sparklineData: [500,1000,1700,2400,3100,3800,4500] }, { label: 'Qualified youth workers remaining', value: '20,000', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down 70% from 68,000 in 2010 · volunteers patching gaps', sparklineData: [68000,58000,48000,38000,30000,24000,20000] }] },
  // ── New topics ──────────────────────────────────────────────────────────
  'cataract-waits': { topic: 'Cataract Waits', slug: 'cataract-waits', href: '/cataract-waits', colour: '#E63946', preposition: 'for', metrics: [{ label: 'Patients waiting over 18 weeks for cataracts', value: '61,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 8,000 in 2019 · sight deteriorating while waiting', sparklineData: [8000,10000,18000,35000,52000,58000,61000] }, { label: 'Average cataract wait (weeks)', value: '19.2', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 8 weeks in 2019', sparklineData: [8,9,11,15,17,18,19.2] }] },
  'hip-knee-waits': { topic: 'Hip & Knee Replacement Waits', slug: 'hip-knee-waits', href: '/hip-knee-waits', colour: '#E63946', preposition: 'for', metrics: [{ label: 'Patients waiting for hip/knee replacement', value: '165,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 55,000 in 2019 · most waiting over a year', sparklineData: [55000,60000,90000,130000,155000,160000,165000] }, { label: 'Waiting over 52 weeks for orthopaedics', value: '42%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 1% in 2019 · pain and disability deteriorating', sparklineData: [1,2,5,15,28,38,42] }] },
  'audiology-waits': { topic: 'Audiology Waits', slug: 'audiology-waits', href: '/audiology-waits', colour: '#E63946', preposition: 'for', metrics: [{ label: 'Adults waiting for hearing assessment', value: '1.1M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 320,000 in 2019 · hidden disability crisis', sparklineData: [320000,400000,550000,750000,900000,1020000,1100000] }, { label: 'Average wait for hearing aid fitting (months)', value: '9', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 3 months pre-pandemic · social isolation consequences', sparklineData: [3,4,5,6,7,8,9] }] },
  'naloxone-provision': { topic: 'Naloxone Provision', slug: 'naloxone-provision', href: '/naloxone-provision', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Naloxone kits distributed (England 2024)', value: '98,000', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 48,000 in 2020 · Scotland distributes 3x more per capita', sparklineData: [22000,28000,35000,48000,60000,78000,98000] }, { label: 'Drug poisoning deaths (England)', value: '4,907', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '2023 record · opioids main driver · naloxone reverses overdose', sparklineData: [3756,3898,4089,4561,4859,4900,4907] }] },
  'hepatitis-c-treatment': { topic: 'Hepatitis C Elimination', slug: 'hepatitis-c-treatment', href: '/hepatitis-c-treatment', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Diagnosed hepatitis C cases (England)', value: '91,000', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 160,000 in 2015 · elimination target 2025 in doubt', sparklineData: [160000,148000,132000,118000,105000,97000,91000] }, { label: 'Patients treated with direct-acting antivirals', value: '35,000/yr', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 40,000/yr · hard-to-reach populations remain', sparklineData: [15000,28000,40000,38000,36000,36000,35000] }] },
  'dementia-diagnosis-rate': { topic: 'Dementia Diagnosis Rate', slug: 'dementia-diagnosis-rate', href: '/dementia-diagnosis-rate', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Dementia diagnosis rate (65+)', value: '62.7%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 68.4% in 2016 · 400,000 people living undiagnosed', sparklineData: [66,68.4,67,65,63,62.5,62.7] }, { label: 'People living with diagnosed dementia', value: '465,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'diagnosis rate falling behind prevalence', sparklineData: [400000,415000,425000,435000,445000,455000,465000] }] },
  'same-day-emergency-care': { topic: 'Same Day Emergency Care', slug: 'same-day-emergency-care', href: '/same-day-emergency-care', colour: '#E63946', preposition: 'with', metrics: [{ label: 'SDEC attendances per month (England)', value: '280,000', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 90,000 in 2019 · diverts patients from inpatient beds', sparklineData: [90000,100000,130000,180000,220000,260000,280000] }, { label: 'A&E admissions avoided by SDEC (est.)', value: '15%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'of all emergency care · reduces pressure on beds', sparklineData: [5,7,9,11,12,14,15] }] },
  'nhs-overseas-cost-recovery': { topic: 'NHS Overseas Cost Recovery', slug: 'nhs-overseas-cost-recovery', href: '/nhs-overseas-cost-recovery', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Overseas visitor charges collected', value: '£430M', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from £283M in 2019 · but estimated £1bn still not collected', sparklineData: [200,230,250,283,310,380,430] }, { label: 'Estimated uncollected overseas charges', value: '£1bn+', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: 'structural gap · pre-treatment checks still inconsistent', sparklineData: [1200,1150,1100,1100,1050,1000,1000] }] },
  'prison-healthcare': { topic: 'Prison Healthcare', slug: 'prison-healthcare', href: '/prison-healthcare', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'GP consultations per prisoner per year', value: '4.8', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 6.1 in 2018 · staffing shortages reducing access', sparklineData: [6.1,5.9,5.5,4.9,4.7,4.8,4.8] }, { label: 'Prisoners with mental illness', value: '70%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 60% in 2010 · prison as de facto psychiatric facility', sparklineData: [60,62,64,66,68,69,70] }] },
  'bowel-screening': { topic: 'Bowel Cancer Screening', slug: 'bowel-screening', href: '/bowel-screening', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Bowel cancer screening uptake (50–74)', value: '67.5%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 58% in 2015 · FIT test improved participation', sparklineData: [58,60,62,64,65,66.5,67.5] }, { label: 'Bowel scope coverage of eligible 55 year olds', value: '45%', direction: 'flat' as const, polarity: 'up-is-good' as const, context: 'backlog from COVID suspension', sparklineData: [30,38,45,50,40,42,45] }] },
  'cervical-screening': { topic: 'Cervical Screening', slug: 'cervical-screening', href: '/cervical-screening', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Cervical screening coverage (25–49)', value: '70.3%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'lowest rate in 20 years · target is 80% · 2,700 lives/year stake', sparklineData: [80,79,77,75,73,71,70.3] }, { label: 'Cervical screening coverage (50–64)', value: '75.8%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'also declining · older age group less often reminded', sparklineData: [81,80,79,78,77,76,75.8] }] },
  'breast-screening': { topic: 'Breast Screening', slug: 'breast-screening', href: '/breast-screening', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Breast screening coverage (50–70)', value: '70.1%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 77% in 2012 · 100 lives/year at stake', sparklineData: [77,76,74,72,71,70.3,70.1] }, { label: 'Women overdue for breast screening', value: '1.4M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'COVID backlog not fully cleared · capacity constrained', sparklineData: [500000,600000,900000,1600000,1500000,1450000,1400000] }] },
  'hpv-vaccination': { topic: 'HPV Vaccination Coverage', slug: 'hpv-vaccination', href: '/hpv-vaccination', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'HPV vaccine coverage (girls, dose 1)', value: '84.5%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'recovering from pandemic low of 58% · target 80%', sparklineData: [84,80,58,65,74,80,84.5] }, { label: 'HPV vaccine coverage (boys, dose 1)', value: '72.3%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'programme extended to boys 2019 · still 12pp below girls', sparklineData: [0,0,55,60,65,70,72.3] }] },
  'vaping-youth': { topic: 'Youth Vaping', slug: 'vaping-youth', href: '/vaping-youth', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Young people aged 11–17 who vape', value: '9.1%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 1.5% in 2020 · disposable vapes dominant vector', sparklineData: [1.5,2.0,3.2,5.0,7.0,8.3,9.1] }, { label: 'Under-18 vape sales by retailers', value: '11%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 28% in 2023 · illegal sales still widespread', sparklineData: [28,26,22,18,15,13,11] }] },
  'ultra-processed-food': { topic: 'Ultra-Processed Food', slug: 'ultra-processed-food', href: '/ultra-processed-food', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'Share of UK diet that is ultra-processed', value: '57%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'highest in Europe · up from 51% in 2008', sparklineData: [51,52,53,54,55,56,57] }, { label: 'UPF share of children\'s diet', value: '67%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 62% in 2010 · school food standards not applied uniformly', sparklineData: [62,63,64,65,66,66.5,67] }] },
  'adult-obesity': { topic: 'Adult Obesity', slug: 'adult-obesity', href: '/adult-obesity', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Adult obesity prevalence (England)', value: '29.5%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 26.9% in 2015 · highest rate on record', sparklineData: [26.9,27.2,27.5,28.0,28.5,29.0,29.5] }, { label: 'Severe obesity (BMI 40+)', value: '4.1%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 2.4% in 2010 · highest deprivation quintile 2x more', sparklineData: [2.4,2.6,2.8,3.2,3.6,3.9,4.1] }] },
  'melanoma-rates': { topic: 'Melanoma Rates', slug: 'melanoma-rates', href: '/melanoma-rates', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Melanoma incidence per 100,000', value: '22.4', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up 135% in 40 years · sunbed use and holiday patterns', sparklineData: [14,16,17,18,19,21,22.4] }, { label: 'Melanoma 5-year survival rate', value: '93%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 76% in 2000 · stage-specific: stage IV still 20%', sparklineData: [76,80,84,87,90,92,93] }] },
  'occupational-disease': { topic: 'Occupational Disease', slug: 'occupational-disease', href: '/occupational-disease', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Work-related ill health cases (annual)', value: '1.8M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'record high · stress, depression, anxiety account for 50%', sparklineData: [1.3,1.4,1.5,1.6,1.7,1.75,1.8] }, { label: 'Days lost to work-related illness (millions)', value: '35.2', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 31.8M in 2019 · mental health main cause', sparklineData: [31.8,33.0,34.0,34.5,35.0,35.1,35.2] }] },
  'sugar-levy-impact': { topic: 'Sugar Levy Impact', slug: 'sugar-levy-impact', href: '/sugar-levy-impact', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Sugar in soft drinks (average reduction)', value: '-35%', direction: 'down' as const, polarity: 'up-is-good' as const, context: 'reduction since 2016 baseline · reformulation before levy took effect', sparklineData: [100,90,80,72,67,66,65] }, { label: 'Childhood obesity rate (reception age)', value: '9.5%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 9.1% pre-levy · levy effect outpaced by wider diet trends', sparklineData: [9.1,9.2,9.3,9.4,9.3,9.4,9.5] }] },
  'stop-and-search': { topic: 'Stop and Search', slug: 'stop-and-search', href: '/stop-and-search', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Stop and searches per year (England & Wales)', value: '1.06M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up 72% since 2016 · knife crime response policy', sparklineData: [380000,420000,530000,680000,780000,940000,1060000] }, { label: 'Black people stopped vs white (ratio)', value: '7:1', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 5:1 in 2018 · disproportionality highest in London', sparklineData: [4,4.5,5,5.5,6,6.5,7] }] },
  'parole-backlog': { topic: 'Parole Board Backlog', slug: 'parole-backlog', href: '/parole-backlog', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Cases awaiting parole hearing', value: '11,800', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 6,200 in 2019 · prisoners held beyond minimum tariff', sparklineData: [6200,6800,7500,8500,9800,11000,11800] }, { label: 'Average wait for parole hearing (months)', value: '18', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 11 months in 2019', sparklineData: [11,12,13,14,15,16,18] }] },
  'deaths-in-custody': { topic: 'Deaths in Custody', slug: 'deaths-in-custody', href: '/deaths-in-custody', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Deaths in prison custody per year', value: '324', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '2023 · 25% self-inflicted · overcrowding and mental health crisis', sparklineData: [230,240,256,270,288,310,324] }, { label: 'Self-inflicted deaths in custody', value: '81', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '2023 · up from 57 in 2015 · inadequate mental health care', sparklineData: [57,62,65,68,72,78,81] }] },
  'prison-education': { topic: 'Prison Education', slug: 'prison-education', href: '/prison-education', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Prisoners engaged in education', value: '38%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 48% in 2010 · lockdowns entrenched low participation', sparklineData: [48,45,42,40,35,36,38] }, { label: 'Prisoners with literacy below age 11', value: '47%', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: 'unchanged since 2003 · literacy key reoffending predictor', sparklineData: [50,49,48,47,47,47,47] }] },
  'rape-reporting-rate': { topic: 'Rape Reporting & Attrition', slug: 'rape-reporting-rate', href: '/rape-reporting-rate', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Rape reports resulting in charge', value: '2.4%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 1.7% in 2022 · but attrition remains catastrophic', sparklineData: [5.0,3.8,2.8,1.7,1.9,2.1,2.4] }, { label: 'Time from report to charge (months)', value: '32', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 18 months in 2015 · victim withdrawal main outcome', sparklineData: [18,20,22,25,28,30,32] }] },
  'online-grooming': { topic: 'Online Grooming', slug: 'online-grooming', href: '/online-grooming', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Online grooming offences recorded', value: '7,285', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '2023 · up 64% since 2019 · under-16s primary target', sparklineData: [3200,3800,4400,5200,5900,6600,7285] }, { label: 'Cases with unknown offender identity', value: '68%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'online platform access the vector', sparklineData: [55,58,60,62,64,66,68] }] },
  'honour-based-abuse': { topic: 'Honour-Based Abuse', slug: 'honour-based-abuse', href: '/honour-based-abuse', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Honour-based abuse offences recorded', value: '3,025', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '2023 · up from 1,601 in 2018 · better recording and awareness', sparklineData: [1601,1800,2000,2200,2500,2800,3025] }, { label: 'Forced Marriage Unit cases', value: '1,050', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: '25% of victims are male · under-reporting remains significant', sparklineData: [1300,1200,800,900,900,1000,1050] }] },
  'forced-marriage': { topic: 'Forced Marriage', slug: 'forced-marriage', href: '/forced-marriage', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Forced Marriage Unit cases annually', value: '1,050', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'recovering from COVID lows · South Asian communities 40% of cases', sparklineData: [1220,1267,1355,500,820,950,1050] }, { label: 'Under-18 victims of forced marriage', value: '17%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 24% in 2015 · school safeguarding improving', sparklineData: [24,23,21,20,19,18,17] }] },
  'homicide-rate': { topic: 'Homicide Rate', slug: 'homicide-rate', href: '/homicide-rate', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Homicides per year (England & Wales)', value: '602', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '2022/23 · up from 571 in 2018/19 · knife crime driving increase', sparklineData: [571,576,649,536,558,583,602] }, { label: 'Knife-involved homicides', value: '44%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 36% in 2010 · highest share since records began', sparklineData: [36,37,38,40,41,43,44] }] },
  'consumer-credit-stress': { topic: 'Consumer Credit Stress', slug: 'consumer-credit-stress', href: '/consumer-credit-stress', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Households in serious financial difficulty', value: '2.4M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 1.5M in 2021 · FCA Financial Lives Survey 2024', sparklineData: [1.5,1.6,1.8,2.0,2.2,2.3,2.4] }, { label: 'Average unsecured debt per household', value: '£4,200', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from £3,600 in 2020 · credit card and BNPL growth', sparklineData: [3600,3650,3700,3800,3900,4050,4200] }] },
  'household-savings-rate': { topic: 'Household Savings Rate', slug: 'household-savings-rate', href: '/household-savings-rate', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'UK household saving ratio', value: '8.6%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from pandemic high of 25.9% · normalising but eroded', sparklineData: [5.0,5.5,25.9,16.0,11.0,9.0,8.6] }, { label: 'Households with less than £100 in savings', value: '11.5M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 9M in 2020 · cost of living crisis eroded buffers', sparklineData: [9.0,9.2,9.0,9.5,10.0,11.0,11.5] }] },
  'services-exports-uk': { topic: 'UK Services Exports', slug: 'services-exports-uk', href: '/services-exports-uk', colour: '#264653', preposition: 'with', metrics: [{ label: 'UK services exports (annual)', value: '£444bn', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'financial, professional, creative services · 48% of total exports', sparklineData: [280,300,320,340,360,400,444] }, { label: 'UK global share of commercial services', value: '6.5%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 7.4% in 2015 · US and EU gaining share', sparklineData: [7.4,7.3,7.2,7.0,6.8,6.7,6.5] }] },
  'manufacturing-output': { topic: 'Manufacturing Output', slug: 'manufacturing-output', href: '/manufacturing-output', colour: '#264653', preposition: 'with', metrics: [{ label: 'Manufacturing GVA share of UK economy', value: '9.3%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 16% in 1997 · long-term deindustrialisation', sparklineData: [16,14,12,11,10.5,9.8,9.3] }, { label: 'Manufacturing output index (2019=100)', value: '95.2', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'below pre-pandemic level · supply chain and energy costs', sparklineData: [100,98,90,88,92,94,95.2] }] },
  'tourism-spending': { topic: 'UK Tourism Spending', slug: 'tourism-spending', href: '/tourism-spending', colour: '#264653', preposition: 'with', metrics: [{ label: 'Overseas visitor spending in UK (annual)', value: '£31.1bn', direction: 'up' as const, polarity: 'up-is-good' as const, context: '2024 · recovering post-COVID · pre-pandemic was £28.4bn', sparklineData: [28.4,4.5,9.0,18.0,24.0,28.0,31.1] }, { label: 'Visitor number shortfall vs EU competitors', value: '-8%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'estimated friction from ETA and visa requirements', sparklineData: [0,0,0,0,0,-5,-8] }] },
  'loan-sharks': { topic: 'Illegal Money Lending', slug: 'loan-sharks', href: '/loan-sharks', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Victims of loan sharks in England (est.)', value: '310,000', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: 'dark figure high · average illegal debt £5,000', sparklineData: [300000,305000,310000,310000,310000,308000,310000] }, { label: 'Illegal lenders prosecuted annually', value: '80', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 50 in 2015 · Illegal Money Lending Teams active', sparklineData: [50,55,60,65,70,75,80] }] },
  'scam-losses': { topic: 'Scam Losses', slug: 'scam-losses', href: '/scam-losses', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Authorised push payment fraud losses', value: '£459M', direction: 'down' as const, polarity: 'up-is-good' as const, context: '2024 · down from £583M in 2023 · reimbursement rules took effect', sparklineData: [355,479,583,583,500,459,459] }, { label: 'UK adults falling victim to scams per year', value: '2.7M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '5% of adults annually · phone and online most common', sparklineData: [1.8,2.0,2.2,2.4,2.5,2.6,2.7] }] },
  'online-fraud-losses': { topic: 'Online Fraud Losses', slug: 'online-fraud-losses', href: '/online-fraud-losses', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Online banking fraud losses (annual)', value: '£154M', direction: 'down' as const, polarity: 'up-is-good' as const, context: 'down from £224M in 2021 · bank security improvements', sparklineData: [148,176,224,196,175,160,154] }, { label: 'Investment fraud losses', value: '£1.2bn', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up 41% since 2020 · crypto and social media main vectors', sparklineData: [0.6,0.7,0.85,1.0,1.1,1.15,1.2] }] },
  'economic-crime-scale': { topic: 'Economic Crime Scale', slug: 'economic-crime-scale', href: '/economic-crime-scale', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Economic crime GDP cost (annual est.)', value: '£290bn', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'RUSI/NCA estimate · fraud 40% of all crime by volume', sparklineData: [190,210,230,250,265,280,290] }, { label: 'Suspicious Activity Reports filed', value: '460,000/yr', direction: 'up' as const, polarity: 'up-is-good' as const, context: '2023 · up 50% since 2018 · NCA processes but prosecutions lag', sparklineData: [190000,260000,320000,370000,400000,435000,460000] }] },
  'right-to-buy': { topic: 'Right to Buy', slug: 'right-to-buy', href: '/right-to-buy', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'Right to Buy sales (annual)', value: '9,600', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 40,000 in 2015 · higher discounts failed to boost sales', sparklineData: [40000,30000,20000,14000,12000,10000,9600] }, { label: 'Social homes replaced per RTB sale', value: '0.29', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'less than 1 in 3 sold homes replaced · net social stock shrinking', sparklineData: [0.15,0.20,0.22,0.25,0.26,0.28,0.29] }] },
  'domestic-abuse-refuges': { topic: 'Domestic Abuse Refuges', slug: 'domestic-abuse-refuges', href: '/domestic-abuse-refuges', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Women turned away from refuges daily', value: '120', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 155 in 2018 · demand still exceeds funded capacity', sparklineData: [155,150,142,135,128,122,120] }, { label: 'Refuge bed spaces (England)', value: '4,200', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 3,800 in 2018 · below 6,500 Council of Europe minimum', sparklineData: [3800,3850,3900,3950,4000,4100,4200] }] },
  'lpa-capacity-crisis': { topic: 'Planning Authority Capacity', slug: 'lpa-capacity-crisis', href: '/lpa-capacity-crisis', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'LPA planning staff vacancies', value: '23%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 12% in 2019 · salary gap with private sector driving exodus', sparklineData: [12,14,16,18,20,22,23] }, { label: 'Average major application decision time (weeks)', value: '30', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 22 weeks in 2018 · 30-week target regularly missed', sparklineData: [22,23,24,25,26,27,30] }] },
  'care-home-supply': { topic: 'Care Home Supply', slug: 'care-home-supply', href: '/care-home-supply', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Registered care home beds (England)', value: '428,000', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 463,000 in 2012 · demand growing as population ages', sparklineData: [463000,455000,448000,440000,435000,430000,428000] }, { label: 'Care home closures per year', value: '380', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 200 in 2015 · fees, staffing and CQC pressures', sparklineData: [200,220,250,280,320,360,380] }] },
  'community-asset-ownership': { topic: 'Community Asset Ownership', slug: 'community-asset-ownership', href: '/community-asset-ownership', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Community Asset Transfer completions', value: '8,400', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'cumulative since 2012 · pubs, libraries, leisure centres', sparklineData: [1000,2000,3500,4800,6000,7200,8400] }, { label: 'Assets of Community Value registered', value: '5,800', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'listed in England · right to bid protects community use', sparklineData: [500,1000,2000,3200,4200,5000,5800] }] },
  'home-education': { topic: 'Home Education', slug: 'home-education', href: '/home-education', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Home-educated children in England', value: '92,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 37,000 in 2019 · SEND crisis and school culture main drivers', sparklineData: [37000,45000,58000,72000,80000,87000,92000] }, { label: 'Councils unable to contact home-educated children', value: '1 in 5', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'safeguarding gap · no mandatory registration in England', sparklineData: [1,1,1,1,1,1,1] }] },
  'phonics-outcomes': { topic: 'Phonics Outcomes', slug: 'phonics-outcomes', href: '/phonics-outcomes', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Year 1 pupils passing phonics check', value: '79%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 58% in 2012 · biggest improvement in reading in a generation', sparklineData: [58,62,66,69,72,75,79] }, { label: 'Phonics pass rate (disadvantaged pupils)', value: '67%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 39% in 2012 · gap with peers narrowing but persistent', sparklineData: [39,43,48,53,58,63,67] }] },
  'school-readiness': { topic: 'School Readiness', slug: 'school-readiness', href: '/school-readiness', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Children at expected development at age 5', value: '67.2%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 71.8% in 2018/19 · COVID regression and poverty', sparklineData: [71.8,72.0,72.6,56.0,65.2,67.0,67.2] }, { label: 'FSM pupils at expected development', value: '50.3%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: '17pp gap with non-FSM peers · poverty biggest predictor', sparklineData: [57,57,58,45,48,49,50.3] }] },
  'speech-language-delays': { topic: 'Speech & Language Delays', slug: 'speech-language-delays', href: '/speech-language-delays', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Children with SLCN needing specialist support', value: '1.7M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '10% of all children · largest SEND category · COVID accelerated', sparklineData: [1.3,1.35,1.4,1.5,1.6,1.65,1.7] }, { label: 'Waiting for speech therapy assessment', value: '120,000', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 50,000 in 2019 · average wait 18 months', sparklineData: [50000,55000,70000,90000,105000,115000,120000] }] },
  'family-hubs': { topic: 'Family Hubs', slug: 'family-hubs', href: '/family-hubs', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Local authorities with Family Hubs', value: '75', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'out of 153 · government target reached · Sure Start replacement', sparklineData: [0,10,25,40,55,65,75] }, { label: 'Families seen by Family Hubs (2024)', value: '650,000', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'cumulative since 2022 launch · early years focus', sparklineData: [0,50000,120000,250000,400000,520000,650000] }] },
  'oral-health-inequalities': { topic: 'Oral Health Inequalities', slug: 'oral-health-inequalities', href: '/oral-health-inequalities', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Deprivation gap in child tooth decay', value: '3x', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: '42% most deprived vs 14% least · gap unchanged since 2008', sparklineData: [3,3,3,3,3,3,3] }, { label: 'Children in deprived areas seeing NHS dentist', value: '48%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 62% in 2019 · NHS dentistry collapse worst in poor areas', sparklineData: [62,60,55,50,49,48,48] }] },
  'student-loan-economics': { topic: 'Student Loan Economics', slug: 'student-loan-economics', href: '/student-loan-economics', colour: '#264653', preposition: 'with', metrics: [{ label: 'Graduate debt on graduation (England)', value: '£48,800', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from £27,000 in 2012 · higher fees and maintenance loan reliance', sparklineData: [27000,30000,33000,37000,41000,45000,48800] }, { label: 'Graduates expected to repay loan in full', value: '19%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 30% in 2019 · government bearing more write-off cost', sparklineData: [30,28,25,22,20,19,19] }] },
  'council-tax-bailiffs': { topic: 'Council Tax Bailiff Use', slug: 'council-tax-bailiffs', href: '/council-tax-bailiffs', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Bailiff referrals for council tax debt (annual)', value: '2.4M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 1.9M in 2019 · councils under financial pressure', sparklineData: [1900000,1950000,2000000,1800000,2100000,2250000,2400000] }, { label: 'Households in council tax arrears', value: '3.6M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 2.9M in 2020 · cost of living forcing arrears', sparklineData: [2900000,3000000,3100000,3200000,3300000,3500000,3600000] }] },
  'uc-deductions': { topic: 'Universal Credit Deductions', slug: 'uc-deductions', href: '/uc-deductions', colour: '#E63946', preposition: 'with', metrics: [{ label: 'UC claimants subject to deductions', value: '60%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 70% peak · deduction cap lowered to 15% in 2024', sparklineData: [64,70,68,66,64,62,60] }, { label: 'Average monthly deduction amount', value: '£61', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from £79 in 2022 · advance repayment main cause', sparklineData: [55,65,79,75,70,65,61] }] },
  'pension-auto-enrolment': { topic: 'Pension Auto-Enrolment', slug: 'pension-auto-enrolment', href: '/pension-auto-enrolment', colour: '#264653', preposition: 'with', metrics: [{ label: 'Workers enrolled in workplace pension', value: '22.6M', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 10.7M in 2012 · auto-enrolment doubled pension saving', sparklineData: [10.7,14.0,16.5,18.5,20.0,21.5,22.6] }, { label: 'Opt-out rate', value: '9%', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: 'stable since 2012 · rising cost of living may push opt-outs up', sparklineData: [9,9,9,9,10,10,9] }] },
  'credit-union-membership': { topic: 'Credit Union Membership', slug: 'credit-union-membership', href: '/credit-union-membership', colour: '#264653', preposition: 'with', metrics: [{ label: 'Credit union members (UK)', value: '2.1M', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 1.4M in 2015 · far below Ireland and US penetration', sparklineData: [1.4,1.5,1.6,1.7,1.8,1.95,2.1] }, { label: 'Credit union total assets (£bn)', value: '£3.8bn', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from £1.8bn in 2015 · growing but still niche', sparklineData: [1.8,2.0,2.4,2.8,3.2,3.5,3.8] }] },
  'air-quality-deaths': { topic: 'Air Quality Deaths', slug: 'air-quality-deaths', href: '/air-quality-deaths', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Premature deaths from air pollution (UK)', value: '43,000/yr', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 52,000 in 2010 · but 7th highest burden in Europe', sparklineData: [52000,50000,48000,46000,45000,44000,43000] }, { label: 'UK areas exceeding WHO PM2.5 guidelines', value: '95%', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 99% in 2020 · WHO tightened guidelines in 2021', sparklineData: [99,99,99,98,97,96,95] }] },
  'single-use-plastic-reduction': { topic: 'Single-Use Plastic Reduction', slug: 'single-use-plastic-reduction', href: '/single-use-plastic-reduction', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Single-use carrier bags sold (England)', value: '215M', direction: 'down' as const, polarity: 'up-is-good' as const, context: 'down 97% since 2015 · 5p then 10p charge · largest behaviour change', sparklineData: [7600,3000,1000,600,400,270,215] }, { label: 'Plastic straw/plate ban compliance', value: '87%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 65% in 2021 · bans rolled out 2020–2023', sparklineData: [0,0,65,72,78,84,87] }] },
  'textile-waste': { topic: 'Textile Waste', slug: 'textile-waste', href: '/textile-waste', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'Clothing sent to landfill (tonnes/year)', value: '350,000', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 450,000 in 2015 · charity shops and resale absorbing more', sparklineData: [450000,430000,410000,390000,370000,355000,350000] }, { label: 'Clothing purchased per person per year (kg)', value: '26.7', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: 'UK highest in Europe · fast fashion volumes stable', sparklineData: [28,27,28,22,25,26,26.7] }] },
  'meat-consumption-trend': { topic: 'Meat Consumption Trend', slug: 'meat-consumption-trend', href: '/meat-consumption-trend', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'UK per capita meat consumption (kg/year)', value: '83', direction: 'down' as const, polarity: 'up-is-good' as const, context: 'down from 92kg in 2010 · flexitarian shift · cost of living', sparklineData: [92,90,89,88,86,84,83] }, { label: 'Plant-based food market share', value: '1.8%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 0.8% in 2018 · growth slowing after 2021 peak', sparklineData: [0.8,1.0,1.4,1.9,2.1,1.9,1.8] }] },
  'urban-green-space': { topic: 'Urban Green Space Access', slug: 'urban-green-space', href: '/urban-green-space', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Urban residents within 300m of green space', value: '72%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 66% in 2018 · but deprived areas 25pp below average', sparklineData: [66,67,68,69,70,71,72] }, { label: 'Green space per person in most deprived LAs', value: '22 m²', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: 'vs 66m² in least deprived · inequality hardwired into planning', sparklineData: [20,21,21,21,22,22,22] }] },
  'water-company-leakage': { topic: 'Water Company Leakage', slug: 'water-company-leakage', href: '/water-company-leakage', colour: '#264653', preposition: 'with', metrics: [{ label: 'Water lost to leakage daily (England & Wales)', value: '2.4bn litres', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 3.1bn in 2018 · Ofwat 2030 target of 1.8bn still ambitious', sparklineData: [3100,3000,2900,2800,2700,2550,2400] }, { label: 'Companies missing leakage reduction targets', value: '7 of 9', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'most companies failing Ofwat targets · profit prioritisation', sparklineData: [2,3,4,5,6,7,7] }] },
  'fly-tipping-england': { topic: 'Fly-Tipping', slug: 'fly-tipping-england', href: '/fly-tipping-england', colour: '#F4A261', preposition: 'with', metrics: [{ label: 'Fly-tipping incidents (England)', value: '1.15M', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 900,000 in 2015 · household waste tip charges driving increase', sparklineData: [900000,950000,990000,1030000,1080000,1110000,1150000] }, { label: 'Cost of fly-tipping clearance', value: '£392M/yr', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from £280M in 2015 · borne by councils and landowners', sparklineData: [280,300,320,340,360,375,392] }] },
  'habitat-net-gain': { topic: 'Biodiversity Net Gain', slug: 'habitat-net-gain', href: '/habitat-net-gain', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Planning permissions with BNG requirement', value: '28,000', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'since mandatory BNG from April 2024 · early implementation', sparklineData: [0,0,0,0,0,5000,28000] }, { label: 'Habitat bank units registered', value: '12,500', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from near-zero in 2023 · biodiversity market emerging', sparklineData: [0,0,0,500,2000,7000,12500] }] },
  'road-casualties': { topic: 'Road Casualties', slug: 'road-casualties', href: '/road-casualties', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Road deaths per year (UK)', value: '1,695', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 3,172 in 2000 · but reduction stalled since 2013', sparklineData: [3172,2222,1750,1730,1720,1700,1695] }, { label: 'Serious road injuries per year', value: '28,900', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: 'stagnant since 2010 · UK once world leader in safety, now slipping', sparklineData: [26000,27000,28000,28200,28500,28800,28900] }] },
  'rail-fares': { topic: 'Rail Fares', slug: 'rail-fares', href: '/rail-fares', colour: '#264653', preposition: 'with', metrics: [{ label: 'Rail fares increase above CPI since 2010', value: '+51%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'fares risen 51% above inflation · among highest in Europe', sparklineData: [100,108,116,124,132,142,151] }, { label: 'Annual season ticket London–Manchester', value: '£9,700', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from £7,200 in 2015 · commuter cost forcing remote-work choices', sparklineData: [7200,7500,7800,8200,8700,9200,9700] }] },
  'cycling-fatalities': { topic: 'Cycling Fatalities', slug: 'cycling-fatalities', href: '/cycling-fatalities', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Cyclist deaths per year (UK)', value: '99', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '2023 · up from 73 in 2019 · cycling growth without infrastructure', sparklineData: [73,80,90,102,95,97,99] }, { label: 'Cyclist serious injuries per year', value: '4,400', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up 23% since 2019 · HGV and junction design main factors', sparklineData: [3600,3700,3900,4100,4200,4300,4400] }] },
  'bridge-maintenance-backlog': { topic: 'Bridge Maintenance Backlog', slug: 'bridge-maintenance-backlog', href: '/bridge-maintenance-backlog', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Local authority bridge maintenance backlog', value: '£5.6bn', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from £3.9bn in 2018 · austerity cuts to structural maintenance', sparklineData: [3900,4200,4600,4900,5100,5400,5600] }, { label: 'Bridges with weight restrictions', value: '4,200', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 3,100 in 2018 · restricting freight and emergency access', sparklineData: [3100,3300,3500,3700,3900,4050,4200] }] },
  'gambling-advertising': { topic: 'Gambling Advertising', slug: 'gambling-advertising', href: '/gambling-advertising', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Children seeing gambling ads weekly (est.)', value: '720,000', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 1.4M in 2020 · watershed rules tightened · online loophole remains', sparklineData: [1400000,1300000,1100000,900000,800000,750000,720000] }, { label: 'Gambling advertising spend (annual)', value: '£1.5bn', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from £760M in 2014 · sport sponsorship and streaming dominant', sparklineData: [760,850,950,1050,1200,1380,1500] }] },
  'online-gambling-growth': { topic: 'Online Gambling Growth', slug: 'online-gambling-growth', href: '/online-gambling-growth', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Online gambling gross yield (annual)', value: '£6.9bn', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from £1.8bn in 2012 · now 46% of total GGY', sparklineData: [1800,2300,2800,3300,3900,5500,6900] }, { label: 'Online gamblers betting in-play on mobiles', value: '54%', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'up from 22% in 2015 · in-play most closely linked with harm', sparklineData: [22,27,32,38,44,50,54] }] },
  'fixed-odds-betting-reform': { topic: 'Fixed-Odds Betting Terminals', slug: 'fixed-odds-betting-reform', href: '/fixed-odds-betting-reform', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Maximum FOBT stake', value: '£2', direction: 'down' as const, polarity: 'up-is-good' as const, context: 'reduced from £100 in 2019 · est. 100,000 problem gamblers helped', sparklineData: [100,100,100,100,2,2,2] }, { label: 'UK bookmaker shops remaining', value: '5,700', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 8,700 in 2018 · 2,400 shops closed post-cap', sparklineData: [8700,8500,7500,6500,6000,5800,5700] }] },
  'alcohol-specific-deaths': { topic: 'Alcohol-Specific Deaths', slug: 'alcohol-specific-deaths', href: '/alcohol-specific-deaths', colour: '#E63946', preposition: 'with', metrics: [{ label: 'Alcohol-specific deaths per year (UK)', value: '9,641', direction: 'up' as const, polarity: 'up-is-bad' as const, context: '2022 record · up 32% since 2019 · lockdown drinking legacy', sparklineData: [6567,7023,7423,7565,9641,9641,9641] }, { label: 'Alcohol-specific death rate per 100,000', value: '16.5', direction: 'up' as const, polarity: 'up-is-bad' as const, context: 'highest on record · Scotland and North West worst affected', sparklineData: [11.5,12.0,12.8,13.0,16.5,16.5,16.5] }] },
  'heritage-at-risk': { topic: 'Heritage at Risk', slug: 'heritage-at-risk', href: '/heritage-at-risk', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Listed buildings at risk (England)', value: '4,958', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 5,800 in 2010 · but pandemic and cost of living reversed gains', sparklineData: [5800,5600,5400,5200,5000,4900,4958] }, { label: 'Scheduled monuments at risk', value: '3%', direction: 'flat' as const, polarity: 'up-is-bad' as const, context: 'stable · climate change and development pressure increasing', sparklineData: [3,3,3,3,3,3,3] }] },
  'veteran-rough-sleeping': { topic: 'Veteran Rough Sleeping', slug: 'veteran-rough-sleeping', href: '/veteran-rough-sleeping', colour: '#6B7280', preposition: 'with', metrics: [{ label: 'Veterans counted sleeping rough (single night)', value: '380', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 600 in 2010 · SPACES programme and Op FORTITUDE', sparklineData: [600,570,530,480,440,400,380] }, { label: 'Veterans accessing Op FORTITUDE support', value: '2,800/yr', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'since 2023 launch · fast-track to social housing', sparklineData: [0,0,0,0,0,1200,2800] }] },
  'disability-sport-gap': { topic: 'Disability Sport Gap', slug: 'disability-sport-gap', href: '/disability-sport-gap', colour: '#2A9D8F', preposition: 'with', metrics: [{ label: 'Disabled people meeting activity guidelines', value: '42%', direction: 'up' as const, polarity: 'up-is-good' as const, context: 'up from 32% in 2015 · but 24pp gap with non-disabled people', sparklineData: [32,34,36,38,40,41,42] }, { label: 'Activity gap (disabled vs non-disabled)', value: '24pp', direction: 'down' as const, polarity: 'up-is-bad' as const, context: 'down from 32pp in 2015 · accessible facilities still a major barrier', sparklineData: [32,30,29,28,26,25,24] }] },
